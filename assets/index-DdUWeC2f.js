import{r as a,A as L,f as k,i as _,j as e,x as Q,T as v,s as I,ag as W,v as A,q as w,ai as G,aZ as K,a_ as Z,a0 as U,a$ as J,b0 as V,b1 as X,m as Y,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-DFLxrXjz.js";import{T as ae}from"./Tabs-B4QJrvWg.js";import{C as ie}from"./index-DeLg1i6n.js";import{R as ne}from"./ResponsiveImage-DTtglx1x.js";import{C as le}from"./index-DBIqiG2E.js";import{C as ce}from"./index-DusIoz3Z.js";import{R as de}from"./index-cBYSkTIa.js";import{b as ue,Q as me}from"./questionnaires-DOvOndsg.js";import{u as pe}from"./useDownloadCertificate-DURE7IJp.js";import{t as ge}from"./toast-Bspdnwd0.js";import{u as xe}from"./useRoles-_Zzxr2h8.js";import{u as H}from"./useSearchParams-B4M0tKQi.js";import{P as he}from"./index-B8NC1KIp.js";import{S as fe}from"./swiper-BkFuU53M.js";import{S as O}from"./swiper-react-B78FQ3Jo.js";import{C as B}from"./CourseCard-BJfuI2Xc.js";import"./base-C7euzKDi.js";import"./a11y-Ck2cbnC9.js";import"./index-CTnSS98m.js";const Ce=({courseData:s,visible:d,onClose:t})=>{const{sendProgress:u}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:l}=_(),g=a.useCallback(async()=>{await u(s.course.id,s.progress.map(({topic_id:f})=>({topic_id:f,status:0}))),l(`/course/${s.course.id}`)},[s.course.id,s.progress,u,l]);return e.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:e.jsxs(e.Fragment,{children:[e.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),e.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),e.jsxs(W,{$gap:16,children:[e.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),e.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},je=w(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
