...
`,qe=({title:e,children:t,active:n,onClick:a})=>{const[i,s]=B.useState(n||!1);return r.jsxs(kt,{children:[r.jsx("div",{className:"collapse-title",children:r.jsx(Ze,{name:e,label:r.jsx("strong",{children:e}),checked:n||i,onChange:()=>[s(!i),a&&a()]})}),(n||i)&&r.jsx("div",{className:"collapse-content",children:t})]})},Tt=Z.div`
  .input-wrapper {
