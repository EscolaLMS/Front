import{q as c,j as s,i as r,r as o,H as p,f as v,h as y,T as $,bn as k,bo as g,x as d,o as T}from"./index-mArHxJMN.js";const w=c.div`
  padding: 11px 6px;
  background: ${({theme:e})=>e.mode==="dark"?e.dm__cardBackgroundColor:e.white};
  border-radius: ${({theme:e})=>e.cardRadius}px;
`,m=({children:e})=>s.jsx(w,{children:e}),C=c.div`
  h2 {
    margin-bottom: 10px;
  }
`,h=c("aside")`
