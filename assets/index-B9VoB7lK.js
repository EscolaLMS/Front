import{b as E,U as M,r as i,m as k,j as e,q as x,i as n,W as c,L as m,aA as N,y as d,O as u,T as b,f as p,h as L,o as v,aB as C,I as T,aC as _,l as I,aD as R,aE as h,aF as B,aG as z,aH as A,ar as S,ak as D,al as W,w as G,C as O}from"./index-B3KsnArT.js";import{P as U}from"./index-BZprMsnL.js";import{a as q}from"./PricingCard-BM1qNTS4.js";import{P as F}from"./index-DkmVBOmL.js";import{B as H}from"./index-BNWatGFK.js";const V=E.createContext({}),J=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},K=x.div`
  width: 100%;
  left: 0;
