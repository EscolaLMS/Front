import{b as E,V as M,r as i,n as k,j as e,q as x,k as n,Y as c,L as m,az as N,z as d,Q as u,T as b,h as p,i as L,p as v,aA as C,I as T,aB as _,m as I,aC as R,aD as h,aE as z,aF as B,aG as A,aq as S,aj as D,ak as q,x as G,C as W}from"./index-BrDgRaEo.js";import{P as F}from"./index-iFVeEm4w.js";import{a as O}from"./PricingCard-BnrZYgbj.js";import{P as U}from"./index-Dn8AjmU3.js";import{B as V}from"./index-D6wFQ5u_.js";const H=E.createContext({}),Q=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(H.Provider,{value:{},children:t})},Y=x.div`
  width: 100%;
  left: 0;
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(F,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},fe=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(G,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(Q,{children:e.jsx(W,{children:e.jsx(pe,{})})})})};export{fe as default};
