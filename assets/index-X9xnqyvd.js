...
`,Ue=({title:t,children:e,active:n,onClick:a})=>{const[i,s]=A.useState(n||!1);return r.jsxs(Tt,{children:[r.jsx("div",{className:"collapse-title",children:r.jsx(Ze,{name:t,label:r.jsx("strong",{children:t}),checked:n||i,onChange:()=>[s(!i),a&&a()]})}),(n||i)&&r.jsx("div",{className:"collapse-content",children:e})]})},Nt=Z.div`
  .input-wrapper {
...
`,Ht=()=>{var l,o,E,w,k;const{config:t}=A.useContext(rt.EscolaLMSContext),e=f=>kt(f),n=(o=(l=t==null?void 0:t.value)==null?void 0:l.escolalms_payments)==null?void 0:o.drivers,a=(E=n==null?void 0:n.stripe)==null?void 0:E.publishable_key,i=Ee(),s=ke.getFontFromTheme(i),c=(k=(w=t==null?void 0:t.value)==null?void 0:w.escolalms_payments)==null?void 0:k.default_gateway;if(c==="Przelewy24")return r.jsx(_e,{children:r.jsx(Lt,{})});if(c==="stripe")return r.jsx(_e,{children:r.jsx(Be,{stripe:e(a),options:{fonts:[{cssSrc:s.links[0]}]},children:r.jsx(It,{stripeKey:a})})})};export{Ht as default};
