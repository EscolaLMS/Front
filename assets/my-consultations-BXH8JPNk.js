import{r as i,i as P,h as x,j as e,U as h,x as g,o as v,q as m,L as S,ak as M,X as w,K as A,aP as T,aQ as b,aR as N,aS as D,aT as _,aj as L,as as U,aU as R,g as k,y as $,aV as F,aW as B,$ as G,v as W,C as O}from"./index-Dw0jMVas.js";import{a as K,T as q}from"./index-CEcVtfmt.js";import{C as z}from"./index-C-2YFBI_.js";import{P as H,C as V,D as f,a as j,b as X}from"./index-BKLBtC2o.js";import{u as J}from"./useRoles-DXPXp7bJ.js";import{C as Q}from"./CourseCard-DptZ095z.js";import"./questionnaire-CXWDgbJ4.js";import"./questionnaires-mpruX4bR.js";import"./useDownloadCertificate-DCC5wf-A.js";import"./base-7gvCcPfx.js";import"./index-DbP1v-Dy.js";import"./swiper-BcjZlipX.js";import"./swiper-react-DL3BDhpm.js";import"./a11y-DjADS165.js";import"./warning-CaCfmk4V.js";import"./index-BrYfG95Q.js";import"./index-BehfQop9.js";import"./index-BHvNIL2j.js";const Y=({type:t})=>{var l;const{userConsultations:s,fetchUserConsultations:n}=i.useContext(P.EscolaLMSContext),{t:o}=x(),[a,r]=i.useState([]),c=i.useMemo(()=>{var p;return((p=s.list)==null?void 0:p.data.filter(C=>t===E.STARTED||t===E.UPCOMING?C.in_coming||C.is_started:C.is_ended))||[]},[t,(l=s.list)==null?void 0:l.data]);return i.useEffect(()=>{n()},[t,n]),i.useEffect(()=>(r(c),()=>{r([])}),[c]),e.jsx(H,{children:e.jsx(h.Row,{style:{gap:"30px 0"},children:s.loading?Array.from({length:8}).map((p,C)=>e.jsx(h.Col,{md:3,children:e.jsx(Q,{})},`skeleton-card-${C}`)):a.length===0?e.jsx(g.Text,{style:{paddingLeft:v?20:40},children:o("MyProfilePage.OrdersEmpty")}):e.jsx(e.Fragment,{children:a.map(p=>e.jsx(h.Col,{xs:12,md:6,lg:3,children:e.jsx(V,{consultation:p})},p.id))})})})},y=i.memo(Y),Z=m.div`
  .course-section {
    margin-top: 0px;
  }
