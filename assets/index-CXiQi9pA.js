import{b as L,r as g,D as B,i as R,k as q,q as C,n as P,f as b,j as e,w as S,s as j,m as f,L as $,T as W,V as N,W as k,X as M,Y as H,Z as X,o as G,C as O}from"./index-CBf-QksF.js";import{P as U}from"./index-C3JxcG_U.js";import{q as _}from"./base-C7euzKDi.js";import{R as V}from"./ResponsiveImage-BnPBXGWb.js";import{C as Y}from"./index-DVEYPayL.js";import{C as Z}from"./index-DSumW0cD.js";import{P as J}from"./index-JHcu9MtM.js";import{C as K}from"./CourseCard-DwcXtjc_.js";import{u as Q}from"./useFetchCourses-D4UdEUZe.js";const z=L.createContext({}),ee=()=>{const{courses:r,params:t,setParams:s,loading:x}=g.useContext(z),{fetchCategories:a,categoryTree:c}=g.useContext(B.EscolaLMSContext),[o,n]=g.useState([]),i=R(),h=q(),y=g.useCallback(l=>{s&&s({...t,order:l})},[t,s]),u=g.useCallback(l=>{s&&s({...t,page:l})},[t,s]),E=g.useCallback(l=>{const d=o.filter(p=>p.id!==l);n(d),s&&s({...t,page:1,"categories[]":d.map(p=>p.id)})},[t,o,s]),T=g.useCallback(l=>{const d=o.some(p=>p.id===l.id)?o.filter(p=>p.id!==l.id):[...o,l];n(d),s&&s({...t,page:1,"categories[]":d.map(p=>p.id)})},[t,o,s]),v=g.useCallback(()=>{n([]),s&&s({...t,page:1,order:void 0,"categories[]":void 0})},[t,s]),w=g.useCallback(l=>l.flatMap(d=>{const p=w(d.subcategories||[]);return[d,...p]}),[]);return g.useEffect(()=>{const d=_.parse(h.search)["categories[]"];if(d){const D=w(c.list||[]).filter(A=>d.includes(String(A.id)));n(D)}},[h.search,c,w]),g.useEffect(()=>{a()},[a]),g.useEffect(()=>{t&&i.push(`${h.pathname}?${_.stringify(t)}`)},[t,h.pathname,i]),{courses:r,loading:x,prevCategories:o,handleSortChange:y,handlePageChange:u,handleRemoveCategory:E,handleCategoryChange:T,onClearCategories:v,params:t,categoryTree:c}},F=C.section`
  margin-bottom: ${P?"50px":"75px"};
`,se=({courses:r,loading:t})=>{const s=R(),{t:x}=b();return r&&!t&&r.length===0?e.jsx(S.Row,{justify:"center",children:e.jsx(j.Text,{size:"18",children:x("NoCourses")})}):t?e.jsx(F,{children:e.jsx(S.Row,{style:{gap:"30px 0"},children:Array.from({length:12}).map((a,c)=>e.jsx(K,{colProps:{xl:3,lg:4,md:6}},`index-${c}-skeleton`))})}):e.jsx(F,{children:e.jsx(S.Row,{style:{gap:"30px 0"},children:r==null?void 0:r.map(a=>{var c,o,n;return e.jsx(S.Col,{md:6,lg:4,xl:3,children:e.jsx(f.NewCourseCard,{mobile:P,id:a.id,image:e.jsx($,{to:`/courses/${a.id}`,children:a.image_path?e.jsx(V.ResponsiveImage,{path:a.image_path,alt:a.title,srcSizes:[300,600,900]}):e.jsx(Z,{})}),price:a.public?e.jsx("div",{className:"course-price",children:x("FREE")}):e.jsx(J,{price:(c=a.product)==null?void 0:c.price,oldPrice:(o=a.product)==null?void 0:o.price_old,taxRate:(n=a.product)==null?void 0:n.tax_rate}),title:e.jsx($,{to:`/courses/${a.id}`,children:e.jsx(W.Title,{level:3,as:"h3",className:"title",children:a.title})}),categories:e.jsx(Y,{categories:a.categories,onCategoryClick:i=>{s.push(`/courses/?categories[]=${i}`)}})})},a.id)})})})},re=C.div`
  display: flex;
...
`,he=C.div`
  ...
  position: relative;
  margin-bottom: 16px;
`,ve=()=>{const{t:r}=b();return e.jsx(G,{metaTitle:r("CoursesPage.Courses"),children:e.jsx(ge,{onlyFree:!1,children:e.jsxs(xe,{className:"courses-page",children:[e.jsx(he,{children:e.jsx(O,{children:e.jsxs(f.Title,{level:1,children:[" ",r("CoursesPage.Courses")]})})}),e.jsx(O,{children:e.jsx(le,{})})]})})})};export{ve as default};
