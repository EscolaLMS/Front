import{b as cn,r as b,h as dn,k as G,i as un,j as r,q as X,n as N,d as h,E as pn,a5 as gn,aG as xn,aH as fn,G as hn,aI as mn,F as bn,a6 as vn,D as J,f as A,X as K,T as wn,S as jn,w as H,o as yn,C as Cn}from"./index-BrnsqxCr.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-BUk6-CIV.js";import{F as kn,S as Tn}from"./index-D6Mu6m_p.js";import{W as On}from"./index-CxweHXOw.js";import{P as Pn}from"./index-BvzEMQss.js";import"./swiper-react-DvG64NmY.js";import"./ResponsiveImage-Cy_iuZ6S.js";import"./index-D6Vr4FBf.js";import"./index-CQOyv8Aw.js";const D=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(D.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
