...
`,he=u.div`
  ...
  position: relative;
  margin-bottom: 16px;
`,be=()=>{const{t:r}=b();return e.jsx(G,{metaTitle:r("CoursesPage.Courses"),children:e.jsx(ge,{onlyFree:!1,children:e.jsxs(xe,{className:"courses-page",children:[e.jsx(he,{children:e.jsx(O,{children:e.jsxs(f.Title,{level:1,children:[" ",r("CoursesPage.Courses")]})})}),e.jsx(O,{children:e.jsx(le,{})})]})})})};export{be as default};
