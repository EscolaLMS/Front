import{f as p,j as e,am as F,T as R,aw as q,r as l,D as j,w as k,k as S,v as C,q as T,h as m,at as z,o as r,au as u,af as w,ag as A,ah as G,l as D,i as U,Z as J,B as h,N as L,a0 as Z,a1 as K,m as Q,H as V,L as X,aB as Y}from"./index-B8t7bxZo.js";import{C as b,T as O}from"./index-CuTZvxiv.js";import{B as ee}from"./index-TCOD3AvE.js";import{a as te}from"./ResponsiveImage-B7bcvD5e.js";import{f as $}from"./date-DjWK0l4x.js";import{P as se}from"./PricingCard-C-MVvD2_.js";import{W as ae}from"./index-R2gt0C-J.js";import{P as oe}from"./index-PJPEAvUT.js";import"./app-B2E7767C.js";import"./index-Cks0KJwc.js";import"./index-B3TTgJzd.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&F(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(R.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(q,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(k,{to:S.home,children:a("Home")}),e.jsx(k,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
