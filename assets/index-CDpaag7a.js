import{b as J,r as x,A as ne,i as A,n as K,q as C,O as oe,j as r,Q as ie,k as P,f as k,s as D,T as w,V as T,v as G,o as ce,W as M,Y as E,X as le,Z as de,d as I,g as ge,L as pe,C as q}from"./index-DPt-kbd_.js";import{P as ue}from"./index-CSgweNPG.js";import{q as N}from"./base-C7euzKDi.js";import{R as me}from"./ResponsiveImage-CM6EDuxv.js";import{C as xe}from"./index-CRbTpvtt.js";import{C as fe}from"./index-BfRUgfmI.js";import{P as he}from"./index-VcbCZUss.js";import{C as Ce,u as be}from"./CourseCard-3ILGwHQb.js";import"./index-DB6D8qFb.js";import"./app-B2E7767C.js";import"./date-BM4UYDeF.js";const ee=J.createContext({}),je=()=>{const{courses:e,params:s,setParams:t,loading:c}=x.useContext(ee),{fetchCategories:a,categoryTree:l}=x.useContext(ne.EscolaLMSContext),[i,n]=x.useState([]),o=A(),g=K(),b=x.useCallback(u=>{t&&t({...s,order:u})},[s,t]),f=x.useCallback(u=>{t&&t({...s,page:u})},[s,t]),h=x.useCallback(u=>{const p=i.filter(m=>m.id!==u);n(p),t&&t({...s,page:1,"categories[]":p.map(m=>m.id)})},[s,i,t]),v=x.useCallback(u=>{const p=i.some(m=>m.id===u.id)?i.filter(m=>m.id!==u.id):[...i,u];n(p),t&&t({...s,page:1,"categories[]":p.map(m=>m.id)})},[s,i,t]),S=x.useCallback(()=>{n([]),t&&t({...s,page:1,order:void 0,"categories[]":void 0})},[s,t]),$=x.useCallback(u=>u.flatMap(p=>{const m=$(p.subcategories||[]);return[p,...m]}),[]);return x.useEffect(()=>{const p=N.parse(g.search)["categories[]"];if(p){const R=$(l.list||[]).filter(L=>p.includes(String(L.id)));n(R)}},[g.search,l,$]),x.useEffect(()=>{a()},[a]),x.useEffect(()=>{s&&o.push(`${g.pathname}?${N.stringify(s)}`)},[s,g.pathname,o]),{courses:e,loading:c,prevCategories:i,handleSortChange:b,handlePageChange:f,handleRemoveCategory:h,handleCategoryChange:v,onClearCategories:S,params:s,categoryTree:l}},ye=C.div`
  .close {
    all: unset;
    cursor: pointer;
  }
