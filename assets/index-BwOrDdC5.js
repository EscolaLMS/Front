import{q as d,j as t,n as j,ae as B,r as c,h as C,K as v,o as b,$ as T,ca as L,ap as g,cb as P,cc as z,T as y,k as $,cd as W,ce as O,cf as V,x as S,y as D,cg as Q,aG as H,aF as I,ch as q,L as N,m as k,c4 as R,ci as U,i as K,v as G}from"./index-Dw0jMVas.js";import{u as w,C as Y,a as J,b as X}from"./CourseAgenda-CS59vU1A.js";import{Q as Z}from"./index-BrYfG95Q.js";import{u as ee}from"./useDownloadCertificate-DCC5wf-A.js";import{Q as te}from"./questionnaire-CXWDgbJ4.js";import"./index-CPuXaJnf.js";import"./warning-CaCfmk4V.js";import"./Upload-CzcRMlrc.js";import"./useRoles-DXPXp7bJ.js";const se=d.div`
...
`,Be=({onNextClick:e})=>{const{t:s}=C();return t.jsxs(_,{children:[t.jsx("div",{className:"icon-container",children:t.jsx(V,{})}),t.jsx(y.Title,{className:"title",level:1,children:s("CoursePanel.FinishPage.Congrats")}),t.jsx(y.Title,{className:"subtitle",level:2,children:s("CoursePanel.FinishPage.Subtitle")}),t.jsx(S.Text,{className:"text",children:s("CoursePanel.FinishPage.Text")}),t.jsx(D.Button,{className:"button",onClick:e,children:s("Next")})]})},Le=({certificates:e})=>{const{t:s}=C(),{downloadCertificate:i,loadingId:o}=ee(),n=c.useCallback(()=>{e.forEach(({id:l,title:r})=>{i(l,r)})},[e,i]);return t.jsxs(_,{className:"certificate-container",children:[t.jsx("div",{className:"icon-container",children:t.jsx(Q,{})}),t.jsx(H,{className:"subtitle",level:2,children:s("CoursePanel.FinishPage.YourCertificate")}),t.jsx(I,{className:"button",onClick:n,loading:o!==-1,disabled:o!==-1,children:s("DownloadCertificate")}),t.jsx(q,{className:"text",children:s("CoursePanel.FinishPage.CertificateText")}),t.jsx(N,{to:k.home,children:t.jsx(I,{mode:"outline",className:"button",children:s("BackToHomePage")})})]})},ze=()=>{const[e,s]=c.useState({showModal:!1,isAnyQuestionnaire:null,showCertificate:!1,certificates:null}),{courseId:i}=w(),{fetchCertificates:o}=c.useContext(v.EscolaLMSContext),n=$(),l=c.useCallback(async()=>{try{const p=await o({assignable_type:R.CertificateAssignableTypes.Course,assignable_id:Number(i)});p&&p.success&&s(f=>({...f,certificates:p.data}))}catch(p){console.log("Error: ",p)}},[i,o]);c.useEffect(()=>{l()},[]);const r=c.useCallback(()=>{s(p=>({...p,showModal:!1,showCertificate:!0}))},[]),x=c.useCallback(()=>{if(e.isAnyQuestionnaire){r();return}if(e.certificates&&e.certificates.length>0){r();return}n.push(k.myProfile)},[n,r,e.certificates,e.isAnyQuestionnaire]),h=c.useCallback(p=>{s(f=>({...f,isAnyQuestionnaire:p}))},[]);return t.jsxs(Fe,{children:[!e.showCertificate&&t.jsx(Be,{onNextClick:x}),e.showCertificate&&e.certificates&&t.jsx(Le,{certificates:e.certificates}),t.jsx(Z,{entityId:Number(i),entityModel:te.COURSE,showModal:e.showModal,onSuccesGetQuestionnaires:h})]})},We=d.header`
  display: flex;
  align-items: center;
  justify-content: space-between;
