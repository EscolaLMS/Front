...
`;var m=(r=>(r.categories="categories",r.sort="sort",r))(m||{});const pe=()=>{var v,w,l,d,p;const[r,a]=q.useState({showDrawer:!1,type:"categories"}),{courses:s,loading:x,prevCategories:t,handleSortChange:c,handlePageChange:o,handleRemoveCategory:n,handleCategoryChange:i,onClearCategories:h,params:y,categoryTree:C}=se(),E=G(),{t:T}=b();return e.jsxs(e.Fragment,{children:[e.jsx(ie,{prevCategories:t,onClearCategories:h,handleCategoryChange:i,categories:C.list||[],handleSortChange:c,params:y,setMobileDrawerState:a,parentState:r}),t.length>0&&e.jsxs(ce,{children:[t.map(S=>e.jsxs(le,{onClick:()=>n(S.id),children:[e.jsx(j.Text,{size:"13",children:S.name}),e.jsx(U,{color:E.gray2})]})),e.jsx("button",{className:"clear-categories",onClick:h,children:e.jsx(j.Text,{size:"13",children:T("CoursesPage.clearAll")})})]}),e.jsx(X,{isOpen:r.showDrawer,onClose:()=>a({showDrawer:!1,type:"categories"}),height:r.type==="categories"?"40vh":"12vh",children:e.jsx(te,{showDrawer:r.showDrawer,type:r.type,prevCategories:t,onClearCategories:h,handleCategoryChange:i,categories:C.list||[],handleSortChange:c,setMobileDrawerState:a})}),e.jsx(re,{courses:(s==null?void 0:s.data)||[],loading:x}),Number((v=s==null?void 0:s.meta)==null?void 0:v.total)>Number((w=s==null?void 0:s.meta)==null?void 0:w.per_page)&&e.jsx(V,{total:Number((l=s==null?void 0:s.meta)==null?void 0:l.total),perPage:Number((d=s==null?void 0:s.meta)==null?void 0:d.per_page),currentPage:Number((p=s==null?void 0:s.meta)==null?void 0:p.current_page),onPage:o})]})},de=12,ge=(r={})=>_.stringify(r),xe=({onlyFree:r=!0,children:a})=>{const[s,x]=g.useState({page:1,per_page:de,order_by:"created_at"}),{courses:t,loading:c,fetchCoursesData:o}=ee(s),n=z(),{push:i}=$();return g.useEffect(()=>{const h=_.parse(n.search),y=h&&{...h,order_by:"created_at"},C=y||s;x(C),i(`${n.pathname}?${ge(C)}`),o(C)},[n.search]),e.jsx(A.Provider,{value:{params:s,setParams:x,courses:t,onlyFree:r,loading:c},children:a})},he=u.section`
  padding-top: 31px;
`,ue=u.div`
  ...
  position: relative;
  margin-bottom: 16px;
`,be=()=>{const{t:r}=b();return e.jsx(Q,{metaTitle:r("CoursesPage.Courses"),children:e.jsx(xe,{onlyFree:!1,children:e.jsxs(he,{className:"courses-page",children:[e.jsx(ue,{children:e.jsx(F,{children:e.jsxs(f.Title,{level:1,children:[" ",r("CoursesPage.Courses")]})})}),e.jsx(F,{children:e.jsx(pe,{})})]})})})};export{be as default};
