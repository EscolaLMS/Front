import{aC as b,g as l,f as h,j as e,q as m,k as n,aD as u,r as x,A as y,T as k,Z as j}from"./index-DPt-kbd_.js";var w=b();const C=l(w),v=({onSubmit:a})=>{const{t}=h();return e.jsx(C,{placeholder:t("Filters.Search"),onSubmit:a})},S=m("div")`
  display: flex;
