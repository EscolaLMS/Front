import{r,A as $,f as k,i as F,j as t,w as q,o as N,T as _,ac as V,p as L,q as R,ae as Y,S as K,X as W,I as Z,k as B,v as O,K as U,U as ee,N as te,h as se,n as oe,s as Q,l as ne,d as M,D as re,F as ae,aO as ie}from"./index-DPt-kbd_.js";import{T as le}from"./Tabs-A6fnFTeS.js";import{C as ce}from"./index-BI9dgBs_.js";import{C as de}from"./index-BfRUgfmI.js";import{R as ue}from"./ResponsiveImage-CM6EDuxv.js";import{C as me}from"./index-DEm8zgWJ.js";import{C as pe}from"./index-CRbTpvtt.js";import{R as xe}from"./index-x6bWAbs5.js";import{g as ge,r as he}from"./index-DB6D8qFb.js";import{b as fe,Q as je}from"./questionnaires-COZ3EFCJ.js";import{P as ye}from"./index-CSbehMxQ.js";import{u as be}from"./useRoles-7-9e0HkA.js";import{u as G}from"./useSearchParams-BYZiDKU5.js";import{P as Ce}from"./index-CSgweNPG.js";import"./app-B2E7767C.js";import"./date-BM4UYDeF.js";import"./base-C7euzKDi.js";const Pe=({courseData:e,visible:s,onClose:o})=>{const{sendProgress:a}=r.useContext($.EscolaLMSContext),{t:n}=k(),{push:l}=F(),p=r.useCallback(async()=>{await a(e.course.id,e.progress.map(({topic_id:b})=>({topic_id:b,status:0}))),l(`/course/${e.course.id}`)},[e.course.id,e.progress,a,l]);return t.jsx(q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:s,onClose:o,children:t.jsxs(t.Fragment,{children:[t.jsx(N.Title,{level:4,children:n("ResetProgressModal.Continue")}),t.jsxs(_.Text,{children:[" ",n("ResetProgressModal.RestartCourse")]}),t.jsxs(V,{$gap:16,children:[t.jsx(L.Button,{mode:"primary",onClick:p,children:n("ResetProgressModal.WantContinue")}),t.jsx(L.Button,{mode:"primary",onClick:o,children:n("ResetProgressModal.Cancel")})]})]})})},ve=R(Y)`
  gap: 6px;
  margin: 0;
  width: 100%;
