import{b as J,G as Q,r as o,h as L,j as e,A as m,f as h,v as A,l as v,T as p,q as E,s as x,an as S,k as C,ao as b,ap as Y,aq as Z,ar as ee,i as te,a0 as q,o as u,p as j,K as N,as as se,at as ie,W as ae,aa as re,ab as ne,ag as oe,au as le,X as de,av as ce,al as xe,L as me,C as pe}from"./index-Dgt1a0Cx.js";import{P as ue}from"./index-BWBThmhh.js";import{B as he}from"./index-Cs9k-PPZ.js";import{a as K}from"./ResponsiveImage-ghj5d5AC.js";import{f as ge}from"./date-Bv1nYvSV.js";import{P as z}from"./PricingCard-DifkS3yL.js";import{f as W}from"./index-B_M1NQ7l.js";import{P as je}from"./index-DmY6vcHz.js";import{D as Ee}from"./index-DD4_5MUE.js";import{C as _}from"./index-DUA7v6e-.js";import{E as w}from"./index-CIxPdHgx.js";import"./app-B2E7767C.js";import"./index-Dp_qiSfW.js";import"./index-Bai6EYDK.js";import"./index-C29f-TlD.js";const ve=J.createContext({}),Ce=({children:t})=>{const{id:s}=Q(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(he,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
