import{f as g,j as e,af as R,l,ao as D,r,h as S,v as k,o as C,G as F,q as j,i as p,al as H,n as d,am as m,ab as q,ac as z,ad as G,k as B,m as A,V as U,T as J,W as V,Y,C as w,E as K,L as Q,at as X}from"./index-DaafzRP_.js";import{C as Z,T as b}from"./index-Q3Q68GJ4.js";import{B as O}from"./index-DVPhWZqb.js";import{a as ee}from"./ResponsiveImage-BWLsb9wG.js";import{f as L}from"./date-D2Y_Z1t9.js";import{P as te}from"./PricingCard-yK-81SRW.js";import{W as se}from"./index-S-n9hY2c.js";import{P as ae}from"./index-bfvIBFek.js";import"./app-B2E7767C.js";import"./index-p2Hnf5if.js";import"./index-DfHnr1oM.js";const $=({description:t,title:a})=>{const{t:o}=g();return t?e.jsx(e.Fragment,{children:t&&R(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(l.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(D,{children:t})]})}):null},oe=()=>{const{webinar:t}=r.useContext(S.EscolaLMSContext),{t:a}=g();return t.value?e.jsx(O,{items:[e.jsx(k,{to:C.home,children:a("Home")}),e.jsx(k,{to:C.webinars,children:a("Menu.Webinars")}),e.jsx(F.Text,{size:"12",children:t.value.name})]}):null},ie=j.div`
  .webinar-main-info {
    .image-wrapper {
