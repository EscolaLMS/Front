import{b as N,N as M,r as i,m as k,j as e,q as x,i as n,Q as c,L as m,aw as E,x as d,J as u,T as b,f as p,h as L,o as v,ax as C,I as T,ay as _,l as I,az as R,aA as h,aB as B,aC as z,aD as A,an as S,ag as D,ah as W,v as q,C as G}from"./index-flVLDudU.js";import{P as O}from"./index-C99Szp3t.js";import{a as U}from"./PricingCard-BUm3zRQY.js";import{P as F}from"./index-DFfvHZ7l.js";import{B as H}from"./index-untzBHxu.js";const V=N.createContext({}),J=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},Q=x.div`
  width: 100%;
  left: 0;
...
`,K=({children:t})=>e.jsx(Q,{children:t});var l=(t=>(t.Consultation="App\\Models\\Consultation",t.StationaryEvent="App\\Models\\StationaryEvent",t.Course="App\\Models\\Course",t.Webinar="App\\Models\\Webinar",t))(l||{});const X=t=>t.reduce((a,s)=>{const o=s.productable_type,r=a[o]??[];return{...a,[o]:[...r,s]}},{}),Y=x(c.Col)`
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(O,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},fe=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(q,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(J,{children:e.jsx(G,{children:e.jsx(pe,{})})})})};export{fe as default};
