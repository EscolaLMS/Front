...
`,Ae=({product:e})=>e?t.jsx(ne,{to:`/consultations/${e==null?void 0:e.consultation_term_id}`,children:e.consultation_media?t.jsx(ae,{path:e.consultation_media.image_path,alt:e.name,srcSizes:[300,600,900]}):t.jsx(je,{})}):null,Se=T.div`
  display: flex;
  align-items: center;
  user-select: none;
