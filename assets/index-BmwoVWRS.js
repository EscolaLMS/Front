import{b as M,D as E,r as n,h as y,j as e,q as b,w as c,L as m,aO as N,s as d,A as x,n as o,T as v,f as u,i as L,l as j,aK as C,J as w,ar as I,N as B,ax as R,ay as p,az as _,aA as $,aB as z,o as A,C as D}from"./index-qD7U5zMV.js";import{P as W}from"./index-2XLFpg2V.js";import{a as q}from"./PricingCard-knAeA_PI.js";import{P as G}from"./index-CPQe3EBT.js";import{D as O}from"./index-DJwITm-x.js";import{B as H}from"./index-Dzgask-Z.js";import{a as U}from"./ResponsiveImage-biK-hrc-.js";import{C as F,T as J}from"./index-CUgz6tbi.js";const K=M.createContext({}),V=({children:a})=>{const{id:s}=E(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{s&&t(Number(s))},[t,s]),e.jsx(K.Provider,{value:{},children:a})};var i=(a=>(a.Consultation="App\\Models\\Consultation",a.StationaryEvent="App\\Models\\StationaryEvent",a.Course="App\\Models\\Course",a.Webinar="App\\Models\\Webinar",a))(i||{});const Q=a=>a.reduce((s,t)=>{const r=t.productable_type,l=s[r]??[];return{...s,[r]:[...l,t]}},{}),X=b(c.Col)`
