import{r as p,A as W,q as O,v as F,f as Q,i as de,W as e1,j as n,Y as Se,s as B,l as se,n as k,X as Me,h as ze,D as Oe,Z as we,J as ne,L as K,a0 as n1,a1 as t1,d as C,a2 as Ae,a3 as ue,a4 as r1,a5 as pe,a6 as s1,a7 as o1,a8 as Z,b as i1,a9 as a1,aa as l1,ab as c1,T as xe,ac as d1,w as L,ad as u1,ae as p1,I as Ze,m as Y,af as De,ag as x1,ah as Fe,ai as m1,S as g1,C as Te,o as C1,aj as h1,ak as Le,M as He,x as Re}from"./index-CQ96WfSz.js";import{P as f1}from"./PricingCard-NI9GpFWz.js";import{P as Ge}from"./index-D0cv_siB.js";import{l as v1,A as _1,_ as j1,P as b1,I as y1,a as w1,O as T1,H as P1}from"./index-P0ht1xy3.js";import{B as M1}from"./index-DJo8rp4U.js";import{Q as qe,a as Ie,g as O1}from"./questionnaires-f2FHD02J.js";import{R as A1,a as S1}from"./ResponsiveImage-D_FmW4Qc.js";import{C as L1}from"./index-NPaUK2Xa.js";import{t as H1}from"./toast-CwM_HkAX.js";import{P as R1}from"./index-reJ2lLFi.js";import{D as I1}from"./index-k_ZnGrQR.js";import{S as N1}from"./swiper-CClqrQVx.js";import{S as B1}from"./swiper-react-DPen1Ja8.js";import{C as V1}from"./index-DwLacoX8.js";import{S as N}from"./index-D6sSRccO.js";import"./warning-CUCqxP7g.js";import"./index-BZ8bAeGI.js";import"./useFetchCourses-C34JRAWf.js";import"./CourseCard-A30qlITF.js";import"./a11y-Bvn7SDsJ.js";const k1=e=>{const[t,r]=p.useState({data:void 0,loaded:!1,loading:!1}),{user:i,fetchCourseProgress:a,courseProgressDetails:o}=p.useContext(W.EscolaLMSContext);return p.useEffect(()=>{o.byId&&o.byId[Number(e)]&&o.byId[Number(e)].value&&r({...t,data:o.byId[Number(e)].value,loaded:!0,loading:!1})},[e,o]),p.useEffect(()=>{i!=null&&i.value&&!i.loading&&!t.loading&&!t.loaded?(r({...t,loading:!0}),a(e).catch(()=>r({...t,loaded:!0,loading:!1}))):t.loaded||r({...t,loaded:!0})},[i,t,a,e]),{progress:t}},Ne=O(F.Button)`
  display: block;
  margin-bottom: 10px;
`,$1=({course:e,onRequestAccess:t})=>{var v,s;const{t:r}=Q(),{push:i}=de(),{courseAccess:a,cart:o,addToCart:l}=p.useContext(W.EscolaLMSContext),x=p.useMemo(()=>{var c,m;return(m=(c=a.list)==null?void 0:c.data)==null?void 0:m.find(u=>{var b;return((b=u==null?void 0:u.course)==null?void 0:b.id)===e.id})},[(v=a.list)==null?void 0:v.data,e.id]),g=p.useMemo(()=>n.jsx(F.Button,{loading:o.loading,mode:"secondary",onClick:()=>{var c;return l(Number((c=e.product)==null?void 0:c.id)).then(()=>i(se.cart))},children:r("Buy Course")}),[l,o.loading,(s=e.product)==null?void 0:s.id,i,r]);return x?x.status!=="approved"?n.jsxs(n.Fragment,{children:[n.jsx(Ne,{mode:"secondary",disabled:!0,children:r("CourseAccess.Pending")}),g]}):x.status==="approved"?n.jsx(F.Button,{onClick:()=>i(`/course/${e.id}`),mode:"secondary",children:r("Go to the course")}):g:n.jsxs(n.Fragment,{children:[n.jsx(Ne,{mode:"secondary",onClick:t,children:r("CourseAccess.RequestAccess")}),g]})},E1=({course:e,userOwnThisCourse:t,onRequestAccess:r})=>{var g,v;const{cart:i,user:a}=p.useContext(W.EscolaLMSContext),{t:o}=Q(),{push:l}=de(),x=p.useMemo(()=>{var s;return(s=i==null?void 0:i.value)==null?void 0:s.items.some(c=>{var m;return Number(c.product_id)===Number((m=e.product)==null?void 0:m.id)})},[(g=e.product)==null?void 0:g.id,i]);return e1(Number((v=a.value)==null?void 0:v.id),e)?n.jsx(F.Button,{onClick:()=>l(`/course/${e.id}`),mode:"secondary",children:o("Go to the course")}):Se(new Date(e.active_to||""))?n.jsx(B.Text,{children:o("CoursePage.IsFinished")}):x?n.jsx(F.Button,{mode:"secondary",onClick:()=>l(se.cart),children:o("CoursePage.GoToCheckout")}):t&&Se(new Date(e.active_from||""))?n.jsx(F.Button,{onClick:()=>l(`/course/${e.id}`),mode:"secondary",children:o("Go to the course")}):t?n.jsx(B.Text,{children:o("CoursePage.NotStarted")}):a.value&&e.product?n.jsx($1,{course:e,onRequestAccess:r}):e.product?n.jsx(F.Button,{onClick:()=>l(`/login?referrer=/courses/${e.id}`),mode:"secondary",children:o("Buy Course")}):n.jsx(B.Text,{children:o("CoursePage.UnavailableCourse")})},z1=O.div`
  width: 100%;
  left: 0;
...
`,ln=({author:e})=>n.jsx(L.Col,{lg:6,children:n.jsx(K,{to:`/tutors/${e.id}`,children:n.jsx(u1,{mobile:k,avatar:{alt:`${e.first_name} ${e.last_name}`,src:e.path_avatar?`${p1}/api/images/img?path=${e.path_avatar}`:Ze.tutorPlaceholderPath},fullName:`${e.first_name} ${e.last_name}`,description:e.bio})})});var D=(e=>(e.INIT="INIT",e.LOADED="LOADED",e.LOADING="LOADING",e.ERROR="ERROR",e))(D||{});const cn=O.div`
  display: flex;
  align-items: center;
  gap: 5px;
  p {
...
`,dn=({courseData:e})=>{const{fetchQuestionnaireStarsByModel:t}=p.useContext(W.EscolaLMSContext),[r,i]=p.useState({type:D.INIT}),a=de(),o=p.useCallback(async()=>{if(e.id)try{i({type:D.LOADING});const l=await t("course",Number(e.id));l.success&&i({type:D.LOADED,rating:l.data})}catch(l){i({type:D.ERROR,error:l instanceof Error?l.message:"Unknown error"})}},[e.id,t]);return p.useEffect(()=>{o()},[e.id,o]),n.jsx("section",{className:"course-main-info",children:n.jsxs(L.Row,{children:[n.jsxs(L.Col,{lg:12,children:[n.jsx(L1,{categories:e.categories,onCategoryClick:l=>{a.push(`/courses/?categories[]=${l}`)}}),n.jsx(xe.Title,{mobile:k,level:1,children:e.title}),r.type===D.LOADED?n.jsxs(cn,{children:[n.jsx(Y.Rating,{ratingValue:r.rating.avg_rate,label:`${r.rating.avg_rate}`}),n.jsx(Y.Text,{size:"13",children:"Śr. ocena kursu"}),n.jsx("div",{children:n.jsxs(Y.Text,{size:"13",children:["Dodane opinie ",n.jsx("strong",{children:r.rating.count_answers})]})})]}):r.type===D.LOADING?n.jsx(we,{width:"20px",height:"20px"}):r.type===D.ERROR?r.error:null]}),n.jsx(L.Col,{lg:12,children:e.image_path&&n.jsx("div",{className:"image-wrapper",children:n.jsx(A1.ResponsiveImage,{path:e.image_path,srcSizes:[790*.5,790,2*790]})})})]})})},ye={total:0,per_page:3,page:1,current_page:1},un=({questionId:e,courseId:t})=>{const[r,i]=p.useState(void 0),[a,o]=p.useState(ye),[l,x]=p.useState(!0),{fetchQuestionnairesAnswers:g}=p.useContext(W.EscolaLMSContext),{t:v}=Q(),s=p.useCallback(m=>{e&&t&&(x(!0),g(qe.COURSE,Number(t),e,{per_page:a.per_page,page:m,order_by:"updated_at",order:"DESC"}).then(u=>{u.success&&(i(u.data),o(b=>({...b,total:u.meta.total,current_page:u.meta.current_page,page:u.meta.current_page})))}).catch(u=>{H1(v("UnexpectedError"),u),console.log(u)}).finally(()=>x(!1)))},[a,g,t,e,v]),c=p.useCallback(m=>{o(u=>({...u,current_page:m}))},[]);return p.useEffect(()=>{a.page!==a.current_page&&s(a.current_page)},[a.current_page,a.page,s]),p.useEffect(()=>{o(ye),s(ye.page)},[e]),{answersMeta:a,questionnaireAnswers:r,loading:l,onPageChange:c}},pn=O(De)`
  justify-content: space-between;
...
`,gn=({name:e})=>{const t=()=>"#"+Math.floor(Math.random()*16777215).toString(16),r=e.charAt(0).toUpperCase();return n.jsx(mn,{style:{backgroundColor:t()},children:n.jsx(B.Text,{size:"18",children:r})})},Cn=({question:e})=>{const{user:t,note:r,updated_at:i}=e,a=Me();return r?n.jsx(xn,{children:n.jsx(pn,{children:n.jsxs(De,{$gap:19,children:[t.avatar?n.jsx(x1.Avatar,{src:t.avatar,alt:`user-avatar-${t.name}`}):n.jsx(gn,{name:t.name}),n.jsxs(Fe,{$justifyContent:"flex-start",$alignItems:"flex-start",children:[n.jsx(B.Text,{noMargin:!0,color:a.gray2,className:"date",size:"13",children:m1(i,Ze.defaultDateFormat)}),n.jsx(B.Text,{className:"note",size:"13",children:r})]})]})})}):null},hn=O(Fe)`
  gap: 22px;
  margin: 16px auto;
`,fn=O(xe.Title)`
  margin-bottom: 16px;
`,vn=O.div`
  margin: 0 auto;
`,_n=({courseId:e,questionId:t})=>{var x;const{answersMeta:r,loading:i,onPageChange:a,questionnaireAnswers:o}=un({questionId:t,courseId:e}),{t:l}=Q();return n.jsx(hn,{children:i?n.jsx(g1.Spin,{}):((x=o||[])==null?void 0:x.length)>0?n.jsxs(n.Fragment,{children:[n.jsx(fn,{level:4,children:l("CoursePage.CourseRatingsTitle")}),(o||[]).map(g=>n.jsx(Cn,{question:g})),r.total>r.per_page&&n.jsx(vn,{children:n.jsx(R1,{total:r.total,perPage:r.per_page,currentPage:r.current_page,onPage:a})})]}):null})},Ee=()=>console.warn("INITIAL STATE"),Pe=p.createContext({questionnaires:[],questionnaireId:null,setQuestionnaireId:Ee,questionId:null,setQuestionId:Ee,reviewId:void 0,courseId:void 0}),jn=({children:e,questionnaires:t})=>{var s;const[r,i]=p.useState(null),[a,o]=p.useState(null),{id:l}=Oe(),x=t==null?void 0:t.at(0),g=(s=x==null?void 0:x.questions)==null?void 0:s.find(({type:c})=>c===Ie.RATE),v=O1({questionnaires:t,questionnaireId:r,questionType:Ie.REVIEW});return p.useEffect(()=>{x!=null&&x.id&&!r&&i(x.id)},[x==null?void 0:x.id,r]),p.useEffect(()=>{g!=null&&g.id&&!a&&o(g.id)},[g==null?void 0:g.id,a]),n.jsx(Pe.Provider,{value:{questionnaires:t,questionnaireId:r,setQuestionnaireId:i,questionId:a,setQuestionId:o,reviewId:v,courseId:Number(l)},children:e})},bn=()=>{const e=p.useContext(Pe);if(!Pe)throw new Error("useCourseRatingContext must be used inside the CourseRatingProvider");return e},yn=p.memo(()=>{const{courseId:e,reviewId:t}=bn();return n.jsx(n.Fragment,{children:e&&t&&n.jsx(_n,{courseId:e,questionId:t})})}),wn=p.memo(({questionnaires:e})=>n.jsx(jn,{questionnaires:e,children:n.jsx("section",{className:"course-ratings",children:n.jsx(yn,{})})})),Tn=O.section`
  position: relative;
  margin-top: 100px;
  @media (max-width: 991px) {
    margin-top: 40px;
...
`,Pn=({relatedProducts:e})=>{const{t}=Q();return n.jsx(Tn,{className:"course-related-courses",children:n.jsx(Te,{children:n.jsx(L.Row,{children:n.jsxs(L.Col,{lg:9,children:[e&&(e==null?void 0:e.length)>0&&n.jsxs("div",{className:"content-container",children:[n.jsx(Y.Title,{level:1,as:"h2",children:t("CoursePage.RelatedCoursesTitle")}),n.jsx(N1,{slidesPerView:3,children:e==null?void 0:e.map(r=>{var i;return n.jsx(B1,{children:n.jsx(Y.NewCourseCard,{mobile:k,id:r.id,image:n.jsx(K,{to:`/courses/${(i=r==null?void 0:r.productables[0])==null?void 0:i.id}`,children:r.poster_path?n.jsx(S1,{path:r.poster_path,alt:r.name,srcSizes:[300,600,900]}):n.jsx(V1,{})}),price:r.public?n.jsx("div",{className:"course-price",children:t("FREE")}):n.jsx(Ge,{price:r==null?void 0:r.price,oldPrice:r==null?void 0:r.price_old,taxRate:r==null?void 0:r.tax_rate}),title:n.jsx(K,{to:`/courses/${r.id}`,children:n.jsx(Y.Title,{level:3,as:"h3",className:"title",children:r.name})})})},r.id)})})]}),n.jsx("div",{className:"content-container",children:n.jsx(I1,{titleText:t("CoursePage.InterestTitle"),params:{per_page:6,order_by:"created_at",order:"ASC"},slidesPerView:3})})]})})})})},Mn=O.div`
...
`,Sn=()=>n.jsxs(An,{children:[n.jsx(N,{width:"20px",style:{marginBottom:"5px"}}),n.jsx(N,{width:"40%",height:37,style:{marginBottom:"10px"}}),n.jsx(N,{width:"40%",style:{marginBottom:"10px"}})," ",n.jsx(N,{width:"100%",height:490,style:{marginBottom:"40px"}}),n.jsx("div",{style:{marginBottom:"40px"},children:n.jsx(N,{width:"100%",count:4,style:{marginBottom:"5px"}})}),n.jsx("div",{style:{marginBottom:"40px"},children:n.jsx(N,{width:"100%",count:5,style:{marginBottom:"5px"}})}),n.jsx(N,{width:"80px",style:{marginBottom:"20px"}}),n.jsxs("div",{className:"tutors",children:[n.jsx(N,{circle:!0,width:"112px",height:"112px"}),n.jsxs("div",{children:[n.jsx(N,{width:"140px",style:{marginBottom:"20px"}}),n.jsx(N,{width:"140px",count:2})]})]}),n.jsx("div",{style:{marginTop:"40px"},children:n.jsx(N,{width:"100%",height:"51px",style:{marginBottom:"5px"},count:8})})]}),Ln=O.button`
  all: unset;
  margin-top: 10px;
  margin-bottom: 15px;
  svg {
...
`,Yn=()=>{var w,y;const[e,t]=p.useState([]),[r,i]=p.useState(!1),[a,o]=p.useState(),{id:l}=Oe(),{t:x}=Q(),g=de(),v=Me(),{course:s,fetchCourse:c,fetchCourses:m,fetchCourseAccess:u,fetchQuestionnaires:b}=p.useContext(ze.EscolaLMSContext),d=p.useCallback(()=>i(!1),[]),h=p.useCallback(()=>i(!0),[]),_=p.useCallback(()=>u({course_id:Number(l),current_page:1,per_page:1}),[l,u]);return p.useEffect(()=>{m({per_page:6}),l&&(c(Number(l)),_(),b(qe.COURSE,Number(l)).then(M=>M.success&&t(M.data)))},[l]),s.error?n.jsx("pre",{children:s.error.message}):n.jsxs(C1,{metaTitle:((w=s==null?void 0:s.value)==null?void 0:w.title)||"Loading",children:[s.loading&&n.jsx(n.Fragment,{children:n.jsx(ke,{children:n.jsx(Te,{children:n.jsxs(L.Row,{children:[n.jsx(L.Col,{md:12,lg:8,children:n.jsx(Sn,{})}),n.jsx(L.Col,{md:12,lg:3,offset:{lg:1},children:n.jsx(On,{})})]})})})}),!s.loading&&s.value&&n.jsxs(n.Fragment,{children:[n.jsxs(ke,{children:[n.jsxs(Te,{children:[!k&&n.jsx(M1,{items:[n.jsx(K,{to:se.home,children:x("Home")}),n.jsx(K,{to:se.courses,children:x("Courses")}),n.jsx(B.Text,{size:"13",children:s.value.title})]}),n.jsxs(L.Row,{children:[n.jsxs(L.Col,{md:12,lg:8,children:[k&&n.jsx(Ln,{onClick:()=>g.push(se.courses),children:n.jsx(h1,{color:v.black})}),n.jsx(dn,{courseData:s.value}),k&&s.value&&n.jsx(Be,{course:s.value,onRequestAccess:h}),s.value.description&&Le(s.value.description)!==""&&n.jsx("section",{className:"course-description-short",children:n.jsx(He.MarkdownRenderer,{children:s.value.description})}),s.value.summary&&Le(s.value.summary)!==""&&n.jsx("section",{className:"course-description",children:n.jsx(He.MarkdownRenderer,{children:s.value.summary})}),n.jsxs("section",{className:"",children:[n.jsx(xe.Title,{as:"h3",level:4,className:"title",children:x("CoursePage.Teacher")}),n.jsx(L.Row,{children:s.value&&s.value.authors.map(M=>n.jsx(ln,{author:M}))})]}),s.value.lessons&&s.value.lessons.length>0&&n.jsx(Ue.CourseProgram,{lessons:s.value.lessons,onTopicClick:M=>o(M)}),n.jsx(wn,{questionnaires:e})]}),!k&&n.jsx(L.Col,{md:12,lg:3,offset:{lg:1},children:s.value&&n.jsx(Be,{course:s.value,onRequestAccess:h})})]})]}),n.jsx(Pn,{relatedProducts:(y=s.value.product)==null?void 0:y.related_products})]}),n.jsxs(Re.Modal,{onClose:()=>o(void 0),visible:!!a,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,bodyStyle:{maxHeight:"80vh",overflow:"auto"},children:[n.jsx($e,{}),a&&n.jsx(an,{topic:a})]}),n.jsxs(Re.Modal,{onClose:d,visible:r,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,children:[n.jsx($e,{}),n.jsx(Je.ModalCourseAccess,{course:s.value,onCancel:d,onSuccess:()=>{_(),d()}})]})]})]})};export{Yn as default};
