...
`,Me=({courseId:e})=>{const{fetchCertificates:d}=i.useContext(F.EscolaLMSContext),{downloadCertificate:r,loadingId:c}=Ce(),{t:a}=R(),[x,b]=i.useState(!1),y=i.useCallback(async()=>{try{const u=await d({assignable_type:ae.CertificateAssignableTypes.Course,assignable_id:Number(e)});if(u&&u.success){const j=u.data||[];if(j.length===0){b(!0);return}j.forEach(({id:C,title:p})=>{r(C,p)})}}catch(u){oe(`${a("UnexpectedError")}`,"error"),console.log(u)}},[e,r,a,d]);return t.jsx(Z,{onClick:y,children:!x&&t.jsxs(t.Fragment,{children:[t.jsx(ie,{})," ",a("MyProfilePage.DownloadCertificate")," ",c>-1&&t.jsx(J,{width:"10px",height:"10px"})]})})},Z=k.button`
  all: unset;
...
`,Ne=k.div`
  ...
  padding: ${Q?"80px 20px":"192px 20px"};
  width: calc(100% - 30px);
  margin: 0 auto;
  text-align: center;
  .small-text {
...
`,$e=()=>{const{t:e}=R(),{isTutor:d}=Le(),{query:r,setQueryParam:c}=X(),a={tabs:[{label:e("MyProfilePage.ALlCourses"),key:1,component:t.jsx(O,{filter:"all"})},{label:e("MyProfilePage.InProgress"),key:2,component:t.jsx(O,{filter:"inProgress"})},{label:e("MyProfilePage.Finished"),key:4,component:t.jsx(O,{filter:"finished"})},{label:e("MyProfilePage.Authored"),key:5,component:t.jsx(O,{filter:"authored"}),hidden:!d}],defaultActiveKey:Number(r.get("status")||1)};return t.jsx(fe,{children:t.jsx(Ie,{children:t.jsx(ge,{children:t.jsx("div",{className:"courses-wrapper",children:t.jsx(Y.Tabs,{onClick:x=>{c("status",String(x)),c("page","1")},tabs:a.tabs,defaultActiveKey:a.defaultActiveKey})})})})})},Ke=Object.freeze(Object.defineProperty({__proto__:null,CourseStatus:S,default:$e},Symbol.toStringTag,{value:"Module"}));export{S as C,Ke as i,X as u};
