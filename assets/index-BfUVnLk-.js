import{b as M,G as E,r as o,h as y,j as e,q as b,s as c,v as m,aF as L,T as d,A as x,k as n,o as v,f as u,i as N,l as j,aA as C,K as w,ah as I,W as R,an as B,ao as g,ap as _,aq as $,ar as z,L as A,C as D}from"./index-CJUViYQs.js";import{P as W}from"./index-CBMYHIOy.js";import{a as q}from"./PricingCard-BTy5Kmij.js";import{P as G}from"./index-CAagf-yf.js";import{D as F}from"./index-DADftZCe.js";import{B as H}from"./index-CWOTO5_N.js";import{a as O}from"./ResponsiveImage-CYeKSXk0.js";import{C as U,T as K}from"./index-DQ5zMKuv.js";import"./index-CkZQCNYJ.js";import"./app-B2E7767C.js";import"./date-DocSkm8y.js";const V=M.createContext({}),J=({children:t})=>{const{id:a}=E(),{fetchProduct:s}=o.useContext(y.EscolaLMSContext);return o.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})};var i=(t=>(t.Consultation="App\\Models\\Consultation",t.StationaryEvent="App\\Models\\StationaryEvent",t.Course="App\\Models\\Course",t.Webinar="App\\Models\\Webinar",t))(i||{});const Q=t=>t.reduce((a,s)=>{const r=s.productable_type,l=a[r]??[];return{...a,[r]:[...l,s]}},{}),X=b(c.Col)`
