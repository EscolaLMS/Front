import{r as o,i as H,h as I,ar as Q,j as t,V as P,y as N,o as K,q as v,L as se,ax as re,X as ae,N as q,aP as U,aQ as X,aR as Y,aS as z,aT as G,aw as oe,al as ie,aU as ce,g as de,z as O,aV as le,aW as ue,T as me,F as Z,aX as ee,a0 as fe,v as pe,C as ge}from"./index-dyNbFCkh.js";import{a as he,T as xe}from"./index-BGVNLAf1.js";import{C as te,a as Ce}from"./CourseCard-CzXIKd2k.js";import{P as je,C as ye,D as R,a as M,b as _e}from"./index-tw39RgmT.js";import{u as B,R as Ee}from"./useRoles-DVDYxsCR.js";import{Q as F}from"./questionnaire-CXWDgbJ4.js";import{u as we,Q as ve}from"./index-CvEoeG_1.js";import"./questionnaires-D6BHurCN.js";import"./useDownloadCertificate-CExf7U9r.js";import"./base-7gvCcPfx.js";import"./index-C9NwJgNW.js";import"./swiper-DO66gVDh.js";import"./swiper-react-1s9nkag_.js";import"./a11y-9TD6Jtgu.js";import"./index-EdGxmQbb.js";import"./floating-ui.react-dom-LybTxsOl.js";import"./index-lLtf2rUj.js";const Te=({type:e})=>{var g;const{userConsultations:r,fetchUserConsultations:a,token:n}=o.useContext(H.EscolaLMSContext),{t:d}=I(),[i,l]=o.useState([]),u=o.useMemo(()=>{var C;const c=((C=r.list)==null?void 0:C.data.filter(h=>e===k.STARTED||e===k.UPCOMING?h.in_coming||h.is_started:h.is_ended))||[];return Array.from(new Map(c.map(h=>[h.id,h])).values())},[e,(g=r.list)==null?void 0:g.data]),s=o.useCallback(async c=>{try{const C=await(await fetch(`${Q}/api/consultations/me?ids[]=${c}`,{headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`}})).json();C.success&&C.data.length>0&&l(h=>{const x=h.findIndex(m=>m.id===c);return x!==-1&&(h[x]=C.data[0]),[...h]})}catch(f){console.error(f)}},[n]),p=o.useCallback(()=>{i.forEach(c=>{!c.is_started&&!c.is_ended&&s(c.id)})},[i,s]);return o.useEffect(()=>{a()},[e,a]),o.useEffect(()=>{l([]),l(u);const c=setInterval(()=>{p()},5e3);return()=>{l([]),clearInterval(c)}},[e,u,p]),t.jsx(je,{children:t.jsx(P.Row,{style:{gap:"30px 0"},children:r.loading?Array.from({length:8}).map((c,f)=>t.jsx(P.Col,{md:3,children:t.jsx(te,{})},`skeleton-card-${f}`)):i.length===0?t.jsx(N.Text,{style:{paddingLeft:K?20:40},children:d("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:i.map(c=>t.jsx(P.Col,{xs:12,md:6,lg:3,children:t.jsx(ye,{consultation:c})},c.id))})})})},$=o.memo(Te),be=v.div`
  .course-section {
    margin-top: 0px;
  }
...
`,Ie=({product:e})=>e?t.jsx(se,{to:`/consultations/${e.id}`,children:e.poster_path?t.jsx(re,{path:e.poster_path,alt:e.name,srcSizes:[300,600,900]}):t.jsx(Ce,{})}):null,Se=v.div`
  display: flex;
  align-items: center;
  user-select: none;
