import{q as l,j as s,o,r as c,K as T,cI as w,h as A,k as M,T as P,cJ as C,cK as p,x as t,m as N,cL as S}from"./index-CD4m0m91.js";const D=l.div`
  padding: 11px 6px;
  background: ${({theme:e})=>e.mode==="dark"?e.dm__cardBackgroundColor:e.white};
  border-radius: ${({theme:e})=>e.cardRadius}px;
`,g=({children:e})=>s.jsx(D,{children:e}),L=l.div`
  h2 {
    margin-bottom: 10px;
  }
`,h=l("aside")`
