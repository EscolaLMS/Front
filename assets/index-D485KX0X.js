import{b as A,j as e,J as o,T as m,g as z,h as G,q as h,c as q,a as L,f as k,K as $,i as F,o as E,p as g,W as B,ah as D,ai as V,aj as W,ak as J,H as K,k as Q,C as R,L as M,ab as O,M as U}from"./index-C8RYle4a.js";import{r as j}from"./sentry-DZqhWugq.js";import{P as X}from"./index-Bqp2gs8d.js";import{B as Y}from"./index-xLklIcjt.js";import{a as Z}from"./CourseCard-H03ZoLrr.js";import{P as N}from"./PricingCard-BnHr5ojY.js";import{u as ee,E as se,S as H,a as te,b as ie}from"./sidebar-DnJMZb0p.js";import{u as re,P as oe}from"./usePayment-gpasD-x_.js";import{C as _}from"./index-BrazeI_c.js";import{S as p}from"./index-B7vnVY_d.js";import"./katex-D1m830yy.js";import"./lodash-Bu-jC-fW.js";import"./questionnaire-CXWDgbJ4.js";import"./index-BfmoqrZO.js";import"./questionnaires-Dk2u0aZr.js";import"./index-BSMH6xmF.js";import"./index-BTHE13-u.js";import"./swiper-CphuuvCl.js";import"./index-j13jBhAP.js";import"./swiper-Cjr7D3Sq.js";import"./useFetchCourses-C4k5lyAX.js";import"./index-CMg6wq3C.js";const ae=i=>{const{consultation:s}=i,t=A();return e.jsxs(o.Row,{align:"center",children:[e.jsxs(o.Col,{lg:7,children:[(s==null?void 0:s.categories)&&s.categories.length>0&&e.jsx(Z,{categories:s.categories,onCategoryClick:x=>{t.push(`/consultations/?categories[]=${x}`)}}),e.jsx("br",{}),e.jsx(m.Title,{mobile:z,level:1,children:s==null?void 0:s.name})]}),e.jsx(o.Col,{lg:4,children:(s==null?void 0:s.image_path)&&e.jsx("div",{className:"image-wrapper",children:e.jsx(G.ResponsiveImage,{path:s.image_path,srcSizes:[790*.5,790,2*790]})})})]})};h.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: 10px;
...
`,pe={arrows:!1,infinite:!0,speed:500,slidesToShow:4,draggable:!1,slidesToScroll:3,responsive:[{breakpoint:768,settings:{draggable:!0,slidesToShow:2,slidesToScroll:2}},{breakpoint:576,settings:{slidesToShow:1,centerMode:!0,slidesToScroll:1}}]},me=i=>{const{category:s,title:t=s,consultations:x,sliderSettings:u=pe}=i,[r]=j.useState(!0),n=x.filter(a=>{var l;return(l=a.categories)==null?void 0:l.some(d=>d.name===s)});return e.jsxs(ue,{children:[e.jsx(m.Title,{level:3,style:{marginBottom:30},children:t}),n.length>4?e.jsx(J.Slider,{settings:{...u,dots:r,onSwipe:()=>{const a=document.querySelectorAll('.slick-slide[aria-hidden="true"]');document.querySelectorAll('.slick-slide[aria-hidden="false"]').forEach(d=>d.removeAttribute("aria-modal")),a.forEach(d=>d.setAttribute("aria-modal","true"))},onInit:()=>{document.querySelectorAll('.slick-slide[aria-hidden="true"]').forEach(l=>l.setAttribute("aria-modal","true"))}},dotsPosition:"top right",children:n.map(a=>e.jsx(_,{consultation:a},a.id))}):e.jsx(o.Row,{children:n.map(a=>e.jsx(o.Col,{xs:12,sm:6,md:4,lg:3,children:e.jsx(_,{consultation:a})},a.id))})]})},he=h.div`
  position: relative;
  .tutors {
    display: flex;
    > div {
...
`,ge=()=>e.jsxs(he,{children:[e.jsx(p,{width:"20px",style:{marginBottom:"5px"}}),e.jsxs(o.Row,{children:[e.jsx(o.Col,{style:{marginTop:"120px"},md:7,children:e.jsx(p,{height:45,style:{marginBottom:"10px"}})}),e.jsx(o.Col,{children:e.jsx(p,{height:300,style:{marginBottom:"10px"}})})]}),e.jsx("div",{style:{marginBottom:"40px"},children:e.jsx(p,{width:"100%",height:20,count:12,style:{marginBottom:"5px"}})})," ",e.jsxs("div",{className:"tutors",children:[e.jsx(p,{circle:!0,width:"112px",height:"112px"}),e.jsxs("div",{children:[e.jsx(p,{width:"140px",style:{marginBottom:"20px"}}),e.jsx(p,{width:"140px",count:2})]})]})]}),je=()=>{var n,a,l,d,C,y,b;const{t:i}=L(),{id:s}=K(),{consultation:t,fetchConsultation:x,consultations:u}=j.useContext(q.EscolaLMSContext),r=(a=(n=t.value)==null?void 0:n.categories)==null?void 0:a.map(c=>c.name);return j.useEffect(()=>{s&&x(Number(s))},[s]),t.loading&&!((l=t.value)!=null&&l.id)?e.jsx(X,{}):t.error?e.jsx("pre",{children:t.error.message}):e.jsxs(Q,{metaTitle:`${i("Consultation")} ${(d=t.value)==null?void 0:d.name}`,children:[t.loading&&e.jsx(e.Fragment,{children:e.jsx(H,{children:e.jsx(R,{children:e.jsxs(o.Row,{children:[e.jsx(o.Col,{md:12,lg:8,children:e.jsx(ge,{})}),e.jsx(o.Col,{md:12,lg:3,offset:{lg:1},children:e.jsx(te,{})})]})})})}),!t.loading&&e.jsx(H,{children:e.jsx(R,{children:e.jsxs(o.Row,{children:[e.jsx(o.Col,{xs:12,children:e.jsx(Y,{items:[e.jsx(M,{to:k.home,children:i("Home")}),e.jsx(M,{to:k.consultations,children:i("Consultations")}),e.jsx(E.Text,{size:"12",children:(C=t==null?void 0:t.value)==null?void 0:C.name})]})}),e.jsx(o.Col,{xs:12,md:9,children:e.jsxs(o.Row,{children:[e.jsx(o.Col,{md:12,children:e.jsx(ae,{consultation:t.value})}),e.jsx(o.Col,{md:12,children:((y=t==null?void 0:t.value)==null?void 0:y.description)&&O(t.value.description)!==""&&e.jsx(ne,{children:e.jsx(U.MarkdownRenderer,{children:t.value.description})})}),e.jsxs(o.Col,{md:12,children:[" ",e.jsx("br",{}),e.jsx(m.Title,{as:"h3",level:4,className:"title",children:i("ConsultationPage.Teacher")}),t.value&&t.value.teachers.map(c=>e.jsx(ie,{author:c}))]})]})}),((b=t==null?void 0:t.value)==null?void 0:b.product)&&e.jsx(o.Col,{xs:12,md:3,children:e.jsx(xe,{consultation:t.value})})]})})}),r&&r.length>0&&e.jsx(le,{children:e.jsx(R,{children:r.map(c=>{var S,f;return e.jsx(me,{category:c,title:`${i("Inni specjaliści")} ${c}`,consultations:((f=(S=u==null?void 0:u.list)==null?void 0:S.data)==null?void 0:f.filter(P=>P.id!==Number(s)))||[]},c)})})})]})},qe=()=>e.jsx(je,{});export{qe as default};
//# sourceMappingURL=index-D485KX0X.js.map
