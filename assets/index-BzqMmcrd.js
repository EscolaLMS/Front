import{b as L,O as M,r as i,i as k,j as e,q as x,o as n,U as c,L as m,aF as N,x as d,K as u,T as b,h as p,k as E,m as v,aG as C,a0 as T,at as _,aB as I,aH as R,aI as h,aJ as B,aK as z,aL as A,al as S,ae as D,af as G,v as O,C as U}from"./index-fLzfRICx.js";import{P as W}from"./index-DfLuKi_t.js";import{a as q}from"./PricingCard-v5KbwKCx.js";import{P as F}from"./index-B5qUhDbL.js";import{B as H}from"./index-BHf87JtN.js";const K=L.createContext({}),V=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(K.Provider,{value:{},children:t})},J=x.div`
  width: 100%;
  left: 0;
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(W,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},fe=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(O,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(V,{children:e.jsx(U,{children:e.jsx(pe,{})})})})};export{fe as default};
