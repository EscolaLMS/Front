import{b as cn,r as b,h as dn,k as G,i as un,j as r,q as X,n as N,d as h,a6 as pn,a3 as gn,aG as xn,aH as fn,a7 as hn,aI as mn,a5 as bn,a4 as vn,A as J,f as D,X as K,T as wn,S as jn,w as H,o as yn,C as Cn}from"./index-CcQ9x6fP.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-CWHW7to5.js";import{F as kn,S as Tn}from"./index-ByjhH5O8.js";import{W as On}from"./index-xu-cjq4y.js";import{P as Pn}from"./index-BaRBH6h5.js";import"./swiper-react-Dwa8Yg-L.js";import"./ResponsiveImage-C6DmWZXU.js";import"./index-B_UJVbS6.js";import"./index-BGykWdhw.js";const A=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(A.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
    background: ${({theme:a})=>a.primaryColor};
    padding: ${N?"60px 20px 20px 20px":"140px 40px 30px"};
    margin-bottom: ${N?"100px":"40px"};

    h1 {
      color: ${({theme:a})=>a.white};
      margin-bottom: ${({filters:a})=>N?0:a&&Object.keys(a).length>1?"35px":a&&Object.keys(a).length===1&&"page"in a||a===void 0?"-35px":"35px"};
      transition: margin-bottom 0.5s ease-out;
    }
  `,{params:t}=b.useContext(A);return r.jsx(l,{filters:t,children:i})},Wn=X("div")`
  display: flex;
  row-gap: 30px;
  flex-wrap: wrap;
...
`])),function(n){var e=n.theme;return(0,W.getStylesBasedOnTheme)(e.mode,e.white,e.gray1)},function(n){var e=n.theme;return(0,W.getStylesBasedOnTheme)(e.mode,e.white,e.gray1)},function(n){var e=n.theme;return(0,W.getStylesBasedOnTheme)(e.mode,e.white,e.gray1)}),on=(0,v.default)("div")(E||(E=l([`
  .tags-collapse {
    position: absolute;
    right: 0;
    top: 0;
...
`]))),$=function(n){var e=n.tags,s=n.labelPrefix,c=n.selectedTags,d=c===void 0?[]:c,x=n.label,w=n.handleChange,j=n.mobile,y=n.className,P=y===void 0?"":y,_=g.useCallback(function(f){w&&w(d.includes(f)?d.filter(function(T){return T!==f}):u(u([],d,!0),[f],!1))},[d]);return(0,o.jsxs)(on,t({className:"wellms-component ".concat(j?"tags-drawer-list":"tags-dropdown-options"," ").concat(P)},{children:[j&&x&&(0,o.jsx)(F.Title,t({level:5,style:{marginTop:"32px",marginBottom:"17px"}},{children:x})),e.map(function(f){return(0,o.jsx)("div",{children:(0,o.jsx)(F.Checkbox,{value:f.id,label:s?"".concat(s).concat(f.title):f.title,checked:d.includes(f.title),onChange:function(){return _(f.title)}})},f.id)})]}))},an=function(n){var e=g.useContext(v.ThemeContext),s=n.tags,c=n.labelPrefix,d=n.label,x=n.selectedTags,w=n.handleChange,j=n.backgroundColor,y=j===void 0?(0,W.getStylesBasedOnTheme)(e.mode,e.dm__background,e.background):j,P=g.useMemo(function(){return(0,U.contrast)("#fff",y)>=1.85},[y]),_=g.useState(!1),f=_[0],T=_[1],B=(0,S.useRef)(null),O=function(){T(function(L){return!L})};return(0,k.useOnClickOutside)(B,function(){return T(!1)}),(0,o.jsxs)(tn,t({open:f,ref:B,className:"wellms-component",lightContrast:P,backgroundColor:y},{children:[(0,o.jsxs)("button",t({type:"button",className:"tags-dropdown-button",onClick:O},{children:[d," ",x&&x.length>0&&"(".concat(x.length,")"),(0,o.jsx)(nn,{})]})),(0,o.jsx)($,{tags:s,labelPrefix:c,selectedTags:x,handleChange:w})]}))},sn=function(n){var e=n.tags,s=n.labelPrefix,c=n.label,d=n.handleChange,x=n.handleDrawerButtonClick,w=n.selectedTags,j=n.drawerButtonText,y=n.drawerTitle,P=n.mobile,_=g.useState(!1),f=_[0],T=_[1],B=(0,Y.useTranslation)().t,O=function(){T(function(L){return!L})};return(0,o.jsxs)(g.Fragment,{children:[(0,o.jsx)(rn,{}),(0,o.jsxs)(F.Button,t({type:"button",mode:"outline",onClick:O},{children:[B("Tags.Filter")," ",w&&w.length>0&&"(".concat(w.length,")")]})),(0,o.jsxs)(V.default,t({open:f,onClose:O},{children:[(0,o.jsxs)("div",t({className:"drawer-content-header"},{children:[(0,o.jsx)("button",t({type:"button",onClick:O,className:"drawer-content-btn"},{children:(0,o.jsx)(en,{})})),y&&(0,o.jsx)(g.Fragment,{children:y})]})),(0,o.jsx)("div",t({className:"drawer-content-inner"},{children:(0,o.jsx)($,{tags:e,label:c,labelPrefix:s,selectedTags:w,handleChange:d,mobile:P})})),j&&x&&(0,o.jsx)("div",t({className:"drawer-content-footer"},{children:(0,o.jsx)(F.Button,t({block:!0,mode:"secondary",onClick:function(){O(),x&&x()}},{children:j&&j}))}))]}))]})},ln=function(n){var e=n.mobile;return(0,o.jsx)(g.Fragment,{children:e?(0,o.jsx)(sn,t({},n)):(0,o.jsx)(g.Fragment,{children:(0,o.jsx)(an,t({},n))})})};i.Tags=ln,i.default=(0,v.withTheme)((0,v.default)(i.Tags)(q||(q=l([""],[""]))));var R,z,E,q})(Q);const Bn=({selectedTags:i,handleChange:l})=>{var m;const{uniqueTags:t}=b.useContext(J.EscolaLMSContext),{t:a}=D(),p=K();return r.jsx(Q.Tags,{mobile:N,backgroundColor:p.primaryColor,tags:(t==null?void 0:t.list)||[],label:a("Tags"),selectedTags:(m=t.list)==null?void 0:m.map(({title:u})=>u).filter(u=>i==null?void 0:i.includes(u)),handleChange:u=>{l(u)}})},Nn=()=>{const{params:i,setParams:l}=b.useContext(A),t=G(),a=M.parse(t.search,{arrayFormat:"bracket",parseNumbers:!0}),p=b.useMemo(()=>({categories:[],name:(a==null?void 0:a.name)||"",tags:(a==null?void 0:a.tags)||[]}),[a]);return r.jsxs(Wn,{children:[r.jsx("div",{className:"tags",children:r.jsx(kn,{filters:p,onReset:()=>{l&&l({page:1})}})}),r.jsxs("div",{className:"selects-row",children:[r.jsx("div",{className:"single-select single-select--search",children:r.jsx(Tn,{onSubmit:m=>{if(l){const u={...i,page:1,name:m};l({...u})}}})}),r.jsx("div",{className:"single-select single-select--tag",children:r.jsx(Bn,{selectedTags:a==null?void 0:a.tags,handleChange:m=>{l&&l({...i,"tags[]":m})}})})]})]})},An=()=>{const{t:i}=D();return r.jsxs(Fn,{children:[r.jsxs(wn.Title,{level:1,children:[" ",i("WebinarsPage.Webinars")]}),r.jsx(Nn,{})]})},Ln=()=>{var u,C,o,g,v,S;const{params:i,setParams:l,webinars:t}=b.useContext(A),a=t==null?void 0:t.loading,p=(u=t==null?void 0:t.list)==null?void 0:u.meta,m=K();return a?r.jsx("div",{style:{display:"flex",justifyContent:"center"},children:r.jsx(jn.Spin,{color:m.primaryColor})}):r.jsxs(r.Fragment,{children:[r.jsx(H.Row,{style:{gap:"30px 0"},children:(C=t==null?void 0:t.list)==null?void 0:C.data.map(k=>r.jsx(H.Col,{md:6,lg:4,xl:3,children:r.jsx(On,{webinar:k})},k.id))}),p&&(Number((g=(o=t==null?void 0:t.list)==null?void 0:o.meta)==null?void 0:g.total)||0)>(Number((S=(v=t==null?void 0:t.list)==null?void 0:v.meta)==null?void 0:S.per_page)||0)&&r.jsx(Pn,{total:p.total,perPage:Number(p.per_page),currentPage:p.current_page,onPage:k=>l&&l({...i,page:k,per_page:8})})]})},Dn=()=>{var l;const{categoryTree:i}=b.useContext(J.EscolaLMSContext);return r.jsxs(r.Fragment,{children:[r.jsx(An,{}),r.jsx(Ln,{}),i&&r.jsx(r.Fragment,{children:r.jsx(_n,{categories:((l=i.list)==null?void 0:l.filter(t=>!!t.icon))||[]})})]})},Jn=()=>{const{t:i}=D();return r.jsx(yn,{metaTitle:i("WebinarsPage.Webinars"),children:r.jsx(Sn,{children:r.jsx("section",{className:"webinars-page",children:r.jsx(Cn,{children:r.jsx(Dn,{})})})})})};export{Jn as default};
