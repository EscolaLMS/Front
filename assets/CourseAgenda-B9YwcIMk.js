import{q as le,h as ce,r as p,j as _,M as ye,y as ue,bw as be,e as x,bx as xe,by as ge,a7 as Pe,a9 as we,N as K,a5 as Te,bz as Ee,a8 as Ce,z as de,bA as Me,S as Se,aj as re,bB as Oe,b as fe,Q as Ie,k as Ne,ak as Ae,i as ke,o as se,bC as De}from"./index-BPG9AQw6.js";import{S as ze,A as g,_ as Be,P as Le,a as oe,I as Fe,O as He,H as Re}from"./index.esm-DDAUV6IQ.js";import{U as Ve}from"./Upload-G5XT3K7b.js";const $e=le.div`
  h1 {
    font-size: 2em;
  }
  h2 {
...
`]))),X=function(){return(0,f.jsx)("svg",e({width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},{children:(0,f.jsx)("path",{d:"M5 2C5 0.89543 5.89543 0 7 0H13C14.1046 0 15 0.895431 15 2V4H16.9897C16.9959 3.99994 17.0021 3.99994 17.0083 4H19C19.5523 4 20 4.44772 20 5C20 5.55228 19.5523 6 19 6H17.9311L17.0638 18.1425C16.989 19.1891 16.1182 20 15.0689 20H4.93112C3.88184 20 3.01096 19.1891 2.9362 18.1425L2.06888 6H1C0.447715 6 0 5.55228 0 5C0 4.44772 0.447715 4 1 4H2.99174C2.99795 3.99994 3.00414 3.99994 3.01032 4H5V2ZM7 4H13V2H7V4ZM4.07398 6L4.93112 18H15.0689L15.926 6H4.07398ZM8 8C8.55228 8 9 8.44772 9 9V15C9 15.5523 8.55228 16 8 16C7.44772 16 7 15.5523 7 15V9C7 8.44772 7.44772 8 8 8ZM12 8C12.5523 8 13 8.44772 13 9V15C13 15.5523 12.5523 16 12 16C11.4477 16 11 15.5523 11 15V9C11 8.44772 11.4477 8 12 8Z",fill:"currentColor"})}))},$=function(c){var u=c.projects,d=c.onDeleteSuccess,b=c.onDeleteError,w=c.className,A=(0,j.useTranslation)().t,F=(0,P.useContext)(M.EscolaLMSContext),v=F.token,h=F.apiUrl,T=(0,P.useState)([]),E=T[0],k=T[1],B=(0,P.useCallback)(function(N){return function(){if(!v)return console.warn("noToken");k(function(L){return y(y([],L,!0),[N],!1)}),(0,O.removeProject)(h,v,N).then(function(){return d==null?void 0:d()}).catch(function(){return b==null?void 0:b()}).finally(function(){return k(function(L){return L.filter(function(H){return H!==N})})})}},[v,h]);return(0,f.jsxs)("div",e({className:w},{children:[u.loading&&!u.data.length&&(0,f.jsx)(S.Spin,{}),u.data.map(function(N,L){var H=N.id,V=N.created_at;return(0,f.jsxs)(I.Card,e({className:"project-card"},{children:[(0,f.jsxs)("div",e({className:"project-card__details"},{children:[(0,f.jsxs)(q.Text,e({className:"project-card__title"},{children:[A("ProjectPlayer.ProjectFile")," ".concat(L+1)]})),(0,f.jsx)(q.Text,e({className:"project-card__date"},{children:(0,C.format)(new Date(V),m.DATETIME_FORMAT)}))]})),(0,f.jsx)(l.Button,e({className:"project-card__delete-btn",mode:"icon",loading:E.includes(H),onClick:B(H)},{children:(0,f.jsx)(X,{})}))]}),H)})]}))},Y=function(c){var u=c.course_id,d=c.topic,b=c.onSuccess,w=c.onError,A=c.className,F=c.onProjectsChange,v=(0,P.useContext)(M.EscolaLMSContext),h=v.token,T=v.apiUrl,E=(0,P.useState)({data:[],loading:!1}),k=E[0],B=E[1],N=(0,P.useState)(!1),L=N[0],H=N[1];(0,P.useEffect)(function(){F&&F(k)},[k]);var V=(0,P.useCallback)(function(){if(!h)return console.error("noToken");B(function(D){return e(e({},D),{loading:!0})}),(0,O.fetchProjects)(T,h,{course_id:u,topic_id:d==null?void 0:d.id}).then(function(D){D.success&&B(function(G){return e(e({},G),{data:D.data})})}).catch(function(D){return console.warn(D)}).finally(function(){return B(function(D){return e(e({},D),{loading:!1})})})},[h,T,u,d==null?void 0:d.id]);(0,P.useEffect)(function(){V()},[V]);var _e=(0,P.useCallback)(function(D){var G;if(!(!(!((G=D.currentTarget.files)===null||G===void 0)&&G[0])||!h)){H(!0);var je={topic_id:(d==null?void 0:d.id)+"",file:D.currentTarget.files[0]};(0,O.addProject)(T,h,je).then(function(){V(),b==null||b()}).catch(function(){w==null||w()}).finally(function(){H(!1)})}},[T,h,d==null?void 0:d.id,V]);return(0,f.jsxs)(r,e({className:"wellms-component"+" ".concat(A),"data-testid":"project-player"},{children:[d.description&&(0,f.jsx)(Z.MarkdownRenderer,e({className:"project-player__description"},{children:d.description})),(0,f.jsx)(W.Upload,{className:"project-player__upload-input",name:"project_file",onChange:_e,disabled:L}),(0,f.jsx)($,{className:"project-player__projects-list",projects:k,onDeleteSuccess:V})]}))};t.ProjectPlayer=Y,t.default=(0,i.withTheme)((0,i.default)(t.ProjectPlayer)(z||(z=s([""],[""]))));var Q,z})(pe);const Xe=le.div`
  > button {
    position: fixed;
    right: 5px;
    bottom: 5px;
