import{a as P,j as a,aN as k,o as i,ar as C,p as T,G as $,q as w,b as N,f as x,O as y,V as A,Q as B,v as j,T as E,K as O}from"./index-C8RYle4a.js";import{r as d}from"./sentry-DZqhWugq.js";import{P as c,a as M,f as R,r as z}from"./payment-yDpLN_o5.js";import{u as D}from"./usePayment-gpasD-x_.js";const K=w.div`
...
`,G=({subscription:e})=>{var u,m,g;const{t:s}=P(),{buySubscriptionByP24:l,user:t}=D(),o=N(),p=d.useMemo(()=>e.tags&&e.tags.includes("best-deal"),[e.tags]),S=d.useCallback(()=>{var r;(r=t.value)!=null&&r.id?l(e.id):o.push(x.login)},[e.id,(u=t.value)==null?void 0:u.id,l,o]);d.useEffect(()=>{(async function(){var n;const r=(n=t==null?void 0:t.value)==null?void 0:n.id;y.getPlatform()==="ios"?await c.configure({apiKey:A,appUserID:`${r}`}):y.getPlatform()==="android"&&await c.configure({apiKey:B,appUserID:`${r}`})})()},[(m=t==null?void 0:t.value)==null?void 0:m.id]);const I=d.useCallback(async()=>{var h,b;if(!((h=t.value)!=null&&h.id)){o.push(x.login);return}const r=M(e),n=await c.getOfferings(),_=((b=n==null?void 0:n.current)==null?void 0:b.availablePackages)||[],f=R(_,r);if(f)try{await c.purchaseStoreProduct({product:f}),o.push(x.home)}catch(v){z(v)}},[o,e,(g=t.value)==null?void 0:g.id]);return a.jsx(V,{$isMobile:j,children:a.jsxs("div",{className:"content",children:[p&&a.jsx("div",{className:"tag",children:a.jsx(i.Text,{size:"13",children:s("Subscriptions.CheapestOffer")})}),a.jsx(i.Text,{children:s("Subscriptions.AccessVia")}),a.jsxs(E.Title,{level:1,as:"h4",children:[e.subscription_duration," ",s(`Subscriptions.Periods.${e.subscription_period}`)]}),a.jsxs(i.Text,{className:"information",size:"13",children:[a.jsx(k,{})," ",e.trial_duration,"-",s(`Subscriptions.Periods.${e.trial_period}`)," ",s("Subscriptions.TrialText")]}),a.jsx("div",{className:"divider"}),a.jsx(i.Text,{size:"13",className:"description",children:e.name}),a.jsxs(i.Text,{size:"24",className:"price",bold:!0,children:[O(e.gross_price)," zł"]}),a.jsx(T.Button,{mode:"secondary",onClick:()=>{if(j){I();return}S()},children:s("Subscriptions.IPick")})]})})};export{F as A,G as S};
//# sourceMappingURL=index-B83i8PPt.js.map
