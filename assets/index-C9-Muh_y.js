import{r as a,A as L,f as k,i as _,j as e,x as Q,T as v,s as I,ag as W,v as A,q as w,ai as G,aZ as K,a_ as Z,a0 as U,a$ as J,b0 as V,b1 as X,m as Y,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-BxTLNZRa.js";import{T as ae}from"./Tabs-CwZWgZha.js";import{C as ie}from"./index-BO57T78B.js";import{R as ne}from"./ResponsiveImage-BL00KlJk.js";import{C as le}from"./index-B77BtExu.js";import{C as ce}from"./index-B7nHKoFI.js";import{R as de}from"./index-dvqLGPbj.js";import{b as ue,Q as me}from"./questionnaires-n1pQPrgI.js";import{u as pe}from"./useDownloadCertificate-CBadqJvv.js";import{t as ge}from"./toast-sK0s2imx.js";import{u as xe}from"./useRoles-DLjQR0B4.js";import{u as H}from"./useSearchParams-cc0lXuk_.js";import{P as he}from"./index-DzQ2qUl1.js";import{S as fe}from"./swiper-B6pLL460.js";import{S as O}from"./swiper-react-BLhf_PLg.js";import{C as B}from"./CourseCard-CN9f1PTI.js";import"./base-C7euzKDi.js";import"./a11y-wu9Crm3o.js";import"./index-DQePpHZG.js";const Ce=({courseData:s,visible:d,onClose:t})=>{const{sendProgress:u}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:l}=_(),g=a.useCallback(async()=>{await u(s.course.id,s.progress.map(({topic_id:f})=>({topic_id:f,status:0}))),l(`/course/${s.course.id}`)},[s.course.id,s.progress,u,l]);return e.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:e.jsxs(e.Fragment,{children:[e.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),e.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),e.jsxs(W,{$gap:16,children:[e.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),e.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},je=w(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
