import{r as i,l as P,f as x,j as e,v as m,o as _,h,q as c,w as A,an as v,X as M,aR as b,g as N,D as w,aD as y,aS as L,aT as S,B as U,aU as R,J as k}from"./index-B8t7bxZo.js";import{P as B}from"./index-Cka8reF9.js";import{T as F}from"./Tabs-lM-qfhAO.js";import{a as $}from"./ResponsiveImage-B7bcvD5e.js";import{C as G}from"./index-Dp8bV9hL.js";import{a as T,e as E,f as O}from"./date-DjWK0l4x.js";import{D as p,a as C}from"./index-AujWqiiR.js";import{P as W,C as q,a as K}from"./index-BHz8FjBP.js";import{C as I}from"./index-Cks0KJwc.js";import{u as z}from"./useRoles-CG5Kd-d6.js";import"./app-B2E7767C.js";const H=({type:t})=>{var d;const{userConsultations:s,fetchUserConsultations:o}=i.useContext(P.EscolaLMSContext),{t:n}=x(),r=i.useMemo(()=>{var a;return((a=s.list)==null?void 0:a.data.filter(l=>t===j.STARTED||t===j.UPCOMING?l.in_coming||l.is_started:l.is_ended))||[]},[t,(d=s.list)==null?void 0:d.data]);return i.useEffect(()=>{o()},[t,o]),e.jsx(W,{children:s.loading?e.jsx(I,{}):r.length===0?e.jsx(m.Text,{style:{paddingLeft:_?20:40},children:n("MyProfilePage.OrdersEmpty")}):e.jsx(h.Row,{style:{gap:"30px 0"},children:r.map(a=>e.jsx(h.Col,{xs:12,md:6,lg:4,children:e.jsx(q,{consultation:a})},a.id))})})},g=i.memo(H),J=c.div`
  .course-section {
    margin-top: 0px;
  }
...
`,X=({product:t})=>t?e.jsx(A,{to:`/consultations/${t.id}`,children:t.poster_path?e.jsx($,{path:t.poster_path,alt:t.name,srcSizes:[300,600,900]}):e.jsx(G,{})}):null,V=c.div`
  display: flex;
