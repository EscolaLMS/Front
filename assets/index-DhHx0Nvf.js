import{b as E,E as M,r as n,h as y,j as e,q as b,w as c,L as m,aO as N,s as d,D as x,n as o,T as v,f as u,i as L,l as j,aK as C,J as w,ar as I,N as B,ax as R,ay as p,az as _,aA as $,aB as z,o as D,C as A}from"./index-gbJMaPe7.js";import{P as W}from"./index-CVz7XqFh.js";import{a as q}from"./PricingCard-fPqOFL6B.js";import{P as G}from"./index-CDz9AdaM.js";import{D as O}from"./index-puRotPNF.js";import{B as H}from"./index-DR6cgSD7.js";import{a as U}from"./ResponsiveImage-aNRm3e5Q.js";import{C as F,T as J}from"./index-BQDcHA3k.js";const K=E.createContext({}),V=({children:a})=>{const{id:s}=M(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{s&&t(Number(s))},[t,s]),e.jsx(K.Provider,{value:{},children:a})};var i=(a=>(a.Consultation="App\\Models\\Consultation",a.StationaryEvent="App\\Models\\StationaryEvent",a.Course="App\\Models\\Course",a.Webinar="App\\Models\\Webinar",a))(i||{});const Q=a=>a.reduce((s,t)=>{const r=t.productable_type,l=s[r]??[];return{...s,[r]:[...l,t]}},{}),X=b(c.Col)`
