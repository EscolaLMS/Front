...
`,le=()=>{const{product:a}=n.useContext(x.EscolaLMSContext),{t:s}=u();return a.loading||!a.value?e.jsx(O,{}):e.jsx(ie,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(te,{}),e.jsx(oe,{}),e.jsx(V,{title:s("PackagePage.CompaniesSectionTitle")}),e.jsx(re,{}),e.jsx(F,{title:s("PackagePage.TutorsSectionTitle"),users:a.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},be=()=>{var s;const{product:a}=n.useContext(x.EscolaLMSContext);return e.jsx(D,{metaTitle:(s=a.value)==null?void 0:s.name,children:e.jsx(J,{children:e.jsx(A,{children:e.jsx(le,{})})})})};export{be as default};
