import{q as x,j as t,m as y,af as B,r as l,f as w,A as $,n as C,a0 as P,cM as L,ao as f,cN as S,cO as z,T as v,i as k,cP as O,cQ as W,cR as Q,s as N,v as V,cS as D,ax as R,aK as I,cT as q,L as M,l as T,aZ as H,cU as U,h as K,o as Y}from"./index-BxTLNZRa.js";import{u as m,C as G,a as J,b as Z}from"./CourseAgenda--Q0kMCl2.js";import{R as X}from"./index-dvqLGPbj.js";import{b as ee,Q as te}from"./questionnaires-n1pQPrgI.js";import{u as se}from"./useDownloadCertificate-CBadqJvv.js";import"./index-Ch8lCZ0S.js";import"./warning-BMyEIIAD.js";import"./ResponsiveImage-BL00KlJk.js";import"./Upload-CplDyF3P.js";import"./toast-sK0s2imx.js";const ie=x.div`
...
`,Re=x(N.Text)`
  ...
  margin: 0;
  line-height: 0;
`,qe=()=>{const{currentCourseProgram:e}=m(),{t:s}=w();return t.jsxs(Qe,{children:[t.jsxs(Ve,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(M,{to:T.myProfile,children:t.jsxs(De,{children:[!C&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=m();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(We,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ke=()=>t.jsx(Z,{children:t.jsx(Ue,{})}),nt=()=>{var s;const{program:e}=l.useContext(K.EscolaLMSContext);return t.jsx(Y,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ke,{})})};export{nt as default};
