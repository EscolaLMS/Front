import{r as c,O as G,q as P,f as q,h as ee,o as Y,j as n,T as U,y as M,W as O,i as B,a2 as we,p as F,z as $,a3 as Ke,s as Pe,Y as Q,F as je,m as $e,U as ye,a4 as ve,I as re,a5 as Je,a6 as Ze,d as j,a7 as Ce,a8 as ae,a9 as en,aa as le,ab as nn,ac as tn,ad as z,b as sn,ae as rn,af as on,ag as an,ah as ln,ai as cn,aj as dn,ak as Ee,v as un,K as pn,al as Ie,X as ze,am as mn,an as De,ao as xn,S as gn,C as _e,L as ie,ap as hn,w as fn,aq as jn,ar as Te,M as Oe}from"./index-bnskEQCp.js";import{P as vn}from"./PricingCard-Yrcxl7mE.js";import{u as Fe}from"./useSubscriptions-DkzrN2AK.js";import{P as Ge}from"./index-CpkKrMmj.js";import{A as _n,_ as bn,P as yn,I as Cn,a as wn,O as Pn,H as Tn}from"./index-CUk_CKfw.js";import{B as On}from"./index-BJ54XCbq.js";import{Q as qe,a as Me,g as Mn}from"./questionnaires-DT9BVgCA.js";import{b as Sn,a as Nn}from"./CourseCard-CKOWGiDv.js";import{P as Rn}from"./index-CvcxFA_P.js";import{D as kn}from"./index-DKi5yv25.js";import{S as An}from"./swiper-2KPEUOa4.js";import{a as Bn}from"./a11y-C2yy1KRV.js";import{S as A}from"./index-CIdi4ygg.js";import"./useFetchCourses-DAk-Wg-I.js";const Ln=e=>{const[t,s]=c.useState({data:void 0,loaded:!1,loading:!1}),{user:i,fetchCourseProgress:r,courseProgressDetails:a}=c.useContext(G.EscolaLMSContext);return c.useEffect(()=>{a.byId&&a.byId[Number(e)]&&a.byId[Number(e)].value&&s({...t,data:a.byId[Number(e)].value,loaded:!0,loading:!1})},[e,a]),c.useEffect(()=>{i!=null&&i.value&&!i.loading&&!t.loading&&!t.loaded?(s({...t,loading:!0}),r(e).catch(()=>s({...t,loaded:!0,loading:!1}))):t.loaded||s({...t,loaded:!0})},[i,t,r,e]),{progress:t}},$n=P.div`
  text-align: center;
  .modal-header {
    margin-bottom: 10px;
  }
...
`,En=({course:e})=>{var x,f;const{getCheapestSubscription:t}=Fe(),{cart:s,addToCart:i}=c.useContext(G.EscolaLMSContext),{t:r}=q(),{push:a}=ee(),o=c.useCallback(()=>{var u;i(Number((u=e.product)==null?void 0:u.id)).then(()=>a(Y.cart))},[(x=e.product)==null?void 0:x.id,i,a]);return n.jsxs($n,{children:[n.jsx(U.Title,{className:"modal-header",level:2,children:r("Subscriptions.GetAccess")}),n.jsx(M.Text,{children:r("Subscriptions.YouHaveTwoOptions")}),n.jsxs(O.Row,{children:[n.jsx(O.Col,{lg:6,md:12,sm:12,children:n.jsxs(Se,{className:"product-box",$isMobile:B,children:[n.jsx(U.Title,{className:"title",level:3,children:r("Buy Course")}),n.jsx("div",{className:"divider"}),n.jsx(M.Text,{className:"description",size:"13",children:e.title}),n.jsxs(M.Text,{className:"price",size:"24",bold:!0,children:[we((f=e.product)==null?void 0:f.gross_price)," zł"]}),n.jsx(F.Button,{loading:s.loading,onClick:()=>o(),children:r("Subscriptions.IPick")})]})}),(t==null?void 0:t.id)&&n.jsx(O.Col,{lg:6,md:12,sm:12,children:n.jsxs(Se,{className:"product-box",$isMobile:B,children:[n.jsx(U.Title,{className:"title",level:3,children:t==null?void 0:t.name}),n.jsx("div",{className:"divider"}),n.jsx(M.Text,{className:"description",size:"13",children:t==null?void 0:t.description}),n.jsxs(M.Text,{className:"price",size:"24",bold:!0,children:[r("From")," ",we(t==null?void 0:t.gross_price)," ","zł"]}),n.jsx(F.Button,{onClick:()=>{var u;return a((u=Y)==null?void 0:u.subscriptions)},children:r("Subscriptions.IPick")})]})})]})]})},Ne=P($.Button)`
  display: block;
  margin-bottom: 10px;
`,In=({course:e,onRequestAccess:t,setModalVisible:s})=>{var m;const{t:i}=q(),{push:r}=ee(),{courseAccess:a,fetchCourseAccess:o}=c.useContext(G.EscolaLMSContext),{attachProduct:x,getActiveSubscription:f}=Fe(),u=c.useMemo(()=>{var _,d;return(d=(_=a.list)==null?void 0:_.data)==null?void 0:d.find(h=>{var b;return((b=h==null?void 0:h.course)==null?void 0:b.id)===e.id})},[(m=a.list)==null?void 0:m.data,e.id]),l=c.useCallback(()=>{s(!0)},[s]),p=c.useCallback(()=>{x(e.id,"EscolaLms\\Courses\\Models\\Course").then(()=>[r(`/course/${e.id}`),o({course_id:Number(e.id),current_page:1,per_page:1})])},[x,e.id,r,o]),g=c.useMemo(()=>n.jsx(n.Fragment,{children:n.jsx(Q,{children:n.jsx($.Button,{mode:"secondary",onClick:()=>l(),children:i("Buy Course")})})}),[i,l]);return f!=null&&f.id?n.jsx($.Button,{onClick:()=>p(),mode:"secondary",children:i("Go to the course")}):u?u.status!=="approved"?n.jsxs(n.Fragment,{children:[n.jsx(Ne,{mode:"secondary",disabled:!0,children:i("CourseAccess.Pending")}),g]}):u.status==="approved"?n.jsx($.Button,{onClick:()=>r(`/course/${e.id}`),mode:"secondary",children:i("Go to the course")}):g:n.jsx(n.Fragment,{children:n.jsxs(Q,{children:[n.jsx(Ne,{mode:"secondary",onClick:t,children:i("CourseAccess.RequestAccess")}),g]})})},zn=({course:e,userOwnThisCourse:t,onRequestAccess:s})=>{var l,p;const{cart:i,user:r}=c.useContext(G.EscolaLMSContext),{t:a}=q(),{push:o}=ee(),[x,f]=c.useState(!1),u=c.useMemo(()=>{var g;return(g=i==null?void 0:i.value)==null?void 0:g.items.some(m=>{var _;return Number(m.product_id)===Number((_=e.product)==null?void 0:_.id)})},[(l=e.product)==null?void 0:l.id,i]);return Ke(Number((p=r.value)==null?void 0:p.id),e)?n.jsx($.Button,{onClick:()=>o(`/course/${e.id}`),mode:"secondary",children:a("Go to the course")}):Pe(new Date(e.active_to||""))?n.jsx(M.Text,{children:a("CoursePage.IsFinished")}):u?n.jsx(n.Fragment,{children:n.jsx(Q,{children:n.jsx($.Button,{mode:"secondary",onClick:()=>o(Y.cart),children:a("CoursePage.GoToCheckout")})})}):t&&Pe(new Date(e.active_from||""))?n.jsx($.Button,{onClick:()=>o(`/course/${e.id}`),mode:"secondary",children:a("Go to the course")}):t?n.jsx(M.Text,{children:a("CoursePage.NotStarted")}):r.value&&e.product?n.jsxs(n.Fragment,{children:[n.jsx(In,{course:e,onRequestAccess:s,setModalVisible:f}),n.jsx(je.Modal,{onClose:()=>f(!1),visible:x,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:800,children:n.jsx(En,{course:e})})]}):e.product?n.jsx(n.Fragment,{children:n.jsx(Q,{children:n.jsx($.Button,{onClick:()=>o(`/login?referrer=/courses/${e.id}`),mode:"secondary",children:a("Buy Course")})})}):n.jsx(M.Text,{children:a("CoursePage.UnavailableCourse")})},Dn=P.div`
  width: 100%;
  left: 0;
...
`])),function(v){var y=v.theme;return y.errorColor}),C=function(v){var y=v.course,T=v.className,N=v.initialValues,R=N===void 0?{phone_number:"",contact_details:""}:N,Xe=v.onCancel,pe=v.onSuccess,me=v.onError,K=(0,f.useTranslation)().t,Ye=(0,x.useContext)(p.EscolaLMSContext).addCourseAccess;return(0,o.jsxs)(b,s({className:"wellms-component ".concat(T),"data-testid":"modal-course-access"},{children:[(0,o.jsxs)("header",{children:[(0,o.jsx)(d.Title,s({level:1},{children:y.title})),(0,o.jsx)(h.Text,s({size:"14",bold:!0},{children:K("ModalCourseAccess.Title")}))]}),(0,o.jsx)(u.Formik,s({initialValues:R,onSubmit:function(E,X){var ne=X.setErrors,V=X.setSubmitting,te=X.resetForm,se={course_id:y.id,data:E};Ye(se).then(function(){te(),pe==null||pe()}).catch(function(I){var xe,ge;ne(s({error:(xe=I==null?void 0:I.data)===null||xe===void 0?void 0:xe.message},(ge=I==null?void 0:I.data)===null||ge===void 0?void 0:ge.errors)),me==null||me()}).finally(function(){V(!1)})}},{children:function(E){var X=E.values,ne=E.touched,V=E.errors,te=E.handleChange,se=E.handleBlur,I=E.handleSubmit;return(0,o.jsxs)("form",s({onSubmit:I},{children:[(0,o.jsxs)("div",s({className:"form-content"},{children:[V&&V.error&&(0,o.jsx)(h.Text,s({className:"error-msg",size:"12",bold:!0},{children:V.error})),(0,o.jsxs)("div",s({className:"input-group"},{children:[(0,o.jsx)(m.Input,{type:"text",label:K("ModalCourseAccess.PhoneNumber"),error:ne.phone_number&&V.phone_number,id:"phone_number",name:"phone_number",onChange:te,onBlur:se,value:X.phone_number}),(0,o.jsx)(_.TextArea,{label:K("ModalCourseAccess.ContactDetails"),error:ne.contact_details&&V.contact_details,id:"contact_details",name:"contact_details",onChange:te,onBlur:se,value:X.contact_details})]}))]})),(0,o.jsxs)("div",s({className:"button-group"},{children:[(0,o.jsx)(g.Button,s({type:"button",mode:"secondary",onClick:Xe},{children:K("ModalCourseAccess.Cancel")})),(0,o.jsx)(g.Button,s({type:"submit",mode:"secondary"},{children:K("ModalCourseAccess.Submit")}))]}))]}))}}))]}))};e.ModalCourseAccess=C,e.default=(0,l.withTheme)((0,l.default)(e.ModalCourseAccess)(S||(S=t([""],[""]))));var w,S})(Qe);const Ae=P.div`
  padding-top: 40px;
  section {
    margin-bottom: 40px;
...
`,Lt=()=>{var C,w;const[e,t]=c.useState([]),[s,i]=c.useState(!1),[r,a]=c.useState(),{id:o}=ye(),{t:x}=q(),f=ee(),u=ze(),{course:l,fetchCourse:p,fetchCourses:g,fetchCourseAccess:m,fetchQuestionnaires:_}=c.useContext($e.EscolaLMSContext),d=c.useCallback(()=>i(!1),[]),h=c.useCallback(()=>i(!0),[]),b=c.useCallback(()=>m({course_id:Number(o),current_page:1,per_page:1}),[o,m]);return c.useEffect(()=>{g({per_page:6}),o&&(p(Number(o)),b(),_(qe.COURSE,Number(o)).then(S=>S.success&&t(S.data)))},[o]),l.error?n.jsx("pre",{children:l.error.message}):n.jsxs(fn,{metaTitle:((C=l==null?void 0:l.value)==null?void 0:C.title)||"Loading",children:[l.loading&&n.jsx(n.Fragment,{children:n.jsx(Ae,{children:n.jsx(_e,{children:n.jsxs(O.Row,{children:[n.jsx(O.Col,{md:12,lg:8,children:n.jsx(vt,{})}),n.jsx(O.Col,{md:12,lg:3,offset:{lg:1},children:n.jsx(ft,{})})]})})})}),!l.loading&&l.value&&n.jsxs(n.Fragment,{children:[n.jsxs(Ae,{children:[n.jsxs(_e,{children:[!B&&n.jsx(On,{items:[n.jsx(ie,{to:Y.home,children:x("Home")}),n.jsx(ie,{to:Y.courses,children:x("Courses")}),n.jsx(M.Text,{size:"13",children:l.value.title})]}),n.jsxs(O.Row,{children:[n.jsxs(O.Col,{md:12,lg:8,children:[B&&n.jsx(_t,{onClick:()=>f.push(Y.courses),children:n.jsx(jn,{color:u.black})}),n.jsx(Zn,{courseData:l.value}),B&&l.value&&n.jsx(Re,{course:l.value,onRequestAccess:h}),l.value.description&&Te(l.value.description)!==""&&n.jsx("section",{className:"course-description-short",children:n.jsx(Oe.MarkdownRenderer,{children:l.value.description})}),l.value.summary&&Te(l.value.summary)!==""&&n.jsx("section",{className:"course-description",children:n.jsx(Oe.MarkdownRenderer,{children:l.value.summary})}),n.jsxs("section",{className:"",children:[n.jsx(U.Title,{as:"h3",level:4,className:"title",children:x("CoursePage.Teacher")}),n.jsx(O.Row,{children:l.value&&l.value.authors.map(S=>n.jsx(Kn,{author:S}))})]}),l.value.lessons&&l.value.lessons.length>0&&n.jsx(Ve.CourseProgram,{lessons:l.value.lessons,onTopicClick:S=>a(S)}),n.jsx(mt,{questionnaires:e})]}),!B&&n.jsx(O.Col,{md:12,lg:3,offset:{lg:1},children:l.value&&n.jsx(Re,{course:l.value,onRequestAccess:h})})]})]}),n.jsx(gt,{relatedProducts:(w=l.value.product)==null?void 0:w.related_products})]}),n.jsxs(je.Modal,{onClose:()=>a(void 0),visible:!!r,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,bodyStyle:{maxHeight:"80vh",overflow:"auto"},children:[n.jsx(Be,{}),r&&n.jsx(Yn,{topic:r})]}),n.jsxs(je.Modal,{onClose:d,visible:s,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,children:[n.jsx(Be,{}),n.jsx(Qe.ModalCourseAccess,{course:l.value,onCancel:d,onSuccess:()=>{b(),d()}})]})]})]})};export{Lt as default};
