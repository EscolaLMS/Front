...
`,St=({billingDetails:t,setBillingDetails:e})=>{const r=je(),{t:a}=le(),s=Ee.getFontFromTheme(r).fontFamily.split(",")[0].replace(/['"]/g,""),u=k.useMemo(()=>({style:{base:{fontFamily:s,backgroundColor:"transparent",padding:"11px 12px 13px",border:"1px solid red",color:r.mode==="dark"?r.white:r.gray1,fontSize:"12px","::placeholder":{color:r.mode==="dark"?"#c3c3c3":r.gray1}},invalid:{color:"#ff0000"}}}),[]);return n.jsxs(bt,{children:[n.jsxs(T.Row,{children:[n.jsx(T.Col,{lg:6,children:n.jsx("div",{className:"input-wrapper--custom",children:n.jsx(Ue.Input,{label:a("Cart.FullName"),type:"text",onChange:p=>e({...t,name:p.currentTarget.value}),value:t.name})})}),n.jsx(T.Col,{lg:6,children:n.jsxs("div",{className:"input-wrapper",children:[n.jsx(Oe,{options:u,id:"cardNumber"}),n.jsx(se,{htmlFor:"cardNumber",children:a("Card number")})]})})]}),n.jsxs(T.Row,{children:[n.jsx(T.Col,{lg:6,children:n.jsxs("div",{className:"input-wrapper",children:[n.jsx(lt,{options:u,id:"cardExpiry"}),n.jsx(se,{htmlFor:"cardExpiry",children:a("Expiration date")})]})}),n.jsx(T.Col,{lg:6,children:n.jsxs("div",{className:"input-wrapper",children:[n.jsx(ut,{options:u,id:"cardCVC"}),n.jsx(se,{htmlFor:"cardCVC",children:"CVC"})]})})]})]})},jt=Y.section`
...
`,kt=({stripeKey:t})=>{var L,B,K;const{user:e,cart:r,fetchCart:a,removeFromCart:o,payWithStripe:s,fetchCourses:u,courses:p,realizeVoucher:i}=k.useContext(ke.EscolaLMSContext),{t:c}=le(),{push:S,location:w}=we(),j=it(),R=ot(),[_,h]=k.useState(!1),[v,A]=k.useState({name:""}),[$,O]=k.useState(r.value.additional_discount>0?"granted":void 0),y=t.includes("_test_");k.useEffect(()=>{!e.loading&&!e.value?S(V.login):(u({per_page:6}),a())},[]);const F=k.useCallback(f=>{h(!0),s(f,"https://demo-stage.escolalms.com/#/user/my-profile").then(()=>{h(!1),S("/cart?status=success")}).catch(()=>{q.error(`${c("UnexpectedError")}`),h(!1)}).finally(()=>h(!1))},[]),N=()=>{if(!v.name){q.error(`${c("Cart.EmptyNameWarning")}`);return}if(!j||!R){q.error(`${c("UnexpectedError")}`);return}const f=R.getElement(Oe);f&&h(!0),f&&j.createPaymentMethod({type:"card",card:f,billing_details:v}).then(E=>{var I;E.error?(h(!1),q.error(E.error.message),console.log(E.error)):(F((I=E==null?void 0:E.paymentMethod)==null?void 0:I.id),setTimeout(()=>{h(!1)},3e3))}).catch(()=>{h(!1),q.error(`${c("UnexpectedError")}`)})};return w.search.includes("?status=success")?n.jsx(Et,{}):n.jsx(Pe,{metaTitle:c("Cart.Cart"),children:n.jsxs(wt,{children:[n.jsx(Ne,{children:((L=r.value)==null?void 0:L.items.length)!==0?n.jsxs(T.Row,{children:[n.jsxs(T.Col,{lg:9,children:[n.jsx(Ke,{items:[n.jsx(ze,{to:V.home,children:c("Home")}),n.jsx(ne.Text,{size:"12",children:c("Cart.YourCart")})]}),n.jsxs("div",{className:"module-wrapper",children:[n.jsx(W.Title,{level:4,children:c("Cart.YourCart")}),n.jsx("div",{className:"products-container",children:(B=r.value)==null?void 0:B.items.map(f=>{var E,I,M,X,D,C,G,P;return n.jsx(De.CheckoutCard,{mobile:ie,img:{src:((E=f.product)==null?void 0:E.poster_url)||Xe,alt:((I=f.product)==null?void 0:I.name)||""},title:(M=f.product)==null?void 0:M.name,price:`${ae((X=f.product)==null?void 0:X.price,(D=f.product)==null?void 0:D.tax_rate)} zł`,oldPrice:(C=f.product)!=null&&C.price_old?`${ae((G=f.product)==null?void 0:G.price_old,(P=f.product)==null?void 0:P.tax_rate)} zł`:void 0,handleDelete:()=>{var U;return o(Number((U=f.product)==null?void 0:U.id))}},f.id)})})]}),n.jsxs("div",{className:"module-wrapper",children:[n.jsx(W.Title,{level:4,children:c("Cart.ChoosePaymentMethod")}),n.jsxs("div",{className:"payments-form",children:[n.jsx("div",{className:"collapse-wrapper",children:n.jsx(gt,{active:!0,title:c("Cart.CreditCard"),children:n.jsx(St,{setBillingDetails:A,billingDetails:v})})}),y&&n.jsx("div",{className:"card-info",children:n.jsxs(ne.Text,{size:"14",children:[c("Cart.UseTestCard"),":"," ",n.jsx(qe.Link,{href:"https://docs.wellms.io/getting-started/demo.html",target:"_blank",rel:"noreferrer nofollow",children:c("Cart.LearnMore")})]})})]})]}),n.jsxs("section",{className:"slider-section",children:[n.jsx(W.Title,{level:4,children:c("Cart.Interest")}),p&&p.list&&n.jsx(xe,{courses:p.list.data})]})]}),n.jsxs(T.Col,{lg:3,children:[n.jsx(W.Title,{style:{marginBottom:20},level:4,as:"h3",children:c("Cart.Summary")}),n.jsx("div",{className:"summary-box-wrapper",children:n.jsx(vt.CartCard,{mobile:ie,onBuyClick:()=>N(),id:1,title:`${ae(Number(((K=r.value)==null?void 0:K.total_with_tax)||0))} zł`,discount:{onDiscountClick:f=>i(f).then(E=>{E.success?(O("granted"),a()):O("error")}).catch(()=>{O("error")}),onDeleteDiscountClick:()=>console.log("clicked"),status:$}})})]})]}):n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"empty-cart",children:[n.jsx(W.Title,{level:3,children:c("Cart.EmptyCartTitle")}),n.jsx(ne.Text,{children:c("Cart.EmptyCartText")}),n.jsx(oe.Button,{mode:"secondary",onClick:()=>S(V.courses),children:c("Cart.EmptyCartBtnText")})]}),n.jsxs("section",{className:"slider-section",children:[n.jsx(W.Title,{level:4,children:c("Cart.Interest")}),p&&p.list&&n.jsx(xe,{courses:p.list.data})]})]})}),(r.loading||_)&&n.jsx(Ye,{})]})})},Bt=()=>{var u,p,i;const{config:t}=k.useContext(Ve.EscolaLMSContext),e=c=>Ct(c),r=(p=(u=t==null?void 0:t.value)==null?void 0:u.escolalms_payments)==null?void 0:p.drivers,a=(i=r==null?void 0:r.stripe)==null?void 0:i.publishable_key,o=je(),s=Ee.getFontFromTheme(o);return n.jsx(Ae,{stripe:e(a),options:{fonts:[{cssSrc:s.links[0]}]},children:n.jsx(kt,{stripeKey:a})})};export{Bt as default};
