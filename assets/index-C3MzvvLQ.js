import{b as M,H as E,r as n,h as y,j as e,q as b,w as c,L as m,aK as L,s as d,D as x,n as o,T as v,f as u,i as N,l as j,aF as C,O as w,am as I,V as R,as as B,at as p,au as _,av as $,aw as z,o as D,C as A}from"./index-CBf-QksF.js";import{P as W}from"./index-xwqFlg5Y.js";import{a as q}from"./PricingCard-poshWCmx.js";import{P as G}from"./index-JHcu9MtM.js";import{D as H}from"./index-BdXw4yLt.js";import{B as O}from"./index-E9QXZg2w.js";import{a as F}from"./ResponsiveImage-BnPBXGWb.js";import{C as U,T as V}from"./index-CYXIgfIK.js";const K=M.createContext({}),J=({children:s})=>{const{id:a}=E(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{a&&t(Number(a))},[t,a]),e.jsx(K.Provider,{value:{},children:s})};var i=(s=>(s.Consultation="App\\Models\\Consultation",s.StationaryEvent="App\\Models\\StationaryEvent",s.Course="App\\Models\\Course",s.Webinar="App\\Models\\Webinar",s))(i||{});const Q=s=>s.reduce((a,t)=>{const r=t.productable_type,l=a[r]??[];return{...a,[r]:[...l,t]}},{}),X=b(c.Col)`
...
`,le=()=>{const{product:s}=n.useContext(x.EscolaLMSContext),{t:a}=u();return s.loading||!s.value?e.jsx(W,{}):e.jsx(ie,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(te,{}),e.jsx(oe,{}),e.jsx(U,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(re,{}),e.jsx(V,{title:a("PackagePage.TutorsSectionTitle"),users:s.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(ae,{})})]})})},be=()=>{var a;const{product:s}=n.useContext(x.EscolaLMSContext);return e.jsx(D,{metaTitle:(a=s.value)==null?void 0:a.name,children:e.jsx(J,{children:e.jsx(A,{children:e.jsx(le,{})})})})};export{be as default};
