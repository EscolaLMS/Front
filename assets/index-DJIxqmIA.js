import{b as E,E as M,r as n,h as y,j as e,q as b,w as c,L as m,aO as N,s as d,D as x,n as o,T as v,f as u,i as L,l as j,aK as C,J as w,ar as I,N as B,ax as R,ay as p,az as _,aA as $,aB as z,o as D,C as A}from"./index-C31D5yYy.js";import{P as W}from"./index-Bn3mPjKt.js";import{a as q}from"./PricingCard-DUkWc-fW.js";import{P as G}from"./index-CIGceE9d.js";import{D as O}from"./index-YsT40XJo.js";import{B as H}from"./index-CD0ueHbR.js";import{a as U}from"./ResponsiveImage-DJtrkYdm.js";import{C as F,T as J}from"./index-DSDh9NVE.js";const K=E.createContext({}),V=({children:a})=>{const{id:s}=M(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{s&&t(Number(s))},[t,s]),e.jsx(K.Provider,{value:{},children:a})};var i=(a=>(a.Consultation="App\\Models\\Consultation",a.StationaryEvent="App\\Models\\StationaryEvent",a.Course="App\\Models\\Course",a.Webinar="App\\Models\\Webinar",a))(i||{});const Q=a=>a.reduce((s,t)=>{const r=t.productable_type,l=s[r]??[];return{...s,[r]:[...l,t]}},{}),X=b(c.Col)`
