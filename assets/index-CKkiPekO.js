import{r as a,A as L,f as k,i as _,j as s,x as Q,T as v,s as I,ag as W,v as A,q as P,ai as G,a_ as K,a0 as U,a$ as J,b0 as V,b1 as X,m as Y,n as $,L as F,h as Z,k as ee,l as se,w as N,o as te,C as oe}from"./index-DvAWm433.js";import{T as re}from"./Tabs-CbzHops0.js";import{C as ae}from"./index-s4NFn4uQ.js";import{R as ie}from"./ResponsiveImage-Cth0O_1O.js";import{C as ne}from"./index-dBAMktj9.js";import{C as le}from"./index-azsKiB8G.js";import{R as de}from"./index-yvZVZsLP.js";import{b as ce,Q as me}from"./questionnaires-BgSEdNGG.js";import{u as ue}from"./useDownloadCertificate-Cr18nCr-.js";import{t as pe}from"./toast-DKFFGsXi.js";import{u as ge}from"./useRoles-cu6cDVlG.js";import{u as H}from"./useSearchParams-DeS21SOZ.js";import{P as xe}from"./index-CUw63Xwg.js";import{S as he}from"./swiper-DfhQq162.js";import{S as O}from"./swiper-react-DWVW_Yzd.js";import{C as B}from"./CourseCard-hUDdWhRW.js";import"./base-C7euzKDi.js";import"./a11y-CyPfFaPx.js";import"./index-Ctlg9Kww.js";const fe=({courseData:e,visible:d,onClose:t})=>{const{sendProgress:c}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:n}=_(),g=a.useCallback(async()=>{await c(e.course.id,e.progress.map(({topic_id:p})=>({topic_id:p,status:0}))),n(`/course/${e.course.id}`)},[e.course.id,e.progress,c,n]);return s.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:s.jsxs(s.Fragment,{children:[s.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),s.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),s.jsxs(W,{$gap:16,children:[s.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),s.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},Ce=P(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
