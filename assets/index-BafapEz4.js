import{b as Z,F as J,r as o,h as L,j as e,D as m,f as h,L as A,l as v,s as p,q as E,w as x,ay as S,n as C,az as b,aA as Q,aB as Y,aC as ee,aj as te,i as se,Z as z,T as u,v as j,K as N,aD as ie,aE as ae,O as re,ar as q,ae as ne,af as oe,al as le,aF as de,X as ce,aG as xe,aw as me,o as pe,C as ue}from"./index-BCUQyqgJ.js";import{P as he}from"./index-1Md6b6Wi.js";import{B as ge}from"./index-CiQtPsm4.js";import{a as W}from"./ResponsiveImage-BEYjcc29.js";import{P as X}from"./PricingCard-C5dpSqp1.js";import{P as je}from"./index-Fwc0ZvEu.js";import{D as Ee}from"./index-ASEZV_65.js";import{C as _}from"./index-umsRqGuf.js";import{E as w}from"./index-BdI1KZ8y.js";import"./index-eQjFQKsi.js";import"./index-Bl-_qDRp.js";import"./index-Bte0mGZh.js";const ve=Z.createContext({}),Ce=({children:t})=>{const{id:s}=J(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
...
`,Ae=()=>{const{settings:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return e.jsx(Ne,{children:e.jsxs("section",{className:"event-companies",children:[e.jsx(p.Text,{children:e.jsx("strong",{children:s("CoursePage.CompaniesTitle")})}),e.jsx("div",{className:"companies-row",children:t&&t.value.courseLogos&&Object.values(t.value.courseLogos).map((i,n)=>{var a;return e.jsx("div",{className:"single-company",children:e.jsx(W,{path:((a=t==null?void 0:t.value)==null?void 0:a.courseLogos[`logo${n+1}`])||"",srcSizes:[100,200,300]})},n)})})]})})},Le=()=>{var n;const{stationaryEvent:t}=o.useContext(L.EscolaLMSContext),{t:s}=h(),i=(n=t.value)==null?void 0:n.description;return i?e.jsx(e.Fragment,{children:i&&le(i)!==""&&e.jsxs("section",{className:"course-description-short with-border",children:[e.jsx(u.Title,{level:4,children:s("CoursePage.CourseDescriptionTitle")}),e.jsx(de,{children:i})]})}):null},De=E.div`
  section {
    margin-bottom: 45px;
    &.with-border {
      padding-bottom: 45px;
...
`,Oe={arrows:!1,infinite:!0,speed:500,draggable:!1,slidesToShow:4,slidesToScroll:4,responsive:[{breakpoint:1201,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:768,settings:{draggable:!0,slidesToShow:2,slidesToScroll:2}},{breakpoint:576,settings:{slidesToShow:1,centerMode:!0,slidesToScroll:1}}]},K=({nodes:t,sliderSettings:s=Oe})=>{const[i]=o.useState(!0);return e.jsx(ke,{children:e.jsx("div",{children:e.jsx(me.Slider,{settings:{...s,dots:i,onSwipe:()=>{const n=document.querySelectorAll('.slick-slide[aria-hidden="true"]');document.querySelectorAll('.slick-slide[aria-hidden="false"]').forEach(r=>r.removeAttribute("aria-modal")),n.forEach(r=>r.setAttribute("aria-modal","true"))},onInit:()=>{document.querySelectorAll('.slick-slide[aria-hidden="true"]').forEach(a=>a.setAttribute("aria-modal","true"))}},dotsPosition:"top right",children:t})})})},Ge=()=>{var n;const{stationaryEvents:t}=o.useContext(m.EscolaLMSContext),{t:s}=h(),i=(n=t.list)==null?void 0:n.data;return e.jsx(Re,{children:e.jsx("section",{className:"event-related-events",children:e.jsxs(x.Container,{children:[e.jsxs("div",{className:"content-container",children:[e.jsx(u.Title,{level:4,as:"h2",children:s("CoursePage.RelatedCoursesTitle")}),i&&i.length>4?e.jsx(K,{nodes:i.map(a=>e.jsx(_,{children:e.jsx(w,{event:a})},a.id))}):e.jsx(x.Row,{style:{marginTop:"30px",rowGap:"60px"},children:i==null?void 0:i.map(a=>e.jsx(x.Col,{md:6,lg:3,children:e.jsx(_,{children:e.jsx(w,{event:a})})},a.id))})]}),e.jsxs("div",{className:"content-container",children:[e.jsx(u.Title,{level:4,as:"h2",children:s("CoursePage.InterestTitle")}),i&&i.length>4?e.jsx(K,{nodes:i.map(a=>e.jsx(_,{children:e.jsx(w,{event:a})},a.id))}):e.jsx(x.Row,{style:{marginTop:"30px",rowGap:"60px"},children:i==null?void 0:i.map(a=>e.jsx(x.Col,{md:6,lg:3,children:e.jsx(_,{children:e.jsx(w,{event:a})})},a.id))})]})]})})})},Je=()=>{var s;const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext);return e.jsx(pe,{metaTitle:(s=t.value)==null?void 0:s.name,children:e.jsxs(Ce,{children:[e.jsx(ue,{children:e.jsx(Ue,{})}),e.jsx(Ge,{})]})})};export{Je as default};
