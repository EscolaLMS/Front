import{b as Y,E as K,r as o,h as L,j as e,D as m,f as h,L as A,l as v,s as p,q as E,w as x,ax as S,n as C,ay as b,az as Q,aA as Z,aB as ee,ai as te,i as se,Y as q,T as u,v as j,J as N,aC as ie,aD as ae,N as re,aq as z,ad as ne,ae as oe,ak as le,aE as de,X as ce,aF as xe,av as me,o as pe,C as ue}from"./index-BwDDCa5l.js";import{P as he}from"./index-DNAhof5Q.js";import{B as ge}from"./index-fnJvflA6.js";import{a as W}from"./ResponsiveImage-BfAhZdZG.js";import{P as X}from"./PricingCard-qZg96Hng.js";import{P as je}from"./index-Cnd3jTz7.js";import{D as Ee}from"./index-DLg9NA9K.js";import{C as _}from"./index-CA9fETjN.js";import{E as w}from"./index-BqFg9Sk8.js";import"./index-tZXKSMhE.js";import"./index-BUicP6Ke.js";import"./index-CHrUvAxK.js";const ve=Y.createContext({}),Ce=({children:t})=>{const{id:s}=K(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
