import{q as p,k as i,j as t,cJ as B,r as n,A as b,ag as R,T as g,f as D,X as U,i as L,l,cK as T,U as H,o as y,cL as K,cM as F,L as W,C as q,s as j}from"./index-DuLQ5VKT.js";const V=p.div`
  padding: ${i?"20px":"40px"};
...
`,re=({children:e,title:o,withTabs:s,actions:m})=>{const{user:d}=n.useContext(b.EscolaLMSContext),c=L();return n.useEffect(()=>{!d.loading&&!d.value&&c.push(l.login)},[]),t.jsx(W,{metaTitle:o,children:t.jsx(ae,{children:t.jsx(q,{children:t.jsxs(j.Row,{children:[t.jsxs(j.Col,{lg:9,children:[t.jsx(te,{title:o,withTabs:s,actions:m}),e]}),t.jsx(j.Col,{lg:3,children:t.jsx(Q,{})})]})})})})};export{re as P};
