import{b as cn,r as b,h as dn,k as G,i as un,j as r,q as X,n as N,d as h,a5 as pn,a2 as gn,aG as xn,aH as fn,a6 as hn,aI as mn,a4 as bn,a3 as vn,A as J,f as D,X as K,T as wn,S as jn,w as H,o as yn,C as Cn}from"./index-CQ96WfSz.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-Dh-Gkgwp.js";import{F as kn,S as Tn}from"./index-DGUhoeqC.js";import{W as On}from"./index-BXKrnE26.js";import{P as Pn}from"./index-reJ2lLFi.js";import"./swiper-react-DPen1Ja8.js";import"./ResponsiveImage-D_FmW4Qc.js";import"./index-DwLacoX8.js";import"./index-CfteWEsi.js";const A=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(A.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
