import{r as c,J as G,q as T,f as q,h as te,o as J,j as e,T as Q,x as S,Q as M,i as B,Z as we,p as F,y as $,a0 as Ye,a1 as Pe,U,A as je,m as $e,N as ye,a2 as ve,I as Z,a3 as Ze,a4 as Ke,d as j,a5 as Ce,a6 as ae,a7 as en,a8 as le,a9 as nn,aa as tn,ab as z,b as sn,ac as rn,ad as on,ae as an,af as ln,ag as cn,ah as dn,ai as Ee,s as un,G as pn,aj as Ie,X as ze,ak as mn,al as De,am as xn,S as gn,C as _e,L as ie,an as hn,v as fn,ao as jn,ap as Te,M as Oe}from"./index-BoiM7txo.js";import{P as vn}from"./PricingCard-2hldwBfP.js";import{u as Fe}from"./useSubscriptions-C0WwviaZ.js";import{P as Ge}from"./index-DqCfhcK4.js";import{A as _n,_ as bn,P as yn,I as Cn,a as wn,O as Pn,H as Tn}from"./index-BmfPx2oH.js";import{B as On}from"./index-DjPjbVni.js";import{Q as qe,a as Me,g as Mn}from"./questionnaires-DEukBY9n.js";import{b as Sn,a as Nn}from"./CourseCard-DUUyZCpl.js";import{P as Rn}from"./index-XZXFi22c.js";import{D as kn}from"./index-CCF6Riqv.js";import{S as An}from"./swiper-DJbw2-DD.js";import{a as Bn}from"./a11y-BfvOIEc7.js";import{S as A}from"./index-Bm0Ml9sg.js";import"./useFetchCourses-hJyjob3K.js";const Ln=n=>{const[t,s]=c.useState({data:void 0,loaded:!1,loading:!1}),{user:a,fetchCourseProgress:o,courseProgressDetails:i}=c.useContext(G.EscolaLMSContext);return c.useEffect(()=>{i.byId&&i.byId[Number(n)]&&i.byId[Number(n)].value&&s({...t,data:i.byId[Number(n)].value,loaded:!0,loading:!1})},[n,i]),c.useEffect(()=>{a!=null&&a.value&&!a.loading&&!t.loading&&!t.loaded?(s({...t,loading:!0}),o(n).catch(()=>s({...t,loaded:!0,loading:!1}))):t.loaded||s({...t,loaded:!0})},[a,t,o,n]),{progress:t}},$n=T.div`
  text-align: center;
  .modal-header {
    margin-bottom: 10px;
  }
...
`,Yn=({author:n})=>e.jsx(M.Col,{lg:6,children:e.jsx(cn,{mobile:B,avatar:{alt:`${n.first_name} ${n.last_name}`,src:n.path_avatar?`${dn}/api/images/img?path=${n.path_avatar}`:Ee.tutorPlaceholderPath},fullName:`${n.first_name} ${n.last_name}`,description:n.bio})});var D=(n=>(n.INIT="INIT",n.LOADED="LOADED",n.LOADING="LOADING",n.ERROR="ERROR",n))(D||{});const Zn=T.div`
  display: flex;
  align-items: center;
  gap: 5px;
  p {
