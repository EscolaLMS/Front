import{b as cn,r as b,h as dn,n as G,i as un,j as r,q as X,k as L,d as h,D as pn,a3 as gn,aw as xn,ax as fn,F as hn,ay as mn,E as bn,a4 as vn,A as J,f as D,X as K,o as wn,S as jn,s as H,L as yn,C as Cn}from"./index-Dgt1a0Cx.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-GSioCoFt.js";import{F as kn,S as Tn}from"./index-BFHUXpPB.js";import{W as On}from"./index-Dlxi3CVI.js";import{P as Pn}from"./index-D1pxcyh4.js";import"./swiper-react-CkP-HQen.js";import"./ResponsiveImage-ghj5d5AC.js";import"./index-Dp_qiSfW.js";import"./index-Bai6EYDK.js";const N=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(N.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
