import{k as E,j as e,U as a,T as j,o as _,s as z,q as g,r as v,i as F,h as H,V as B,p as P,x as T,y as h,m as C,a0 as f,as as A,at as q,au as L,av as D,aw as V,O as G,v as U,C as k,L as I,am as O,M as Q}from"./index-DMEaDbL2.js";import{P as W}from"./index-pct1kTTf.js";import{B as J}from"./index-Dg2zNsd2.js";import{a as K}from"./index-2_Yu-yEN.js";import{P as R}from"./PricingCard-_GooO2LF.js";import{C as $}from"./index-CMl1UQ5b.js";import{S as M,a as X}from"./sidebar-B_soCgyh.js";import{S as p}from"./index-BcMNIAcd.js";import"./warning-bWiOVVW-.js";import"./useRoles-ClkkD2v2.js";const Y=i=>{const{consultation:t}=i,s=E();return e.jsxs(a.Row,{align:"center",children:[e.jsxs(a.Col,{lg:7,children:[(t==null?void 0:t.categories)&&t.categories.length>0&&e.jsx(K,{categories:t.categories,onCategoryClick:x=>{s.push(`/consultations/?categories[]=${x}`)}}),e.jsx("br",{}),e.jsx(j.Title,{mobile:_,level:1,children:t==null?void 0:t.name})]}),e.jsx(a.Col,{lg:4,children:(t==null?void 0:t.image_path)&&e.jsx("div",{className:"image-wrapper",children:e.jsx(z.ResponsiveImage,{path:t.image_path,srcSizes:[790*.5,790,2*790]})})})]})};g.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: 10px;
