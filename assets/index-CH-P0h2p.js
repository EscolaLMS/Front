import{b as Y,E as J,r as l,k as N,j as e,h as p,f as u,v as y,o as j,G as A,q as g,i as m,al as w,n as E,am as C,ab as K,ac as Q,ad as Z,m as ee,V,T as b,l as o,an as te,W as se,Y as ie,a9 as ae,af as re,ao as ne,X as oe,ap as le,ak as de,L as ce,C as xe}from"./index-DaafzRP_.js";import{P as me}from"./index-DBq-nsKT.js";import{B as pe}from"./index-DVPhWZqb.js";import{a as X}from"./ResponsiveImage-BWLsb9wG.js";import{f as ue}from"./date-D2Y_Z1t9.js";import{P as q}from"./PricingCard-yK-81SRW.js";import{f as z}from"./index-DfHnr1oM.js";import{P as he}from"./index-bfvIBFek.js";import{D as ge}from"./index-D2lYi9--.js";import{C as T}from"./index-D6Quq3aY.js";import{E as _}from"./index-A0_ATuNu.js";import"./app-B2E7767C.js";import"./index-DmeYF39A.js";import"./index-4Hra2YYq.js";import"./index-XxUfqVTU.js";const je=Y.createContext({}),Ee=({children:t})=>{const{id:s}=J(),{fetchStationaryEvent:i}=l.useContext(N.EscolaLMSContext);return l.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(je.Provider,{value:{},children:t})},ve=()=>{const{stationaryEvent:t}=l.useContext(p.EscolaLMSContext),{t:s}=u();return t.value?e.jsx(pe,{items:[e.jsx(y,{to:j.home,children:s("Home")}),e.jsx(y,{to:j.events,children:s("Menu.Events")}),e.jsx(A.Text,{size:"12",children:t.value.name})]}):null},Ce=g.div`
  .event-main-info {
    .image-wrapper {
