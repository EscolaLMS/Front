import{f as p,j as e,ak as F,T as R,au as H,r as l,h as j,w as B,n as S,s as C,q as T,i as m,ar as q,m as r,as as u,ad as G,ae as A,af as U,k as D,l as w,W as J,v as h,K as L,Y as K,Z as Y,C as Z,G as Q,L as V,az as X}from"./index-Duhnd3NG.js";import{C as b,T as O}from"./index-BKnYV56D.js";import{B as ee}from"./index-CAFi8QTa.js";import{a as te}from"./ResponsiveImage-CKPbfW5t.js";import{f as $}from"./date-DtH1bSeH.js";import{P as se}from"./PricingCard-L2C0_epf.js";import{W as ae}from"./index-BgjA_Aub.js";import{P as oe}from"./index-DpXbU8lt.js";import"components/atoms/Typography/Text";import"./app-B2E7767C.js";import"./index-CDaAQ3M0.js";import"./index-CnyZdFlA.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&F(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(R.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(H,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(B,{to:S.home,children:a("Home")}),e.jsx(B,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
...
`,ue=()=>{var o,n,i;const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return e.jsx(Z,{children:e.jsx(xe,{children:e.jsxs(m.Row,{children:[e.jsxs(m.Col,{md:12,lg:9,children:[e.jsx(ie,{}),e.jsx(le,{}),e.jsx(b,{title:a("WebinarPage.CompaniesTitle")}),e.jsx(O,{users:((o=t.value)==null?void 0:o.trainers)||[],title:a("Tutors")}),e.jsx(I,{description:(n=t.value)==null?void 0:n.description}),e.jsx(I,{title:a("Agenda"),description:(i=t.value)==null?void 0:i.agenda})]}),e.jsx(m.Col,{md:12,lg:3,children:e.jsx(ce,{})})]})})})},We=()=>{var n;const{fetchWebinar:t,webinar:a}=l.useContext(D.EscolaLMSContext),{id:o}=Q();return l.useEffect(()=>{t(Number(o))},[t,o]),e.jsxs(V,{metaTitle:((n=a==null?void 0:a.value)==null?void 0:n.name)||"Loading",children:[a.loading&&e.jsx(X,{}),!a.loading&&a.value&&e.jsx(ue,{})]})};export{We as default};
