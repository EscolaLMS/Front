import{b as A,r as x,A as z,i as T,n as L,q as u,Q as B,j as e,V as M,k as b,f as P,s as S,T as j,W as w,v as N,o as H,Y as R,Z as k,X as G,a0 as X,L as Q,C as O}from"./index-OGDo-hkl.js";import{P as U}from"./index-D-Ty7NYk.js";import{q as _}from"./base-C7euzKDi.js";import{R as V}from"./ResponsiveImage-dgTLmURN.js";import{C as Y}from"./index-DeyRTtVF.js";import{C as Z}from"./index-CkkSfJi5.js";import{P as J}from"./index-BAF1aJt1.js";import{C as K,u as ee}from"./CourseCard-BlyWBZq_.js";const W=A.createContext({}),se=()=>{const{courses:r,params:a,setParams:s,loading:l}=x.useContext(W),{fetchCategories:t,categoryTree:c}=x.useContext(z.EscolaLMSContext),[o,n]=x.useState([]),i=T(),h=L(),f=x.useCallback(p=>{s&&s({...a,order:p})},[a,s]),C=x.useCallback(p=>{s&&s({...a,page:p})},[a,s]),$=x.useCallback(p=>{const g=o.filter(d=>d.id!==p);n(g),s&&s({...a,page:1,"categories[]":g.map(d=>d.id)})},[a,o,s]),E=x.useCallback(p=>{const g=o.some(d=>d.id===p.id)?o.filter(d=>d.id!==p.id):[...o,p];n(g),s&&s({...a,page:1,"categories[]":g.map(d=>d.id)})},[a,o,s]),v=x.useCallback(()=>{n([]),s&&s({...a,page:1,order:void 0,"categories[]":void 0})},[a,s]),y=x.useCallback(p=>p.flatMap(g=>{const d=y(g.subcategories||[]);return[g,...d]}),[]);return x.useEffect(()=>{const g=_.parse(h.search)["categories[]"];if(g){const D=y(c.list||[]).filter(q=>g.includes(String(q.id)));n(D)}},[h.search,c,y]),x.useEffect(()=>{t()},[t]),x.useEffect(()=>{a&&i.push(`${h.pathname}?${_.stringify(a)}`)},[a,h.pathname,i]),{courses:r,loading:l,prevCategories:o,handleSortChange:f,handlePageChange:C,handleRemoveCategory:$,handleCategoryChange:E,onClearCategories:v,params:a,categoryTree:c}},re=u.div`
  .close {
    all: unset;
    cursor: pointer;
  }
...
`,je=u.div`
  ...
  position: relative;
  margin-bottom: 16px;
`,ke=()=>{const{t:r}=P();return e.jsx(Q,{metaTitle:r("CoursesPage.Courses"),children:e.jsx(Ce,{onlyFree:!1,children:e.jsxs(me,{className:"courses-page",children:[e.jsx(je,{children:e.jsx(O,{children:e.jsxs(w.Title,{level:1,children:[" ",r("CoursesPage.Courses")]})})}),e.jsx(O,{children:e.jsx(xe,{})})]})})})};export{ke as default};
