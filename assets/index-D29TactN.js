import{r as p,h as _,i as M,k as $,l as A,q as E,j as e,T as B,m as O,n as N,L as H,f as z,o as q,C as I,B as W,M as Q}from"./index-qD7U5zMV.js";import{R as D}from"./ResponsiveImage-biK-hrc-.js";import{C as F}from"./index-Bl4dds4u.js";import{D as y}from"./index-Bc4WMeYi.js";import{S as P}from"./swiper-react-BDSdVK4P.js";import{S as L}from"./swiper-CIn4xG8b.js";import{C as G}from"./CourseCard-B0cTijnI.js";import{u as J}from"./useSearchParams-CXFpqUDw.js";import{CourseStatus as u}from"./index-BSq9sOUL.js";import{C as K}from"./index-DDOwUuXl.js";import{C as X}from"./index-C7NF1b26.js";import"./index-Db1_Zn1c.js";import"./index-CPQe3EBT.js";import"./useFetchCourses-sMdaN-F_.js";import"./a11y-DaslWFvY.js";import"./index-dT5Ynv3g.js";import"./base-C7euzKDi.js";import"./Tabs-B25S27H0.js";import"./index-a7XYl9zz.js";import"./index-BBFLA_ni.js";import"./questionnaires-C-a5RkfO.js";import"./toast-lasjBFrg.js";import"./useDownloadCertificate-rfsH6aun.js";import"./useRoles-BjiWK9L0.js";import"./index-BLDBlx3b.js";const Y=(o=u.ALL)=>{var R,k;const{fetchMyAuthoredCourses:a,myAuthoredCourses:i,fetchPaginatedProgress:l,paginatedProgress:n}=p.useContext(_.EscolaLMSContext),[s,c]=p.useState([]),f=M(),{setQueryParam:S}=J(),{search:b}=$(),h=new URLSearchParams(b),d=h.get("page"),g=h.get("status"),v=p.useMemo(()=>{var t,r;return o===u.AUTHORED?(t=i.list)==null?void 0:t.meta:(r=n.list)==null?void 0:r.meta},[o,(R=i.list)==null?void 0:R.meta,(k=n.list)==null?void 0:k.meta]),x=p.useCallback(t=>{let r="";switch(t){case 1:case 5:break;case 2:r="started";break;case 3:r="planned";break;case 4:r="finished";break}return r},[]);p.useEffect(()=>{l({page:d?parseInt(d):1,per_page:18,status:x(Number(g))}),(o===u.ALL||o===u.AUTHORED)&&a()},[l,o,a,d,g,x]);const j=p.useMemo(()=>{var t;return(((t=n.list)==null?void 0:t.data)||[]).reduce((r,m)=>({...r,[m.course.id?m.course.id:-1]:Math.round((m.progress||[]).reduce((T,U)=>U.status===1?T+1:T,0)/m.progress.length*100)}),{})},[n]),C=p.useCallback(t=>t.map(r=>({...r.course,courseData:r,progress:j[r.course.id?r.course.id:-1]})),[j]);return p.useEffect(()=>{var t,r,m,T;o!==u.AUTHORED?c(C(((t=n.list)==null?void 0:t.data)||[])):o===u.AUTHORED?c(((r=i.list)==null?void 0:r.data)||[]):c([...C(((m=n.list)==null?void 0:m.data)||[]),...((T=i.list)==null?void 0:T.data)||[]])},[o,n,i,C]),{coursesToMap:s,paginationMeta:v,loading:n.loading||i.loading,handlePagination:t=>{S("page",`${t}`),window==null||window.scrollTo(0,0)},redirectToCourses:()=>f.push(A.courses)}},Z=E.div`
  position: relative;
