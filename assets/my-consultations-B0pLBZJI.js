import{r as i,h as P,f as x,j as e,a0 as _,s as m,n as b,w as h,q as c,L as I,b1 as y,b2 as E,aj as A,as as v,X as M,b3 as N,g as w,D as L,aM as T,b4 as S,b5 as U,v as R,b6 as k,H as B}from"./index-BCUQyqgJ.js";import{P as F}from"./index-nAHoL22L.js";import{T as $}from"./Tabs-CcZ96ecJ.js";import{a as G}from"./ResponsiveImage-BEYjcc29.js";import{C as O}from"./index-eQjFQKsi.js";import{D as p,a as C}from"./index-CwcMswST.js";import{P as W,C as q,a as H}from"./index-Bbm2XQq_.js";import{u as K}from"./useRoles-DWF1L03f.js";import"./index-FqIFEvDH.js";import"./warning-DJG_fGC5.js";const z=({type:t})=>{var d;const{userConsultations:s,fetchUserConsultations:o}=i.useContext(P.EscolaLMSContext),{t:n}=x(),r=i.useMemo(()=>{var a;return((a=s.list)==null?void 0:a.data.filter(l=>t===j.STARTED||t===j.UPCOMING?l.in_coming||l.is_started:l.is_ended))||[]},[t,(d=s.list)==null?void 0:d.data]);return i.useEffect(()=>{o()},[t,o]),e.jsx(W,{children:s.loading?e.jsx(_,{}):r.length===0?e.jsx(m.Text,{style:{paddingLeft:b?20:40},children:n("MyProfilePage.OrdersEmpty")}):e.jsx(h.Row,{style:{gap:"30px 0"},children:r.map(a=>e.jsx(h.Col,{xs:12,md:6,lg:4,children:e.jsx(q,{consultation:a})},a.id))})})},g=i.memo(z),X=c.div`
  .course-section {
    margin-top: 0px;
  }
