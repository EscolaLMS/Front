import{b as E,O as M,r as i,m as k,j as e,q as x,i as n,U as c,L as m,ax as N,x as d,K as u,T as b,f as p,h as L,o as v,ay as C,I as T,az as _,l as I,aA as R,aB as h,aC as B,aD as z,aE as A,ao as S,ah as D,ai as O,v as U,C as W}from"./index-Bw3VKjvD.js";import{P as q}from"./index-CbM0ZbWO.js";import{a as G}from"./PricingCard-DNNlHXYo.js";import{P as F}from"./index--0_Z48kA.js";import{B as H}from"./index-DrFUMf6V.js";const V=E.createContext({}),K=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},J=x.div`
  width: 100%;
  left: 0;
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(q,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},fe=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(U,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(K,{children:e.jsx(W,{children:e.jsx(pe,{})})})})};export{fe as default};
