import{b as S,E,r as o,k as w,j as e,q as b,i as d,v as m,l as i,h as x,n,T,f as u,m as M,o as j,au as C,ag as L,Y as N,G as I,al as R,am as g,ab as B,ac as _,ad as $,L as z,C as D}from"./index-DaafzRP_.js";import{P as A}from"./index-DBq-nsKT.js";import{a as G}from"./PricingCard-yK-81SRW.js";import{P as W}from"./index-bfvIBFek.js";import{D as q}from"./index-D2lYi9--.js";import{B as H}from"./index-DVPhWZqb.js";import{a as O}from"./ResponsiveImage-BWLsb9wG.js";import{C as U,T as F}from"./index-Q3Q68GJ4.js";import"./index-DfHnr1oM.js";import"./app-B2E7767C.js";import"./date-D2Y_Z1t9.js";const V=S.createContext({}),Y=({children:t})=>{const{id:s}=E(),{fetchProduct:a}=o.useContext(w.EscolaLMSContext);return o.useEffect(()=>{s&&a(Number(s))},[a,s]),e.jsx(V.Provider,{value:{},children:t})};var l=(t=>(t.Consultation="App\\Models\\Consultation",t.StationaryEvent="App\\Models\\StationaryEvent",t.Course="App\\Models\\Course",t.Webinar="App\\Models\\Webinar",t))(l||{});const J=t=>t.reduce((s,a)=>{const r=a.productable_type,c=s[r]??[];return{...s,[r]:[...c,a]}},{}),K=b(d.Col)`
