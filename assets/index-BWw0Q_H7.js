import{b as N,Q as L,r as i,i as k,j as e,q as x,o as n,V as c,L as m,aF as M,y as d,N as u,T as b,h as p,k as E,m as v,aG as C,a1 as T,at as _,aB as I,aH as R,aI as h,aJ as B,aK as z,aL as A,al as S,ae as D,af as G,v as W,C as q}from"./index-Y9RNIFp-.js";import{P as F}from"./index-BpTzjh51.js";import{a as H}from"./PricingCard-BK-LhdQt.js";import{P as O}from"./index-JVw5OiMB.js";import{B as U}from"./index-7EMgtCIu.js";const V=N.createContext({}),J=({children:t})=>{const{id:a}=L(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},K=x.div`
  width: 100%;
  left: 0;
