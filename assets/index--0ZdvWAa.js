...
`,Ee=k.div`
  ...
  justify-content: center;
  margin-top: 50px;
`,O=({filter:e=S.ALL})=>{var l,h;const{fetchMyAuthoredCourses:d,myAuthoredCourses:r,fetchPaginatedProgress:c,paginatedProgress:a}=i.useContext(Z.EscolaLMSContext),[x,b]=i.useState([]),y=E(),{t:u}=R(),{setQueryParam:j}=J(),{search:C}=W(),p=new URLSearchParams(C),f=p.get("page"),v=p.get("status"),g=i.useMemo(()=>{var o,m;return e===S.AUTHORED?(o=r.list)==null?void 0:o.meta:(m=a.list)==null?void 0:m.meta},[e,(l=r.list)==null?void 0:l.meta,(h=a.list)==null?void 0:h.meta]),P=i.useCallback(o=>{let m="";switch(o){case 1:case 5:break;case 2:m="started";break;case 4:m="finished";break}return m},[]);i.useEffect(()=>{c({page:f?parseInt(f):1,per_page:8,status:P(Number(v))}),(e===S.ALL||e===S.AUTHORED)&&d()},[c,e,d,f,v,P]);const n=i.useMemo(()=>{var o;return(((o=a.list)==null?void 0:o.data)||[]).reduce((m,w)=>({...m,[w.course.id?w.course.id:-1]:Math.round((w.progress||[]).reduce((M,N)=>N.status===1?M+1:M,0)/w.progress.length*100)}),{})},[a]),s=i.useCallback(o=>o.map(m=>({...m.course,courseData:m,progress:n[m.course.id?m.course.id:-1]})),[n]);return i.useEffect(()=>{var o,m,w,M;e!==S.AUTHORED?b(s(((o=a.list)==null?void 0:o.data)||[])):e===S.AUTHORED?b(((m=r.list)==null?void 0:m.data)||[]):b([...s(((w=a.list)==null?void 0:w.data)||[]),...((M=r.list)==null?void 0:M.data)||[]])},[e,a,r,s]),t.jsxs(Oe,{children:[x.length===0&&!a.loading&&!r.loading&&t.jsxs(Ae,{children:[t.jsx(L.Title,{level:3,children:u("MyProfilePage.EmptyCoursesTitle")}),t.jsx(B.Text,{className:"small-text",children:u("MyProfilePage.EmptyCoursesText")}),t.jsx(A.Button,{onClick:()=>y.push(pe.courses),mode:"secondary",children:u("MyProfilePage.EmptyCoursesBtnText")})]}),U?t.jsxs(we,{children:[a.loading&&r.loading&&Array.from({length:8}).map((o,m)=>t.jsx(H,{className:"single-slide",children:t.jsx(z,{})},`skeleton-card-${m}`)),(!a.loading||!r.loading)&&x&&x.map(o=>t.jsx(H,{className:"single-slide",children:t.jsx(G,{course:o})},o.id))]}):t.jsxs(t.Fragment,{children:[t.jsx(F.Row,{children:a.loading||r.loading?Array.from({length:8}).map((o,m)=>t.jsx(F.Col,{md:3,children:t.jsx(z,{})},`skeleton-card-${m}`)):x.map(o=>t.jsx(F.Col,{md:3,children:t.jsx(G,{course:o})},o.id))}),t.jsx(Ee,{children:t.jsx(Pe,{total:(g==null?void 0:g.total)||0,perPage:Number((g==null?void 0:g.per_page)||0),currentPage:Number((g==null?void 0:g.current_page)||1),onPage:o=>{j("page",`${o}`),window==null||window.scrollTo(0,0)}})})]})]})},Le=()=>{const{user:e}=i.useContext(Z.EscolaLMSContext),d=i.useMemo(()=>{var c,a;return!!((a=(c=e.value)==null?void 0:c.roles)!=null&&a.includes("tutor"))},[e]),r=i.useMemo(()=>{var c,a;return!!((a=(c=e.value)==null?void 0:c.roles)!=null&&a.includes("student"))},[e]);return{isTutor:d,isStudent:r}};var S=(e=>(e.IN_PROGRESS="inProgress",e.PLANNED="planned",e.FINISHED="finished",e.AUTHORED="authored",e.ALL="all",e))(S||{});const $e=k.section`
