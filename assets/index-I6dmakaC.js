import{r,h as $,f as k,m as B,j as t,w as X,l as x,q as R,X as q,H as J,n as D,v as O,G as S,T as I,Q as U,U as V,J as Y,k as Z,p as ee,i as z,s as te,o as se,d as M,z as oe,D as ne,aE as re}from"./index-DaafzRP_.js";import{T as ae}from"./Tabs-CqkvBFiW.js";import{C as ie}from"./index-p2Hnf5if.js";import{C as le}from"./index-DmeYF39A.js";import{R as ce}from"./ResponsiveImage-BWLsb9wG.js";import{C as de}from"./index-D6Quq3aY.js";import{C as ue}from"./index-XxUfqVTU.js";import{R as me}from"./index-Db_LNlr-.js";import{g as pe,r as xe}from"./index-DfHnr1oM.js";import{c as ge,a as he}from"./questionnaires-DptVHaG1.js";import{P as fe}from"./index-BuaDi91w.js";import{u as je}from"./useRoles-BDN2hqSP.js";import{u as W}from"./useSearchParams-6oAU0A-0.js";import{P as ye}from"./index-C9fEySCg.js";import"./app-B2E7767C.js";import"./date-D2Y_Z1t9.js";import"./base-CumTa13P.js";const be=({courseData:e,visible:s,onClose:o})=>{const{sendProgress:a}=r.useContext($.EscolaLMSContext),{t:n}=k(),{push:l}=B(),p=r.useCallback(async()=>{await a(e.course.id,e.progress.map(({topic_id:C})=>({topic_id:C,status:0}))),l(`/course/${e.course.id}`)},[e.course.id,e.progress,a,l]);return t.jsx(X.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:s,onClose:o,children:t.jsxs(t.Fragment,{children:[t.jsx(x.Title,{level:4,children:n("ResetProgressModal.Continue")}),t.jsxs(x.Text,{children:[" ",n("ResetProgressModal.RestartCourse")]}),t.jsxs(x.Row,{$gap:16,children:[t.jsx(x.Button,{mode:"primary",onClick:p,children:n("ResetProgressModal.WantContinue")}),t.jsx(x.Button,{mode:"primary",onClick:o,children:n("ResetProgressModal.Cancel")})]})]})})},Ce=R(x.Stack)`
  gap: 6px;
  margin: 0;
  width: 100%;
