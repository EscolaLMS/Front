import{q as d,j as e,r as a,U as p,bi as h,Q as g}from"./index-BoiM7txo.js";import{S as t}from"./index-Bm0Ml9sg.js";const u="/assets/no-picture-sHwVEW-e.png",j=d.div`
  width: 100%;
  height: 100%;
  border: 1px solid
...
`,k=r=>{const{categories:n,onCategoryClick:o}=r,c=a.useRef(null),i=n||[],m=a.useCallback(s=>{o&&o(s)},[o]);return e.jsx(b,{ref:c,children:e.jsx(p,{children:e.jsx(h.BreadCrumbs,{hyphen:"",items:i==null?void 0:i.map((s,x)=>e.jsx(e.Fragment,{children:e.jsx("span",{className:"category-name",onClick:()=>m(s.id),"aria-hidden":"true",children:s.name},s.name+x)}))})})})},l=d.div`
  max-width: 278px;
  min-height: 414px;
