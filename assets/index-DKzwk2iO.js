import{f as p,j as e,al as z,T as R,aF as H,r as l,D as j,L,l as S,s as C,q as T,w as m,ay as q,n as r,az as u,aA as A,aB as G,aC as K,aj as $,h as D,i as U,Z as w,v as h,K as k,aE as J,O as Z,C as Q,F as V,o as X,aK as Y}from"./index-BCUQyqgJ.js";import{C as b,T as O}from"./index-Qwe8Etvl.js";import{B as ee}from"./index-CiQtPsm4.js";import{a as te}from"./ResponsiveImage-BEYjcc29.js";import{P as se}from"./PricingCard-C5dpSqp1.js";import{W as ae}from"./index-rcRLWrG4.js";import{P as oe}from"./index-Fwc0ZvEu.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&z(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(R.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(H,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(L,{to:S.home,children:a("Home")}),e.jsx(L,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
...
`,de=()=>{var P,E;const[t,a]=l.useState(6),[o,n]=l.useState(!1),{cart:i,addToCart:F,user:x,webinar:{value:s}}=l.useContext(D.EscolaLMSContext),{t:d}=p(),{push:v}=U(),y=l.useMemo(()=>{var c;return(c=i==null?void 0:i.value)==null?void 0:c.items.some(f=>{var g;return Number(f.product_id)===Number((g=s==null?void 0:s.product)==null?void 0:g.id)})},[(P=s==null?void 0:s.product)==null?void 0:P.id,i]);return l.useEffect(()=>{var c,f,g,M,W,_,N,B;s!=null&&s.deadline&&w(new Date(s==null?void 0:s.deadline))?a(0):y?a(1):(c=x.value)!=null&&c.id&&((f=s==null?void 0:s.product)!=null&&f.owned)&&(s!=null&&s.is_ended)?a(2):(g=x.value)!=null&&g.id&&((M=s==null?void 0:s.product)!=null&&M.owned)&&(s!=null&&s.in_coming)?a(3):(W=x.value)!=null&&W.id&&((_=s==null?void 0:s.product)!=null&&_.owned)&&(s!=null&&s.is_started)?a(7):(N=x.value)!=null&&N.id&&(s!=null&&s.product)&&(s!=null&&s.product.buyable)?a(4):!(s!=null&&s.product)||(B=x.value)!=null&&B.id&&!(s!=null&&s.product.buyable)?a(5):a(6)},[y,s,(E=x.value)==null?void 0:E.id]),e.jsxs(e.Fragment,{children:[t===0&&e.jsx(C.Text,{children:d("EventPage.IsFinished")}),t===1&&e.jsx(h.Button,{mode:"secondary",onClick:()=>v(S.cart),children:d("EventPage.GoToCheckout")}),t===2&&e.jsx(h.Button,{onClick:()=>v(`/webinar/${s==null?void 0:s.id}`),mode:"secondary",children:d("Show")}),t===3&&e.jsx(C.Text,{children:d("EventPage.NotStarted")}),t===7&&e.jsx(h.Button,{loading:i.loading,mode:"secondary",onClick:()=>n(!0),children:d("Join")}),t===4&&e.jsx(h.Button,{loading:i.loading,mode:"secondary",onClick:()=>{var c;return F(Number((c=s==null?void 0:s.product)==null?void 0:c.id)).then(()=>v(S.cart))},children:d("Buy now")}),t===5&&e.jsx(C.Text,{children:d("EventPage.UnavailableEvent")}),t===6&&e.jsx(h.Button,{onClick:()=>v(`/login?referrer=/webinar/${s==null?void 0:s.id}`),mode:"secondary",children:d("Buy now")}),o&&(s==null?void 0:s.id)&&e.jsx(ae,{visible:o,onClose:()=>n(!1),webinarId:s.id})]})},ce=()=>{var o,n,i;const{webinar:{value:t}}=l.useContext(j.EscolaLMSContext),{t:a}=p();return e.jsx(re,{children:e.jsxs(se.PricingCard,{mobile:r,children:[e.jsx(R.Title,{level:4,as:"h2",children:t==null?void 0:t.name}),e.jsx(oe,{price:(o=t==null?void 0:t.product)==null?void 0:o.price,taxRate:(n=t==null?void 0:t.product)==null?void 0:n.tax_rate,oldPrice:((i=t==null?void 0:t.product)==null?void 0:i.price_old)||void 0}),e.jsx(de,{}),e.jsxs("div",{className:"pricing-card-features",children:[(t==null?void 0:t.duration)&&e.jsx(k.IconText,{icon:e.jsx(J,{}),text:`${a("Duration")}: ${t.duration} ${t.duration==="1"?a("Hour"):a("Hours")}`}),t!=null&&t.users_count?e.jsx(k.IconText,{icon:e.jsx(Z,{}),text:`${a("Students")}: ${t==null?void 0:t.users_count}`}):""]})]})})},xe=T.div`
  section {
    margin-bottom: 45px;
    &.with-border {
      padding-bottom: 45px;
