import{b as M,K as N,r as i,m as k,j as e,q as x,i as n,O as c,L as m,av as E,x as d,H as u,T as b,f as p,h as L,o as v,aw as C,I as T,ax as _,l as I,ay as R,az as h,aA as B,aB as z,aC as A,am as S,af as D,ag as O,v as W,C as q}from"./index-Bdpwia2Z.js";import{P as G}from"./index-DP6SZtxs.js";import{a as H}from"./PricingCard-vpfCnW8x.js";import{P as U}from"./index-ToPPR4wM.js";import{B as F}from"./index-D11m-q8u.js";const V=M.createContext({}),K=({children:t})=>{const{id:a}=N(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},J=x.div`
  width: 100%;
  left: 0;
