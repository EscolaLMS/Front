import{b as cn,r as b,l as dn,s as G,i as un,j as r,q as X,o as L,d as h,E as pn,a5 as gn,az as xn,aA as fn,G as hn,aB as mn,F as bn,a6 as vn,D as J,f as D,X as K,T as wn,S as jn,h as H,L as yn,m as Cn}from"./index-BTvwz0L3.js";import{q as M}from"./base-CumTa13P.js";import{C as _n}from"./index-BCstk8RY.js";import{F as kn,S as Tn}from"./index-BTth33E-.js";import{W as On}from"./index-C2LchGTk.js";import{P as Pn}from"./index-DzsaDRiK.js";import"./swiper-react-BSSPoOCY.js";import"./ResponsiveImage-G_l4wTjD.js";import"./index-ClhuH08r.js";import"./index-WJvgSzYs.js";const N=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(N.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
