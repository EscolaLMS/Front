import{j as s,q as l,D as w,b_ as A,a as P,b as C,T as D,b$ as g,o as t,n as m,c0 as N,f as S,c1 as _,g as a}from"./index-B5nakMtJ.js";import{r as c}from"./sentry-DZqhWugq.js";const R=l.div`
  padding: 11px 6px;
  background: ${({theme:e})=>e.mode==="dark"?e.dm__cardBackgroundColor:e.white};
  border-radius: ${({theme:e})=>e.cardRadius}px;
`,h=({children:e})=>s.jsx(R,{children:e}),E=l.div`
  h2 {
    margin-bottom: 10px;
  }
`,b=l("aside")`
