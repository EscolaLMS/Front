import{f as p,j as e,ak as z,T as D,aE as F,r as l,D as j,L as k,l as S,s as C,q as T,w as m,ax as q,n as r,ay as u,az as A,aA as G,aB as J,ai as L,h as R,i as U,a1 as w,v as h,O as $,aD as V,V as K,C as Q,H as X,o as Y,aJ as Z}from"./index-BrnsqxCr.js";import{C as b,T as O}from"./index-Bjkn39nj.js";import{B as ee}from"./index-Daa_jL_h.js";import{a as te}from"./ResponsiveImage-Cy_iuZ6S.js";import{P as se}from"./PricingCard-B1F4fw_f.js";import{W as ae}from"./index-CgQzPtQy.js";import{P as oe}from"./index-DrjLV46P.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&z(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(D.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(F,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(k,{to:S.home,children:a("Home")}),e.jsx(k,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
