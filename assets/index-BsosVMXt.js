import{b as cn,r as b,h as dn,k as G,i as un,j as r,q as X,n as N,d as h,a6 as pn,a3 as gn,aH as xn,aI as fn,a7 as hn,aJ as mn,a5 as bn,a4 as vn,D as J,f as A,X as K,T as wn,S as jn,w as H,o as yn,C as Cn}from"./index-BCUQyqgJ.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-CrExrpx2.js";import{F as kn,S as Tn}from"./index-C3eCEk7u.js";import{W as On}from"./index-DTtIpWWz.js";import{P as Pn}from"./index-C2nSJp8r.js";import"./swiper-react-skRm1w3h.js";import"./ResponsiveImage-BEYjcc29.js";import"./index-eQjFQKsi.js";import"./index-Bl-_qDRp.js";const D=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(D.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
  ...
  `,{params:t}=b.useContext(D);return r.jsx(l,{filters:t,children:i})},Wn=X("div")`
  display: flex;
  row-gap: 30px;
  flex-wrap: wrap;
