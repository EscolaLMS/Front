...
`,W=()=>{var w;const{orders:l,fetchOrders:g,fetchOrderInvoice:t}=x.useContext(I.EscolaLMSContext),[T,N]=x.useState([]),{t:m}=q(),[r,p]=x.useState(-1);x.useEffect(()=>{g()},[]);const b=x.useCallback(async c=>{p(c);try{const a=await t(c);if(a){const f=document.createElement("a");document.body.appendChild(f),f.setAttribute("href",URL.createObjectURL(new Blob([a]))),f.setAttribute("download",`${m("MyProfilePage.InvoiceTitle")} ${c}.pdf`),f.style.display="",f.click(),document.body.removeChild(f),p(-1)}}catch(a){p(-1),H(m("UnexpectedError"),"error"),console.log(a)}},[t,m]);return x.useEffect(()=>{var c;l.list&&!l.loading&&N((c=l==null?void 0:l.list)==null?void 0:c.data.map(a=>{var f;return{title:d.jsx("div",{className:"name-container",children:(f=a==null?void 0:a.items)==null?void 0:f.map((v,P)=>{var j,y;return d.jsx(O.Text,{children:d.jsxs("strong",{children:[(j=v==null?void 0:v.product)==null?void 0:j.name,P+1!==((y=a==null?void 0:a.items)==null?void 0:y.length)&&", "]})},P)})}),price:d.jsxs(O.Text,{children:[a.subtotal," zł"]}),date:a.created_at?d.jsx(O.Text,{children:A(a.created_at)}):"",actions:d.jsx(R.Button,{mode:"outline",onClick:()=>b(a.id),loading:r===a.id,children:m("MyProfilePage.Invoice")})}}))},[l]),d.jsx(G,{title:m("MyProfilePage.OrdersHistory"),children:d.jsxs(Z,{children:[((w=l.list)==null?void 0:w.data.length)===0?d.jsx(O.Text,{children:m("MyProfilePage.OrdersEmpty")}):d.jsx(E.Orders,{mobile:U,data:T}),l.loading&&d.jsx(F,{})]})})};export{W as default};
