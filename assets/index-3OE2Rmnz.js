...
`,Qe=({options:n,onAnswer:t})=>{const[p,e]=Me.useState([1]),a=n.length,{i18n:o}=se(),h=z.useCallback(c=>{var u;e(c),t(`${(u=n[c[0]-1])==null?void 0:u.value}`)},[t,n]);return z.useEffect(()=>{var c;t(`${(c=n[0])==null?void 0:c.value}`)},[]),C.jsx(Xe,{children:C.jsx(ie.Range,{step:Ye,min:Ge,max:a,direction:ie.Direction.Down,values:p,onChange:c=>h(c),rtl:!1,renderMark:({props:c,index:u})=>C.jsxs(Ke,{...c,children:[C.jsx("div",{className:"line"}),C.jsx("div",{className:"content",children:C.jsx(Oe.Text,{size:"14",children:n[u].label[o.language]})})]}),renderTrack:({props:c,children:u})=>C.jsx(We,{$isMobile:Te,role:"button",tabIndex:0,onMouseDown:c.onMouseDown,onTouchStart:c.onTouchStart,style:{...c.style},children:C.jsx("div",{className:"track",ref:c.ref,children:u})}),renderThumb:({props:c})=>C.jsx(Ze,{...c,style:{...c.style}})})})},Je=G.div`
  .step-image {
    z-index: 0;
  }
  > h4 {
...
`,nt=({step:n,onAnswer:t,answers:p})=>{const{settings:e}=z.useContext(xe.EscolaLMSContext),{i18n:a}=se(),o=z.useCallback(()=>n.image?e.value.onboarding[n.image]:null,[n,e.value.onboarding]),h=z.useCallback(c=>{switch(n.type){case J.radio:return C.jsx(W.Radio,{value:c.value,label:c.label[a.language],name:n.data,onChange:u=>t(u.target.value)});case J.options:return C.jsx(et,{$isActive:p&&p[n.data]===c.value||!1,onClick:()=>t(c.value),children:c.label[a.language]});default:return C.jsx(W.Radio,{value:c.value,label:c.label[a.language],name:n.data,onChange:u=>t(u.target.value)})}},[a.language,n.type,n.data,t,p]);return C.jsxs(Je,{children:[n.image&&o()&&C.jsx("div",{className:"step-image",children:C.jsx(ke,{path:o(),srcSizes:[500,750,1e3]})}),n.hint&&C.jsxs(tt,{children:[C.jsx(W.Title,{level:4,children:n.hint.title[a.language]}),C.jsx(W.Text,{size:"13",children:n.hint.text[a.language]})]}),C.jsx(W.Title,{level:4,children:n.question[a.language]}),C.jsxs("div",{className:`options ${n.type===J.options?"buttons":""}`,children:[n.type===J.slide&&C.jsx(Qe,{options:n.options,onAnswer:t}),n.type!==J.slide&&n.options.map((c,u)=>C.jsx("div",{className:"option",children:h(c)},c.value+u))]})]})},at=G.div`
...
`,ct=()=>C.jsx(st,{children:C.jsx(it,{})});export{ct as default};
