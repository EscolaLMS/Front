import{j as t,l as j,q as d,a9 as B,a as C,D as v,g as b,U as T,bn as L,bo as z,ag as g,bp as P,T as y,b as $,bq as W,br as D,bs as O,o as S,p as V,bt as Q,aE as q,aM as I,bu as H,L as N,f as k,bv as U,bw as R,c as K,k as Y}from"./index-DcQpgbXL.js";import{r as c}from"./sentry-DZqhWugq.js";import{u as w,C as G,a as J,b as X}from"./CourseAgenda-9Yyxr5eG.js";import{Q as Z}from"./index-p-gAq4oX.js";import{u as ee}from"./useDownloadCertificate-BJLOC8IN.js";import{Q as te}from"./questionnaire-CXWDgbJ4.js";import"./katex-D1m830yy.js";import"./lodash-Bu-jC-fW.js";import"./index.esm-Bi3Es1oS.js";import"./Upload-DQe_68SZ.js";import"./useRoles-D8B7bnff.js";import"./index-iWYEsCWG.js";const se=d.div`
...
`,Qe=()=>{const{currentCourseProgram:e}=w(),{t:s}=C();return t.jsxs(We,{children:[t.jsxs(De,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(N,{to:k.myProfile,children:t.jsxs(Oe,{children:[!b&&t.jsx(Ve,{children:s("CoursePanel.Leave")}),t.jsx(R,{})]})})]})},qe=d.div`
  ...
  z-index: 1000;
`,He=()=>{const{showFinish:e,currentLesson:s}=w();return t.jsxs(qe,{children:[t.jsx(Qe,{}),!e&&t.jsx(Ee,{}),e&&t.jsx(ze,{}),(s==null?void 0:s.id)&&t.jsx(fe,{lessonID:s==null?void 0:s.id})]})},Ue=()=>t.jsx(X,{children:t.jsx(He,{})}),nt=()=>{var s;const{program:e}=c.useContext(K.EscolaLMSContext);return t.jsx(Y,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ue,{})})};export{nt as default};
//# sourceMappingURL=index-DoESnfpW.js.map
