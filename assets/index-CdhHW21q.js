import{b as N,N as M,r as i,m as k,j as e,q as x,i as n,Q as c,L as m,aw as E,x as d,J as u,T as b,f as p,h as L,o as v,ax as C,I as T,ay as _,l as I,az as R,aA as h,aB as B,aC as z,aD as A,an as S,ag as D,ah as W,v as q,C as G}from"./index-BoiM7txo.js";import{P as O}from"./index-BdBQG2tr.js";import{a as U}from"./PricingCard-2hldwBfP.js";import{P as F}from"./index-DqCfhcK4.js";import{B as H}from"./index-DjPjbVni.js";const V=N.createContext({}),J=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},Q=x.div`
  width: 100%;
  left: 0;
