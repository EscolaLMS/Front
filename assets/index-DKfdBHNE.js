...
`,yt=({title:t,children:e,active:r})=>{const[a,s]=k.useState(r||!1);return n.jsxs(Ct,{children:[n.jsx("div",{className:"collapse-title",children:n.jsx(Fe,{name:t,label:n.jsx("strong",{children:t}),checked:r||a,onChange:()=>s(!a)})}),a&&n.jsx("div",{className:"collapse-content",children:e})]})},St=V.div`
  .input-wrapper {
...
`,bt=({billingDetails:t,setBillingDetails:e})=>{const r=je(),{t:a}=ue(),o=Ee.getFontFromTheme(r).fontFamily.split(",")[0].replace(/['"]/g,""),u=k.useMemo(()=>({style:{base:{fontFamily:o,backgroundColor:"transparent",padding:"11px 12px 13px",border:"1px solid red",color:r.mode==="dark"?r.white:r.gray1,fontSize:"12px","::placeholder":{color:r.mode==="dark"?"#c3c3c3":r.gray1}},invalid:{color:"#ff0000"}}}),[]);return n.jsxs(St,{children:[n.jsxs(R.Row,{children:[n.jsx(R.Col,{lg:6,children:n.jsx("div",{className:"input-wrapper--custom",children:n.jsx(Ue.Input,{label:a("Cart.FullName"),type:"text",onChange:d=>e({...t,name:d.currentTarget.value}),value:t.name})})}),n.jsx(R.Col,{lg:6,children:n.jsxs("div",{className:"input-wrapper",children:[n.jsx(Ae,{options:u,id:"cardNumber"}),n.jsx(oe,{htmlFor:"cardNumber",children:a("Card number")})]})})]}),n.jsxs(R.Row,{children:[n.jsx(R.Col,{lg:6,children:n.jsxs("div",{className:"input-wrapper",children:[n.jsx(lt,{options:u,id:"cardExpiry"}),n.jsx(oe,{htmlFor:"cardExpiry",children:a("Expiration date")})]})}),n.jsx(R.Col,{lg:6,children:n.jsxs("div",{className:"input-wrapper",children:[n.jsx(ut,{options:u,id:"cardCVC"}),n.jsx(oe,{htmlFor:"cardCVC",children:"CVC"})]})})]})]})},jt=V.section`
...
`,kt=({stripeKey:t})=>{var I,Y,G;const{user:e,cart:r,fetchCart:a,removeFromCart:s,payWithStripe:o,fetchCourses:u,courses:d,realizeVoucher:i}=k.useContext(ke.EscolaLMSContext),{t:c}=ue(),{push:C,location:w}=we(),E=it(),O=ot(),[$,h]=k.useState(!1),[g,A]=k.useState({name:""}),[L,_]=k.useState(r.value.additional_discount>0?"granted":void 0),y=t.includes("_test_"),B={arrows:!1,infinite:!0,speed:500,slidesToShow:3,draggable:!1,slidesToScroll:3,responsive:[{breakpoint:768,settings:{draggable:!0,slidesToShow:2,slidesToScroll:2}},{breakpoint:576,settings:{slidesToShow:1,centerMode:!0,slidesToScroll:1}}]};k.useEffect(()=>{!e.loading&&!e.value?C(K.login):(u({per_page:6}),a())},[]);const T=k.useCallback(f=>{h(!0),o(f,"https://demo-stage.escolalms.com/#/user/my-profile").then(()=>{h(!1),C("/cart?status=success")}).catch(()=>{q.error(`${c("UnexpectedError")}`),h(!1)}).finally(()=>h(!1))},[]),M=()=>{if(!g.name){q.error(`${c("Cart.EmptyNameWarning")}`);return}if(!E||!O){q.error(`${c("UnexpectedError")}`);return}const f=O.getElement(Ae);f&&h(!0),f&&E.createPaymentMethod({type:"card",card:f,billing_details:g}).then(S=>{var N;S.error?(h(!1),q.error(S.error.message),console.log(S.error)):(T((N=S==null?void 0:S.paymentMethod)==null?void 0:N.id),setTimeout(()=>{h(!1)},3e3))}).catch(S=>{h(!1),q.error(`${c("UnexpectedError")}`)})};return w.search.includes("?status=success")?n.jsx(Et,{}):n.jsx(Pe,{metaTitle:c("Cart.Cart"),children:n.jsxs(wt,{children:[n.jsx(Te,{children:((I=r.value)==null?void 0:I.items.length)!==0?n.jsxs(R.Row,{children:[n.jsxs(R.Col,{lg:9,children:[n.jsx(Ye,{items:[n.jsx(ze,{to:K.home,children:c("Home")}),n.jsx(ae.Text,{size:"12",children:c("Cart.YourCart")})]}),n.jsxs("div",{className:"module-wrapper",children:[n.jsx(U.Title,{level:4,children:c("Cart.YourCart")}),n.jsx("div",{className:"products-container",children:(Y=r.value)==null?void 0:Y.items.map(f=>{var S,N,X,z,v,H,P,F;return n.jsx(De.CheckoutCard,{mobile:ce,img:{src:((S=f.product)==null?void 0:S.poster_url)||Ge,alt:((N=f.product)==null?void 0:N.name)||""},title:(X=f.product)==null?void 0:X.name,price:`${se((z=f.product)==null?void 0:z.price,(v=f.product)==null?void 0:v.tax_rate)} zł`,oldPrice:(H=f.product)!=null&&H.price_old?`${se((P=f.product)==null?void 0:P.price_old,(F=f.product)==null?void 0:F.tax_rate)} zł`:void 0,handleDelete:()=>{var D;return s(Number((D=f.product)==null?void 0:D.id))}},f.id)})})]}),n.jsxs("div",{className:"module-wrapper",children:[n.jsx(U.Title,{level:4,children:c("Cart.ChoosePaymentMethod")}),n.jsxs("div",{className:"payments-form",children:[n.jsx("div",{className:"collapse-wrapper",children:n.jsx(yt,{active:!0,title:c("Cart.CreditCard"),children:n.jsx(bt,{setBillingDetails:A,billingDetails:g})})}),y&&n.jsx("div",{className:"card-info",children:n.jsxs(ae.Text,{size:"14",children:[c("Cart.UseTestCard"),":"," ",n.jsx(qe.Link,{href:"https://docs.wellms.io/getting-started/demo.html",target:"_blank",rel:"noreferrer nofollow",children:c("Cart.LearnMore")})]})})]})]}),n.jsxs("section",{className:"slider-section",children:[n.jsx(U.Title,{level:4,children:c("Cart.Interest")}),d&&d.list&&n.jsx(xe,{courses:d.list.data,sliderSettings:B})]})]}),n.jsxs(R.Col,{lg:3,children:[n.jsx(U.Title,{style:{marginBottom:20},level:4,as:"h3",children:c("Cart.Summary")}),n.jsx("div",{className:"summary-box-wrapper",children:n.jsx(gt.CartCard,{mobile:ce,onBuyClick:()=>M(),id:1,title:`${se(Number(((G=r.value)==null?void 0:G.total_with_tax)||0))} zł`,discount:{onDiscountClick:f=>i(f).then(S=>{S.success?(_("granted"),a()):_("error")}).catch(S=>{_("error")}),onDeleteDiscountClick:()=>console.log("clicked"),status:L}})})]})]}):n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"empty-cart",children:[n.jsx(U.Title,{level:3,children:c("Cart.EmptyCartTitle")}),n.jsx(ae.Text,{children:c("Cart.EmptyCartText")}),n.jsx(ie.Button,{mode:"secondary",onClick:()=>C(K.courses),children:c("Cart.EmptyCartBtnText")})]}),n.jsxs("section",{className:"slider-section",children:[n.jsx(U.Title,{level:4,children:c("Cart.Interest")}),d&&d.list&&n.jsx(xe,{courses:d.list.data,sliderSettings:B})]})]})}),(r.loading||$)&&n.jsx(Ve,{})]})})},Ft=({children:t})=>{var d,i,c;const{config:e}=k.useContext(Ke.EscolaLMSContext),r=C=>vt(C),a=(i=(d=e==null?void 0:e.value)==null?void 0:d.escolalms_payments)==null?void 0:i.drivers,s=(c=a==null?void 0:a.stripe)==null?void 0:c.publishable_key,o=je(),u=Ee.getFontFromTheme(o);return n.jsx(Oe,{stripe:r(s),options:{fonts:[{cssSrc:u.links[0]}]},children:n.jsx(kt,{stripeKey:s})})};export{Ft as default};
