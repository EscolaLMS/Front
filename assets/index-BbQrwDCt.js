...
`,Ue=({title:e,children:t,active:n,onClick:a})=>{const[i,s]=A.useState(n||!1);return r.jsxs(kt,{children:[r.jsx("div",{className:"collapse-title",children:r.jsx(Ze,{name:e,label:r.jsx("strong",{children:e}),checked:n||i,onChange:()=>[s(!i),a&&a()]})}),(n||i)&&r.jsx("div",{className:"collapse-content",children:t})]})},Tt=Z.div`
  .input-wrapper {
...
`,Kt=()=>{var l,o,E,w,k;const{config:e}=A.useContext(tt.EscolaLMSContext),t=f=>Et(f),n=(o=(l=e==null?void 0:e.value)==null?void 0:l.escolalms_payments)==null?void 0:o.drivers,a=(E=n==null?void 0:n.stripe)==null?void 0:E.publishable_key,i=Ee(),s=ke.getFontFromTheme(i),c=(k=(w=e==null?void 0:e.value)==null?void 0:w.escolalms_payments)==null?void 0:k.default_gateway;if(c==="Przelewy24")return r.jsx(_e,{children:r.jsx(Ot,{})});if(c==="Stripe")return r.jsx(_e,{children:r.jsx(Le,{stripe:t(a),options:{fonts:[{cssSrc:s.links[0]}]},children:r.jsx(Rt,{stripeKey:a})})})};export{Kt as default};
