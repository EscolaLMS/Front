import{r as i,h as _,f as x,j as e,a3 as P,s as m,n as I,w as h,q as c,L as A,aX as y,aY as E,ai as v,am as b,X as M,aZ as N,g as w,D as L,aG as T,a_ as S,a$ as U,v as R,b0 as k,J as $}from"./index-CU_5DVq5.js";import{P as B}from"./index-BaZdqCo7.js";import{T as F}from"./Tabs-DR9OvYMY.js";import{a as G}from"./ResponsiveImage-DO1LARVL.js";import{C as O}from"./index-C4rUuFGZ.js";import{D as C,a as p}from"./index-C4TkHQ4T.js";import{P as W,C as q,a as K}from"./index-BMldPjlK.js";import{u as X}from"./useRoles-Btl73oqU.js";const z=({type:t})=>{var d;const{userConsultations:s,fetchUserConsultations:n}=i.useContext(_.EscolaLMSContext),{t:o}=x(),r=i.useMemo(()=>{var a;return((a=s.list)==null?void 0:a.data.filter(l=>t===j.STARTED||t===j.UPCOMING?l.in_coming||l.is_started:l.is_ended))||[]},[t,(d=s.list)==null?void 0:d.data]);return i.useEffect(()=>{n()},[t,n]),e.jsx(W,{children:s.loading?e.jsx(P,{}):r.length===0?e.jsx(m.Text,{style:{paddingLeft:I?20:40},children:o("MyProfilePage.OrdersEmpty")}):e.jsx(h.Row,{style:{gap:"30px 0"},children:r.map(a=>e.jsx(h.Col,{xs:12,md:6,lg:4,children:e.jsx(q,{consultation:a})},a.id))})})},g=i.memo(z),H=c.div`
  .course-section {
    margin-top: 0px;
  }
