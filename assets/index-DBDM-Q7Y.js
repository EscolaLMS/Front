import{f as p,j as e,ak as F,T as D,aE as H,r as l,D as j,L as k,l as S,s as C,q as T,w as m,ax as q,n as r,ay as u,az as A,aA as J,aB as G,ai as L,h as R,i as U,Y as w,v as h,J as $,aD as Y,N as K,C as Q,E as V,o as X,aJ as Z}from"./index-DdHAFv7l.js";import{C as b,T as O}from"./index-Drqs9lhD.js";import{B as ee}from"./index-BswJ-77S.js";import{a as te}from"./ResponsiveImage-C5aumxut.js";import{P as se}from"./PricingCard-T_FPXHlO.js";import{W as ae}from"./index-BmaOoWDL.js";import{P as oe}from"./index-aR0wNjxz.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&F(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(D.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(H,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(k,{to:S.home,children:a("Home")}),e.jsx(k,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
