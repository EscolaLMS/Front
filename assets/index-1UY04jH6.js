import{b as M,D as E,r as n,h as y,j as e,q as b,w as c,L as m,aO as N,s as d,A as x,n as o,T as v,f as u,i as L,l as j,aK as C,J as w,ar as I,N as B,ax as R,ay as p,az as _,aA as $,aB as z,o as A,C as D}from"./index-DvAWm433.js";import{P as W}from"./index-XNi-vh7-.js";import{a as q}from"./PricingCard-DOxCuQ7h.js";import{P as G}from"./index-D8EfHB45.js";import{D as O}from"./index-Dh7R9mzR.js";import{B as H}from"./index-DzA4Qp_b.js";import{a as U}from"./ResponsiveImage-Cth0O_1O.js";import{C as F,T as J}from"./index-BQpvmEGc.js";const K=M.createContext({}),V=({children:a})=>{const{id:s}=E(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{s&&t(Number(s))},[t,s]),e.jsx(K.Provider,{value:{},children:a})};var i=(a=>(a.Consultation="App\\Models\\Consultation",a.StationaryEvent="App\\Models\\StationaryEvent",a.Course="App\\Models\\Course",a.Webinar="App\\Models\\Webinar",a))(i||{});const Q=a=>a.reduce((s,t)=>{const r=t.productable_type,l=s[r]??[];return{...s,[r]:[...l,t]}},{}),X=b(c.Col)`
