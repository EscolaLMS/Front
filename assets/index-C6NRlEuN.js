import{k as E,j as e,V as a,T as j,o as _,s as N,q as g,r as v,i as z,h as F,W as B,p as P,y as T,z as h,m as C,a1 as f,at as A,au as q,av as L,aw as D,ax as V,Q as G,v as Q,C as k,L as I,an as W,M as U}from"./index-Ccx-J0-t.js";import{P as J}from"./index-7jZ8z4E5.js";import{B as K}from"./index-B7epkz7R.js";import{a as O}from"./index-DX1s6P2O.js";import{P as R}from"./PricingCard-Darr4Uia.js";import{C as $}from"./index-W1zxSdOk.js";import{S as M,a as X}from"./sidebar-FUosb3lB.js";import{S as p}from"./index-Bg3mEJa2.js";import"./floating-ui.react-dom-BR8JsIz3.js";import"./index-CrPFZKyg.js";const Y=i=>{const{consultation:t}=i,s=E();return e.jsxs(a.Row,{align:"center",children:[e.jsxs(a.Col,{lg:7,children:[(t==null?void 0:t.categories)&&t.categories.length>0&&e.jsx(O,{categories:t.categories,onCategoryClick:x=>{s.push(`/consultations/?categories[]=${x}`)}}),e.jsx("br",{}),e.jsx(j.Title,{mobile:_,level:1,children:t==null?void 0:t.name})]}),e.jsx(a.Col,{lg:4,children:(t==null?void 0:t.image_path)&&e.jsx("div",{className:"image-wrapper",children:e.jsx(N.ResponsiveImage,{path:t.image_path,srcSizes:[790*.5,790,2*790]})})})]})};g.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: 10px;
