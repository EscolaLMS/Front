import{r as c,H as G,q as P,f as V,h as ne,o as X,j as n,T as Q,x as M,z as O,i as B,V as Ce,p as F,y as $,W as Ye,Y as we,A as fe,m as Le,K as be,Z as ve,I as K,a0 as Ke,a1 as Ze,d as v,a2 as ye,a3 as ie,a4 as Je,a5 as ae,a6 as en,a7 as nn,a8 as z,b as tn,a9 as sn,aa as rn,ab as on,ac as an,ad as ln,ae as cn,af as $e,s as dn,ag as Ee,X as Ie,ah as un,ai as ze,aj as pn,S as mn,C as je,L as oe,ak as xn,v as gn,al as hn,am as Pe,M as Te}from"./index-mArHxJMN.js";import{P as fn}from"./PricingCard-D5KoYlJW.js";import{u as De}from"./useSubscriptions-C5hZIQh3.js";import{P as Fe}from"./index-BzUxKdvM.js";import{A as vn,_ as jn,P as _n,I as bn,a as yn,O as Cn,H as wn}from"./index-BZR6HOYb.js";import{B as Pn}from"./index-DXdjY6lF.js";import{Q as Ge,a as Oe,g as Tn}from"./questionnaires-BktwGAby.js";import{b as On,a as Mn}from"./CourseCard-BpCmpqEF.js";import{t as Sn}from"./toast-CS-r7NTC.js";import{P as Nn}from"./index-cYc_KKk0.js";import{D as Rn}from"./index-BOd9QfLM.js";import{S as kn}from"./swiper-ypl9wKSt.js";import{a as An}from"./a11y-BJfgiw6R.js";import{S as A}from"./index-Cc5AViG1.js";import"./index-CKMSAvs9.js";import"./useFetchCourses-SBWHf-yG.js";const Bn=e=>{const[t,s]=c.useState({data:void 0,loaded:!1,loading:!1}),{user:i,fetchCourseProgress:r,courseProgressDetails:a}=c.useContext(G.EscolaLMSContext);return c.useEffect(()=>{a.byId&&a.byId[Number(e)]&&a.byId[Number(e)].value&&s({...t,data:a.byId[Number(e)].value,loaded:!0,loading:!1})},[e,a]),c.useEffect(()=>{i!=null&&i.value&&!i.loading&&!t.loading&&!t.loaded?(s({...t,loading:!0}),r(e).catch(()=>s({...t,loaded:!0,loading:!1}))):t.loaded||s({...t,loaded:!0})},[i,t,r,e]),{progress:t}},Ln=P.div`
  text-align: center;
  .modal-header {
    margin-bottom: 10px;
  }
...
`])),function(j){var y=j.theme;return y.errorColor}),C=function(j){var y=j.course,T=j.className,N=j.initialValues,R=N===void 0?{phone_number:"",contact_details:""}:N,Ue=j.onCancel,ue=j.onSuccess,pe=j.onError,Y=(0,f.useTranslation)().t,Xe=(0,x.useContext)(p.EscolaLMSContext).addCourseAccess;return(0,o.jsxs)(b,s({className:"wellms-component ".concat(T),"data-testid":"modal-course-access"},{children:[(0,o.jsxs)("header",{children:[(0,o.jsx)(d.Title,s({level:1},{children:y.title})),(0,o.jsx)(h.Text,s({size:"14",bold:!0},{children:Y("ModalCourseAccess.Title")}))]}),(0,o.jsx)(u.Formik,s({initialValues:R,onSubmit:function(E,U){var te=U.setErrors,q=U.setSubmitting,se=U.resetForm,re={course_id:y.id,data:E};Xe(re).then(function(){se(),ue==null||ue()}).catch(function(I){var me,xe;te(s({error:(me=I==null?void 0:I.data)===null||me===void 0?void 0:me.message},(xe=I==null?void 0:I.data)===null||xe===void 0?void 0:xe.errors)),pe==null||pe()}).finally(function(){q(!1)})}},{children:function(E){var U=E.values,te=E.touched,q=E.errors,se=E.handleChange,re=E.handleBlur,I=E.handleSubmit;return(0,o.jsxs)("form",s({onSubmit:I},{children:[(0,o.jsxs)("div",s({className:"form-content"},{children:[q&&q.error&&(0,o.jsx)(h.Text,s({className:"error-msg",size:"12",bold:!0},{children:q.error})),(0,o.jsxs)("div",s({className:"input-group"},{children:[(0,o.jsx)(m.Input,{type:"text",label:Y("ModalCourseAccess.PhoneNumber"),error:te.phone_number&&q.phone_number,id:"phone_number",name:"phone_number",onChange:se,onBlur:re,value:U.phone_number}),(0,o.jsx)(_.TextArea,{label:Y("ModalCourseAccess.ContactDetails"),error:te.contact_details&&q.contact_details,id:"contact_details",name:"contact_details",onChange:se,onBlur:re,value:U.contact_details})]}))]})),(0,o.jsxs)("div",s({className:"button-group"},{children:[(0,o.jsx)(g.Button,s({type:"button",mode:"secondary",onClick:Ue},{children:Y("ModalCourseAccess.Cancel")})),(0,o.jsx)(g.Button,s({type:"submit",mode:"secondary"},{children:Y("ModalCourseAccess.Submit")}))]}))]}))}}))]}))};e.ModalCourseAccess=C,e.default=(0,l.withTheme)((0,l.default)(e.ModalCourseAccess)(S||(S=t([""],[""]))));var w,S})(Qe);const ke=P.div`
  padding-top: 40px;
  section {
    margin-bottom: 40px;
...
`,st=({name:e})=>{const t=()=>"#"+Math.floor(Math.random()*16777215).toString(16),s=e.charAt(0).toUpperCase();return n.jsx(tt,{style:{backgroundColor:t()},children:n.jsx(M.Text,{size:"18",children:s})})},rt=({question:e})=>{const{user:t,note:s,updated_at:i}=e,r=Ie();return s?n.jsx(nt,{children:n.jsx(et,{children:n.jsxs(Ee,{$gap:19,children:[t.avatar?n.jsx(un.Avatar,{src:t.avatar,alt:`user-avatar-${t.name}`}):n.jsx(st,{name:t.name}),n.jsxs(ze,{$justifyContent:"flex-start",$alignItems:"flex-start",children:[n.jsx(M.Text,{noMargin:!0,color:r.gray2,className:"date",size:"13",children:pn(i,$e.defaultDateFormat)}),n.jsx(M.Text,{className:"note",size:"13",children:s})]})]})})}):null},ot=P(ze)`
  gap: 22px;
  margin: 16px auto;
`,it=P(Q.Title)`
  margin-bottom: 16px;
...
`,$t=()=>{var C,w;const[e,t]=c.useState([]),[s,i]=c.useState(!1),[r,a]=c.useState(),{id:o}=be(),{t:x}=V(),f=ne(),u=Ie(),{course:l,fetchCourse:p,fetchCourses:g,fetchCourseAccess:m,fetchQuestionnaires:_}=c.useContext(Le.EscolaLMSContext),d=c.useCallback(()=>i(!1),[]),h=c.useCallback(()=>i(!0),[]),b=c.useCallback(()=>m({course_id:Number(o),current_page:1,per_page:1}),[o,m]);return c.useEffect(()=>{g({per_page:6}),o&&(p(Number(o)),b(),_(Ge.COURSE,Number(o)).then(S=>S.success&&t(S.data)))},[o]),l.error?n.jsx("pre",{children:l.error.message}):n.jsxs(gn,{metaTitle:((C=l==null?void 0:l.value)==null?void 0:C.title)||"Loading",children:[l.loading&&n.jsx(n.Fragment,{children:n.jsx(ke,{children:n.jsx(je,{children:n.jsxs(O.Row,{children:[n.jsx(O.Col,{md:12,lg:8,children:n.jsx(vt,{})}),n.jsx(O.Col,{md:12,lg:3,offset:{lg:1},children:n.jsx(ht,{})})]})})})}),!l.loading&&l.value&&n.jsxs(n.Fragment,{children:[n.jsxs(ke,{children:[n.jsxs(je,{children:[!B&&n.jsx(Pn,{items:[n.jsx(oe,{to:X.home,children:x("Home")}),n.jsx(oe,{to:X.courses,children:x("Courses")}),n.jsx(M.Text,{size:"13",children:l.value.title})]}),n.jsxs(O.Row,{children:[n.jsxs(O.Col,{md:12,lg:8,children:[B&&n.jsx(jt,{onClick:()=>f.push(X.courses),children:n.jsx(hn,{color:u.black})}),n.jsx(Zn,{courseData:l.value}),B&&l.value&&n.jsx(Ne,{course:l.value,onRequestAccess:h}),l.value.description&&Pe(l.value.description)!==""&&n.jsx("section",{className:"course-description-short",children:n.jsx(Te.MarkdownRenderer,{children:l.value.description})}),l.value.summary&&Pe(l.value.summary)!==""&&n.jsx("section",{className:"course-description",children:n.jsx(Te.MarkdownRenderer,{children:l.value.summary})}),n.jsxs("section",{className:"",children:[n.jsx(Q.Title,{as:"h3",level:4,className:"title",children:x("CoursePage.Teacher")}),n.jsx(O.Row,{children:l.value&&l.value.authors.map(S=>n.jsx(Yn,{author:S}))})]}),l.value.lessons&&l.value.lessons.length>0&&n.jsx(Ve.CourseProgram,{lessons:l.value.lessons,onTopicClick:S=>a(S)}),n.jsx(pt,{questionnaires:e})]}),!B&&n.jsx(O.Col,{md:12,lg:3,offset:{lg:1},children:l.value&&n.jsx(Ne,{course:l.value,onRequestAccess:h})})]})]}),n.jsx(xt,{relatedProducts:(w=l.value.product)==null?void 0:w.related_products})]}),n.jsxs(fe.Modal,{onClose:()=>a(void 0),visible:!!r,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,bodyStyle:{maxHeight:"80vh",overflow:"auto"},children:[n.jsx(Ae,{}),r&&n.jsx(Xn,{topic:r})]}),n.jsxs(fe.Modal,{onClose:d,visible:s,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,children:[n.jsx(Ae,{}),n.jsx(Qe.ModalCourseAccess,{course:l.value,onCancel:d,onSuccess:()=>{b(),d()}})]})]})]})};export{$t as default};
