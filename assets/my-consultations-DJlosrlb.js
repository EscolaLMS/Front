import{r as a,i as V,h as S,j as t,V as R,y as P,o as H,q as v,L as ne,al as se,X as re,N as Q,aQ as O,aR as K,aS as X,aT as B,aU as G,ak as oe,at as ae,aV as ie,g as ce,z as $,aW as de,aX as le,a0 as Y,af as ue,T as me,F as Z,aY as ee,v as fe,C as pe}from"./index-Y9RNIFp-.js";import{a as ge,T as xe}from"./index-Bq0xhNXp.js";import{C as he}from"./index-C99Vx5M6.js";import{P as Ce,C as je,D as N,a as M,b as ye}from"./index-fL1SF44_.js";import{u as J,R as Ee}from"./useRoles-B3unqG86.js";import{Q as F}from"./questionnaire-CXWDgbJ4.js";import{u as ve,Q as we}from"./index-CU16jSMA.js";import{C as Te}from"./CourseCard-C2ks7pgJ.js";import"./questionnaires-BkZUm3c3.js";import"./useDownloadCertificate-D91jOt4v.js";import"./base-7gvCcPfx.js";import"./index-DwdhqF2e.js";import"./swiper-CAjj5jOy.js";import"./swiper-react-CcpYy784.js";import"./a11y-qVZAL2UN.js";import"./floating-ui.react-dom-CY0F3x1W.js";import"./index-JVw5OiMB.js";import"./index-DXsdHx6a.js";const _e=({type:e})=>{var l;const{userConsultations:r,fetchUserConsultations:o}=a.useContext(V.EscolaLMSContext),{t:n}=S(),[c,i]=a.useState([]),d=a.useMemo(()=>{var p;const s=((p=r.list)==null?void 0:p.data.filter(u=>e===L.STARTED||e===L.UPCOMING?u.in_coming||u.is_started:u.is_ended))||[];return Array.from(new Map(s.map(u=>[u.id,u])).values())},[e,(l=r.list)==null?void 0:l.data]);return a.useEffect(()=>{o()},[e,o]),a.useEffect(()=>(i([]),i(d),()=>{i([])}),[e,d]),t.jsx(Ce,{children:t.jsx(R.Row,{style:{gap:"30px 0"},children:r.loading?Array.from({length:8}).map((s,m)=>t.jsx(R.Col,{md:3,children:t.jsx(Te,{})},`skeleton-card-${m}`)):c.length===0?t.jsx(P.Text,{style:{paddingLeft:H?20:40},children:n("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:c.map(s=>t.jsx(R.Col,{xs:12,md:6,lg:3,children:t.jsx(je,{consultation:s})},s.id))})})})},k=a.memo(_e),be=v.div`
  .course-section {
    margin-top: 0px;
  }
...
`,ft=.3,pt=({jitsyData:e,term:r,consultationTermId:o,consultationId:n,close:c})=>{const[i,d]=a.useState(!1),{camera:l,getDataUrl:s,hasCameraAccess:m}=ot(),p=a.useRef(!1),u=a.useRef(!1),x=a.useRef(null),{isStudent:j}=J(),{t:T}=S(),g=a.useCallback(()=>{console.log("Video conference joined"),u.current=!0},[]),f=a.useCallback(()=>{console.log("Video conference left"),u.current=!1},[]),w=a.useCallback(async(h,b,D)=>{D.on?(console.log("Recording has started in mode:",D.mode),x.current||(x.current=setInterval(async()=>{const I=await b(),q=await ct(h);q&&(console.log("Saving image..."),I?it(n??0,o,e.data.userInfo.email,I,r,`${q.displayName}.png`):console.error("Failed to get data URL for saving image."))},1e3/ft))):(console.log("Recording has stopped."),x.current&&(clearInterval(x.current),x.current=null),D.error&&console.error("Recording error:",D.error))},[n,o,e.data.userInfo.email,r]),y=a.useCallback(async h=>{window.api=h,await l(),h.addListener("videoConferenceJoined",()=>g()),h.addListener("videoConferenceLeft",()=>f()),h.on("recordingStatusChanged",b=>{s&&p.current?w(h,async()=>await s(),b):console.error("User has not consented to record video or data url is not available.")})},[l,g,f,s,w]),C=()=>{var h;c&&c(),(h=window.api)==null||h.dispose()},_=a.useCallback(()=>{const h=/\/([^/?]+)\?/,b=e.url.match(h);return b?b[1]:e.data.roomName},[e]);return a.useEffect(()=>()=>{x.current&&clearInterval(x.current)},[]),a.useEffect(()=>(setTimeout(()=>{m&&u&&j&&d(!0)},5e3),()=>{}),[m,u,j,T]),t.jsxs(t.Fragment,{children:[e&&t.jsx(rt,{jwt:e.data.jwt,appId:e.data.app_id,roomName:_(),getIFrameRef:h=>{h.style.height="calc(100vh - 76px)",h.style.width="100%"},onApiReady:y,onReadyToClose:C,interfaceConfigOverwrite:{...e.data.interfaceConfigOverwrite},configOverwrite:{...e.data.configOverwrite,prejoinConfig:{enabled:!1}}}),t.jsx(mt,{onClose:()=>d(!1),visible:i,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:468,children:t.jsx(ut,{message:T("ConsultationPage.AdditionalRecording"),closeToast:()=>d(!1),userConsentedRef:p})})]})},gt=({entityId:e,entityModel:r,onSuccesGetQuestionnaires:o,setIsEnded:n})=>{const{questionnaires:c,loading:i,getQuestionnaires:d}=ve({entityId:e||0,entityModel:r}),[l,s]=a.useState({show:!1,step:0,loading:!0,endMeetingQuestionnaires:[]}),{isStudent:m,isTutor:p}=J(),u=a.useMemo(()=>c.filter(g=>g.models.some(f=>f.model_type_title===r?f.model_type_title===F.CONSULTATION?m&&f.target_group==="user"||p&&f.target_group==="author":!0:!1)),[c,m,p,r]),x=a.useCallback(()=>{if(!u)return;const g=u.reduce((f,w)=>{var C;const y=(C=w.models.find(_=>_.model_type_title===r))==null?void 0:C.display_frequency_minutes;return y!=null&&y===0&&f.endMeetingQuestionnaires.push(w),f},{endMeetingQuestionnaires:[]});s(f=>({...f,...g}))},[u,r]),j=a.useCallback(()=>{s(f=>({...f,step:f.step+1}));const g=setTimeout(()=>{s(f=>({...f,show:!0}))},500);return()=>clearTimeout(g)},[]),T=a.useCallback(()=>{s(g=>({...g,show:!1})),l.step<l.endMeetingQuestionnaires.length-1?j():(s(g=>({...g,show:!1})),n&&n(!1))},[l,j,n]);return a.useEffect(()=>{d()},[e]),a.useEffect(()=>{x()},[u,x,o]),a.useEffect(()=>{let g;return l.endMeetingQuestionnaires.length&&s(f=>({...f,show:!0})),()=>{clearTimeout(g)}},[u,l.endMeetingQuestionnaires]),t.jsx(t.Fragment,{children:l.show&&e&&!!u.length&&!i&&t.jsx(Ee,{entityModel:r,entityId:Number(e),visible:l.show,onClose:T,questionnaire:l.endMeetingQuestionnaires[l.step]})})},xt=({onClose:e})=>{var p,u,x,j,T;const[r,o]=a.useState(null),[n,c]=a.useState(!1),[i,d]=a.useState(!1),{generateConsultationJitsy:l}=a.useContext(Q.EscolaLMSContext),s=a.useContext(ee);a.useEffect(()=>((async()=>{var f,w;if(d(!0),s!=null&&s.consultationData){const y=await l((f=s==null?void 0:s.consultationData)==null?void 0:f.consultationTermId,(w=s==null?void 0:s.consultationData)==null?void 0:w.term);y.success&&o(y.data),d(!1)}})(),()=>{Object.keys(localStorage).forEach(f=>{f.startsWith("questionnaire_")&&localStorage.removeItem(f)})}),[s==null?void 0:s.consultationData]),a.useEffect(()=>{c(!1)},[s==null?void 0:s.consultationData]);const m=a.useCallback(()=>{var g;c(!0),(g=s==null?void 0:s.setModalOpen)==null||g.call(s,!1),e()},[c,e,s]);return t.jsxs(t.Fragment,{children:[t.jsxs(Z.Modal,{onClose:m,visible:s==null?void 0:s.isModalOpen,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:"100vw",height:"100vh",bodyStyle:{minHeight:"93vh"},children:[t.jsxs(We,{children:[i&&t.jsx(Y,{}),!i&&r&&t.jsx(pt,{jitsyData:r,close:m,consultationId:(p=s==null?void 0:s.consultationData)==null?void 0:p.consultationId,consultationTermId:((u=s==null?void 0:s.consultationData)==null?void 0:u.consultationTermId)??0,term:((x=s==null?void 0:s.consultationData)==null?void 0:x.term)??""})]}),t.jsx(we,{entityId:Number((j=s==null?void 0:s.consultationData)==null?void 0:j.consultationId),entityModel:F.CONSULTATION})]}),n&&t.jsx(gt,{entityId:Number((T=s==null?void 0:s.consultationData)==null?void 0:T.consultationId),entityModel:F.CONSULTATION,setIsEnded:c})]})};var L=(e=>(e.UPCOMING="in_coming",e.PAST="is_ended",e.STARTED="is_started",e))(L||{});const Lt=()=>{const{t:e}=S(),{isTutor:r}=J(),o=a.useContext(ee),n=a.useMemo(()=>({tabs:r?[{label:e("MyProfilePage.Upcoming"),key:1,component:t.jsx(W,{type:"in_coming"})},{label:e("MyProfilePage.Archived"),key:2,component:t.jsx(W,{type:"is_ended"})},{label:e("MyProfilePage.BoughtUpcoming"),key:3,component:t.jsx(k,{type:"in_coming"})},{label:e("MyProfilePage.BoughtArchived"),key:4,component:t.jsx(k,{type:"is_ended"})}]:[{label:e("MyProfilePage.Upcoming"),key:1,component:t.jsx(k,{type:"in_coming"})},{label:e("MyProfilePage.Archived"),key:2,component:t.jsx(k,{type:"is_ended"})}],defaultActiveKey:1}),[r,e]);return t.jsx(fe,{children:t.jsx(ge,{children:t.jsxs(pe,{children:[t.jsx("div",{className:"courses-wrapper",children:t.jsx(xe.Tabs,{tabs:n.tabs,defaultActiveKey:n.defaultActiveKey})}),t.jsx(xt,{onClose:()=>[o==null?void 0:o.setModalOpen(!1)]})]})})})};export{L as ConsultationStatus,Lt as default};
