import{q as l,j as s,i as o,r as c,O as T,bm as w,f as A,h as M,T as P,bn as C,bo as p,y as t,o as N,bp as S}from"./index-bnskEQCp.js";const D=l.div`
  padding: 11px 6px;
...
`,E=({tabs:e,isProfile:n=!0})=>{var u,x;const[d]=c.useState(!1),{logout:m,fetchProgress:b,settings:a}=c.useContext(T.EscolaLMSContext),{triggerDeleteAccount:j,handleDeleteAccount:f,showModal:y,closeModal:v,loading:$}=w(),{t:r}=A(),k=M();return c.useEffect(()=>{b()},[]),s.jsxs(R,{children:[n&&s.jsx(P.Title,{level:2,as:"h2",children:r("MyProfilePage.YourAccount")}),s.jsx(h,{opened:d,children:s.jsx("div",{className:"user-main-sidebar",children:s.jsx(g,{icon:s.jsx(C,{}),children:s.jsxs("nav",{className:"navigation",children:[e.map(i=>s.jsx(p,{activeClassName:"selected",to:i.url,children:s.jsx(t.Text,{size:"16",children:i.title})},i.key)),n&&((x=(u=a==null?void 0:a.value)==null?void 0:u.config)==null?void 0:x.termsPage)&&s.jsx(p,{to:`/${a.value.config.termsPage}`,children:s.jsx(t.Text,{size:"16",children:r("Terms")})})]})})})}),n&&s.jsx(h,{opened:d,children:s.jsx("div",{className:"user-main-sidebar",children:s.jsx(g,{children:s.jsxs("div",{className:"navigation",children:[s.jsx("button",{onClick:()=>m().then(()=>k.push(N.home)),children:s.jsx(t.Text,{children:r("MyProfilePage.Logout")})}),s.jsx("button",{className:"delete-account",onClick:()=>j(),children:s.jsx(t.Text,{children:r("MyProfilePage.DeleteAccount")})})]})})})}),s.jsx(S,{closeModal:v,showModal:y,handleDeleteAccount:f,isLoading:$})]})};export{E as P};
