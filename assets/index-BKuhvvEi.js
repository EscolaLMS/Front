import{q as x,j as t,m as y,c6 as P,an as f,ae as B,r as l,f as w,A as $,n as m,Z as S,c7 as L,c8 as z,T as v,i as k,c9 as W,ca as V,cb as D,s as N,v as Q,cc as O,ax as R,aK as I,cd as q,L as _,l as T,ce as H,cf as U,h as Y,o as K}from"./index-CQ96WfSz.js";import{u as C,C as G,a as J,b as Z}from"./CourseAgenda-C2B9ElDB.js";import{R as X}from"./index-DapZIaGy.js";import{b as ee,Q as te}from"./questionnaires-f2FHD02J.js";import{u as se}from"./useDownloadCertificate-E_WbM1Jf.js";import"./index-P0ht1xy3.js";import"./warning-CUCqxP7g.js";import"./ResponsiveImage-D_FmW4Qc.js";import"./Upload-CreUycbF.js";import"./toast-CwM_HkAX.js";const ie=x.div`
...
`,Re=x(N.Text)`
  ...
  margin: 0;
  line-height: 0;
`,qe=()=>{const{currentCourseProgram:e}=C(),{t:s}=w();return t.jsxs(De,{children:[t.jsxs(Qe,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(_,{to:T.myProfile,children:t.jsxs(Oe,{children:[!m&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=C();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(Ve,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ye=()=>t.jsx(Z,{children:t.jsx(Ue,{})}),at=()=>{var s;const{program:e}=l.useContext(Y.EscolaLMSContext);return t.jsx(K,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ye,{})})};export{at as default};
