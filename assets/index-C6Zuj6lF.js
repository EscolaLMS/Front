import{q as x,j as t,m as y,af as L,r as l,f as w,A as $,n as C,a0 as P,cE as B,ao as f,cF as S,cG as z,T as v,i as k,cH as W,cI as O,cJ as V,s as N,v as D,cK as Q,ax as R,aK as T,cL as q,L as M,l as I,aZ as H,cM as U,h as K,o as G}from"./index-Y7MkVNL0.js";import{u as m,C as J,a as Y,b as Z}from"./CourseAgenda-CSgYhQSa.js";import{R as X}from"./index-Bm7tgtz_.js";import{b as ee,Q as te}from"./questionnaires-S75rh2Il.js";import{u as se}from"./useDownloadCertificate-BgD15HEJ.js";import"./index-CyhWLps6.js";import"./warning-xb3mCaSx.js";import"./ResponsiveImage-Bg5JmU8F.js";import"./Upload-CpeaJMbF.js";import"./toast-Do-tUl85.js";const ie=x.div`
...
`,Re=x(N.Text)`
  ...
  margin: 0;
  line-height: 0;
`,qe=()=>{const{currentCourseProgram:e}=m(),{t:s}=w();return t.jsxs(Ve,{children:[t.jsxs(De,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(M,{to:I.myProfile,children:t.jsxs(Qe,{children:[!C&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=m();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(Oe,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ke=()=>t.jsx(Z,{children:t.jsx(Ue,{})}),nt=()=>{var s;const{program:e}=l.useContext(K.EscolaLMSContext);return t.jsx(G,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ke,{})})};export{nt as default};
