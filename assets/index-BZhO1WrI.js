import{r as u,D as W,q as O,v as F,f as Q,i as de,a1 as e1,j as n,a2 as Se,s as B,l as se,n as k,X as Me,h as ze,H as Oe,a3 as we,O as ne,L as Y,a4 as n1,a5 as t1,d as C,a6 as Ae,a7 as ue,F as r1,E as pe,G as s1,a8 as o1,a9 as D,b as i1,aa as a1,ab as l1,ac as c1,T as xe,V as d1,w as L,ad as u1,ae as p1,N as De,m as K,A as x1,af as Ze,ag as m1,ah as Fe,ai as g1,S as C1,C as Te,o as h1,aj as f1,ak as Le,M as He,x as Re}from"./index-CU_5DVq5.js";import{P as v1}from"./PricingCard-DbJbnea0.js";import{P as Ge}from"./index-B1Sr3u5b.js";import{l as _1,A as j1,_ as b1,P as y1,I as w1,a as T1,O as P1,H as M1}from"./index-BxI0lBkz.js";import{B as O1}from"./index-yvTSSGHX.js";import{Q as qe,a as Ie,g as A1}from"./questionnaires-Osa78dt7.js";import{R as S1,a as L1}from"./ResponsiveImage-DO1LARVL.js";import{C as H1}from"./index-j3h8hXcH.js";import{P as R1}from"./index-B3aStsVP.js";import{D as I1}from"./index-BOhzO8Cj.js";import{S as N1}from"./index-CQeFy1QA.js";import{S as B1}from"./swiper-react-B5-D-2Tr.js";import{C as V1}from"./index-C4rUuFGZ.js";import{S as N}from"./CourseCard-uH8BUU-R.js";const k1=e=>{const[t,r]=u.useState({data:void 0,loaded:!1,loading:!1}),{user:i,fetchCourseProgress:a,courseProgressDetails:o}=u.useContext(W.EscolaLMSContext);return u.useEffect(()=>{o.byId&&o.byId[Number(e)]&&o.byId[Number(e)].value&&r({...t,data:o.byId[Number(e)].value,loaded:!0,loading:!1})},[e,o]),u.useEffect(()=>{i!=null&&i.value&&!i.loading&&!t.loading&&!t.loaded?(r({...t,loading:!0}),a(e).catch(()=>r({...t,loaded:!0,loading:!1}))):t.loaded||r({...t,loaded:!0})},[i,t,a,e]),{progress:t}},Ne=O(F.Button)`
  display: block;
  margin-bottom: 10px;
...
`,Pn=({relatedProducts:e})=>{const{t}=Q();return n.jsx(Tn,{className:"course-related-courses",children:n.jsx(Te,{children:n.jsx(L.Row,{children:n.jsxs(L.Col,{lg:9,children:[e&&(e==null?void 0:e.length)>0&&n.jsxs("div",{className:"content-container",children:[n.jsx(K.Title,{level:1,as:"h2",children:t("CoursePage.RelatedCoursesTitle")}),n.jsx(N1,{slidesPerView:3,children:e==null?void 0:e.map(r=>{var i;return n.jsx(B1,{children:n.jsx(K.NewCourseCard,{mobile:k,id:r.id,image:n.jsx(Y,{to:`/courses/${(i=r==null?void 0:r.productables[0])==null?void 0:i.id}`,children:r.poster_path?n.jsx(L1,{path:r.poster_path,alt:r.name,srcSizes:[300,600,900]}):n.jsx(V1,{})}),price:r.public?n.jsx("div",{className:"course-price",children:t("FREE")}):n.jsx(Ge,{price:r==null?void 0:r.price,oldPrice:r==null?void 0:r.price_old,taxRate:r==null?void 0:r.tax_rate}),title:n.jsx(Y,{to:`/courses/${r.id}`,children:n.jsx(K.Title,{level:3,as:"h3",className:"title",children:r.name})})})},r.id)})})]}),n.jsx("div",{className:"content-container",children:n.jsx(I1,{titleText:t("CoursePage.InterestTitle"),params:{per_page:6,order_by:"created_at",order:"ASC"},slidesPerView:3})})]})})})})},Mn=O.div`
