import{r as a,i as V,h as S,j as t,V as R,y as P,o as H,q as v,L as ne,al as se,X as re,N as Q,aQ as O,aR as K,aS as X,aT as q,aU as G,ak as oe,at as ae,aV as ie,g as ce,z as $,aW as de,aX as le,a0 as Y,af as ue,T as me,F as Z,aY as ee,v as fe,C as pe}from"./index-9BhopFAA.js";import{a as ge,T as xe}from"./index-DecRvvb-.js";import{C as he}from"./index-C9z0WaVi.js";import{P as Ce,C as je,D as N,a as M,b as ye}from"./index-mj4FoJdt.js";import{u as J,R as Ee}from"./useRoles-BOfkT7Ap.js";import{Q as F}from"./questionnaire-CXWDgbJ4.js";import{u as ve,Q as we}from"./index-D4iJ-V-y.js";import{C as Te}from"./CourseCard-Cj7ESEt4.js";import"./questionnaires-DuAURpvG.js";import"./useDownloadCertificate-BCaDCMVY.js";import"./base-7gvCcPfx.js";import"./index-1C4VuMvt.js";import"./swiper-CofHKOIz.js";import"./swiper-react-CVc95LqO.js";import"./a11y-D1ykok7u.js";import"./floating-ui.react-dom-BZ7vqki9.js";import"./index-dCvOnDWi.js";import"./index-RJU1vUaY.js";const _e=({type:e})=>{var l;const{userConsultations:r,fetchUserConsultations:o}=a.useContext(V.EscolaLMSContext),{t:n}=S(),[c,i]=a.useState([]),d=a.useMemo(()=>{var p;const s=((p=r.list)==null?void 0:p.data.filter(u=>e===L.STARTED||e===L.UPCOMING?u.in_coming||u.is_started:u.is_ended))||[];return Array.from(new Map(s.map(u=>[u.id,u])).values())},[e,(l=r.list)==null?void 0:l.data]);return a.useEffect(()=>{o()},[e,o]),a.useEffect(()=>(i([]),i(d),()=>{i([])}),[e,d]),t.jsx(Ce,{children:t.jsx(R.Row,{style:{gap:"30px 0"},children:r.loading?Array.from({length:8}).map((s,m)=>t.jsx(R.Col,{md:3,children:t.jsx(Te,{})},`skeleton-card-${m}`)):c.length===0?t.jsx(P.Text,{style:{paddingLeft:H?20:40},children:n("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:c.map(s=>t.jsx(R.Col,{xs:12,md:6,lg:3,children:t.jsx(je,{consultation:s})},s.id))})})})},k=a.memo(_e),be=v.div`
  .course-section {
    margin-top: 0px;
  }
