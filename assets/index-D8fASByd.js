import{r,A as $,f as k,i as F,j as s,w as q,o as N,T as _,af as J,p as L,q as R,ah as Y,aT as Z,S as W,aU as ee,X as K,I as se,k as B,v as O,N as U,U as te,O as ne,h as oe,n as re,s as Q,l as ae,a3 as ie,d as M,D as le,F as ce,aV as de}from"./index-DuLQ5VKT.js";import{T as ue}from"./Tabs-9KdPk0Ur.js";import{C as me}from"./index-PVNoMdOp.js";import{R as pe}from"./ResponsiveImage-D9-kAHzA.js";import{C as xe}from"./index-CY_0W4mQ.js";import{C as ge}from"./index-zkd_jZQt.js";import{R as he}from"./index-9_ty0nqF.js";import{b as fe,Q as je}from"./questionnaires-BgvcS0G3.js";import{P as ye}from"./index-DnLHhXZt.js";import{u as be}from"./useRoles-NUjoBInM.js";import{u as G}from"./useSearchParams-BZ1NXX5i.js";import{P as Ce}from"./index-On7EuCy6.js";import"./base-C7euzKDi.js";const Pe=({courseData:e,visible:t,onClose:n})=>{const{sendProgress:a}=r.useContext($.EscolaLMSContext),{t:o}=k(),{push:l}=F(),p=r.useCallback(async()=>{await a(e.course.id,e.progress.map(({topic_id:b})=>({topic_id:b,status:0}))),l(`/course/${e.course.id}`)},[e.course.id,e.progress,a,l]);return s.jsx(q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:t,onClose:n,children:s.jsxs(s.Fragment,{children:[s.jsx(N.Title,{level:4,children:o("ResetProgressModal.Continue")}),s.jsxs(_.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),s.jsxs(J,{$gap:16,children:[s.jsx(L.Button,{mode:"primary",onClick:p,children:o("ResetProgressModal.WantContinue")}),s.jsx(L.Button,{mode:"primary",onClick:n,children:o("ResetProgressModal.Cancel")})]})]})})},ve=R(Y)`
  gap: 6px;
  margin: 0;
  width: 100%;
