import{b as Y,E as K,r as o,h as L,j as e,D as m,f as h,L as A,l as v,s as p,q as E,w as x,ax as S,n as C,ay as b,az as Q,aA as Z,aB as ee,ai as te,i as se,Y as q,T as u,v as j,J as N,aC as ie,aD as ae,N as re,aq as z,ad as ne,ae as oe,ak as le,aE as de,X as ce,aF as xe,av as me,o as pe,C as ue}from"./index-Bo8UkscO.js";import{P as he}from"./index-B8tRK7-_.js";import{B as ge}from"./index-XD7REZpG.js";import{a as W}from"./ResponsiveImage-wHQCVyd2.js";import{P as X}from"./PricingCard-DH5RPEzw.js";import{P as je}from"./index-CsJcOuQH.js";import{D as Ee}from"./index-Gh1hdRAR.js";import{C as _}from"./index-B7Mx4ryn.js";import{E as w}from"./index-DIpJ4xhM.js";import"./index-PGMEsYK1.js";import"./index-BlWqUIM7.js";import"./index-rPhH6DdW.js";const ve=Y.createContext({}),Ce=({children:t})=>{const{id:s}=K(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
