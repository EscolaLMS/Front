...
`])),function(f){var _=f.theme;return _.errorColor}),P=function(f){var _=f.course,y=f.className,T=f.initialValues,S=T===void 0?{phone_number:"",contact_details:""}:T,c1=f.onCancel,fe=f.onSuccess,ve=f.onError,Y=(0,l.useTranslation)().t,d1=(0,u.useContext)(d.EscolaLMSContext).addCourseAccess;return(0,a.jsxs)(b,r({className:"wellms-component ".concat(y),"data-testid":"modal-course-access"},{children:[(0,a.jsxs)("header",{children:[(0,a.jsx)(C.Title,r({level:1},{children:_.title})),(0,a.jsx)(v.Text,r({size:"14",bold:!0},{children:Y("ModalCourseAccess.Title")}))]}),(0,a.jsx)(g.Formik,r({initialValues:S,onSubmit:function(E,W){var ne=W.setErrors,Q=W.setSubmitting,te=W.resetForm,re={course_id:_.id,data:E};d1(re).then(function(){te(),fe==null||fe()}).catch(function(Z){var _e,je;ne(r({error:(_e=Z==null?void 0:Z.data)===null||_e===void 0?void 0:_e.message},(je=Z==null?void 0:Z.data)===null||je===void 0?void 0:je.errors)),ve==null||ve()}).finally(function(){Q(!1)})}},{children:function(E){var W=E.values,ne=E.touched,Q=E.errors,te=E.handleChange,re=E.handleBlur,Z=E.handleSubmit;return(0,a.jsxs)("form",r({onSubmit:Z},{children:[(0,a.jsxs)("div",r({className:"form-content"},{children:[Q&&Q.error&&(0,a.jsx)(v.Text,r({className:"error-msg",size:"12",bold:!0},{children:Q.error})),(0,a.jsxs)("div",r({className:"input-group"},{children:[(0,a.jsx)(x.Input,{type:"text",label:Y("ModalCourseAccess.PhoneNumber"),error:ne.phone_number&&Q.phone_number,id:"phone_number",name:"phone_number",onChange:te,onBlur:re,value:W.phone_number}),(0,a.jsx)(j.TextArea,{label:Y("ModalCourseAccess.ContactDetails"),error:ne.contact_details&&Q.contact_details,id:"contact_details",name:"contact_details",onChange:te,onBlur:re,value:W.contact_details})]}))]})),(0,a.jsxs)("div",r({className:"button-group"},{children:[(0,a.jsx)(p.Button,r({type:"button",mode:"secondary",onClick:c1},{children:Y("ModalCourseAccess.Cancel")})),(0,a.jsx)(p.Button,r({type:"submit",mode:"secondary"},{children:Y("ModalCourseAccess.Submit")}))]}))]}))}}))]}))};e.ModalCourseAccess=P,e.default=(0,c.withTheme)((0,c.default)(e.ModalCourseAccess)(B||(B=t([""],[""]))));var w,B})(s1);const mn=K.div`
  section {
    margin-bottom: 45px;
    &.with-border {
      padding-bottom: 45px;
