import{q as x,j as t,p as y,ai as B,r as l,f as w,K as $,i as C,a3 as P,aO as L,at as f,aP as S,aQ as z,T as v,h as k,aR as W,aS as O,aT as V,x as N,y as Q,aU as D,aA as R,ay as I,aV as q,L as _,o as T,aH as H,aW as U,m as K,v as Y}from"./index-Bw3VKjvD.js";import{u as m,C as G,a as J,b as X}from"./CourseAgenda-pCmJNc6f.js";import{R as Z}from"./index-PQH1diLq.js";import{b as ee,Q as te}from"./questionnaires-eH2jRd0n.js";import{u as se}from"./useDownloadCertificate-ZpYROhRq.js";import"./index-DDMOGluD.js";import"./Upload-XyxNyYHz.js";const ie=x.div`
...
`,_e=x.main`
  ...
  ${Ne()}
`,Ae=()=>{const{currentTopic:e,isAnyDataLoading:s}=m();return t.jsxs(_e,{children:[t.jsx(J,{topic:e}),s&&t.jsx(P,{})]})};var Me=O();const Ee=()=>{const{completeCurrentTopic:e,currentTopic:s,finishedTopicsIds:i,courseId:o,currentLesson:a,nextTopic:c,prevTopic:r,availableTopicsIds:u,isNextTopicButtonDisabled:p,isAnyDataLoading:g,isLastTopic:d}=m(),n=k(),h=l.useMemo(()=>(s==null?void 0:s.id)!==void 0&&(i??[]).includes(s==null?void 0:s.id),[i,s==null?void 0:s.id]),j=l.useCallback(()=>{o===void 0||c===void 0||n.push(`/course/${o}/${a==null?void 0:a.id}/${c==null?void 0:c.id}`)},[o,a==null?void 0:a.id,n,c]),E=l.useCallback(()=>{o===void 0||r===void 0||n.push(`/course/${o}/${a==null?void 0:a.id}/${r==null?void 0:r.id}`)},[o,a==null?void 0:a.id,n,r]),F=l.useMemo(()=>!!((c==null?void 0:c.id)!==void 0&&(u!=null&&u.includes(c.id))),[u,c==null?void 0:c.id]);return t.jsx(Me.CourseTopNav,{mobile:C,onFinish:()=>e==null?void 0:e(),onNext:()=>j(),isFinished:h,onPrev:()=>E(),hasPrev:!!r,hasNext:F,isLast:d,isMarkBtnDisabled:p,onCourseFinished:()=>e==null?void 0:e(!0),allButtonsDisabled:g})},Fe=()=>{const[e,s]=l.useState(!1);return t.jsxs(Ce,{children:[t.jsxs(we,{children:[t.jsx(Se,{menuOnClick:()=>s(i=>!i)}),t.jsx(Ae,{}),t.jsx(Ee,{})]}),t.jsx(je,{$isOpen:e,children:t.jsx(Pe,{})})]})},Be=x.div`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 100%;
...
`,Re=x(N.Text)`
  ...
  margin: 0;
  line-height: 0;
`,qe=()=>{const{currentCourseProgram:e}=m(),{t:s}=w();return t.jsxs(Ve,{children:[t.jsxs(Qe,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(_,{to:T.myProfile,children:t.jsxs(De,{children:[!C&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=m();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(Oe,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ke=()=>t.jsx(X,{children:t.jsx(Ue,{})}),st=()=>{var s;const{program:e}=l.useContext(K.EscolaLMSContext);return t.jsx(Y,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ke,{})})};export{st as default};
