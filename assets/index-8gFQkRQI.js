import{b as K,H as Q,r as o,h as L,j as e,D as m,f as h,L as A,l as v,s as p,q as E,w as x,ax as S,n as C,ay as b,az as Y,aA as Z,aB as ee,ai as te,i as se,a1 as q,T as u,v as j,O as N,aC as ie,aD as ae,V as re,aq as z,ad as ne,ae as oe,ak as le,aE as de,X as ce,aF as xe,av as me,o as pe,C as ue}from"./index-BrnsqxCr.js";import{P as he}from"./index-CsT2ZWt5.js";import{B as ge}from"./index-Daa_jL_h.js";import{a as J}from"./ResponsiveImage-Cy_iuZ6S.js";import{P as X}from"./PricingCard-B1F4fw_f.js";import{P as je}from"./index-DrjLV46P.js";import{D as Ee}from"./index-CpuaUHw_.js";import{C as _}from"./index-Cw-ZecKL.js";import{E as w}from"./index-DerbMIvq.js";import"./index-D6Vr4FBf.js";import"./index-CQOyv8Aw.js";import"./index-Be7kF9a5.js";const ve=K.createContext({}),Ce=({children:t})=>{const{id:s}=Q(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
...
`,Oe={arrows:!1,infinite:!0,speed:500,draggable:!1,slidesToShow:4,slidesToScroll:4,responsive:[{breakpoint:1201,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:768,settings:{draggable:!0,slidesToShow:2,slidesToScroll:2}},{breakpoint:576,settings:{slidesToShow:1,centerMode:!0,slidesToScroll:1}}]},W=({nodes:t,sliderSettings:s=Oe})=>{const[i]=o.useState(!0);return e.jsx(ke,{children:e.jsx("div",{children:e.jsx(me.Slider,{settings:{...s,dots:i,onSwipe:()=>{const n=document.querySelectorAll('.slick-slide[aria-hidden="true"]');document.querySelectorAll('.slick-slide[aria-hidden="false"]').forEach(r=>r.removeAttribute("aria-modal")),n.forEach(r=>r.setAttribute("aria-modal","true"))},onInit:()=>{document.querySelectorAll('.slick-slide[aria-hidden="true"]').forEach(a=>a.setAttribute("aria-modal","true"))}},dotsPosition:"top right",children:t})})})},He=()=>{var n;const{stationaryEvents:t}=o.useContext(m.EscolaLMSContext),{t:s}=h(),i=(n=t.list)==null?void 0:n.data;return e.jsx(Re,{children:e.jsx("section",{className:"event-related-events",children:e.jsxs(x.Container,{children:[e.jsxs("div",{className:"content-container",children:[e.jsx(u.Title,{level:4,as:"h2",children:s("CoursePage.RelatedCoursesTitle")}),i&&i.length>4?e.jsx(W,{nodes:i.map(a=>e.jsx(_,{children:e.jsx(w,{event:a})},a.id))}):e.jsx(x.Row,{style:{marginTop:"30px",rowGap:"60px"},children:i==null?void 0:i.map(a=>e.jsx(x.Col,{md:6,lg:3,children:e.jsx(_,{children:e.jsx(w,{event:a})})},a.id))})]}),e.jsxs("div",{className:"content-container",children:[e.jsx(u.Title,{level:4,as:"h2",children:s("CoursePage.InterestTitle")}),i&&i.length>4?e.jsx(W,{nodes:i.map(a=>e.jsx(_,{children:e.jsx(w,{event:a})},a.id))}):e.jsx(x.Row,{style:{marginTop:"30px",rowGap:"60px"},children:i==null?void 0:i.map(a=>e.jsx(x.Col,{md:6,lg:3,children:e.jsx(_,{children:e.jsx(w,{event:a})})},a.id))})]})]})})})},Qe=()=>{var s;const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext);return e.jsx(pe,{metaTitle:(s=t.value)==null?void 0:s.name,children:e.jsxs(Ce,{children:[e.jsx(ue,{children:e.jsx(Ue,{})}),e.jsx(He,{})]})})};export{Qe as default};
