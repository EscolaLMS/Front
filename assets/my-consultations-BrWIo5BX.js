import{r as i,h as P,f as x,j as e,T as m,k as _,s as g,q as c,v as A,ah as v,X as M,aQ as b,g as N,A as w,aB as y,aR as L,aS as S,p as U,aT as R,I as k}from"./index-DPt-kbd_.js";import{P as B}from"./index-CSbehMxQ.js";import{T as F}from"./Tabs-A6fnFTeS.js";import{a as $}from"./ResponsiveImage-CM6EDuxv.js";import{C as G}from"./index-BfRUgfmI.js";import{a as T,e as E,f as O}from"./date-BM4UYDeF.js";import{D as p,a as C}from"./index-wjmm3o21.js";import{P as W,C as q,a as K}from"./index-COseRsbE.js";import{C as I}from"./index-BI9dgBs_.js";import{u as z}from"./useRoles-7-9e0HkA.js";import"./app-B2E7767C.js";const H=({type:t})=>{var d;const{userConsultations:s,fetchUserConsultations:o}=i.useContext(P.EscolaLMSContext),{t:n}=x(),r=i.useMemo(()=>{var a;return((a=s.list)==null?void 0:a.data.filter(l=>t===j.STARTED||t===j.UPCOMING?l.in_coming||l.is_started:l.is_ended))||[]},[t,(d=s.list)==null?void 0:d.data]);return i.useEffect(()=>{o()},[t,o]),e.jsx(W,{children:s.loading?e.jsx(I,{}):r.length===0?e.jsx(m.Text,{style:{paddingLeft:_?20:40},children:n("MyProfilePage.OrdersEmpty")}):e.jsx(g.Row,{style:{gap:"30px 0"},children:r.map(a=>e.jsx(g.Col,{xs:12,md:6,lg:4,children:e.jsx(q,{consultation:a})},a.id))})})},h=i.memo(H),X=c.div`
  .course-section {
    margin-top: 0px;
  }
