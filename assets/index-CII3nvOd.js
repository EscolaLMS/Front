import{b as M,D as E,r as n,h as y,j as e,q as b,w as c,L as m,aO as N,s as d,A as x,n as o,T as v,f as u,i as L,l as j,aK as C,J as w,ar as I,N as B,ax as R,ay as p,az as _,aA as $,aB as z,o as A,C as D}from"./index-DFLxrXjz.js";import{P as W}from"./index-Cf0suRIC.js";import{a as q}from"./PricingCard-CBegqV89.js";import{P as G}from"./index-CXHzztkv.js";import{D as O}from"./index-vL4DVvDJ.js";import{B as H}from"./index-BYenw5EM.js";import{a as U}from"./ResponsiveImage-DTtglx1x.js";import{C as F,T as J}from"./index-e7F2YD5y.js";const K=M.createContext({}),V=({children:a})=>{const{id:s}=E(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{s&&t(Number(s))},[t,s]),e.jsx(K.Provider,{value:{},children:a})};var i=(a=>(a.Consultation="App\\Models\\Consultation",a.StationaryEvent="App\\Models\\StationaryEvent",a.Course="App\\Models\\Course",a.Webinar="App\\Models\\Webinar",a))(i||{});const Q=a=>a.reduce((s,t)=>{const r=t.productable_type,l=s[r]??[];return{...s,[r]:[...l,t]}},{}),X=b(c.Col)`
...
`,le=()=>{const{product:a}=n.useContext(x.EscolaLMSContext),{t:s}=u();return a.loading||!a.value?e.jsx(W,{}):e.jsx(ie,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(te,{}),e.jsx(oe,{}),e.jsx(F,{title:s("PackagePage.CompaniesSectionTitle")}),e.jsx(re,{}),e.jsx(J,{title:s("PackagePage.TutorsSectionTitle"),users:a.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},be=()=>{var s;const{product:a}=n.useContext(x.EscolaLMSContext);return e.jsx(A,{metaTitle:(s=a.value)==null?void 0:s.name,children:e.jsx(V,{children:e.jsx(D,{children:e.jsx(le,{})})})})};export{be as default};
