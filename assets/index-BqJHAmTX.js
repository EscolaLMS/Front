import{b as J,G as Q,r as o,h as L,j as e,A as m,f as h,v as A,l as v,T as p,q as E,s as x,an as S,k as C,ao as b,ap as Y,aq as Z,ar as ee,i as te,a0 as q,o as u,p as j,K as N,as as se,at as ie,W as ae,aa as re,ab as ne,ag as oe,au as le,X as de,av as ce,al as xe,L as me,C as pe}from"./index-CJUViYQs.js";import{P as ue}from"./index-CBMYHIOy.js";import{B as he}from"./index-CWOTO5_N.js";import{a as K}from"./ResponsiveImage-CYeKSXk0.js";import{f as ge}from"./date-DocSkm8y.js";import{P as z}from"./PricingCard-BTy5Kmij.js";import{f as W}from"./index-CkZQCNYJ.js";import{P as je}from"./index-CAagf-yf.js";import{D as Ee}from"./index-DADftZCe.js";import{C as _}from"./index-DvWLuWMt.js";import{E as w}from"./index-BMebzaQK.js";import"./app-B2E7767C.js";import"./index-YkBOJNJW.js";import"./index-WpwygM9U.js";import"./index-BovjN4tP.js";const ve=J.createContext({}),Ce=({children:t})=>{const{id:s}=Q(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(he,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
