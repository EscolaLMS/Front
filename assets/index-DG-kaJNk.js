import{q as p,m as r,j as t,cx as B,r as n,h as b,ai as R,s as g,f as D,X as U,l as L,n as l,aj as T,U as H,T as y,cy as K,cz as F,L as W,C as q,i as j}from"./index-8nfYNS1Y.js";const V=p.div`
  padding: ${r?"20px":"40px"};
  background: ${({theme:e})=>e.mode==="dark"?e.dm__cardBackgroundColor:e.cardBackgroundColor};
  border-radius: ${({theme:e})=>e.cardRadius}px;
`,S=({title:e,icon:o,children:s})=>t.jsxs(V,{children:[t.jsx(B.IconTitle,{title:e,icon:o,as:"h2",level:4}),s]}),X=p.div`
...
`,z=({size:e})=>{var d;const{updateAvatar:o,user:s}=n.useContext(b.EscolaLMSContext),m=n.useCallback(c=>{var a,u;const x=(u=(a=c.target)==null?void 0:a.files)==null?void 0:u[0];x&&o(x)},[o]);return t.jsxs(Z,{children:[t.jsx(R.Avatar,{size:e,src:(d=s.value)==null?void 0:d.avatar,alt:""}),t.jsxs("label",{htmlFor:"fileInput",children:[t.jsx(g.Text,{className:"avatar-upload-text",size:"12",children:"Dodaj nowe zdjęcie"}),t.jsx("input",{type:"file",id:"fileInput",accept:"image/*",style:{display:"none"},onChange:m})]})]})},G=p("aside")`
  ${r&&`
    ...
    overflow: scroll;
    `}
  transform: ${e=>e.opened&&r?"translate(0, 0%)":!e.opened&&r?"translate(0, 91%)":"translate(0, 0)"};
  background: ${({theme:e})=>e.mode==="dark"?e.dm__background:e.background};
  .user-main-sidebar {
    margin-bottom: ${r?"70px":"22px"};
    .name {
...
`,E=p.div`
  ...
  &:not(:last-child) {
    margin-bottom: ${r?0:"14px"};
    margin-right: ${r?"10px":0};
  }
  .number {
    color: ${({theme:e})=>e.primaryColor};
  }
  .label {
    margin-left: ${r?0:"11px"};
    margin-top: 10px;
    position: relative;
    font-size: 14px;
    line-height: 1.2;
    font-weight: 700;
    max-width: ${r?"80px":"unset"};
  }
...
`,Q=()=>{var k,_,C,P,$,M,N;const[e,o]=n.useState(!1),{user:s,logout:m,certificates:d,progress:c,fetchProgress:x}=n.useContext(b.EscolaLMSContext),{t:a}=D(),u=U(),A=L(),O=i=>{if(!i)return"-";let h=i;const f=Math.trunc(i/3600);f>=1&&(h-=f*3600);const v=Math.trunc(i/60);return v>=1&&(h-=v*60),`
        ${f>=1?f+"h ":""}${v>=1?v+"min ":""}${h>=1?h+"s":""}
    `};n.useEffect(()=>{x()},[]);const w=n.useMemo(()=>(c.value||[]).filter(i=>i.finish_date),[c]),I=n.useMemo(()=>[{key:"COURSES",title:a("MyProfilePage.MyCourses"),url:l.myProfile},{key:"CONSULTATIONS",title:a("MyProfilePage.MyConsultations"),url:l.myConsultations},{key:"WEBINARS",title:a("MyProfilePage.MyWebinars"),url:l.myWebinars},{key:"EVENTS",title:a("MyProfilePage.MyStationaryEvents"),url:l.myStationaryEvents},{key:"TASKS",title:a("MyProfilePage.MyTasks"),url:l.myTasks},{key:"BOOKMARKS",title:a("MyProfilePage.MyBookmarks"),url:l.myBookmarks},{key:"ORDERS",title:a("MyProfilePage.OrdersHistory"),url:l.myOrders},{key:"NOTIFICATIONS",title:a("MyProfilePage.Notifications"),url:l.myNotifications},{key:"EDIT",title:a("MyProfilePage.EditData"),url:l.myData}],[a]);return t.jsxs(G,{opened:e,children:[r&&t.jsx(J,{opened:e,onClick:()=>o(!e),children:t.jsxs("div",{className:"content-wrapper",children:[(k=s.value)!=null&&k.avatar?t.jsx(z,{size:"extraSmall"}):t.jsx(T,{mode:u.mode==="dark"?"light":"dark"}),t.jsx(g.Text,{children:t.jsxs("strong",{children:[(_=s.value)==null?void 0:_.first_name," ",(C=s.value)==null?void 0:C.last_name]})})]})}),t.jsx("div",{className:"user-main-sidebar",children:t.jsxs(S,{title:a("MyProfilePage.YourAccount"),icon:t.jsx(H,{}),children:[t.jsxs("div",{className:"avatar-wrapper",children:[(P=s.value)!=null&&P.avatar?t.jsx(z,{size:"small"}):t.jsx(T,{mode:u.mode==="dark"?"light":"dark"}),t.jsxs(y.Title,{className:"name",level:4,as:"h3",children:[($=s.value)==null?void 0:$.first_name," ",(M=s.value)==null?void 0:M.last_name]})]}),t.jsx("nav",{className:"navigation",children:I.map(i=>t.jsx(K,{activeClassName:"selected",to:i.url,children:t.jsx(g.Text,{size:"14",children:i.title})},i.key))}),t.jsx("div",{className:"logout-wrapper",children:t.jsx("button",{onClick:()=>m().then(()=>A.push(l.home)),children:t.jsx(g.Text,{children:a("MyProfilePage.Logout")})})})]})}),t.jsx("div",{className:"user-progress sidebar",children:t.jsx(S,{title:a("MyProfilePage.MyProgress"),icon:t.jsx(F,{}),children:t.jsxs("div",{className:"progress-container",children:[t.jsxs(E,{children:[t.jsx(y.Title,{className:"number",level:1,children:w.length}),t.jsx(g.Text,{className:"label",children:a("MyProfilePage.FinishedCourses")}),t.jsx("ul",{className:"list-box",children:w.map((i,h)=>t.jsx("li",{className:"list-box-item",children:t.jsxs(Y,{initialValue:h===0,headerTitle:i.course.title,headerClassName:"list-box-item__title",children:[i.start_date&&i.finish_date&&t.jsxs("p",{className:"list-box-item__time",children:[t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M20 20h-4v-4h4v4zm-6-10h-4v4h4v-4zm6 0h-4v4h4v-4zm-12 6h-4v4h4v-4zm6 0h-4v4h4v-4zm-6-6h-4v4h4v-4zm16-8v22h-24v-22h3v1c0 1.103.897 2 2 2s2-.897 2-2v-1h10v1c0 1.103.897 2 2 2s2-.897 2-2v-1h3zm-2 6h-20v14h20v-14zm-2-7c0-.552-.447-1-1-1s-1 .448-1 1v2c0 .552.447 1 1 1s1-.448 1-1v-2zm-14 2c0 .552-.447 1-1 1s-1-.448-1-1v-2c0-.552.447-1 1-1s1 .448 1 1v2z"})}),t.jsxs("span",{className:"list-box-item__value",children:[new Date(i.start_date).toLocaleDateString()," - ",new Date(i.finish_date).toLocaleDateString()]})]}),t.jsxs("p",{className:"list-box-item__time",children:[t.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M6 14h6v-6c3.309 0 6 2.691 6 6s-2.691 6-6 6-6-2.691-6-6zm16 0c0 5.523-4.478 10-10 10s-10-4.477-10-10 4.478-10 10-10 10 4.477 10 10zm-2 0c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8 8-3.589 8-8zm-6-11.819v-2.181h-4v2.181c1.408-.238 2.562-.243 4 0zm6.679 3.554l1.321-1.321-1.414-1.414-1.407 1.407c.536.402 1.038.844 1.5 1.328z"})}),t.jsx("span",{className:"list-box-item__value",children:O(i.total_spent_time)})]})]})}))})]}),t.jsxs(E,{children:[t.jsx(y.Title,{className:"number",level:1,children:(N=d.list)==null?void 0:N.data.length}),t.jsx(g.Text,{className:"label",children:a("MyProfilePage.TotalCertificates")})]})]})})})]})},ee=p.div`
  position: relative;
  z-index: 0;
...
`,ie=({children:e,title:o,withTabs:s,actions:m})=>{const{user:d}=n.useContext(b.EscolaLMSContext),c=L();return n.useEffect(()=>{!d.loading&&!d.value&&c.push(l.login)},[]),t.jsx(W,{metaTitle:o,children:t.jsx(ae,{children:t.jsx(q,{children:t.jsxs(j.Row,{children:[t.jsxs(j.Col,{lg:9,children:[t.jsx(te,{title:o,withTabs:s,actions:m}),e]}),t.jsx(j.Col,{lg:3,children:t.jsx(Q,{})})]})})})})};export{ie as P};
