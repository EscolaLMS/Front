import{q as x,j as t,p as y,ae as L,r as l,f as w,H as $,i as C,Z as P,aK as B,ap as f,aL as S,aM as z,T as v,h as k,aN as O,aO as W,aP as D,x as N,y as Q,aQ as V,aw as R,au as T,aR as q,L as M,o as I,aD as H,aS as U,m as K,v as Y}from"./index-mArHxJMN.js";import{u as m,C as G,a as J,b as Z}from"./CourseAgenda-CCsaxUy6.js";import{R as X}from"./index-a71Vt_21.js";import{b as ee,Q as te}from"./questionnaires-BktwGAby.js";import{u as se}from"./useDownloadCertificate-BjIKTpKN.js";import"./index-BZR6HOYb.js";import"./Upload-B-Bg1vLe.js";import"./toast-CS-r7NTC.js";const ie=x.div`
...
`,Be=({onNextClick:e})=>{const{t:s}=w();return t.jsxs(A,{children:[t.jsx("div",{className:"icon-container",children:t.jsx(D,{})}),t.jsx(v.Title,{className:"title",level:1,children:s("CoursePanel.FinishPage.Congrats")}),t.jsx(v.Title,{className:"subtitle",level:2,children:s("CoursePanel.FinishPage.Subtitle")}),t.jsx(N.Text,{className:"text",children:s("CoursePanel.FinishPage.Text")}),t.jsx(Q.Button,{className:"button",onClick:e,children:s("Next")})]})},ze=({showModal:e,onClose:s,onFinish:i,onSuccesGetQuestionnaires:o})=>{const{fetchQuestionnaires:a,fetchQuestionnaire:c}=l.useContext($.EscolaLMSContext),[r,u]=l.useState({show:!1,step:0,loading:!0}),[p,g]=l.useState([]),{courseId:d}=m();l.useEffect(()=>{u(h=>({...h,show:e}))},[e]);const n=l.useCallback(()=>{if(u(h=>({...h,show:!1})),r.step<p.length-1){u(j=>({...j,step:j.step+1}));const h=setTimeout(()=>{u(j=>({...j,show:!0}))},500);return()=>clearTimeout(h)}s()},[s,p.length,r.step]);return l.useEffect(()=>{d&&ee({courseId:Number(d),fetchQuestionnaire:c,fetchQuestionnaires:a,onSucces:h=>{o(!!h.length),g(h)},onFinish:()=>u(h=>({...h,loading:!1}))})},[d]),t.jsx(t.Fragment,{children:e&&d&&!!p.length&&!r.loading&&t.jsx(X,{course:te.COURSE,courseId:Number(d),visible:r.show,onClose:n,questionnaire:p[r.step],onFinish:i})})},Oe=({certificates:e})=>{const{t:s}=w(),{downloadCertificate:i,loadingId:o}=se(),a=l.useCallback(()=>{e.forEach(({id:c,title:r})=>{i(c,r)})},[e,i]);return t.jsxs(A,{className:"certificate-container",children:[t.jsx("div",{className:"icon-container",children:t.jsx(V,{})}),t.jsx(R,{className:"subtitle",level:2,children:s("CoursePanel.FinishPage.YourCertificate")}),t.jsx(T,{className:"button",onClick:a,loading:o!==-1,disabled:o!==-1,children:s("DownloadCertificate")}),t.jsx(q,{className:"text",children:s("CoursePanel.FinishPage.CertificateText")}),t.jsx(M,{to:I.home,children:t.jsx(T,{mode:"outline",className:"button",children:s("BackToHomePage")})})]})},We=()=>{const[e,s]=l.useState({showModal:!1,isAnyQuestionnaire:null,showCertificate:!1,certificates:null}),{courseId:i}=m(),{fetchCertificates:o}=l.useContext($.EscolaLMSContext),a=k(),c=l.useCallback(async()=>{try{const d=await o({assignable_type:H.CertificateAssignableTypes.Course,assignable_id:Number(i)});d&&d.success&&s(n=>({...n,certificates:d.data}))}catch(d){console.log("Error: ",d)}},[i,o]);l.useEffect(()=>{c()},[]);const r=l.useCallback(()=>{s(d=>({...d,showModal:!1,showCertificate:!0}))},[]),u=l.useCallback(d=>{s(n=>({...n,showModal:d}))},[]),p=l.useCallback(()=>{if(e.isAnyQuestionnaire){u(!0);return}if(e.certificates&&e.certificates.length>0){r();return}a.push(I.myProfile)},[u,a,r,e.certificates,e.isAnyQuestionnaire]),g=l.useCallback(d=>{s(n=>({...n,isAnyQuestionnaire:d}))},[]);return t.jsxs(Le,{children:[!e.showCertificate&&t.jsx(Be,{onNextClick:p}),e.showCertificate&&e.certificates&&t.jsx(Oe,{certificates:e.certificates}),t.jsx(ze,{showModal:e.showModal,onClose:()=>u(!1),onFinish:r,onSuccesGetQuestionnaires:g})]})},De=x.header`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,Re=x(N.Text)`
  ...
  margin: 0;
  line-height: 0;
`,qe=()=>{const{currentCourseProgram:e}=m(),{t:s}=w();return t.jsxs(De,{children:[t.jsxs(Qe,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(M,{to:I.myProfile,children:t.jsxs(Ve,{children:[!C&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=m();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(We,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ke=()=>t.jsx(Z,{children:t.jsx(Ue,{})}),it=()=>{var s;const{program:e}=l.useContext(K.EscolaLMSContext);return t.jsx(Y,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ke,{})})};export{it as default};
