import{r as u,A as Q,q as O,p as F,f as U,i as de,a1 as e1,j as n,a2 as Se,T as B,l as se,k,X as Me,h as ze,G as Oe,a3 as we,N as ne,v as Y,a4 as n1,a5 as t1,d as C,a6 as Ae,a7 as ue,E as r1,D as pe,F as s1,a8 as o1,a9 as D,b as i1,aa as a1,ab as l1,ac as c1,o as xe,Q as d1,s as L,ad as u1,ae as p1,K as De,W as J,z as x1,af as Ze,ag as m1,ah as Fe,ai as g1,S as C1,C as Te,L as h1,aj as f1,ak as Le,M as He,w as Re}from"./index-DuLQ5VKT.js";import{P as v1}from"./PricingCard-CZ6W3Msx.js";import{P as Ge}from"./index-Csz7Orhm.js";import{l as _1,A as j1,_ as b1,P as y1,I as w1,a as T1,O as P1,H as M1}from"./index-DEOHlK3r.js";import{B as O1}from"./index-YzPqBO_p.js";import{Q as qe,a as Ie,g as A1}from"./questionnaires-BgvcS0G3.js";import{R as S1,a as L1}from"./ResponsiveImage-D9-kAHzA.js";import{C as H1}from"./index-zkd_jZQt.js";import{P as R1}from"./index-On7EuCy6.js";import{D as I1}from"./index-CjfqVpRP.js";import{S as N1}from"./index-C2aGPEwU.js";import{S as B1}from"./swiper-react-F7bwAxV3.js";import{C as V1}from"./index-PVNoMdOp.js";import{S as N}from"./CourseCard-BtFKQ3uB.js";const k1=e=>{const[t,r]=u.useState({data:void 0,loaded:!1,loading:!1}),{user:i,fetchCourseProgress:a,courseProgressDetails:o}=u.useContext(Q.EscolaLMSContext);return u.useEffect(()=>{o.byId&&o.byId[Number(e)]&&o.byId[Number(e)].value&&r({...t,data:o.byId[Number(e)].value,loaded:!0,loading:!1})},[e,o]),u.useEffect(()=>{i!=null&&i.value&&!i.loading&&!t.loading&&!t.loaded?(r({...t,loading:!0}),a(e).catch(()=>r({...t,loaded:!0,loading:!1}))):t.loaded||r({...t,loaded:!0})},[i,t,a,e]),{progress:t}},Ne=O(F.Button)`
  display: block;
  margin-bottom: 10px;
`,$1=({course:e,onRequestAccess:t})=>{var v,s;const{t:r}=U(),{push:i}=de(),{courseAccess:a,cart:o,addToCart:l}=u.useContext(Q.EscolaLMSContext),p=u.useMemo(()=>{var c,m;return(m=(c=a.list)==null?void 0:c.data)==null?void 0:m.find(x=>{var b;return((b=x==null?void 0:x.course)==null?void 0:b.id)===e.id})},[(v=a.list)==null?void 0:v.data,e.id]),g=u.useMemo(()=>n.jsx(F.Button,{loading:o.loading,mode:"secondary",onClick:()=>{var c;return l(Number((c=e.product)==null?void 0:c.id)).then(()=>i(se.cart))},children:r("Buy Course")}),[l,o.loading,(s=e.product)==null?void 0:s.id,i,r]);return p?p.status!=="approved"?n.jsxs(n.Fragment,{children:[n.jsx(Ne,{mode:"secondary",disabled:!0,children:r("CourseAccess.Pending")}),g]}):p.status==="approved"?n.jsx(F.Button,{onClick:()=>i(`/course/${e.id}`),mode:"secondary",children:r("Go to the course")}):g:n.jsxs(n.Fragment,{children:[n.jsx(Ne,{mode:"secondary",onClick:t,children:r("CourseAccess.RequestAccess")}),g]})},E1=({course:e,userOwnThisCourse:t,onRequestAccess:r})=>{var g,v;const{cart:i,user:a}=u.useContext(Q.EscolaLMSContext),{t:o}=U(),{push:l}=de(),p=u.useMemo(()=>{var s;return(s=i==null?void 0:i.value)==null?void 0:s.items.some(c=>{var m;return Number(c.product_id)===Number((m=e.product)==null?void 0:m.id)})},[(g=e.product)==null?void 0:g.id,i]);return e1(Number((v=a.value)==null?void 0:v.id),e)?n.jsx(F.Button,{onClick:()=>l(`/course/${e.id}`),mode:"secondary",children:o("Go to the course")}):Se(new Date(e.active_to||""))?n.jsx(B.Text,{children:o("CoursePage.IsFinished")}):p?n.jsx(F.Button,{mode:"secondary",onClick:()=>l(se.cart),children:o("CoursePage.GoToCheckout")}):t&&Se(new Date(e.active_from||""))?n.jsx(F.Button,{onClick:()=>l(`/course/${e.id}`),mode:"secondary",children:o("Go to the course")}):t?n.jsx(B.Text,{children:o("CoursePage.NotStarted")}):a.value&&e.product?n.jsx($1,{course:e,onRequestAccess:r}):e.product?n.jsx(F.Button,{onClick:()=>l(`/login?referrer=/courses/${e.id}`),mode:"secondary",children:o("Buy Course")}):n.jsx(B.Text,{children:o("CoursePage.UnavailableCourse")})},z1=O.div`
  width: 100%;
  left: 0;
...
`,ln=({author:e})=>n.jsx(L.Col,{lg:6,children:n.jsx(Y,{to:`/tutors/${e.id}`,children:n.jsx(u1,{mobile:k,avatar:{alt:`${e.first_name} ${e.last_name}`,src:e.path_avatar?`${p1}/api/images/img?path=${e.path_avatar}`:De.tutorPlaceholderPath},fullName:`${e.first_name} ${e.last_name}`,description:e.bio})})});var Z=(e=>(e.INIT="INIT",e.LOADED="LOADED",e.LOADING="LOADING",e.ERROR="ERROR",e))(Z||{});const cn=O.div`
  display: flex;
  align-items: center;
  gap: 5px;
  p {
...
`,dn=({courseData:e})=>{const{fetchQuestionnaireStarsByModel:t}=u.useContext(Q.EscolaLMSContext),[r,i]=u.useState({type:Z.INIT}),a=de(),o=u.useCallback(async()=>{if(e.id)try{i({type:Z.LOADING});const l=await t("course",Number(e.id));l.success&&i({type:Z.LOADED,rating:l.data})}catch(l){i({type:Z.ERROR,error:l.message})}},[e.id,t]);return u.useEffect(()=>{o()},[e.id,o]),n.jsx("section",{className:"course-main-info",children:n.jsxs(L.Row,{children:[n.jsxs(L.Col,{lg:12,children:[n.jsx(H1,{categories:e.categories,onCategoryClick:l=>{a.push(`/courses/?categories[]=${l}`)}}),n.jsx(xe.Title,{mobile:k,level:1,children:e.title}),r.type===Z.LOADED?n.jsxs(cn,{children:[n.jsx(J.Rating,{ratingValue:r.rating.avg_rate,label:`${r.rating.avg_rate}`}),n.jsx(J.Text,{size:"13",children:"Śr. ocena kursu"}),n.jsx("div",{children:n.jsxs(J.Text,{size:"13",children:["Dodane opinie ",n.jsx("strong",{children:r.rating.count_answers})]})})]}):r.type===Z.LOADING?n.jsx(we,{width:"20px",height:"20px"}):r.type===Z.ERROR?r.error:null]}),n.jsx(L.Col,{lg:12,children:e.image_path&&n.jsx("div",{className:"image-wrapper",children:n.jsx(S1.ResponsiveImage,{path:e.image_path,srcSizes:[790*.5,790,2*790]})})})]})})},ye={total:0,per_page:3,page:1,current_page:1},un=({questionId:e,courseId:t})=>{const[r,i]=u.useState(void 0),[a,o]=u.useState(ye),[l,p]=u.useState(!0),{fetchQuestionnairesAnswers:g}=u.useContext(Q.EscolaLMSContext),{t:v}=U(),s=u.useCallback(m=>{e&&t&&(p(!0),g(qe.COURSE,Number(t),e,{per_page:a.per_page,page:m,order_by:"updated_at",order:"DESC"}).then(x=>{x.success&&(i(x.data),o(b=>({...b,total:x.meta.total,current_page:x.meta.current_page,page:x.meta.current_page})))}).catch(x=>{x1.error(v("UnexpectedError")),console.log(x)}).finally(()=>p(!1)))},[a,g,t,e,v]),c=u.useCallback(m=>{o(x=>({...x,current_page:m}))},[]);return u.useEffect(()=>{a.page!==a.current_page&&s(a.current_page)},[a.current_page,a.page,s]),u.useEffect(()=>{o(ye),s(ye.page)},[e]),{answersMeta:a,questionnaireAnswers:r,loading:l,onPageChange:c}},pn=O(Ze)`
  justify-content: space-between;
...
`,gn=({name:e})=>{const t=()=>"#"+Math.floor(Math.random()*16777215).toString(16),r=e.charAt(0).toUpperCase();return n.jsx(mn,{style:{backgroundColor:t()},children:n.jsx(B.Text,{size:"18",children:r})})},Cn=({question:e})=>{const{user:t,note:r,updated_at:i}=e,a=Me();return r?n.jsx(xn,{children:n.jsx(pn,{children:n.jsxs(Ze,{$gap:19,children:[t.avatar?n.jsx(m1.Avatar,{src:t.avatar,alt:`user-avatar-${t.name}`}):n.jsx(gn,{name:t.name}),n.jsxs(Fe,{$justifyContent:"flex-start",$alignItems:"flex-start",children:[n.jsx(B.Text,{noMargin:!0,color:a.gray2,className:"date",size:"13",children:g1(i,De.defaultDateFormat)}),n.jsx(B.Text,{className:"note",size:"13",children:r})]})]})})}):null},hn=O(Fe)`
  gap: 22px;
  margin: 16px auto;
`,fn=O(xe.Title)`
  margin-bottom: 16px;
...
`,Pn=({relatedProducts:e})=>{const{t}=U();return n.jsx(Tn,{className:"course-related-courses",children:n.jsx(Te,{children:n.jsx(L.Row,{children:n.jsxs(L.Col,{lg:9,children:[e&&(e==null?void 0:e.length)>0&&n.jsxs("div",{className:"content-container",children:[n.jsx(J.Title,{level:1,as:"h2",children:t("CoursePage.RelatedCoursesTitle")}),n.jsx(N1,{slidesPerView:3,children:e==null?void 0:e.map(r=>{var i;return n.jsx(B1,{children:n.jsx(J.NewCourseCard,{mobile:k,id:r.id,image:n.jsx(Y,{to:`/courses/${(i=r==null?void 0:r.productables[0])==null?void 0:i.id}`,children:r.poster_path?n.jsx(L1,{path:r.poster_path,alt:r.name,srcSizes:[300,600,900]}):n.jsx(V1,{})}),price:r.public?n.jsx("div",{className:"course-price",children:t("FREE")}):n.jsx(Ge,{price:r==null?void 0:r.price,oldPrice:r==null?void 0:r.price_old,taxRate:r==null?void 0:r.tax_rate}),title:n.jsx(Y,{to:`/courses/${r.id}`,children:n.jsx(J.Title,{level:3,as:"h3",className:"title",children:r.name})})})},r.id)})})]}),n.jsx("div",{className:"content-container",children:n.jsx(I1,{titleText:t("CoursePage.InterestTitle"),params:{per_page:6,order_by:"created_at",order:"ASC"},slidesPerView:3})})]})})})})},Mn=O.div`
...
`,qn=()=>{var w,y;const[e,t]=u.useState([]),[r,i]=u.useState(!1),[a,o]=u.useState(),{id:l}=Oe(),{t:p}=U(),g=de(),v=Me(),{course:s,fetchCourse:c,fetchCourses:m,fetchCourseAccess:x,fetchQuestionnaires:b}=u.useContext(ze.EscolaLMSContext),d=u.useCallback(()=>i(!1),[]),h=u.useCallback(()=>i(!0),[]),_=u.useCallback(()=>x({course_id:Number(l),current_page:1,per_page:1}),[l,x]);return u.useEffect(()=>{m({per_page:6}),l&&(c(Number(l)),_(),b(qe.COURSE,Number(l)).then(M=>M.success&&t(M.data)))},[l]),s.error?n.jsx("pre",{children:s.error.message}):n.jsxs(h1,{metaTitle:((w=s==null?void 0:s.value)==null?void 0:w.title)||"Loading",children:[s.loading&&n.jsx(n.Fragment,{children:n.jsx(ke,{children:n.jsx(Te,{children:n.jsxs(L.Row,{children:[n.jsx(L.Col,{md:12,lg:8,children:n.jsx(Sn,{})}),n.jsx(L.Col,{md:12,lg:3,offset:{lg:1},children:n.jsx(On,{})})]})})})}),!s.loading&&s.value&&n.jsxs(n.Fragment,{children:[n.jsxs(ke,{children:[n.jsxs(Te,{children:[!k&&n.jsx(O1,{items:[n.jsx(Y,{to:se.home,children:p("Home")}),n.jsx(Y,{to:se.courses,children:p("Courses")}),n.jsx(B.Text,{size:"13",children:s.value.title})]}),n.jsxs(L.Row,{children:[n.jsxs(L.Col,{md:12,lg:8,children:[k&&n.jsx(Ln,{onClick:()=>g.push(se.courses),children:n.jsx(f1,{color:v.black})}),n.jsx(dn,{courseData:s.value}),k&&s.value&&n.jsx(Be,{course:s.value,onRequestAccess:h}),s.value.description&&Le(s.value.description)!==""&&n.jsx("section",{className:"course-description-short",children:n.jsx(He.MarkdownRenderer,{children:s.value.description})}),s.value.summary&&Le(s.value.summary)!==""&&n.jsx("section",{className:"course-description",children:n.jsx(He.MarkdownRenderer,{children:s.value.summary})}),n.jsxs("section",{className:"",children:[n.jsx(xe.Title,{as:"h3",level:4,className:"title",children:p("CoursePage.Teacher")}),n.jsx(L.Row,{children:s.value&&s.value.authors.map(M=>n.jsx(ln,{author:M}))})]}),s.value.lessons&&s.value.lessons.length>0&&n.jsx(We.CourseProgram,{lessons:s.value.lessons,onTopicClick:M=>o(M)}),n.jsx(wn,{questionnaires:e})]}),!k&&n.jsx(L.Col,{md:12,lg:3,offset:{lg:1},children:s.value&&n.jsx(Be,{course:s.value,onRequestAccess:h})})]})]}),n.jsx(Pn,{relatedProducts:(y=s.value.product)==null?void 0:y.related_products})]}),n.jsxs(Re.Modal,{onClose:()=>o(void 0),visible:!!a,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,bodyStyle:{maxHeight:"80vh",overflow:"auto"},children:[n.jsx($e,{}),a&&n.jsx(an,{topic:a})]}),n.jsxs(Re.Modal,{onClose:d,visible:r,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,children:[n.jsx($e,{}),n.jsx(Ke.ModalCourseAccess,{course:s.value,onCancel:d,onSuccess:()=>{_(),d()}})]})]})]})};export{qn as default};
