...
`,R=({error:t,goTo:s=y.courses,goToText:e,alternativeButton:o})=>{const{t:a}=w(),l=F(),i=e??a("CoursePage.SeeOtherCourses");return r.jsx(L,{children:r.jsxs(Ce,{children:[r.jsx(E.Text,{size:"16",children:r.jsx("strong",{children:a("CoursePage.ErrorOccurred")})}),r.jsx(E.Text,{size:"14",children:t}),r.jsx("hr",{}),r.jsxs("div",{className:"buttons-block",children:[r.jsx(_.Button,{mode:"secondary",onClick:()=>l.push(s),children:i}),o&&r.jsx(_.Button,{mode:"outline",onClick:()=>l.push(o.goTo),children:o.goToText})]})]})})},be=D.section`
...
`,je=({courseId:t})=>{const{t:s}=w(),{push:e}=F(),[o,a]=d.useState({show:!1,step:0,loading:!1}),[l,i]=d.useState([]),{fetchQuestionnaires:x,fetchQuestionnaire:m}=d.useContext(U.EscolaLMSContext),f=d.useCallback(()=>{if(a(c=>({...c,show:!1})),o.step<l.length-1){a(n=>({...n,step:n.step+1}));const c=setTimeout(()=>{a(n=>({...n,show:!0}))},500);return()=>clearTimeout(c)}},[l,o.step]);return d.useEffect(()=>{a(c=>({...c,loading:!0})),t&&le({courseId:t,fetchQuestionnaire:m,fetchQuestionnaires:x,onSucces:c=>{i(c)},onFinish:()=>a(c=>({...c,loading:!1}))})},[t]),r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"course-program-finish-modal",children:o.loading?r.jsx(K.Spin,{}):r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"course-program-finish-modal__title",children:s("CourseProgram.FinishTitle")}),r.jsx("p",{className:"course-program-finish-modal__paragraph",children:l!=null&&l.length?s("CourseProgram.FinishSubtitle"):s("CourseProgram.FinishSubtitleNoRating")}),r.jsxs("div",{className:"course-program-finish-modal__buttons",children:[!!(l!=null&&l.length)&&r.jsx(_.Button,{mode:"primary",onClick:()=>a(c=>({...c,show:!0})),children:s("MyProfilePage.RateCourse")}),r.jsx(_.Button,{mode:"primary",onClick:()=>e(y.myProfile),children:s("Menu.Profile")}),r.jsx(_.Button,{mode:"primary",onClick:()=>e(y.courses),children:s("Menu.Courses")})]})]})}),o.show&&t&&!!l.length&&r.jsx(ie,{course:ue.COURSE,courseId:t,visible:o.show,onClose:()=>f(),questionnaire:l[o.step]})]})},ke=D.div`
  margin-top: 100px;
`,ge=({resources:t,subtitle:s})=>{const{t:e}=w(),o=t.map(a=>({href:a.url,fileName:a.name}));return r.jsx(ke,{children:r.jsx(X.Downloads,{subtitle:s,title:e("CourseProgram.TopicAttachment"),downloads:o})})},Pe=({lesson:t,topic:s,disableNextTopicButton:e,getNextPrevTopic:o,onXAPI:a,onVideoEnd:l,onAudioEnd:i,onPdfEnd:x,onQuizEnd:m,onProjectEnd:f,onProjectsChange:c})=>{var u,h;const n=t&&t.summary&&s&&s.summary?6:12;return r.jsxs("div",{className:"course-program-player",children:[r.jsxs("div",{className:"course-program-player-content",children:[s&&s.introduction&&r.jsx(B.MarkdownRenderer,{children:s.introduction}),r.jsx("div",{className:"course-program-player-content__wrapper",style:{...((u=s==null?void 0:s.json)==null?void 0:u.wrapperStyle)||{}},children:r.jsx(te,{topic:s,disableNextTopicButton:e,isThereAnotherTopic:!!o(Number(s==null?void 0:s.id)),onXAPI:C=>a==null?void 0:a(C),onVideoEnd:l,onAudioEnd:i,onPdfEnd:x,onQuizEnd:m,onProjectEnd:f,onProjectsChange:c},s==null?void 0:s.id)})]}),r.jsx("div",{className:"course-program-content__container",children:r.jsxs(N.Row,{children:[t&&t.summary&&r.jsx(N.Col,{sm:12,md:n,lg:n,children:r.jsx("div",{className:"course-program-summary",children:r.jsx(B.MarkdownRenderer,{children:t.summary})})}),s&&s.summary&&r.jsx(N.Col,{sm:12,md:n,lg:n,children:r.jsxs("div",{className:"course-program-summary",children:[r.jsx(B.MarkdownRenderer,{children:s.summary}),s&&s.resources&&((h=s.resources)==null?void 0:h.length)>0&&r.jsx(ge,{resources:s.resources||[],subtitle:s.introduction||""})]})})]})})]})},Te=(t,s,e)=>{var a,l;if(!s||!e||!t.byId)return!1;const o=(l=(a=t.byId[e])==null?void 0:a.value)==null?void 0:l.find(({topic_id:i})=>s===i);return(o==null?void 0:o.status)===1},ye=({program:t,courseId:s})=>{const{topic:e,lesson:o,onNextTopic:a,onPrevTopic:l,getNextPrevTopic:i,isNextTopicButtonDisabled:x,disableNextTopicButton:m,sendProgress:f,courseProgressDetails:c,isLastTopic:n}=re(t),[u,h]=d.useState(!1),[C,k]=d.useState(!1),{onCompleteTopic:P,onXAPI:G}=he({program:t}),{topicBookmark:v,handleBookmark:V,topicNote:M}=xe({topic:e,lesson:o,program:t,courseId:s}),{finishedTopicIndex:A}=fe({courseId:s,program:t,topic:e}),{t:T}=w();d.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[o==null?void 0:o.id,e==null?void 0:e.id]),d.useEffect(()=>{const b=i(Number(e==null?void 0:e.id));if(!(!t||!e))if(b===null||e.can_skip===!1&&Te(c,e.id,s)===!1){m(!0);return}else m(!1)},[e==null?void 0:e.id,t,c,s]),window.resetProgress=()=>(async()=>{await f(t.id,t.lessons.flatMap(b=>b.topics).map(b=>({topic_id:Number(b==null?void 0:b.id),status:0})))})();const p=d.useCallback(b=>{if(((e==null?void 0:e.topicable_type)===j.TopicType.Video||(e==null?void 0:e.topicable_type)===j.TopicType.Audio||(e==null?void 0:e.topicable_type)===j.TopicType.GiftQuiz||(e==null?void 0:e.topicable_type)===j.TopicType.Project||(e==null?void 0:e.topicable_type)===j.TopicType.Pdf)&&(e==null?void 0:e.can_skip)===!1&&!C)return!1;P(e==null?void 0:e.can_skip),b&&h(!0)},[C,P,e==null?void 0:e.can_skip,e==null?void 0:e.topicable_type]),g=d.useCallback(()=>{n?k(!0):P()},[n,P]),W=d.useCallback(b=>{if(b.data.length>0){g();return}n&&k(!1)},[n,g]);return t?e?r.jsxs(be,{className:"course-program-wrapper",children:[r.jsxs(Q,{children:[r.jsx(ae,{items:[r.jsx(H,{to:y.home,children:T("Home")}),r.jsx(H,{to:y.courses,children:T("Courses")}),r.jsx(E.Text,{size:"12",children:t.title}),r.jsx(E.Text,{size:"12",children:e.title})]}),r.jsx(Y.Title,{className:"main-title",level:3,children:e.title}),r.jsxs(N.Row,{children:[r.jsxs(N.Col,{lg:9,children:[u&&r.jsx(je,{courseId:s}),!u&&r.jsx(Pe,{lesson:o,topic:e,onXAPI:G,disableNextTopicButton:m,getNextPrevTopic:i,onAudioEnd:g,onVideoEnd:g,onPdfEnd:g,onQuizEnd:g,onProjectEnd:g,onProjectsChange:W})]}),r.jsx(N.Col,{lg:3,children:r.jsx(oe,{course:t,topicId:Number(e==null?void 0:e.id),onCourseFinish:()=>p(!0),onCompleteTopic:p})})]})]}),r.jsx("div",{className:"course-nav",children:r.jsx(Q,{children:r.jsx(de.CourseTopNav,{onFinish:p,mobile:Z,onNext:a,isFinished:typeof A=="number"?A>-1:!1,onPrev:l,addNotes:!0,newNoteData:{id:e.id,type:`${s}/${o==null?void 0:o.id}/${e==null?void 0:e.id}:${t.title}:${e==null?void 0:e.title}`},currentNote:M==null?void 0:M[0],addBookmarks:!0,bookmarkBtnText:v!=null&&v.length?"deleteBookmark":"addBookmark",onBookmarkClick:()=>V(),hasPrev:!!i(Number(e==null?void 0:e.id),!1),hasNext:!x,isLast:n,onCourseFinished:()=>p(!0)})})})]}):r.jsx(R,{error:T("CourseProgram.NoTopic"),goTo:`/course/${t.id}`,goToText:T("CoursePage.BackToCourse"),alternativeButton:{goTo:y.courses,goToText:T("CoursePage.SeeOtherCourses")}}):r.jsx(R,{error:T("CourseProgram.NoProgram")})},Ne=({program:t})=>{const s=t==null?void 0:t.scorm_sco,e=s==null?void 0:s.uuid;return!s&&!e?r.jsx(se.Fragment,{}):r.jsx(ne,{value:{title:s.title,uuid:s.uuid}})},ze=()=>{var a;const{id:t}=I(),{program:s,fetchProgram:e,fetchCourseProgress:o}=d.useContext(S.EscolaLMSContext);return d.useEffect(()=>{t&&(e(Number(t)),o(Number(t)))},[t]),s.loading?r.jsx(O,{}):s.error?r.jsx(R,{error:ee("CourseProgram.NoProgram")}):s.value&&((a=s==null?void 0:s.value)!=null&&a.scorm_sco_id)?r.jsx(L,{metaTitle:s.value.title,children:r.jsx(Ne,{program:s.value})}):s.value&&s.value.lessons&&s.value.lessons.length?r.jsx(L,{metaTitle:s.value.title,children:r.jsx(ye,{program:s.value,courseId:Number(t)})}):r.jsx(O,{})};export{ze as default};
