import{r as a,D as L,f as k,i as _,j as s,x as Q,T as A,s as I,af as W,v,q as y,ah as G,A as K,aX as Z,Z as U,aY as X,aZ as Y,a_ as J,m as V,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-Ba_2FdXr.js";import{T as ae}from"./Tabs-Czl4O2R1.js";import{C as ne}from"./index-BG-rGcdP.js";import{R as ie}from"./ResponsiveImage-DZYeXYfo.js";import{C as le}from"./index-DQZbxABP.js";import{C as de}from"./index-DTb7IJLS.js";import{R as ce}from"./index-DQDCoAW9.js";import{b as me,Q as ue}from"./questionnaires-C3yqVtPU.js";import{u as pe}from"./useDownloadCertificate-BKlVXx3o.js";import{u as ge}from"./useRoles-CRZEtaBg.js";import{u as H}from"./useSearchParams-BCQkSQEy.js";import{P as xe}from"./index-Br4I4p60.js";import{S as he}from"./swiper-Cr9L8wSW.js";import{S as B}from"./swiper-react-7yEnN6SU.js";import{C as D}from"./CourseCard-DMMa2srU.js";import"./base-C7euzKDi.js";import"./a11y-CZHHFuqB.js";import"./index-CFfhIvGP.js";const fe=({courseData:e,visible:d,onClose:t})=>{const{sendProgress:c}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:i}=_(),g=a.useCallback(async()=>{await c(e.course.id,e.progress.map(({topic_id:p})=>({topic_id:p,status:0}))),i(`/course/${e.course.id}`)},[e.course.id,e.progress,c,i]);return s.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:s.jsxs(s.Fragment,{children:[s.jsx(A.Title,{level:4,children:o("ResetProgressModal.Continue")}),s.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),s.jsxs(W,{$gap:16,children:[s.jsx(v.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),s.jsx(v.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},Ce=y(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
