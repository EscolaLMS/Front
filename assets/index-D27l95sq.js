import{b as N,Q as E,r as i,m as k,j as e,q as x,i as n,V as c,L as m,ay as M,x as d,N as u,T as b,f as p,h as L,o as v,az as C,I as T,aA as _,l as I,aB as R,aC as h,aD as B,aE as z,aF as A,ap as S,ai as D,aj as W,v as q,C as F}from"./index-rkmB2-qz.js";import{P as G}from"./index-DtMqXEXn.js";import{a as O}from"./PricingCard-Bq9xBjpw.js";import{P as U}from"./index-DCaaO-oe.js";import{B as V}from"./index-4PFGeimt.js";const H=N.createContext({}),Q=({children:t})=>{const{id:a}=E(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(H.Provider,{value:{},children:t})},J=x.div`
  width: 100%;
  left: 0;
