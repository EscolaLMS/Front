...
`,ue=u.div`
  ...
  position: relative;
  margin-bottom: 16px;
`,be=()=>{const{t:r}=b();return e.jsx(J,{metaTitle:r("CoursesPage.Courses"),children:e.jsx(xe,{onlyFree:!1,children:e.jsxs(he,{className:"courses-page",children:[e.jsx(ue,{children:e.jsx(F,{children:e.jsxs(f.Title,{level:1,children:[" ",r("CoursesPage.Courses")]})})}),e.jsx(F,{children:e.jsx(pe,{})})]})})})};export{be as default};
