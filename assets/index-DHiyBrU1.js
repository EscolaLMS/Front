import{r,D as $,f as k,i as B,j as t,x as q,T as R,v as _,aj as V,B as L,q as N,ai as Y,S as W,X as G,J as Z,o as D,w as I,N as U,U as ee,O as te,l as se,s as oe,h as z,k as ne,d as M,E as re,G as ae,aR as ie}from"./index-BTvwz0L3.js";import{T as le}from"./Tabs-BG637HTY.js";import{C as ce}from"./index-B2HKkCHC.js";import{C as de}from"./index-ClhuH08r.js";import{R as ue}from"./ResponsiveImage-G_l4wTjD.js";import{C as me}from"./index-eMEuee3m.js";import{C as pe}from"./index-BHYkv3Er.js";import{R as xe}from"./index-DbTzvoRw.js";import{g as ge,r as he}from"./index-1V4e0nUl.js";import{c as fe,a as je}from"./questionnaires-BykLl9Mv.js";import{P as ye}from"./index-DOxl94Sr.js";import{u as be}from"./useRoles-Du9QW3QV.js";import{u as K}from"./useSearchParams-Dcu5KpUk.js";import{P as Ce}from"./index-DzsaDRiK.js";import"./app-B2E7767C.js";import"./date-msTaMnuE.js";import"./base-CumTa13P.js";const Pe=({courseData:e,visible:s,onClose:o})=>{const{sendProgress:a}=r.useContext($.EscolaLMSContext),{t:n}=k(),{push:l}=B(),p=r.useCallback(async()=>{await a(e.course.id,e.progress.map(({topic_id:b})=>({topic_id:b,status:0}))),l(`/course/${e.course.id}`)},[e.course.id,e.progress,a,l]);return t.jsx(q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:s,onClose:o,children:t.jsxs(t.Fragment,{children:[t.jsx(R.Title,{level:4,children:n("ResetProgressModal.Continue")}),t.jsxs(_.Text,{children:[" ",n("ResetProgressModal.RestartCourse")]}),t.jsxs(V,{$gap:16,children:[t.jsx(L.Button,{mode:"primary",onClick:p,children:n("ResetProgressModal.WantContinue")}),t.jsx(L.Button,{mode:"primary",onClick:o,children:n("ResetProgressModal.Cancel")})]})]})})},ve=N(Y)`
  gap: 6px;
  margin: 0;
  width: 100%;
`,we=({courseData:e,courseProgress:s})=>{const[o,a]=r.useState(void 0),[n,l]=r.useState(!1),{fetchQuestionnaires:p,fetchQuestionnaire:b}=r.useContext($.EscolaLMSContext),[m,j]=r.useState({show:!1,step:0,loading:!1}),{t:y}=k(),C={isDone:e.finish_date,isActive:e.start_date&&!e.finish_date,isNotStarted:!e.start_date&&!e.finish_date},x=r.useMemo(()=>e.deadline?new Date(e.deadline):null,[e.deadline]),d=x?x.getTime()<Date.now():!1,u=r.useMemo(()=>x?ge(x):null,[x]),[g,f]=r.useState([]),T=r.useCallback(()=>{if(a(void 0),j(h=>({...h,show:!1})),m.step<g.length-1){j(P=>({...P,step:P.step+1}));const h=setTimeout(()=>{j(P=>({...P,show:!0}))},500);return()=>clearTimeout(h)}},[g,m.step]);return r.useEffect(()=>{o&&fe({courseId:o,fetchQuestionnaire:b,fetchQuestionnaires:p,onSucces:h=>{f(h)},onFinish:()=>j(h=>({...h,loading:!1}))})},[o]),t.jsxs(ve,{children:[s===100&&t.jsxs(t.Fragment,{children:[t.jsx(L.Button,{mode:"secondary",onClick:()=>{a(e.course.id),j(h=>({...h,show:!0,loading:!0}))},children:m.loading?t.jsx(W.Spin,{}):y("MyProfilePage.RateCourse")}),!d&&C.isDone&&t.jsx(L.Button,{mode:"secondary",onClick:()=>l(!0),children:y("MyProfilePage.ResetCourseProgress")})]}),!!d&&u!==null&&u[0]<0&&t.jsxs(_.Text,{children:[y("MyProfilePage.AccessCourseExpired")," ",he.format(u[0],u[1])]}),t.jsx(Pe,{courseData:e,visible:n,onClose:()=>l(!1)}),m.show&&o&&!m.loading&&(g.length?t.jsx(t.Fragment,{children:t.jsx(xe,{course:je.COURSE,courseId:o,visible:m.show,onClose:T,questionnaire:g[m.step]})}):t.jsx(q.Modal,{onClose:T,visible:m.show,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:468,children:t.jsx(R.Title,{children:y("CourseProgram.CourseRated")})}))]})},H=({course:e})=>{const s=G(),o=B(),{t:a}=k();return t.jsx(me,{children:t.jsx(Z,{mobile:D,id:e.id,image:t.jsx(I,{to:`/course/${e.id}`,children:e.image_path?t.jsx(ue.ResponsiveImage,{path:e.image_path,alt:e.title,srcSizes:[300,600,900]}):t.jsx(de,{})}),subtitle:e.subtitle?t.jsx(_.Text,{children:t.jsx(I,{style:{color:s.primaryColor},to:`/course/${e.id}`,children:e.subtitle})}):void 0,title:t.jsx(I,{to:`/courses/${e.id}`,className:"title",children:t.jsx(R.Title,{level:4,as:"h2",children:e.title})}),categories:t.jsx(pe,{categories:e.categories,onCategoryClick:n=>{o.push(`/courses/?categories[]=${n}`)}}),actions:e.courseData&&t.jsx(we,{courseData:e.courseData,courseProgress:e.progress||0}),footer:t.jsxs(t.Fragment,{children:[e.users_count&&e.users_count>0&&t.jsx(U.IconText,{icon:t.jsx(ee,{}),text:`${e.users_count} ${a("Students")}`})," ",e.lessons_count&&e.lessons_count>0&&t.jsx(U.IconText,{icon:t.jsx(te,{}),text:`${e.lessons_count} ${a("Lessons")}`})]}),progress:e.progress&&e.progress!==100&&!isNaN(e.progress)?{currentProgress:e.progress,maxProgress:100}:void 0})})},_e=N.div`
  overflow: hidden;
  .course-wrapper {
    margin-bottom: 24px;
    a {
