import{k as E,j as e,V as a,T as j,o as _,s as N,q as g,r as v,i as z,h as F,W as B,p as P,y as T,z as h,m as C,a1 as f,at as A,au as q,av as L,aw as D,ax as V,Q as G,v as Q,C as k,L as I,an as W,M as U}from"./index-Cov4NIbj.js";import{P as J}from"./index-nc1UsnU2.js";import{B as K}from"./index-DCDEIpXZ.js";import{a as O}from"./index-DQjgTkW6.js";import{P as R}from"./PricingCard-D56TlS95.js";import{C as $}from"./index-DhqZ6sg9.js";import{S as M,a as X}from"./sidebar-DK_Jgx4t.js";import{S as p}from"./index-KCVTbkR8.js";import"./floating-ui.react-dom-D0I_2yxE.js";import"./useRoles-v00MWHfW.js";import"./questionnaire-CXWDgbJ4.js";import"./index-Dd7-zItb.js";import"./index-afGA12bm.js";const Y=i=>{const{consultation:t}=i,s=E();return e.jsxs(a.Row,{align:"center",children:[e.jsxs(a.Col,{lg:7,children:[(t==null?void 0:t.categories)&&t.categories.length>0&&e.jsx(O,{categories:t.categories,onCategoryClick:x=>{s.push(`/consultations/?categories[]=${x}`)}}),e.jsx("br",{}),e.jsx(j.Title,{mobile:_,level:1,children:t==null?void 0:t.name})]}),e.jsx(a.Col,{lg:4,children:(t==null?void 0:t.image_path)&&e.jsx("div",{className:"image-wrapper",children:e.jsx(N.ResponsiveImage,{path:t.image_path,srcSizes:[790*.5,790,2*790]})})})]})};g.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: 10px;
