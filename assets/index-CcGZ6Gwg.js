...
`,We=({title:t,children:e,active:n,onClick:a})=>{const[i,s]=z.useState(n||!1);return r.jsxs(kt,{children:[r.jsx("div",{className:"collapse-title",children:r.jsx(Ke,{name:t,label:r.jsx("strong",{children:t}),checked:n||i,onChange:()=>[s(!i),a&&a()]})}),(n||i)&&r.jsx("div",{className:"collapse-content",children:e})]})},Tt=K.div`
  .input-wrapper {
...
`,Ue=()=>{const{t}=G(),{fetchProgress:e}=z.useContext(Xe.EscolaLMSContext);return z.useEffect(()=>{e()},[]),r.jsx(Pt,{$isMobile:F,children:r.jsx(pe,{children:r.jsxs("div",{className:"cart-success-container",children:[r.jsx(Ge,{}),r.jsx(R.Title,{level:2,children:t("Cart.ThankYouTitle")}),r.jsxs("div",{children:[r.jsx($.Text,{size:"16",className:"cart-success-text",children:t("Cart.ThankYouText")}),r.jsx(ce,{to:X.myProfile,children:r.jsx($.Text,{size:"16",children:t("Navbar.MyCourses")})})]}),r.jsxs("div",{children:[r.jsx($.Text,{size:"16",children:t("Cart.Status")})," ",r.jsx(ce,{to:X.myOrders,children:r.jsx($.Text,{size:"16",children:t("Navbar.MyOrders")})})]})]})})})},de=K.section`
...
`,Jt=()=>{var l,o,E,w,k;const{config:t}=z.useContext(tt.EscolaLMSContext),e=f=>Et(f),n=(o=(l=t==null?void 0:t.value)==null?void 0:l.escolalms_payments)==null?void 0:o.drivers,a=(E=n==null?void 0:n.stripe)==null?void 0:E.publishable_key,i=Ee(),s=ke.getFontFromTheme(i),c=(k=(w=t==null?void 0:t.value)==null?void 0:w.escolalms_payments)==null?void 0:k.default_gateway;if(c==="Przelewy24")return r.jsx(_e,{children:r.jsx(Ot,{})});if(c==="stripe")return r.jsx(_e,{children:r.jsx(Ae,{stripe:e(a),options:{fonts:[{cssSrc:s.links[0]}]},children:r.jsx(Rt,{stripeKey:a})})})};export{Jt as default};
