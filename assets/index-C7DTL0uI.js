import{r as c,A as G,q as P,f as q,i as te,l as X,j as n,T as Q,s as M,w as O,n as B,W as Ce,m as F,v as $,Y as Ye,Z as we,x as fe,h as Le,D as be,a0 as ve,J,a1 as Je,a2 as Ze,d as v,a3 as ye,a4 as ie,a5 as Ke,a6 as ae,a7 as en,a8 as nn,a9 as z,b as tn,aa as sn,ab as rn,ac as on,ad as an,L as ne,ae as ln,af as cn,I as $e,ag as Ee,X as Ie,ah as dn,ai as ze,aj as un,S as pn,C as je,o as mn,ak as xn,al as Pe,M as Te}from"./index-CcQ9x6fP.js";import{P as gn}from"./PricingCard-Ca1fb4AR.js";import{u as De}from"./useSubscriptions-CK9Yz6Hj.js";import{P as Fe}from"./index-h6oG5SsI.js";import{A as hn,_ as fn,P as vn,I as jn,a as _n,O as bn,H as yn}from"./index-BOvkpsSM.js";import{B as Cn}from"./index-C1nK1_YC.js";import{Q as Ge,a as Oe,g as wn}from"./questionnaires-CZURFNf2.js";import{R as Pn,a as Tn}from"./ResponsiveImage-C6DmWZXU.js";import{C as On}from"./index-BbSV2EzZ.js";import{t as Mn}from"./toast-8bhsWSTr.js";import{P as Sn}from"./index-BaRBH6h5.js";import{D as Nn}from"./index-CPshv788.js";import{S as Rn}from"./swiper-C1SOnM5l.js";import{S as kn}from"./swiper-react-Dwa8Yg-L.js";import{C as An}from"./index-B_UJVbS6.js";import{S as A}from"./index-BixcMT39.js";import"./warning-CHuwKAED.js";import"./index-BokLS7km.js";import"./useFetchCourses-DdRttR6t.js";import"./CourseCard-BuC1QxV6.js";import"./a11y-BjMBWk3F.js";const Bn=e=>{const[t,s]=c.useState({data:void 0,loaded:!1,loading:!1}),{user:i,fetchCourseProgress:r,courseProgressDetails:a}=c.useContext(G.EscolaLMSContext);return c.useEffect(()=>{a.byId&&a.byId[Number(e)]&&a.byId[Number(e)].value&&s({...t,data:a.byId[Number(e)].value,loaded:!0,loading:!1})},[e,a]),c.useEffect(()=>{i!=null&&i.value&&!i.loading&&!t.loading&&!t.loaded?(s({...t,loading:!0}),r(e).catch(()=>s({...t,loaded:!0,loading:!1}))):t.loaded||s({...t,loaded:!0})},[i,t,r,e]),{progress:t}},Ln=P.div`
  text-align: center;
  .modal-header {
    margin-bottom: 10px;
  }
...
`])),function(j){var y=j.theme;return y.errorColor}),C=function(j){var y=j.course,T=j.className,N=j.initialValues,R=N===void 0?{phone_number:"",contact_details:""}:N,Ue=j.onCancel,ue=j.onSuccess,pe=j.onError,Y=(0,f.useTranslation)().t,Xe=(0,x.useContext)(p.EscolaLMSContext).addCourseAccess;return(0,o.jsxs)(b,s({className:"wellms-component ".concat(T),"data-testid":"modal-course-access"},{children:[(0,o.jsxs)("header",{children:[(0,o.jsx)(d.Title,s({level:1},{children:y.title})),(0,o.jsx)(h.Text,s({size:"14",bold:!0},{children:Y("ModalCourseAccess.Title")}))]}),(0,o.jsx)(u.Formik,s({initialValues:R,onSubmit:function(E,U){var se=U.setErrors,V=U.setSubmitting,re=U.resetForm,oe={course_id:y.id,data:E};Xe(oe).then(function(){re(),ue==null||ue()}).catch(function(I){var me,xe;se(s({error:(me=I==null?void 0:I.data)===null||me===void 0?void 0:me.message},(xe=I==null?void 0:I.data)===null||xe===void 0?void 0:xe.errors)),pe==null||pe()}).finally(function(){V(!1)})}},{children:function(E){var U=E.values,se=E.touched,V=E.errors,re=E.handleChange,oe=E.handleBlur,I=E.handleSubmit;return(0,o.jsxs)("form",s({onSubmit:I},{children:[(0,o.jsxs)("div",s({className:"form-content"},{children:[V&&V.error&&(0,o.jsx)(h.Text,s({className:"error-msg",size:"12",bold:!0},{children:V.error})),(0,o.jsxs)("div",s({className:"input-group"},{children:[(0,o.jsx)(m.Input,{type:"text",label:Y("ModalCourseAccess.PhoneNumber"),error:se.phone_number&&V.phone_number,id:"phone_number",name:"phone_number",onChange:re,onBlur:oe,value:U.phone_number}),(0,o.jsx)(_.TextArea,{label:Y("ModalCourseAccess.ContactDetails"),error:se.contact_details&&V.contact_details,id:"contact_details",name:"contact_details",onChange:re,onBlur:oe,value:U.contact_details})]}))]})),(0,o.jsxs)("div",s({className:"button-group"},{children:[(0,o.jsx)(g.Button,s({type:"button",mode:"secondary",onClick:Ue},{children:Y("ModalCourseAccess.Cancel")})),(0,o.jsx)(g.Button,s({type:"submit",mode:"secondary"},{children:Y("ModalCourseAccess.Submit")}))]}))]}))}}))]}))};e.ModalCourseAccess=C,e.default=(0,l.withTheme)((0,l.default)(e.ModalCourseAccess)(S||(S=t([""],[""]))));var w,S})(Qe);const ke=P.div`
  padding-top: 40px;
  section {
    margin-bottom: 40px;
...
`,Zn=({courseData:e})=>{const{fetchQuestionnaireStarsByModel:t}=c.useContext(G.EscolaLMSContext),[s,i]=c.useState({type:D.INIT}),r=te(),a=c.useCallback(async()=>{if(e.id)try{i({type:D.LOADING});const o=await t("course",Number(e.id));o.success&&i({type:D.LOADED,rating:o.data})}catch(o){i({type:D.ERROR,error:o instanceof Error?o.message:"Unknown error"})}},[e.id,t]);return c.useEffect(()=>{a()},[e.id,a]),n.jsx("section",{className:"course-main-info",children:n.jsxs(O.Row,{children:[n.jsxs(O.Col,{lg:12,children:[n.jsx(On,{categories:e.categories,onCategoryClick:o=>{r.push(`/courses/?categories[]=${o}`)}}),n.jsx(Q.Title,{mobile:B,level:1,children:e.title}),s.type===D.LOADED?n.jsxs(Jn,{children:[n.jsx(F.Rating,{ratingValue:s.rating.avg_rate,label:`${s.rating.avg_rate}`}),n.jsx(F.Text,{size:"13",children:"Śr. ocena kursu"}),"・",n.jsx("div",{children:n.jsxs(F.Text,{size:"13",children:["Dodane opinie ",n.jsx("strong",{children:s.rating.count_answers})]})})]}):s.type===D.LOADING?n.jsx(ve,{width:"20px",height:"20px"}):s.type===D.ERROR?s.error:null]}),n.jsx(O.Col,{lg:12,children:e.image_path&&n.jsx("div",{className:"image-wrapper",children:n.jsx(Pn.ResponsiveImage,{path:e.image_path,srcSizes:[790*.5,790,2*790]})})})]})})},he={total:0,per_page:3,page:1,current_page:1},Kn=({questionId:e,courseId:t})=>{const[s,i]=c.useState(void 0),[r,a]=c.useState(he),[o,x]=c.useState(!0),{fetchQuestionnairesAnswers:f}=c.useContext(G.EscolaLMSContext),{t:u}=q(),l=c.useCallback(g=>{e&&t&&(x(!0),f(Ge.COURSE,Number(t),e,{per_page:r.per_page,page:g,order_by:"updated_at",order:"DESC"}).then(m=>{m.success&&(i(m.data),a(_=>({..._,total:m.meta.total,current_page:m.meta.current_page,page:m.meta.current_page})))}).catch(m=>{Mn(u("UnexpectedError"),m),console.log(m)}).finally(()=>x(!1)))},[r,f,t,e,u]),p=c.useCallback(g=>{a(m=>({...m,current_page:g}))},[]);return c.useEffect(()=>{r.page!==r.current_page&&l(r.current_page)},[r.current_page,r.page,l]),c.useEffect(()=>{a(he),l(he.page)},[e]),{answersMeta:r,questionnaireAnswers:s,loading:o,onPageChange:p}},et=P(Ee)`
  justify-content: space-between;
...
`,xt=({relatedProducts:e})=>{const{t}=q();return n.jsx(mt,{className:"course-related-courses",children:n.jsx(je,{children:n.jsx(O.Row,{children:n.jsxs(O.Col,{lg:12,children:[e&&(e==null?void 0:e.length)>0&&n.jsxs("div",{className:"content-container",children:[n.jsx(F.Title,{level:1,as:"h2",children:t("CoursePage.RelatedCoursesTitle")}),n.jsx(Rn,{slidesPerView:4,children:e==null?void 0:e.map(s=>{var i;return n.jsx(kn,{children:n.jsx(F.NewCourseCard,{mobile:B,id:s.id,image:n.jsx(ne,{to:`/courses/${(i=s==null?void 0:s.productables[0])==null?void 0:i.id}`,children:s.poster_path?n.jsx(Tn,{path:s.poster_path,alt:s.name,srcSizes:[300,600,900]}):n.jsx(An,{})}),price:s.public?n.jsx("div",{className:"course-price",children:t("FREE")}):n.jsx(Fe,{price:s==null?void 0:s.price,oldPrice:s==null?void 0:s.price_old,taxRate:s==null?void 0:s.tax_rate}),title:n.jsx(ne,{to:`/courses/${s.id}`,children:n.jsx(F.Title,{level:3,as:"h3",className:"title",children:s.name})})})},s.id)})})]}),n.jsx("div",{className:"content-container",children:n.jsx(Nn,{titleText:t("CoursePage.InterestTitle"),params:{per_page:8,order_by:"created_at",order:"ASC"},slidesPerView:4})})]})})})})},gt=P.div`
...
`,Ft=()=>{var C,w;const[e,t]=c.useState([]),[s,i]=c.useState(!1),[r,a]=c.useState(),{id:o}=be(),{t:x}=q(),f=te(),u=Ie(),{course:l,fetchCourse:p,fetchCourses:g,fetchCourseAccess:m,fetchQuestionnaires:_}=c.useContext(Le.EscolaLMSContext),d=c.useCallback(()=>i(!1),[]),h=c.useCallback(()=>i(!0),[]),b=c.useCallback(()=>m({course_id:Number(o),current_page:1,per_page:1}),[o,m]);return c.useEffect(()=>{g({per_page:6}),o&&(p(Number(o)),b(),_(Ge.COURSE,Number(o)).then(S=>S.success&&t(S.data)))},[o]),l.error?n.jsx("pre",{children:l.error.message}):n.jsxs(mn,{metaTitle:((C=l==null?void 0:l.value)==null?void 0:C.title)||"Loading",children:[l.loading&&n.jsx(n.Fragment,{children:n.jsx(ke,{children:n.jsx(je,{children:n.jsxs(O.Row,{children:[n.jsx(O.Col,{md:12,lg:8,children:n.jsx(vt,{})}),n.jsx(O.Col,{md:12,lg:3,offset:{lg:1},children:n.jsx(ht,{})})]})})})}),!l.loading&&l.value&&n.jsxs(n.Fragment,{children:[n.jsxs(ke,{children:[n.jsxs(je,{children:[!B&&n.jsx(Cn,{items:[n.jsx(ne,{to:X.home,children:x("Home")}),n.jsx(ne,{to:X.courses,children:x("Courses")}),n.jsx(M.Text,{size:"13",children:l.value.title})]}),n.jsxs(O.Row,{children:[n.jsxs(O.Col,{md:12,lg:8,children:[B&&n.jsx(jt,{onClick:()=>f.push(X.courses),children:n.jsx(xn,{color:u.black})}),n.jsx(Zn,{courseData:l.value}),B&&l.value&&n.jsx(Ne,{course:l.value,onRequestAccess:h}),l.value.description&&Pe(l.value.description)!==""&&n.jsx("section",{className:"course-description-short",children:n.jsx(Te.MarkdownRenderer,{children:l.value.description})}),l.value.summary&&Pe(l.value.summary)!==""&&n.jsx("section",{className:"course-description",children:n.jsx(Te.MarkdownRenderer,{children:l.value.summary})}),n.jsxs("section",{className:"",children:[n.jsx(Q.Title,{as:"h3",level:4,className:"title",children:x("CoursePage.Teacher")}),n.jsx(O.Row,{children:l.value&&l.value.authors.map(S=>n.jsx(Yn,{author:S}))})]}),l.value.lessons&&l.value.lessons.length>0&&n.jsx(qe.CourseProgram,{lessons:l.value.lessons,onTopicClick:S=>a(S)}),n.jsx(pt,{questionnaires:e})]}),!B&&n.jsx(O.Col,{md:12,lg:3,offset:{lg:1},children:l.value&&n.jsx(Ne,{course:l.value,onRequestAccess:h})})]})]}),n.jsx(xt,{relatedProducts:(w=l.value.product)==null?void 0:w.related_products})]}),n.jsxs(fe.Modal,{onClose:()=>a(void 0),visible:!!r,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,bodyStyle:{maxHeight:"80vh",overflow:"auto"},children:[n.jsx(Ae,{}),r&&n.jsx(Xn,{topic:r})]}),n.jsxs(fe.Modal,{onClose:d,visible:s,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,children:[n.jsx(Ae,{}),n.jsx(Qe.ModalCourseAccess,{course:l.value,onCancel:d,onSuccess:()=>{b(),d()}})]})]})]})};export{Ft as default};
