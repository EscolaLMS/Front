import{b as S,r as i,h as w,k as P,i as k,j as e,q as v,n as d,f as u,T as $,J as _,L as C,as as T,aF as F,aG as N,U as E,X as L,S as I,w as y,D as H,o as M,C as R}from"./index-CBf-QksF.js";import{q as f}from"./base-C7euzKDi.js";import{C as q}from"./index-DESu-F-h.js";import{C as B}from"./index-DTS_8lXu.js";import{F as D,S as O}from"./index-BPF7oUsr.js";import{P as U}from"./index-C3JxcG_U.js";import{a as X}from"./ResponsiveImage-BnPBXGWb.js";import{C as z}from"./index-DSumW0cD.js";import{T as A}from"./index-BRT4m0w7.js";import{C as G}from"./index-DVEYPayL.js";import"./swiper-react-qtwdYFOz.js";const h=S.createContext({}),b=(s={})=>f.stringify(s),J=({children:s})=>{const{fetchProducts:r,products:a,fetchCategories:t,fetchTags:n}=i.useContext(w.EscolaLMSContext),o=P(),{push:g}=k();i.useEffect(()=>{t(),n()},[]);const[c,x]=i.useState(),m=(l={})=>({page:1,per_page:8,type:"bundle",order_by:"created_at",order:"DESC",...l});return i.useEffect(()=>{g(`${o.pathname}?${b(c)}`)},[c,o.pathname]),i.useEffect(()=>{if(o.search&&o.search.split("?")[1]!==b(c)){const l=f.parse(o.search);x(l),r(l||{})}else r(m(c))},[o.search]),e.jsx(h.Provider,{value:{params:c,setParams:x,packages:a},children:s})},K=({children:s})=>{const r=v("div")`
