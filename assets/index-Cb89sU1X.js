...
`,gt=M.div`
  margin: 0 auto;
`,ht=({courseId:e,questionId:t})=>{var d;const{answersMeta:s,loading:a,onPageChange:r,questionnaireAnswers:u}=it({questionId:t,courseId:e}),{t:o}=G();return n.jsx(mt,{children:a?n.jsx(_n.Spin,{}):((d=u||[])==null?void 0:d.length)>0?n.jsxs(n.Fragment,{children:[n.jsx(xt,{level:4,children:o("CoursePage.CourseRatingsTitle")}),(u||[]).map(f=>n.jsx(pt,{question:f})),s.total>s.per_page&&n.jsx(gt,{children:n.jsx($n,{total:s.total,perPage:s.per_page,currentPage:s.current_page,onPage:r})})]}):null})},Ie=()=>console.warn("INITIAL STATE"),be=c.createContext({questionnaires:[],questionnaireId:null,setQuestionnaireId:Ie,questionId:null,setQuestionId:Ie,reviewId:void 0,courseId:void 0}),ft=({children:e,questionnaires:t})=>{var i;const[s,a]=c.useState(null),[r,u]=c.useState(null),{id:o}=ye(),d=t==null?void 0:t.at(0),f=(i=d==null?void 0:d.questions)==null?void 0:i.find(({type:p})=>p===Ne.RATE),m=Bn({questionnaires:t,questionnaireId:s,questionType:Ne.REVIEW});return c.useEffect(()=>{d!=null&&d.id&&!s&&a(d.id)},[d==null?void 0:d.id,s]),c.useEffect(()=>{f!=null&&f.id&&!r&&u(f.id)},[f==null?void 0:f.id,r]),n.jsx(be.Provider,{value:{questionnaires:t,questionnaireId:s,setQuestionnaireId:a,questionId:r,setQuestionId:u,reviewId:m,courseId:Number(o)},children:e})},_t=()=>{const e=c.useContext(be);if(!be)throw new Error("useCourseRatingContext must be used inside the CourseRatingProvider");return e},vt=c.memo(()=>{const{courseId:e,reviewId:t}=_t();return n.jsx(n.Fragment,{children:e&&t&&n.jsx(ht,{courseId:e,questionId:t})})}),jt=c.memo(({questionnaires:e})=>n.jsx(ft,{questionnaires:e,children:n.jsx("section",{className:"course-ratings",children:n.jsx(vt,{})})})),bt=M.section`
  position: relative;
  margin-top: 100px;
