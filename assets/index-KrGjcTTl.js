import{r as a,A as L,f as k,i as _,j as e,x as Q,T as v,s as I,ag as W,v as A,q as w,ai as G,aZ as K,a_ as Z,a0 as U,a$ as J,b0 as V,b1 as X,m as Y,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-CcQ9x6fP.js";import{T as ae}from"./Tabs-CBCXIyuc.js";import{C as ie}from"./index-B_UJVbS6.js";import{R as ne}from"./ResponsiveImage-C6DmWZXU.js";import{C as le}from"./index-BgeObjyM.js";import{C as ce}from"./index-BbSV2EzZ.js";import{R as de}from"./index-D5T86sKi.js";import{b as ue,Q as me}from"./questionnaires-CZURFNf2.js";import{u as pe}from"./useDownloadCertificate-DI2l74Ky.js";import{t as ge}from"./toast-8bhsWSTr.js";import{u as xe}from"./useRoles-Fg2Js3sb.js";import{u as H}from"./useSearchParams-2jlsD3D1.js";import{P as he}from"./index-BaRBH6h5.js";import{S as fe}from"./swiper-C1SOnM5l.js";import{S as O}from"./swiper-react-Dwa8Yg-L.js";import{C as B}from"./CourseCard-BuC1QxV6.js";import"./base-C7euzKDi.js";import"./a11y-BjMBWk3F.js";import"./index-BixcMT39.js";const Ce=({courseData:s,visible:d,onClose:t})=>{const{sendProgress:u}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:l}=_(),g=a.useCallback(async()=>{await u(s.course.id,s.progress.map(({topic_id:f})=>({topic_id:f,status:0}))),l(`/course/${s.course.id}`)},[s.course.id,s.progress,u,l]);return e.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:e.jsxs(e.Fragment,{children:[e.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),e.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),e.jsxs(W,{$gap:16,children:[e.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),e.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},je=w(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
