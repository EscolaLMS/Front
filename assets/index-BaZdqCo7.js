import{q as p,n as i,j as t,cG as B,r as n,D as b,ag as D,s as g,f as R,X as U,i as A,l,cH as T,U as H,T as y,cI as K,cJ as F,o as W,C as q,w as j}from"./index-CU_5DVq5.js";const V=p.div`
  padding: ${i?"20px":"40px"};
...
`,z=({size:e})=>{var d;const{updateAvatar:o,user:s}=n.useContext(b.EscolaLMSContext),m=n.useCallback(c=>{var a,u;const x=(u=(a=c.target)==null?void 0:a.files)==null?void 0:u[0];x&&o(x)},[o]);return t.jsxs(J,{children:[t.jsx(D.Avatar,{size:e,src:(d=s.value)==null?void 0:d.avatar,alt:""}),t.jsxs("label",{htmlFor:"fileInput",children:[t.jsx(g.Text,{className:"avatar-upload-text",size:"12",children:"Dodaj nowe zdjęcie"}),t.jsx("input",{type:"file",id:"fileInput",accept:"image/*",style:{display:"none"},onChange:m})]})]})},Y=p("aside")`
  ${i&&`
