import{r as p,h as _,i as M,k as $,l as A,q as E,j as e,T as B,m as O,n as N,L as H,f as z,o as q,C as I,B as W,M as Q}from"./index-CcQ9x6fP.js";import{R as D}from"./ResponsiveImage-C6DmWZXU.js";import{C as F}from"./index-CWHW7to5.js";import{D as y}from"./index-CPshv788.js";import{S as P}from"./swiper-react-Dwa8Yg-L.js";import{S as L}from"./swiper-C1SOnM5l.js";import{C as G}from"./CourseCard-BuC1QxV6.js";import{u as J}from"./useSearchParams-2jlsD3D1.js";import{CourseStatus as u}from"./index-KrGjcTTl.js";import{C as K}from"./index-B_UJVbS6.js";import{C as X}from"./index-BbSV2EzZ.js";import"./index-BokLS7km.js";import"./index-h6oG5SsI.js";import"./useFetchCourses-DdRttR6t.js";import"./a11y-BjMBWk3F.js";import"./index-BixcMT39.js";import"./base-C7euzKDi.js";import"./Tabs-CBCXIyuc.js";import"./index-BgeObjyM.js";import"./index-D5T86sKi.js";import"./questionnaires-CZURFNf2.js";import"./toast-8bhsWSTr.js";import"./useDownloadCertificate-DI2l74Ky.js";import"./useRoles-Fg2Js3sb.js";import"./index-BaRBH6h5.js";const Y=(o=u.ALL)=>{var R,k;const{fetchMyAuthoredCourses:a,myAuthoredCourses:i,fetchPaginatedProgress:l,paginatedProgress:n}=p.useContext(_.EscolaLMSContext),[s,c]=p.useState([]),f=M(),{setQueryParam:b}=J(),{search:S}=$(),h=new URLSearchParams(S),d=h.get("page"),g=h.get("status"),w=p.useMemo(()=>{var t,r;return o===u.AUTHORED?(t=i.list)==null?void 0:t.meta:(r=n.list)==null?void 0:r.meta},[o,(R=i.list)==null?void 0:R.meta,(k=n.list)==null?void 0:k.meta]),x=p.useCallback(t=>{let r="";switch(t){case 1:case 5:break;case 2:r="started";break;case 3:r="planned";break;case 4:r="finished";break}return r},[]);p.useEffect(()=>{l({page:d?parseInt(d):1,per_page:18,status:x(Number(g))}),(o===u.ALL||o===u.AUTHORED)&&a()},[l,o,a,d,g,x]);const j=p.useMemo(()=>{var t;return(((t=n.list)==null?void 0:t.data)||[]).reduce((r,m)=>({...r,[m.course.id?m.course.id:-1]:Math.round((m.progress||[]).reduce((T,U)=>U.status===1?T+1:T,0)/m.progress.length*100)}),{})},[n]),C=p.useCallback(t=>t.map(r=>({...r.course,courseData:r,progress:j[r.course.id?r.course.id:-1]})),[j]);return p.useEffect(()=>{var t,r,m,T;o!==u.AUTHORED?c(C(((t=n.list)==null?void 0:t.data)||[])):o===u.AUTHORED?c(((r=i.list)==null?void 0:r.data)||[]):c([...C(((m=n.list)==null?void 0:m.data)||[]),...((T=i.list)==null?void 0:T.data)||[]])},[o,n,i,C]),{coursesToMap:s,paginationMeta:w,loading:n.loading||i.loading,handlePagination:t=>{b("page",`${t}`),window==null||window.scrollTo(0,0)},redirectToCourses:()=>f.push(A.courses)}},Z=E.div`
  position: relative;
