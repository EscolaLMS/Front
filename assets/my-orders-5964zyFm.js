...
`,ee=()=>{var h,P,x,N,T,C,S,v,_,O,t,e,s,o;const{orders:n,fetchOrders:f,fetchOrderInvoice:r}=b.useContext(L.EscolaLMSContext),{t:d}=R(),[j,g]=b.useState(-1);b.useEffect(()=>{f({page:1,order_by:"created_at",order:"DESC"})},[]);const i=b.useCallback(a=>{f({page:a,order_by:"created_at",order:"DESC"})},[f]),w=b.useCallback(async a=>{g(a);try{const p=await r(a);if(p){const c=document.createElement("a");document.body.appendChild(c),c.setAttribute("href",URL.createObjectURL(new Blob([p]))),c.setAttribute("download",`${d("MyProfilePage.InvoiceTitle")} ${a}.pdf`),c.style.display="",c.click(),document.body.removeChild(c),g(-1)}}catch(p){g(-1),q(d("UnexpectedError"),"error"),console.log(p)}},[r,d]);return l.jsx(H,{title:d("MyProfilePage.OrdersHistory"),children:l.jsxs(Q,{children:[!n.loading&&((h=n.list)==null?void 0:h.data.length)===0&&l.jsx(y.Text,{children:d("MyProfilePage.OrdersEmpty")}),!n.loading&&!n.error&&n&&((P=n.list)==null?void 0:P.data)&&((x=n.list)==null?void 0:x.data.length)>0&&l.jsx(M.Orders,{mobile:U,data:(((N=n==null?void 0:n.list)==null?void 0:N.data)||[]).map(a=>{var p;return{title:l.jsx("div",{className:"name-container",children:(p=a==null?void 0:a.items)==null?void 0:p.map((c,$)=>{var m;return l.jsx(y.Text,{children:l.jsx("strong",{children:(m=c.product)==null?void 0:m.name})},$)})}),status:l.jsx(y.Text,{children:d(`OrderStatus.${a.status}`)}),price:l.jsxs(y.Text,{children:[k(a.total)," zł"]}),date:a.created_at?l.jsx(y.Text,{children:F(a.created_at)}):"",actions:l.jsx(G.Button,{mode:"outline",onClick:()=>w(a.id),loading:j===a.id,children:d("MyProfilePage.Invoice")})}})}),n.loading&&l.jsx(K,{}),Number((C=(T=n==null?void 0:n.list)==null?void 0:T.meta)==null?void 0:C.total)>Number((v=(S=n==null?void 0:n.list)==null?void 0:S.meta)==null?void 0:v.per_page)&&l.jsx(J,{total:Number((O=(_=n==null?void 0:n.list)==null?void 0:_.meta)==null?void 0:O.total),perPage:Number((e=(t=n==null?void 0:n.list)==null?void 0:t.meta)==null?void 0:e.per_page),currentPage:Number((o=(s=n==null?void 0:n.list)==null?void 0:s.meta)==null?void 0:o.current_page),onPage:i})]})})};export{ee as default};
