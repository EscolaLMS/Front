import{r as c,K as G,q as T,f as q,h as te,o as K,j as e,T as U,x as S,U as M,i as B,a0 as we,p as F,y as $,a1 as Ye,a2 as Pe,V as Q,D as je,m as $e,O as ye,a3 as ve,I as J,a4 as Je,a5 as Ze,d as j,a6 as Ce,a7 as ae,a8 as en,a9 as le,aa as nn,ab as tn,ac as z,b as sn,ad as rn,ae as on,af as an,ag as ln,ah as cn,ai as dn,aj as Ee,s as un,H as pn,ak as Ie,X as ze,al as mn,am as De,an as xn,S as gn,C as _e,L as ie,ao as hn,v as fn,ap as jn,aq as Te,M as Oe}from"./index-Bw3VKjvD.js";import{P as vn}from"./PricingCard-DNNlHXYo.js";import{u as Fe}from"./useSubscriptions-CbTeDmRq.js";import{P as Ge}from"./index--0_Z48kA.js";import{A as _n,_ as bn,P as yn,I as Cn,a as wn,O as Pn,H as Tn}from"./index-DDMOGluD.js";import{B as On}from"./index-DrFUMf6V.js";import{Q as qe,a as Me,g as Mn}from"./questionnaires-eH2jRd0n.js";import{b as Sn,a as Nn}from"./CourseCard-BBPrdX96.js";import{P as Rn}from"./index-DnlXBqnN.js";import{D as kn}from"./index-BcuCaA4X.js";import{S as An}from"./swiper-fR8L1uIA.js";import{a as Bn}from"./a11y-C8TVJ2jD.js";import{S as A}from"./index-hrqn0a4R.js";import"./useFetchCourses-BYuAwTH4.js";const Ln=n=>{const[t,s]=c.useState({data:void 0,loaded:!1,loading:!1}),{user:a,fetchCourseProgress:o,courseProgressDetails:i}=c.useContext(G.EscolaLMSContext);return c.useEffect(()=>{i.byId&&i.byId[Number(n)]&&i.byId[Number(n)].value&&s({...t,data:i.byId[Number(n)].value,loaded:!0,loading:!1})},[n,i]),c.useEffect(()=>{a!=null&&a.value&&!a.loading&&!t.loading&&!t.loaded?(s({...t,loading:!0}),o(n).catch(()=>s({...t,loaded:!0,loading:!1}))):t.loaded||s({...t,loaded:!0})},[a,t,o,n]),{progress:t}},$n=T.div`
  text-align: center;
  .modal-header {
    margin-bottom: 10px;
  }
...
`,En=({course:n})=>{var p,g;const{getCheapestSubscription:t}=Fe(),{cart:s,addToCart:a}=c.useContext(G.EscolaLMSContext),{t:o}=q(),{push:i}=te(),l=c.useCallback(()=>{var v;a(Number((v=n.product)==null?void 0:v.id)).then(()=>i(K.cart))},[(p=n.product)==null?void 0:p.id,a,i]);return e.jsxs($n,{children:[e.jsx(U.Title,{className:"modal-header",level:2,children:o("Subscriptions.GetAccess")}),e.jsx(S.Text,{children:o("Subscriptions.YouHaveTwoOptions")}),e.jsxs(M.Row,{children:[e.jsx(M.Col,{lg:6,md:12,sm:12,children:e.jsxs(Se,{className:"product-box",$isMobile:B,children:[e.jsx(U.Title,{className:"title",level:3,children:o("Buy Course")}),e.jsx("div",{className:"divider"}),e.jsx(S.Text,{className:"description",size:"13",children:n.title}),e.jsxs(S.Text,{className:"price",size:"24",bold:!0,children:[we((g=n.product)==null?void 0:g.gross_price)," zł"]}),e.jsx(F.Button,{loading:s.loading,onClick:()=>l(),children:o("Subscriptions.IPick")})]})}),(t==null?void 0:t.id)&&e.jsx(M.Col,{lg:6,md:12,sm:12,children:e.jsxs(Se,{className:"product-box",$isMobile:B,children:[e.jsx(U.Title,{className:"title",level:3,children:t==null?void 0:t.name}),e.jsx("div",{className:"divider"}),e.jsx(S.Text,{className:"description",size:"13",children:t==null?void 0:t.description}),e.jsxs(S.Text,{className:"price",size:"24",bold:!0,children:[o("From")," ",we(t==null?void 0:t.gross_price)," ","zł"]}),e.jsx(F.Button,{onClick:()=>{var v;return i((v=K)==null?void 0:v.subscriptions)},children:o("Subscriptions.IPick")})]})})]})]})},Ne=T($.Button)`
  display: block;
  margin-bottom: 10px;
`,In=({course:n,onRequestAccess:t,setModalVisible:s})=>{var m;const{t:a}=q(),{push:o}=te(),{courseAccess:i,fetchCourseAccess:l}=c.useContext(G.EscolaLMSContext),{attachProduct:p,getActiveSubscription:g}=Fe(),v=c.useMemo(()=>{var b,d;return(d=(b=i.list)==null?void 0:b.data)==null?void 0:d.find(h=>{var y;return((y=h==null?void 0:h.course)==null?void 0:y.id)===n.id})},[(m=i.list)==null?void 0:m.data,n.id]),r=c.useCallback(()=>{s(!0)},[s]),u=c.useCallback(()=>{p(n.id,"EscolaLms\\Courses\\Models\\Course").then(()=>[o(`/course/${n.id}`),l({course_id:Number(n.id),current_page:1,per_page:1})])},[p,n.id,o,l]),x=c.useMemo(()=>e.jsx(e.Fragment,{children:e.jsx(Q,{children:e.jsx($.Button,{mode:"secondary",onClick:()=>r(),children:a("Buy Course")})})}),[a,r]);return g!=null&&g.id?e.jsx($.Button,{onClick:()=>u(),mode:"secondary",children:a("Go to the course")}):v?v.status!=="approved"?e.jsxs(e.Fragment,{children:[e.jsx(Ne,{mode:"secondary",disabled:!0,children:a("CourseAccess.Pending")}),x]}):v.status==="approved"?e.jsx($.Button,{onClick:()=>o(`/course/${n.id}`),mode:"secondary",children:a("Go to the course")}):x:e.jsx(e.Fragment,{children:e.jsxs(Q,{children:[e.jsx(Ne,{mode:"secondary",onClick:t,children:a("CourseAccess.RequestAccess")}),x]})})},zn=({course:n,userOwnThisCourse:t,onRequestAccess:s})=>{var r,u;const{cart:a,user:o}=c.useContext(G.EscolaLMSContext),{t:i}=q(),{push:l}=te(),[p,g]=c.useState(!1),v=c.useMemo(()=>{var x;return(x=a==null?void 0:a.value)==null?void 0:x.items.some(m=>{var b;return Number(m.product_id)===Number((b=n.product)==null?void 0:b.id)})},[(r=n.product)==null?void 0:r.id,a]);return Ye(Number((u=o.value)==null?void 0:u.id),n)?e.jsx($.Button,{onClick:()=>l(`/course/${n.id}`),mode:"secondary",children:i("Go to the course")}):Pe(new Date(n.active_to||""))?e.jsx(S.Text,{children:i("CoursePage.IsFinished")}):v?e.jsx(e.Fragment,{children:e.jsx(Q,{children:e.jsx($.Button,{mode:"secondary",onClick:()=>l(K.cart),children:i("CoursePage.GoToCheckout")})})}):t&&Pe(new Date(n.active_from||""))?e.jsx($.Button,{onClick:()=>l(`/course/${n.id}`),mode:"secondary",children:i("Go to the course")}):t?e.jsx(S.Text,{children:i("CoursePage.NotStarted")}):o.value&&n.product?e.jsxs(e.Fragment,{children:[e.jsx(In,{course:n,onRequestAccess:s,setModalVisible:g}),e.jsx(je.Modal,{onClose:()=>g(!1),visible:p,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:800,children:e.jsx(En,{course:n})})]}):n.product?e.jsx(e.Fragment,{children:e.jsx(Q,{children:e.jsx($.Button,{onClick:()=>l(`/login?referrer=/courses/${n.id}`),mode:"secondary",children:i("Buy Course")})})}):e.jsx(S.Text,{children:i("CoursePage.UnavailableCourse")})},Dn=T.div`
  width: 100%;
  left: 0;
...
`,Yn=({author:n})=>e.jsx(M.Col,{lg:6,children:e.jsx(cn,{mobile:B,avatar:{alt:`${n.first_name} ${n.last_name}`,src:n.path_avatar?`${dn}/api/images/img?path=${n.path_avatar}`:Ee.tutorPlaceholderPath},fullName:`${n.first_name} ${n.last_name}`,description:n.bio})});var D=(n=>(n.INIT="INIT",n.LOADED="LOADED",n.LOADING="LOADING",n.ERROR="ERROR",n))(D||{});const Jn=T.div`
  display: flex;
  align-items: center;
  gap: 5px;
  p {
...
`,Lt=()=>{var w,C;const[n,t]=c.useState([]),[s,a]=c.useState(!1),[o,i]=c.useState(),{id:l}=ye(),{t:p}=q(),g=te(),v=ze(),{course:r,fetchCourse:u,fetchCourses:x,fetchCourseAccess:m,fetchQuestionnaires:b}=c.useContext($e.EscolaLMSContext),d=c.useCallback(()=>a(!1),[]),h=c.useCallback(()=>a(!0),[]),y=c.useCallback(()=>m({course_id:Number(l),current_page:1,per_page:1}),[l,m]);return c.useEffect(()=>{x({per_page:6}),l&&(u(Number(l)),y(),b(qe.COURSE,Number(l)).then(P=>P.success&&t(P.data)))},[l]),r.error?e.jsx("pre",{children:r.error.message}):e.jsxs(fn,{metaTitle:((w=r==null?void 0:r.value)==null?void 0:w.title)||"Loading",children:[r.loading&&e.jsx(e.Fragment,{children:e.jsx(Ae,{children:e.jsx(_e,{children:e.jsxs(M.Row,{children:[e.jsx(M.Col,{md:12,lg:8,children:e.jsx(vt,{})}),e.jsx(M.Col,{md:12,lg:3,offset:{lg:1},children:e.jsx(ft,{})})]})})})}),!r.loading&&r.value&&e.jsxs(e.Fragment,{children:[e.jsxs(Ae,{children:[e.jsxs(_e,{children:[!B&&e.jsx(On,{items:[e.jsx(ie,{to:K.home,children:p("Home")}),e.jsx(ie,{to:K.courses,children:p("Courses")}),e.jsx(S.Text,{size:"13",children:r.value.title})]}),e.jsxs(M.Row,{children:[e.jsxs(M.Col,{md:12,lg:8,children:[B&&e.jsx(_t,{onClick:()=>g.push(K.courses),children:e.jsx(jn,{color:v.black})}),e.jsx(Zn,{courseData:r.value}),B&&r.value&&e.jsx(Re,{course:r.value,onRequestAccess:h}),r.value.description&&Te(r.value.description)!==""&&e.jsx("section",{className:"course-description-short",children:e.jsx(Oe.MarkdownRenderer,{children:r.value.description})}),r.value.summary&&Te(r.value.summary)!==""&&e.jsx("section",{className:"course-description",children:e.jsx(Oe.MarkdownRenderer,{children:r.value.summary})}),e.jsxs("section",{className:"",children:[e.jsx(U.Title,{as:"h3",level:4,className:"title",children:p("CoursePage.Teacher")}),e.jsx(M.Row,{children:r.value&&r.value.authors.map(P=>e.jsx(Yn,{author:P}))})]}),r.value.lessons&&r.value.lessons.length>0&&e.jsx(Ve.CourseProgram,{lessons:r.value.lessons,onTopicClick:P=>i(P)}),e.jsx(mt,{questionnaires:n})]}),!B&&e.jsx(M.Col,{md:12,lg:3,offset:{lg:1},children:r.value&&e.jsx(Re,{course:r.value,onRequestAccess:h})})]})]}),e.jsx(gt,{relatedProducts:(C=r.value.product)==null?void 0:C.related_products})]}),e.jsxs(je.Modal,{onClose:()=>i(void 0),visible:!!o,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,bodyStyle:{maxHeight:"80vh",overflow:"auto"},children:[e.jsx(Be,{}),o&&e.jsx(Kn,{topic:o})]}),e.jsxs(je.Modal,{onClose:d,visible:s,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:600,children:[e.jsx(Be,{}),e.jsx(Qe.ModalCourseAccess,{course:r.value,onCancel:d,onSuccess:()=>{y(),d()}})]})]})]})};export{Lt as default};
