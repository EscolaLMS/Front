import{b as E,V as M,r as i,n as k,j as e,q as x,k as n,Y as c,L as m,az as N,z as d,Q as u,T as b,h as p,i as L,p as v,aA as C,I as T,aB as _,m as I,aC as R,aD as h,aE as z,aF as B,aG as A,aq as S,aj as D,ak as q,x as G,C as W}from"./index-icc2FodH.js";import{P as F}from"./index-CCW5TaqJ.js";import{a as O}from"./PricingCard-yrZoszrc.js";import{P as U}from"./index-DxVRNWdS.js";import{B as V}from"./index-Cci-gLDq.js";const H=E.createContext({}),Q=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(H.Provider,{value:{},children:t})},Y=x.div`
  width: 100%;
  left: 0;
