import{b as cn,r as b,h as dn,k as G,i as un,j as r,q as X,n as D,d as h,E as pn,a5 as gn,aB as xn,aC as fn,G as hn,aD as mn,F as bn,a6 as vn,D as J,f as A,X as K,T as wn,S as jn,w as H,o as yn,C as Cn}from"./index-CBf-QksF.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-DESu-F-h.js";import{F as kn,S as Tn}from"./index-BPF7oUsr.js";import{W as On}from"./index-DpXvkjCg.js";import{P as Pn}from"./index-C3JxcG_U.js";import"./swiper-react-qtwdYFOz.js";import"./ResponsiveImage-BnPBXGWb.js";import"./index-DSumW0cD.js";import"./index-BRT4m0w7.js";const N=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(N.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
