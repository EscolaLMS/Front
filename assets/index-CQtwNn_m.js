import{f as p,j as e,ak as F,o as R,az as H,r as l,A as j,v as B,l as S,T as C,q as T,s as m,as as q,k as r,at as u,au as A,av as G,aw as U,ai as L,h as D,i as w,a2 as J,p as h,N as $,ay as Y,Y as K,C as Q,G as V,L as X,aE as Z}from"./index-OGDo-hkl.js";import{C as b,T as O}from"./index-CET3ywVj.js";import{B as ee}from"./index-ygSpdREt.js";import{a as te}from"./ResponsiveImage-dgTLmURN.js";import{P as se}from"./PricingCard-Cn_zAan-.js";import{W as ae}from"./index-BOm-Grc0.js";import{P as oe}from"./index-BAF1aJt1.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&F(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(R.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(H,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(B,{to:S.home,children:a("Home")}),e.jsx(B,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
