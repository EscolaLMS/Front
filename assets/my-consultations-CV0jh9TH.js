import{c as q,a as I,a9 as G,j as t,J as v,o as P,g as W,q as h,L as K,as as X,X as V,D as k,aR as N,aS as J,aT as z,aU as $,aV as O,ar as Y,ah as Z,aW as ee,p as te,aX as se,aY as re,aZ as Q,w as ae,U as ne,k as ie,C as oe}from"./index-R-PjQ35V.js";import{r as n}from"./sentry-DZqhWugq.js";import{T as de}from"./Tabs-CKNBOnHX.js";import{C as me}from"./index-BNsfTNWF.js";import{D as b,a as A}from"./index-UnQ7tm0g.js";import{P as ce,C as le,a as fe}from"./index-D0OOIQzo.js";import{g as xe}from"./katex-D1m830yy.js";import{C as H}from"./CourseCard-CWA91XIq.js";import{u as pe}from"./useRoles-CKVU39CR.js";import{a as ue}from"./index-BCFykWwE.js";import{M as Ce,J as he,E as je}from"./index-Bvr56ZZD.js";import{Q as F}from"./questionnaire-CXWDgbJ4.js";import{Q as ge}from"./index-BXDO7vh9.js";import"./lodash-Bu-jC-fW.js";import"./index-CdS33Owk.js";import"./index-B7vnVY_d.js";import"./questionnaires-Dkn_TbEJ.js";import"./useDownloadCertificate-BX9MLev_.js";import"./base-Bd27snqx.js";import"./index-DNUVyc2-.js";import"./swiper-DAktOd0t.js";import"./swiper-CphuuvCl.js";import"./index-DIxmv6s7.js";const ye=({type:e})=>{var T;const{userConsultations:a,fetchUserConsultations:o,token:i}=n.useContext(q.EscolaLMSContext),{t:l}=I(),[d,x]=n.useState([]),j=n.useMemo(()=>{var u;const r=((u=a.list)==null?void 0:u.data.filter(m=>e===S.STARTED||e===S.UPCOMING?m.in_coming||m.is_started:m.is_ended))||[];return Array.from(new Map(r.map(m=>[m.id,m])).values())},[e,(T=a.list)==null?void 0:T.data]),s=n.useCallback(async(r,f)=>{try{const m=await(await fetch(`${G}/api/consultations/me?ids[]=${r}`,{headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`}})).json();if(m.success&&m.data.length>0){const g=m.data.findIndex(c=>(c==null?void 0:c.consultation_term_id)===f);x(c=>{const y=c.findIndex(C=>(C==null?void 0:C.consultation_term_id)===f);return y!==-1&&g!==-1&&(c[y]=m.data[g]),[...c]})}}catch(u){console.error(u)}},[i]),E=n.useCallback(()=>{d.forEach(r=>{!r.is_started&&!r.is_ended&&(r==null?void 0:r.consultation_term_id)!==void 0&&s(r==null?void 0:r.id,r==null?void 0:r.consultation_term_id)})},[d,s]);return n.useEffect(()=>{o()},[e,o]),n.useEffect(()=>{x([]),x(j);const r=setInterval(()=>{E()},3e4);return()=>{x([]),clearInterval(r)}},[e,j,E]),t.jsx(ce,{children:t.jsx(v.Row,{style:{gap:"30px 0"},children:a.loading?Array.from({length:8}).map((r,f)=>t.jsx(v.Col,{md:3,children:t.jsx(H,{})},`skeleton-card-${f}`)):d.length===0?t.jsx(P.Text,{style:{paddingLeft:W?20:40},children:l("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:d.map(r=>t.jsx(v.Col,{xs:12,md:6,lg:3,children:t.jsx(le,{consultation:r})},r.id))})})})},w=n.memo(ye),_e=h.div`
  .course-section {
    margin-top: 0px;
  }
...
//# sourceMappingURL=my-consultations-CV0jh9TH.js.map
