import{f as p,j as e,al as A,T as D,aE as F,r as l,A as j,L,l as S,s as C,q as T,w as m,ax as H,n as r,ay as u,az as q,aA as J,aB as G,aj as $,h as R,i as U,Z as w,v as h,J as k,aD as Z,N as K,C as Q,D as V,o as X,aJ as Y}from"./index-qD7U5zMV.js";import{C as b,T as O}from"./index-CUgz6tbi.js";import{B as ee}from"./index-Dzgask-Z.js";import{a as te}from"./ResponsiveImage-biK-hrc-.js";import{P as se}from"./PricingCard-knAeA_PI.js";import{W as ae}from"./index-OZK1fHE8.js";import{P as oe}from"./index-CPQe3EBT.js";import"./toast-lasjBFrg.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&A(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(D.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(F,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(L,{to:S.home,children:a("Home")}),e.jsx(L,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
