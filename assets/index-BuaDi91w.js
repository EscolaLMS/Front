import{q as p,n as i,j as t,cn as B,r as n,h as b,co as R,G as g,f as D,X as U,m as L,o as l,ae as T,U as H,T as y,cp as K,cq as q,L as F,C as W,i as j}from"./index-DaafzRP_.js";const V=p.div`
  padding: ${i?"20px":"40px"};
...
`,z=({size:e})=>{var d;const{updateAvatar:o,user:s}=n.useContext(b.EscolaLMSContext),m=n.useCallback(c=>{var a,u;const x=(u=(a=c.target)==null?void 0:a.files)==null?void 0:u[0];x&&o(x)},[o]);return t.jsxs(Y,{children:[t.jsx(R.Avatar,{size:e,src:(d=s.value)==null?void 0:d.avatar,alt:""}),t.jsxs("label",{htmlFor:"fileInput",children:[t.jsx(g.Text,{className:"avatar-upload-text",size:"12",children:"Dodaj nowe zdjęcie"}),t.jsx("input",{type:"file",id:"fileInput",accept:"image/*",style:{display:"none"},onChange:m})]})]})},Z=p("aside")`
  ${i&&`
...
`,re=({children:e,title:o,withTabs:s,actions:m})=>{const{user:d}=n.useContext(b.EscolaLMSContext),c=L();return n.useEffect(()=>{!d.loading&&!d.value&&c.push(l.login)},[]),t.jsx(F,{metaTitle:o,children:t.jsx(ae,{children:t.jsx(W,{children:t.jsxs(j.Row,{children:[t.jsxs(j.Col,{lg:9,children:[t.jsx(te,{title:o,withTabs:s,actions:m}),e]}),t.jsx(j.Col,{lg:3,children:t.jsx(Q,{})})]})})})})};export{re as P};
