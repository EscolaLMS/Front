import{b as cn,r as b,l as dn,s as G,i as un,j as r,q as X,o as L,d as h,E as pn,a4 as gn,ay as xn,az as fn,G as hn,aA as mn,F as bn,a5 as vn,D as J,f as D,X as K,T as wn,S as jn,h as H,L as yn,m as Cn}from"./index-B8t7bxZo.js";import{q as M}from"./base-CumTa13P.js";import{C as _n}from"./index-ClUiBIQr.js";import{F as kn,S as Tn}from"./index-BBf4ZTLG.js";import{W as On}from"./index-10nf7mM-.js";import{P as Pn}from"./index-CrC3Z2ZD.js";import"./swiper-react-CojPz2DI.js";import"./Search-CTLKKOal.js";import"./ResponsiveImage-B7bcvD5e.js";import"./index-Dp8bV9hL.js";import"./index-BxmKzVC8.js";const N=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(N.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
...
`])),function(n){var e=n.theme;return(0,W.getStylesBasedOnTheme)(e.mode,e.white,e.gray1)},function(n){var e=n.theme;return(0,W.getStylesBasedOnTheme)(e.mode,e.white,e.gray1)},function(n){var e=n.theme;return(0,W.getStylesBasedOnTheme)(e.mode,e.white,e.gray1)}),on=(0,v.default)("div")(R||(R=l([`
  .tags-collapse {
    position: absolute;
    right: 0;
    top: 0;
