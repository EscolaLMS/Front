import{b as cn,r as b,h as dn,n as G,i as un,j as r,q as X,k as D,d as h,D as pn,a6 as gn,aB as xn,aC as fn,F as hn,aD as mn,E as bn,a7 as vn,A as J,f as A,X as K,o as wn,S as jn,s as H,L as yn,C as Cn}from"./index-OGDo-hkl.js";import{q as M}from"./base-C7euzKDi.js";import{C as _n}from"./index-DbvMYWQb.js";import{F as kn,S as Tn}from"./index-yqcya3Qo.js";import{W as On}from"./index-D0AkaTA5.js";import{P as Pn}from"./index-D-Ty7NYk.js";import"./swiper-react-LoObXzUJ.js";import"./ResponsiveImage-dgTLmURN.js";import"./index-CkkSfJi5.js";import"./index-Cb7SBqEa.js";const L=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(L.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
    ...
    h1 {
      ...
      margin-bottom: ${({filters:a})=>D?0:a&&Object.keys(a).length>1?"35px":a&&Object.keys(a).length===1&&"page"in a||a===void 0?"-35px":"35px"};
      transition: margin-bottom 0.5s ease-out;
    }
  `,{params:t}=b.useContext(L);return r.jsx(l,{filters:t,children:i})},Wn=X("div")`
  display: flex;
  row-gap: 30px;
  flex-wrap: wrap;
