import{b as J,H as K,r as o,l as L,j as e,D as m,f as h,w as A,k as v,v as p,q as E,h as x,at as S,o as C,au as b,af as Q,ag as Y,ah as ee,i as te,Z as q,T as u,B as j,N,av as se,a0 as ie,a1 as ae,ac as re,ad as ne,am as oe,aw as le,X as de,ax as ce,ar as xe,L as me,m as pe}from"./index-B8t7bxZo.js";import{P as ue}from"./index-fXyhVg0R.js";import{B as he}from"./index-TCOD3AvE.js";import{a as Z}from"./ResponsiveImage-B7bcvD5e.js";import{f as ge}from"./date-DjWK0l4x.js";import{P as z}from"./PricingCard-C-MVvD2_.js";import{f as X}from"./index-B3TTgJzd.js";import{P as je}from"./index-PJPEAvUT.js";import{D as Ee}from"./index-DPnrUbDW.js";import{C as _}from"./index-CKt0GIUE.js";import{E as w}from"./index-Bou-aDfP.js";import"./app-B2E7767C.js";import"./index-Dp8bV9hL.js";import"./index-BxmKzVC8.js";import"./index-BAzXgDWl.js";const ve=J.createContext({}),Ce=({children:t})=>{const{id:s}=K(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(he,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
...
`,Ae=()=>{const{settings:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return e.jsx(Ne,{children:e.jsxs("section",{className:"event-companies",children:[e.jsx(p.Text,{children:e.jsx("strong",{children:s("CoursePage.CompaniesTitle")})}),e.jsx("div",{className:"companies-row",children:t&&t.value.courseLogos&&Object.values(t.value.courseLogos).map((i,n)=>{var a;return e.jsx("div",{className:"single-company",children:e.jsx(Z,{path:((a=t==null?void 0:t.value)==null?void 0:a.courseLogos[`logo${n+1}`])||"",srcSizes:[100,200,300]})},n)})})]})})},Le=()=>{var n;const{stationaryEvent:t}=o.useContext(L.EscolaLMSContext),{t:s}=h(),i=(n=t.value)==null?void 0:n.description;return i?e.jsx(e.Fragment,{children:i&&oe(i)!==""&&e.jsxs("section",{className:"course-description-short with-border",children:[e.jsx(u.Title,{level:4,children:s("CoursePage.CourseDescriptionTitle")}),e.jsx(le,{children:i})]})}):null},De=E.div`
  section {
    margin-bottom: 45px;
    &.with-border {
      padding-bottom: 45px;
...
`,He={arrows:!1,infinite:!0,speed:500,draggable:!1,slidesToShow:4,slidesToScroll:4,responsive:[{breakpoint:1201,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:768,settings:{draggable:!0,slidesToShow:2,slidesToScroll:2}},{breakpoint:576,settings:{slidesToShow:1,centerMode:!0,slidesToScroll:1}}]},W=({nodes:t,sliderSettings:s=He})=>{const[i]=o.useState(!0);return e.jsx(ke,{children:e.jsx("div",{children:e.jsx(xe.Slider,{settings:{...s,dots:i,onSwipe:()=>{const n=document.querySelectorAll('.slick-slide[aria-hidden="true"]');document.querySelectorAll('.slick-slide[aria-hidden="false"]').forEach(r=>r.removeAttribute("aria-modal")),n.forEach(r=>r.setAttribute("aria-modal","true"))},onInit:()=>{document.querySelectorAll('.slick-slide[aria-hidden="true"]').forEach(a=>a.setAttribute("aria-modal","true"))}},dotsPosition:"top right",children:t})})})},Oe=()=>{var n;const{stationaryEvents:t}=o.useContext(m.EscolaLMSContext),{t:s}=h(),i=(n=t.list)==null?void 0:n.data;return e.jsx(Re,{children:e.jsx("section",{className:"event-related-events",children:e.jsxs(x.Container,{children:[e.jsxs("div",{className:"content-container",children:[e.jsx(u.Title,{level:4,as:"h2",children:s("CoursePage.RelatedCoursesTitle")}),i&&i.length>4?e.jsx(W,{nodes:i.map(a=>e.jsx(_,{children:e.jsx(w,{event:a})},a.id))}):e.jsx(x.Row,{style:{marginTop:"30px",rowGap:"60px"},children:i==null?void 0:i.map(a=>e.jsx(x.Col,{md:6,lg:3,children:e.jsx(_,{children:e.jsx(w,{event:a})})},a.id))})]}),e.jsxs("div",{className:"content-container",children:[e.jsx(u.Title,{level:4,as:"h2",children:s("CoursePage.InterestTitle")}),i&&i.length>4?e.jsx(W,{nodes:i.map(a=>e.jsx(_,{children:e.jsx(w,{event:a})},a.id))}):e.jsx(x.Row,{style:{marginTop:"30px",rowGap:"60px"},children:i==null?void 0:i.map(a=>e.jsx(x.Col,{md:6,lg:3,children:e.jsx(_,{children:e.jsx(w,{event:a})})},a.id))})]})]})})})},et=()=>{var s;const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext);return e.jsx(me,{metaTitle:(s=t.value)==null?void 0:s.name,children:e.jsxs(Ce,{children:[e.jsx(pe,{children:e.jsx(Ue,{})}),e.jsx(Oe,{})]})})};export{et as default};
