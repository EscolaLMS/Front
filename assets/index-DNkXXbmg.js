import{aM as b,g as l,f as h,j as e,q as m,n,an as u,r as x,D as y,s as k,Q as j}from"./index-Ba_2FdXr.js";var w=b();const C=l(w),v=({onSubmit:a})=>{const{t}=h();return e.jsx(C,{placeholder:t("Filters.Search"),onSubmit:a})},S=m("div")`
  display: flex;
