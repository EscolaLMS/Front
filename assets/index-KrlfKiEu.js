import{q as d,j as s,n as r,r as o,D as p,f as v,i as y,T as $,U as k,cC as g,s as c,l as C}from"./index-pPbH7tDJ.js";const T=d.div`
  padding: 11px 6px;
  background: ${({theme:e})=>e.mode==="dark"?e.dm__cardBackgroundColor:e.white};
  border-radius: ${({theme:e})=>e.cardRadius}px;
`,m=({children:e})=>s.jsx(T,{children:e}),w=d.div`
  h2 {
    margin-bottom: 10px;
  }
`,h=d("aside")`
