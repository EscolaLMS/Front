import{b as M,G as E,r as n,h as y,j as e,q as b,s as c,v as m,aK as N,T as d,A as x,k as o,o as v,f as u,i as L,l as j,aF as C,N as w,am as I,Y as R,as as B,at as p,au as _,av as $,aw as z,L as A,C as D}from"./index-DuLQ5VKT.js";import{P as G}from"./index-B17mMKeX.js";import{a as W}from"./PricingCard-CZ6W3Msx.js";import{P as q}from"./index-Csz7Orhm.js";import{D as F}from"./index-BPm157He.js";import{B as H}from"./index-YzPqBO_p.js";import{a as O}from"./ResponsiveImage-D9-kAHzA.js";import{C as U,T as K}from"./index-Bw9XhifM.js";const V=M.createContext({}),Y=({children:s})=>{const{id:a}=E(),{fetchProduct:t}=n.useContext(y.EscolaLMSContext);return n.useEffect(()=>{a&&t(Number(a))},[t,a]),e.jsx(V.Provider,{value:{},children:s})};var i=(s=>(s.Consultation="App\\Models\\Consultation",s.StationaryEvent="App\\Models\\StationaryEvent",s.Course="App\\Models\\Course",s.Webinar="App\\Models\\Webinar",s))(i||{});const J=s=>s.reduce((a,t)=>{const r=t.productable_type,l=a[r]??[];return{...a,[r]:[...l,t]}},{}),Q=b(c.Col)`
  border: 1px solid ${({theme:s})=>s.primaryColor};
  margin: 4px auto;
  padding: 4px;
`,h=({products:s,linkTo:a})=>e.jsx(Q,{lg:12,children:s.map(t=>e.jsx(m,{to:`${a}/${t.productable_id}`,children:e.jsx(N.Tag,{children:e.jsx(d.Text,{size:"12",children:t.name})})}))}),X=b(c.Row)`
  width: 100%;
  margin: 0 auto !important;
`,Z=()=>{var t;const{product:s}=n.useContext(x.EscolaLMSContext),a=n.useMemo(()=>{var r;return J(((r=s==null?void 0:s.value)==null?void 0:r.productables)||[])},[(t=s==null?void 0:s.value)==null?void 0:t.productables]);return e.jsxs(X,{children:[a[i.Consultation]&&e.jsx(h,{linkTo:"/consultations",products:a[i.Consultation]}),a[i.Webinar]&&e.jsx(h,{linkTo:"/webinar",products:a[i.Webinar]}),a[i.StationaryEvent]&&e.jsx(h,{linkTo:"/event",products:a[i.StationaryEvent]}),a[i.Course]&&e.jsx(h,{linkTo:"/courses",products:a[i.Course]})]})},ee=({title:s})=>o?e.jsx(v.Title,{level:5,as:"h5",children:s}):e.jsx(v.Title,{level:4,as:"h2",children:s}),se=({product:s})=>{var k;const{cart:a,addToCart:t,user:r}=n.useContext(x.EscolaLMSContext),{t:l}=u(),{push:P}=L(),g=(k=r.value)==null?void 0:k.id,f=n.useMemo(()=>{var T;return(T=a==null?void 0:a.value)==null?void 0:T.items.some(S=>Number(S.product_id)===Number(s.id))},[s.id,a]);return n.useMemo(()=>g&&s.owned?e.jsx(d.Text,{size:"12",children:l("PackagePage.ProductOwned")}):f?e.jsx(m,{to:j.cart,children:e.jsx(C,{mode:"secondary",block:o,children:l("EventPage.GoToCheckout")})}):g&&s.buyable&&!s.owned?e.jsx(C,{loading:a.loading,mode:"secondary",block:o,onClick:()=>t(s.id).then(()=>P(j.cart)),children:l("Buy now")}):!s||g&&!s.buyable?e.jsx(d.Text,{size:"12",children:l("EventPage.UnavailableEvent")}):e.jsx(m,{to:`/login?referrer=/package/${s.id}`,children:e.jsx(C,{mode:"secondary",block:o,children:l("Buy now")})}),[t,a.loading,s,f,P,l,g])},ae=()=>{const{product:s}=n.useContext(x.EscolaLMSContext),{t:a}=u(),t=s.value;return t?e.jsx(F,{children:e.jsxs(W,{mobile:o,children:[e.jsx(ee,{title:t.name}),e.jsxs("div",{className:o?"pricing-card-footer":"",children:[e.jsx("div",{children:e.jsx(q,{price:t.price,oldPrice:t.price_old,taxRate:t.tax_rate})}),e.jsxs("div",{children:[e.jsx(se,{product:t}),!o&&e.jsxs(e.Fragment,{children:[e.jsxs(d.Text,{size:"12",children:[" ",a("EventPage.30Days")]}),e.jsxs(d.Text,{size:"12",children:[" ",a("PackagePage.PackageIncludes")]}),e.jsx(Z,{}),e.jsxs("div",{className:"pricing-card-features",children:[t.duration&&e.jsx(w.IconText,{icon:e.jsx(I,{}),text:`${a("Duration")}: ${t.duration}`}),t.users_count&&e.jsx(w.IconText,{icon:e.jsx(R,{}),text:`${a("Students")}: ${t.users_count}`})]})]})]})]})]})}):null},te=()=>{const{product:s}=n.useContext(x.EscolaLMSContext),{t:a}=u();return s.value?e.jsx(H,{items:[e.jsx(m,{to:j.home,children:a("Home")}),e.jsx(m,{to:j.packages,children:a("Menu.Packages")}),e.jsx(d.Text,{size:"12",children:s.value.name})]}):null},ne=b.div`
  .package-main-info {
    .image-wrapper {
...
`,le=()=>{const{product:s}=n.useContext(x.EscolaLMSContext),{t:a}=u();return s.loading||!s.value?e.jsx(G,{}):e.jsx(ie,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(te,{}),e.jsx(oe,{}),e.jsx(U,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(re,{}),e.jsx(K,{title:a("PackagePage.TutorsSectionTitle"),users:s.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(ae,{})})]})})},be=()=>{var a;const{product:s}=n.useContext(x.EscolaLMSContext);return e.jsx(A,{metaTitle:(a=s.value)==null?void 0:a.name,children:e.jsx(Y,{children:e.jsx(D,{children:e.jsx(le,{})})})})};export{be as default};
