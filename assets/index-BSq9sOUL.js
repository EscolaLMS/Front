import{r as a,A as L,f as k,i as _,j as e,x as Q,T as v,s as I,ag as W,v as A,q as w,ai as G,a_ as K,a$ as J,a0 as U,b0 as V,b1 as X,b2 as Y,m as Z,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-qD7U5zMV.js";import{T as ae}from"./Tabs-B25S27H0.js";import{C as ie}from"./index-DDOwUuXl.js";import{R as ne}from"./ResponsiveImage-biK-hrc-.js";import{C as le}from"./index-a7XYl9zz.js";import{C as ce}from"./index-C7NF1b26.js";import{R as de}from"./index-BBFLA_ni.js";import{b as ue,Q as me}from"./questionnaires-C-a5RkfO.js";import{u as pe}from"./useDownloadCertificate-rfsH6aun.js";import{t as ge}from"./toast-lasjBFrg.js";import{u as xe}from"./useRoles-BjiWK9L0.js";import{u as H}from"./useSearchParams-CXFpqUDw.js";import{P as he}from"./index-BLDBlx3b.js";import{S as fe}from"./swiper-CIn4xG8b.js";import{S as O}from"./swiper-react-BDSdVK4P.js";import{C as B}from"./CourseCard-B0cTijnI.js";import"./base-C7euzKDi.js";import"./a11y-DaslWFvY.js";import"./index-dT5Ynv3g.js";const Ce=({courseData:s,visible:d,onClose:t})=>{const{sendProgress:u}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:l}=_(),g=a.useCallback(async()=>{await u(s.course.id,s.progress.map(({topic_id:f})=>({topic_id:f,status:0}))),l(`/course/${s.course.id}`)},[s.course.id,s.progress,u,l]);return e.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:e.jsxs(e.Fragment,{children:[e.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),e.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),e.jsxs(W,{$gap:16,children:[e.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),e.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},je=w(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
