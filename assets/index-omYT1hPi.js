import{b,r as i,h as S,n as v,i as w,j as e,q as C,k as u,f as E,o as P,X as F,S as N,s as j,A as $,L as k,C as L}from"./index-DuLQ5VKT.js";import{q as f}from"./base-C7euzKDi.js";import{C as T}from"./index-BxcpBZEY.js";import{C as _}from"./index-btG5_-2F.js";import{F as H,S as M}from"./index-COzuPSBa.js";import{E as q}from"./index-lMPDo6hl.js";import{P as R}from"./index-On7EuCy6.js";import"./swiper-react-F7bwAxV3.js";import"./ResponsiveImage-D9-kAHzA.js";import"./index-PVNoMdOp.js";import"./index-C7thBZXl.js";import"./index-zkd_jZQt.js";const g=b.createContext({}),y=(a={})=>f.stringify(a),A=({children:a})=>{const{fetchStationaryEvents:r,stationaryEvents:s,fetchCategories:t}=i.useContext(S.EscolaLMSContext),n=v(),{push:c}=w();i.useEffect(()=>{t()},[]);const[o,p]=i.useState(),m=(l={})=>({page:1,per_page:8,...l});return i.useEffect(()=>{c(`${n.pathname}?${y(o)}`)},[o,n.pathname]),i.useEffect(()=>{if(n.search&&n.search.split("?")[1]!==y(o)){const l=f.parse(n.search);p(l),r(l||{})}else r(m(o))},[n.search]),e.jsx(g.Provider,{value:{params:o,setParams:p,events:s},children:a})},I=({children:a})=>{const r=C("div")`
