import{b,r as i,h as w,k as v,i as S,j as e,q as C,n as u,f as E,T as P,X as F,S as N,w as j,A as T,o as $,C as k}from"./index-qD7U5zMV.js";import{q as f}from"./base-C7euzKDi.js";import{C as _}from"./index-Bl4dds4u.js";import{C as H}from"./index-CGeCyM62.js";import{F as L,S as M}from"./index-B1V8zOsD.js";import{E as q}from"./index-D_7Rw73N.js";import{P as R}from"./index-BLDBlx3b.js";import"./swiper-react-BDSdVK4P.js";import"./ResponsiveImage-biK-hrc-.js";import"./index-DDOwUuXl.js";import"./index-C1C2p6PT.js";import"./index-C7NF1b26.js";const g=b.createContext({}),y=(a={})=>f.stringify(a),A=({children:a})=>{const{fetchStationaryEvents:r,stationaryEvents:s,fetchCategories:t}=i.useContext(w.EscolaLMSContext),n=v(),{push:c}=S();i.useEffect(()=>{t()},[]);const[o,p]=i.useState(),m=(l={})=>({page:1,per_page:8,...l});return i.useEffect(()=>{c(`${n.pathname}?${y(o)}`)},[o,n.pathname]),i.useEffect(()=>{if(n.search&&n.search.split("?")[1]!==y(o)){const l=f.parse(n.search);p(l),r(l||{})}else r(m(o))},[n.search]),e.jsx(g.Provider,{value:{params:o,setParams:p,events:s},children:a})},I=({children:a})=>{const r=C("div")`
