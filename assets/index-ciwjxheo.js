import{r,A as $,f as k,i as F,j as t,w as q,o as N,T as _,ac as V,p as L,q as R,ae as Y,S as K,X as W,I as Z,k as B,v as O,K as U,U as ee,N as te,h as se,n as oe,s as Q,l as ne,d as M,D as re,F as ae,aO as ie}from"./index-Blo-PJs7.js";import{T as le}from"./Tabs-QCP9RYPA.js";import{C as ce}from"./index-DbWAbFNo.js";import{C as de}from"./index-BRHuAp1f.js";import{R as ue}from"./ResponsiveImage-Dt4SFaY6.js";import{C as me}from"./index-DdWhG39_.js";import{C as pe}from"./index-Cp2AHIQh.js";import{R as xe}from"./index-DLmsBaZw.js";import{g as ge,r as he}from"./index-UKkASopu.js";import{b as fe,Q as je}from"./questionnaires-S4NsydWZ.js";import{P as ye}from"./index-UkG7utAr.js";import{u as be}from"./useRoles-BNlyGwIL.js";import{u as G}from"./useSearchParams-DfBLlirt.js";import{P as Ce}from"./index-C2K0YxVp.js";import"./app-B2E7767C.js";import"./date-Dq-o8tMk.js";import"./base-C7euzKDi.js";const Pe=({courseData:e,visible:s,onClose:o})=>{const{sendProgress:a}=r.useContext($.EscolaLMSContext),{t:n}=k(),{push:l}=F(),p=r.useCallback(async()=>{await a(e.course.id,e.progress.map(({topic_id:b})=>({topic_id:b,status:0}))),l(`/course/${e.course.id}`)},[e.course.id,e.progress,a,l]);return t.jsx(q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:s,onClose:o,children:t.jsxs(t.Fragment,{children:[t.jsx(N.Title,{level:4,children:n("ResetProgressModal.Continue")}),t.jsxs(_.Text,{children:[" ",n("ResetProgressModal.RestartCourse")]}),t.jsxs(V,{$gap:16,children:[t.jsx(L.Button,{mode:"primary",onClick:p,children:n("ResetProgressModal.WantContinue")}),t.jsx(L.Button,{mode:"primary",onClick:o,children:n("ResetProgressModal.Cancel")})]})]})})},ve=R(Y)`
  gap: 6px;
  margin: 0;
  width: 100%;
