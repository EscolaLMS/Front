...
`,We=({title:e,children:t,active:n,onClick:a})=>{const[i,s]=z.useState(n||!1);return r.jsxs(kt,{children:[r.jsx("div",{className:"collapse-title",children:r.jsx(Ge,{name:e,label:r.jsx("strong",{children:e}),checked:n||i,onChange:()=>[s(!i),a&&a()]})}),(n||i)&&r.jsx("div",{className:"collapse-content",children:t})]})},Tt=G.div`
  .input-wrapper {
...
`,Kt=()=>{var l,c,k,w,_;const{config:e}=z.useContext(tt.EscolaLMSContext),t=C=>Et(C),n=(c=(l=e==null?void 0:e.value)==null?void 0:l.escolalms_payments)==null?void 0:c.drivers,a=(k=n==null?void 0:n.stripe)==null?void 0:k.publishable_key,i=Ee(),s=ke.getFontFromTheme(i),o=(_=(w=e==null?void 0:e.value)==null?void 0:w.escolalms_payments)==null?void 0:_.default_gateway;if(o==="Przelewy24")return r.jsx(_e,{children:r.jsx(Ot,{})});if(o==="Stripe")return r.jsx(_e,{children:r.jsx(Be,{stripe:t(a),options:{fonts:[{cssSrc:s.links[0]}]},children:r.jsx(Rt,{stripeKey:a})})})};export{Kt as default};
