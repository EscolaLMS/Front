import{q as c,j as s,n as r,r as a,D as x,f as j,i as f,T as v,U as y,cy as u,s as i,l as $}from"./index-BwDDCa5l.js";const k=c.div`
  padding: 11px 6px;
  background: ${({theme:e})=>e.mode==="dark"?e.dm__cardBackgroundColor:e.white};
  border-radius: ${({theme:e})=>e.cardRadius}px;
`,p=({children:e})=>s.jsx(k,{children:e}),w=c.div`
  h2 {
    margin-bottom: 10px;
  }
`,g=c("aside")`
