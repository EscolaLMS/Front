import{r as p,h as _,i as M,k as $,l as A,q as E,j as e,T as B,m as O,n as N,L as H,f as z,o as q,C as I,B as W,M as Q}from"./index-DFLxrXjz.js";import{R as D}from"./ResponsiveImage-DTtglx1x.js";import{C as F}from"./index-B9tYNgFE.js";import{D as y}from"./index-ChRL-jAD.js";import{S as P}from"./swiper-react-B78FQ3Jo.js";import{S as L}from"./swiper-BkFuU53M.js";import{C as G}from"./CourseCard-BJfuI2Xc.js";import{u as J}from"./useSearchParams-B4M0tKQi.js";import{CourseStatus as u}from"./index-DdUWeC2f.js";import{C as K}from"./index-DeLg1i6n.js";import{C as X}from"./index-DusIoz3Z.js";import"./index-7ZZxhrD8.js";import"./index-CXHzztkv.js";import"./useFetchCourses-BOamD6Om.js";import"./a11y-Ck2cbnC9.js";import"./index-CTnSS98m.js";import"./base-C7euzKDi.js";import"./Tabs-B4QJrvWg.js";import"./index-DBIqiG2E.js";import"./index-cBYSkTIa.js";import"./questionnaires-DOvOndsg.js";import"./toast-Bspdnwd0.js";import"./useDownloadCertificate-DURE7IJp.js";import"./useRoles-_Zzxr2h8.js";import"./index-B8NC1KIp.js";const Y=(o=u.ALL)=>{var R,k;const{fetchMyAuthoredCourses:a,myAuthoredCourses:i,fetchPaginatedProgress:l,paginatedProgress:n}=p.useContext(_.EscolaLMSContext),[s,c]=p.useState([]),f=M(),{setQueryParam:S}=J(),{search:b}=$(),h=new URLSearchParams(b),d=h.get("page"),g=h.get("status"),v=p.useMemo(()=>{var t,r;return o===u.AUTHORED?(t=i.list)==null?void 0:t.meta:(r=n.list)==null?void 0:r.meta},[o,(R=i.list)==null?void 0:R.meta,(k=n.list)==null?void 0:k.meta]),x=p.useCallback(t=>{let r="";switch(t){case 1:case 5:break;case 2:r="started";break;case 3:r="planned";break;case 4:r="finished";break}return r},[]);p.useEffect(()=>{l({page:d?parseInt(d):1,per_page:18,status:x(Number(g))}),(o===u.ALL||o===u.AUTHORED)&&a()},[l,o,a,d,g,x]);const j=p.useMemo(()=>{var t;return(((t=n.list)==null?void 0:t.data)||[]).reduce((r,m)=>({...r,[m.course.id?m.course.id:-1]:Math.round((m.progress||[]).reduce((T,U)=>U.status===1?T+1:T,0)/m.progress.length*100)}),{})},[n]),C=p.useCallback(t=>t.map(r=>({...r.course,courseData:r,progress:j[r.course.id?r.course.id:-1]})),[j]);return p.useEffect(()=>{var t,r,m,T;o!==u.AUTHORED?c(C(((t=n.list)==null?void 0:t.data)||[])):o===u.AUTHORED?c(((r=i.list)==null?void 0:r.data)||[]):c([...C(((m=n.list)==null?void 0:m.data)||[]),...((T=i.list)==null?void 0:T.data)||[]])},[o,n,i,C]),{coursesToMap:s,paginationMeta:v,loading:n.loading||i.loading,handlePagination:t=>{S("page",`${t}`),window==null||window.scrollTo(0,0)},redirectToCourses:()=>f.push(A.courses)}},Z=E.div`
  position: relative;
