import{b as Y,E as K,r as o,h as L,j as e,D as m,f as h,L as A,l as v,s as p,q as E,w as x,ax as S,n as C,ay as b,az as Q,aA as Z,aB as ee,ai as te,i as se,Y as q,T as u,v as j,J as N,aC as ie,aD as ae,N as re,aq as z,ad as ne,ae as oe,ak as le,aE as de,X as ce,aF as xe,av as me,o as pe,C as ue}from"./index-gbJMaPe7.js";import{P as he}from"./index-CVz7XqFh.js";import{B as ge}from"./index-DR6cgSD7.js";import{a as W}from"./ResponsiveImage-aNRm3e5Q.js";import{P as X}from"./PricingCard-fPqOFL6B.js";import{P as je}from"./index-CDz9AdaM.js";import{D as Ee}from"./index-puRotPNF.js";import{C as _}from"./index-BWuE-Df4.js";import{E as w}from"./index-BUwdLeOP.js";import"./index-CPK7TRFR.js";import"./index-yveM5h58.js";import"./index-Dwxq0LGB.js";const ve=Y.createContext({}),Ce=({children:t})=>{const{id:s}=K(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
