import{r as a,A as L,f as k,i as _,j as e,x as Q,T as v,s as I,ag as W,v as A,q as w,ai as G,aZ as K,a_ as Z,a0 as U,a$ as J,b0 as V,b1 as X,m as Y,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-t6qcE6xV.js";import{T as ae}from"./Tabs-i7RKMRpF.js";import{C as ie}from"./index-BE8EAlaY.js";import{R as ne}from"./ResponsiveImage-DIOCa9vc.js";import{C as le}from"./index-zs_XUQIj.js";import{C as ce}from"./index-BuB9XLgP.js";import{R as de}from"./index-LbYDT4l0.js";import{b as ue,Q as me}from"./questionnaires-BKfEs1vq.js";import{u as pe}from"./useDownloadCertificate-DjmLX4ra.js";import{t as ge}from"./toast-D7XhDk_L.js";import{u as xe}from"./useRoles-DKvCjKCP.js";import{u as H}from"./useSearchParams-XaDnR4cr.js";import{P as he}from"./index-DSE5LBwN.js";import{S as fe}from"./swiper-BPWQb9gm.js";import{S as O}from"./swiper-react-C4MyIGZB.js";import{C as B}from"./CourseCard-HBu7w-OJ.js";import"./base-C7euzKDi.js";import"./a11y-MSMRlRx2.js";import"./index-BZNMhtf1.js";const Ce=({courseData:s,visible:d,onClose:t})=>{const{sendProgress:u}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:l}=_(),g=a.useCallback(async()=>{await u(s.course.id,s.progress.map(({topic_id:f})=>({topic_id:f,status:0}))),l(`/course/${s.course.id}`)},[s.course.id,s.progress,u,l]);return e.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:e.jsxs(e.Fragment,{children:[e.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),e.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),e.jsxs(W,{$gap:16,children:[e.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),e.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},je=w(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
