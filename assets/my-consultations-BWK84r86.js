import{r as i,i as P,h as x,j as e,V as h,y as g,o as b,q as m,L as w,al as L,X as R,N,aQ as T,aR as M,aS as S,aT as I,aU as v,ak as U,at as k,aV as $,g as F,z as B,aW as G,aX as W,a0 as q,v as O,C as z}from"./index-zC_aFvST.js";import{a as K,T as V}from"./index-Bbu1Mty_.js";import{C as X}from"./index-BDx5F_UZ.js";import{P as H,C as J,D as f,a as j,b as Q}from"./index-FvUzK8pN.js";import{u as Y}from"./useRoles-DJ8eAfZY.js";import{C as Z}from"./CourseCard-41leiMgI.js";import"./questionnaire-CXWDgbJ4.js";import"./questionnaires-DW0SYC7E.js";import"./useDownloadCertificate-BhiwT1bA.js";import"./base-7gvCcPfx.js";import"./index-CmwhiQJp.js";import"./swiper-B9f1XG39.js";import"./swiper-react-C6j_hrsJ.js";import"./a11y-BhPrx2M_.js";import"./floating-ui.react-dom-BlK7WIpJ.js";import"./index-D8KGcKzE.js";import"./index-D7fhmC37.js";import"./index-DpLaaERG.js";const tt=({type:t})=>{var c;const{userConsultations:s,fetchUserConsultations:n}=i.useContext(P.EscolaLMSContext),{t:r}=x(),[a,o]=i.useState([]),l=i.useMemo(()=>{var _;const C=((_=s.list)==null?void 0:_.data.filter(p=>t===E.STARTED||t===E.UPCOMING?p.in_coming||p.is_started:p.is_ended))||[];return Array.from(new Map(C.map(p=>[p.id,p])).values())},[t,(c=s.list)==null?void 0:c.data]);return i.useEffect(()=>{n()},[t,n]),i.useEffect(()=>(o([]),o(l),()=>{o([])}),[t,l]),e.jsx(H,{children:e.jsx(h.Row,{style:{gap:"30px 0"},children:s.loading?Array.from({length:8}).map((C,D)=>e.jsx(h.Col,{md:3,children:e.jsx(Z,{})},`skeleton-card-${D}`)):a.length===0?e.jsx(g.Text,{style:{paddingLeft:b?20:40},children:r("MyProfilePage.OrdersEmpty")}):e.jsx(e.Fragment,{children:a.map(C=>e.jsx(h.Col,{xs:12,md:6,lg:3,children:e.jsx(J,{consultation:C})},C.id))})})})},y=i.memo(tt),et=m.div`
  .course-section {
    margin-top: 0px;
  }
