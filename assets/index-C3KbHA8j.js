import{b as E,O as M,r as i,i as k,j as e,q as x,o as n,U as c,L as m,aE as N,x as d,K as u,T as b,h as p,k as L,m as v,aF as C,a0 as T,as as _,aA as I,aG as R,aH as h,aI as B,aJ as z,aK as A,ak as S,ad as D,ae as G,v as O,C as U}from"./index-CWlckqug.js";import{P as W}from"./index-ClmE-k8S.js";import{a as q}from"./PricingCard-DjCYDt8V.js";import{P as F}from"./index-DtLqo7oX.js";import{B as H}from"./index-sQbNspGC.js";const K=E.createContext({}),V=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(K.Provider,{value:{},children:t})},J=x.div`
  width: 100%;
  left: 0;
