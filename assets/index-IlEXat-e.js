import{q as K,f as le,r as b,j as d,M as _e,s as ce,c5 as je,d as j,c6 as be,c7 as ye,E as xe,a7 as me,D as G,a6 as ge,c8 as Pe,G as we,v as J,c9 as Ce,S as Te,aI as ee,ca as Se,h as Ee,b as ue,n as L,cb as Oe,H as $e,i as de,cc as Me,cd as fe,c4 as Ne,a0 as ke}from"./index-CBf-QksF.js";import{P as De,A as S,_ as Ie,a as oe,I as Ae,O as ze,H as He}from"./index-IHJL_1qO.js";import{U as Ve}from"./Upload-Dv2yIh50.js";const Be=K.div`
  h1 {
    font-size: 2em;
  }
  h2 {
...
`]))),Q=function(){return(0,f.jsx)("svg",t({width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg"},{children:(0,f.jsx)("path",{d:"M5 2C5 0.89543 5.89543 0 7 0H13C14.1046 0 15 0.895431 15 2V4H16.9897C16.9959 3.99994 17.0021 3.99994 17.0083 4H19C19.5523 4 20 4.44772 20 5C20 5.55228 19.5523 6 19 6H17.9311L17.0638 18.1425C16.989 19.1891 16.1182 20 15.0689 20H4.93112C3.88184 20 3.01096 19.1891 2.9362 18.1425L2.06888 6H1C0.447715 6 0 5.55228 0 5C0 4.44772 0.447715 4 1 4H2.99174C2.99795 3.99994 3.00414 3.99994 3.01032 4H5V2ZM7 4H13V2H7V4ZM4.07398 6L4.93112 18H15.0689L15.926 6H4.07398ZM8 8C8.55228 8 9 8.44772 9 9V15C9 15.5523 8.55228 16 8 16C7.44772 16 7 15.5523 7 15V9C7 8.44772 7.44772 8 8 8ZM12 8C12.5523 8 13 8.44772 13 9V15C13 15.5523 12.5523 16 12 16C11.4477 16 11 15.5523 11 15V9C11 8.44772 11.4477 8 12 8Z",fill:"currentColor"})}))},y=function(l){var u=l.projects,c=l.onDeleteSuccess,h=l.onDeleteError,g=l.className,$=(0,p.useTranslation)().t,U=(0,_.useContext)(x.EscolaLMSContext),V=U.token,M=U.apiUrl,A=(0,_.useState)([]),W=A[0],B=A[1],q=(0,_.useCallback)(function(N){return function(){if(!V)return console.warn("noToken");B(function(z){return v(v([],z,!0),[N],!1)}),(0,w.removeProject)(M,V,N).then(function(){return c==null?void 0:c()}).catch(function(){return h==null?void 0:h()}).finally(function(){return B(function(z){return z.filter(function(D){return D!==N})})})}},[V,M]);return(0,f.jsxs)("div",t({className:g},{children:[u.loading&&!u.data.length&&(0,f.jsx)(m.Spin,{}),u.data.map(function(N,z){var D=N.id,H=N.created_at;return(0,f.jsxs)(i.Card,t({className:"project-card"},{children:[(0,f.jsxs)("div",t({className:"project-card__details"},{children:[(0,f.jsxs)(k.Text,t({className:"project-card__title"},{children:[$("ProjectPlayer.ProjectFile")," ".concat(z+1)]})),(0,f.jsx)(k.Text,t({className:"project-card__date"},{children:(0,C.format)(new Date(H),P.DATETIME_FORMAT)}))]})),(0,f.jsx)(E.Button,t({className:"project-card__delete-btn",mode:"icon",loading:W.includes(D),onClick:q(D)},{children:(0,f.jsx)(Q,{})}))]}),D)})]}))},O=function(l){var u=l.course_id,c=l.topic,h=l.onSuccess,g=l.onError,$=l.className,U=l.onProjectsChange,V=(0,_.useContext)(x.EscolaLMSContext),M=V.token,A=V.apiUrl,W=(0,_.useState)({data:[],loading:!1}),B=W[0],q=W[1],N=(0,_.useState)(!1),z=N[0],D=N[1];(0,_.useEffect)(function(){U&&U(B)},[B]);var H=(0,_.useCallback)(function(){if(!M)return console.error("noToken");q(function(T){return t(t({},T),{loading:!0})}),(0,w.fetchProjects)(A,M,{course_id:u,topic_id:c==null?void 0:c.id}).then(function(T){T.success&&q(function(R){return t(t({},R),{data:T.data})})}).catch(function(T){return console.warn(T)}).finally(function(){return q(function(T){return t(t({},T),{loading:!1})})})},[M,A,u,c==null?void 0:c.id]);(0,_.useEffect)(function(){H()},[H]);var ve=(0,_.useCallback)(function(T){var R;if(!(!(!((R=T.currentTarget.files)===null||R===void 0)&&R[0])||!M)){D(!0);var he={topic_id:(c==null?void 0:c.id)+"",file:T.currentTarget.files[0]};(0,w.addProject)(A,M,he).then(function(){H(),h==null||h()}).catch(function(){g==null||g()}).finally(function(){D(!1)})}},[A,M,c==null?void 0:c.id,H]);return(0,f.jsxs)(Z,t({className:"wellms-component"+" ".concat($),"data-testid":"project-player"},{children:[c.description&&(0,f.jsx)(Y.MarkdownRenderer,t({className:"project-player__description"},{children:c.description})),(0,f.jsx)(X.Upload,{className:"project-player__upload-input",name:"project_file",onChange:ve,disabled:z}),(0,f.jsx)(y,{className:"project-player__projects-list",projects:B,onDeleteSuccess:H})]}))};e.ProjectPlayer=O,e.default=(0,s.withTheme)((0,s.default)(e.ProjectPlayer)(ie||(ie=o([""],[""]))));var se,ie})(pe);const Ze=K.div`
  ...
  ${e=>e.fullview?ee`
      ...
      `}
`,Qe=({value:e})=>{const{apiUrl:o}=b.useContext(G.EscolaLMSContext),{t}=le(),[a,r]=b.useState(!1);return d.jsx("div",{className:"scorm-wrapper",children:d.jsxs(Ze,{fullview:a,children:[d.jsxs(J.Button,{onClick:()=>r(!a),children:[" ",t("Scorm.Resize")," ",d.jsx(Se,{})]}),d.jsx("iframe",{title:e.title,src:`${o}/api/scorm/play/${e.uuid}`})]})})},We=K(De.PdfPlayer)`
  .course-pdf-player {
...
`,nt=({topic:e,preview:o=!1,disableNextTopicButton:t,isThereAnotherTopic:a=!0,onXAPI:r,onVideoEnd:n,onAudioEnd:v,onPdfEnd:f,onQuizEnd:_,onProjectEnd:s,onProjectsChange:p})=>{var P,E;const{program:C,topicPing:x,topicIsFinished:w}=b.useContext(Ee.EscolaLMSContext);if(b.useEffect(()=>{const i=(e==null?void 0:e.id)&&w(e.id);a&&t&&i&&t(!i&&!(e!=null&&e.can_skip))},[t,e,a,w]),b.useEffect(()=>{if(!o){const i=()=>(e==null?void 0:e.id)&&!w(e==null?void 0:e.id)&&x(e==null?void 0:e.id),m=setInterval(()=>{i()},5e3);return i(),()=>clearInterval(m)}},[x,o,e==null?void 0:e.id,w]),!e)return d.jsx(ue.Fragment,{});if(!((P=e.topicable)!=null&&P.value))return d.jsx("pre",{className:"error",children:"Error: topic.topicable?.value is missing"});if(e.topicable_type)switch(e.topicable_type){case S.TopicType.H5P:return d.jsx(He.H5Player,{onXAPI:i=>r==null?void 0:r(i),h5pObject:e.topicable.content,hideActionButtons:!0});case S.TopicType.OEmbed:return d.jsx(d.Fragment,{children:d.jsx(ze.OEmbedPlayer,{url:e.topicable.value},e.id)});case S.TopicType.RichText:return d.jsx(Le,{value:e.topicable.value,resources:e.resources});case S.TopicType.Video:return d.jsx(oe.AudioVideoPlayer,{mobile:L,url:e.topicable.url,light:!0,onTopicEnd:n});case S.TopicType.Image:return d.jsx(Ae.ImagePlayer,{topic:e,onLoad:()=>{}});case S.TopicType.Audio:return d.jsx(oe.AudioVideoPlayer,{mobile:L,audio:!0,url:e.topicable.url,light:!0,onTopicEnd:v});case S.TopicType.Pdf:return d.jsx(We,{url:e.topicable.url,pageConfig:{renderMode:"svg",className:"course-pdf-player"},onTopicEnd:f});case S.TopicType.Scorm:return d.jsx(Qe,{value:{title:e.title,uuid:e.topicable.uuid}});case S.TopicType.GiftQuiz:return d.jsx(Ie,{topic:e,onTopicEnd:_});case S.TopicType.Project:return d.jsx(pe.ProjectPlayer,{course_id:((E=C.value)==null?void 0:E.id)??0,topic:e,onSuccess:s,onProjectsChange:p});default:return d.jsx("pre",{children:e.topicable_type})}return d.jsx("pre",{children:"loading... (or error)"})};var Je=Oe();function Ke(e,o="/course/"){var Z,Q;const{sendProgress:t,getNextPrevTopic:a,progress:r,courseProgressDetails:n}=b.useContext(G.EscolaLMSContext),[v,f]=b.useState(!1),{lessonID:_,topicID:s}=$e(),{push:p}=de(),C=b.useMemo(()=>Me((e==null?void 0:e.lessons)??[]),[e==null?void 0:e.lessons]),x=b.useMemo(()=>fe((e==null?void 0:e.lessons)??[]),[e==null?void 0:e.lessons]),w=_?Number(_):(Z=C==null?void 0:C[0])==null?void 0:Z.id,P=s?Number(s):(Q=x==null?void 0:x[0])==null?void 0:Q.id,E=b.useMemo(()=>C.find(y=>y.id===w),[C,w]),i=b.useMemo(()=>x.find(y=>y.id===P),[x,P]),m=b.useMemo(()=>{var y;return((y=x.at(-1))==null?void 0:y.id)===(i==null?void 0:i.id)},[x,i==null?void 0:i.id]),k=b.useCallback(()=>{e.id&&t(e.id,[{topic_id:Number(P),status:1}]).then(()=>{const y=a(Number(P));y&&p(`${o}${e.id}/${y.lesson_id}/${y.id}`,null)})},[P,e,p,a,t,o]),Y=b.useCallback(()=>{const y=a(Number(P),!1);if(e.id&&(i!=null&&i.can_skip)){t(e.id,[{topic_id:Number(P),status:1}]).then(()=>{y&&p(`${o}${e.id}/${y.lesson_id}/${y.id}`,null)});return}y&&p(`${o}${e.id}/${y.lesson_id}/${y.id}`,null)},[P,e,p,a,t,o,i]),X=b.useCallback((y=!0)=>{const O=a(Number(P),y);O&&p(`${o}${e.id}/${O==null?void 0:O.lesson_id}/${O==null?void 0:O.id}`)},[w,P,e,e.id,p,o]);return{topic:i,lesson:E,onNextTopic:k,onPrevTopic:Y,getNextPrevTopic:a,isNextTopicButtonDisabled:v,disableNextTopicButton:f,onNextTopicPreview:X,sendProgress:t,progress:r,courseProgressDetails:n,isLastTopic:m}}const Ye=K.aside`
...
`,rt=({course:e,topicId:o,onCompleteTopic:t,onCourseFinish:a})=>{var E;const{progress:r}=Ke(e),{courseProgressDetails:n,user:v}=b.useContext(G.EscolaLMSContext),f=de(),[_,s]=b.useState(!1),p=((e==null?void 0:e.lessons)||[]).filter(i=>{var m;return(((m=i==null?void 0:i.topics)==null?void 0:m.length)??0)>0}),{topicIsFinished:C}=b.useContext(G.EscolaLMSContext),x=b.useMemo(()=>fe(e.lessons??[]),[e.lessons]),w=b.useMemo(()=>{var m;const i=e.id;return n&&n.byId&&n.byId[Number(i)]&&n.byId[Number(i)].value?n.byId[Number(i)].value:r&&r.value&&((m=r.value.find(k=>k.course.id===Number(i)))==null?void 0:m.progress)},[r,e]),P=x.filter(i=>C(i.id)||(w==null?void 0:w.some(m=>m.topic_id===i.id&&m.status===1))).map(i=>i.id);return!e&&!p?d.jsx(ue.Fragment,{}):d.jsxs(Ye,{children:[L&&d.jsx(J.Button,{mode:"outline",className:"show-agenda-btn",onClick:()=>s(!0),children:Ne("CourseProgram.ShowAgenda").toString()}),d.jsxs("div",{className:`${_?"agenda-wrapper agenda-wrapper--visible":"agenda-wrapper"}`,children:[L&&d.jsx(J.Button,{className:"hide-agenda-btn",mode:"secondary",onClick:()=>s(!1),children:"✕"}),d.jsx(Je.CourseAgenda,{availableTopicsIds:x.map(i=>i.id),areAllTopicsUnlocked:ke(Number((E=v.value)==null?void 0:E.id),e),onNextTopicClick:()=>{const i=x.findIndex(k=>k.id===o),m=x==null?void 0:x[i+1];m&&i!==-1&&(f.push(`/course/${e.id}/${m.lesson_id}/${m.id}`),s(!1))},mobile:L,lessons:e.lessons,currentTopicId:o,finishedTopicIds:P,onMarkFinished:()=>t==null?void 0:t(),onTopicClick:i=>{f.push(`/course/${e.id}/${i.lesson_id}/${i.id}`),s(!1)},onCourseFinished:()=>a==null?void 0:a()})]})]})};export{nt as C,Qe as S,rt as a,Ke as u};
