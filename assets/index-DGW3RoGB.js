import{b as N,Q as E,r as i,i as k,j as e,q as x,o as n,V as c,L as m,aE as M,y as d,N as u,T as b,h as p,k as L,m as v,aF as C,a1 as T,al as _,aA as I,aG as R,aH as h,aI as B,aJ as z,aK as A,ax as S,aq as D,ar as q,v as G,C as W}from"./index-CM2TS3Ay.js";import{P as F}from"./index-DCq18e6y.js";import{a as H}from"./PricingCard-BvrLEuPI.js";import{P as O}from"./index-CtLOpZqB.js";import{B as U}from"./index-D6uo1LYp.js";const V=N.createContext({}),J=({children:t})=>{const{id:a}=E(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},K=x.div`
  width: 100%;
  left: 0;
