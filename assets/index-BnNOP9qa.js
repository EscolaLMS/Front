import{q as d,aP as c,f as l,r as x,j as t,n as p,s as r,T as m,aQ as u,W as g,v as b}from"./index-DvAWm433.js";import{u as h}from"./usePayment-BkTzNuZV.js";const j=d.div`
  border-radius: ${({theme:e})=>e.cardRadius}px;
  border: 1px solid ${({theme:e})=>e.gray3};
  padding: ${({$isMobile:e})=>e?"20px":"23px 75px"};
  transition: border 0.3s ease-in-out;
  margin-bottom: ${({$isMobile:e})=>e?"30px":"0"};
