import{b as cn,r as b,k as dn,p as G,m as un,j as r,q as X,n as L,d as h,z as pn,a0 as gn,aq as xn,ar as fn,D as hn,as as mn,A as bn,a1 as vn,h as J,f as D,X as K,l as wn,S as jn,i as H,L as yn,C as Cn}from"./index-DaafzRP_.js";import{q as M}from"./base-CumTa13P.js";import{C as _n}from"./index-CXY8MKGG.js";import{F as kn,S as Tn}from"./index-LZ3uND3U.js";import{W as On}from"./index-CM6IMS7c.js";import{P as Pn}from"./index-C9fEySCg.js";import"./ResponsiveImage-BWLsb9wG.js";import"./index-DmeYF39A.js";import"./index-4Hra2YYq.js";const N=cn.createContext({}),I=(i={})=>M.stringify(i),Sn=({children:i})=>{const{fetchWebinars:l,webinars:t,fetchTags:a}=b.useContext(dn.EscolaLMSContext),p=G(),{push:m}=un(),[u,C]=b.useState(),o=(g={})=>({page:1,per_page:8,...g});return b.useEffect(()=>{a()},[a]),b.useEffect(()=>{m(`${p.pathname}?${I(u)}`)},[u,p.pathname]),b.useEffect(()=>{if(p.search&&p.search.split("?")[1]!==I(u)){const g=M.parse(p.search);C(g),l(g||{})}else l(o(u))},[p.search]),r.jsx(N.Provider,{value:{params:u,setParams:C,webinars:t},children:i})},Fn=({children:i})=>{const l=X("div")`
