...
`,kt=({stripeKey:t})=>{var I,K,X;const{user:e,cart:r,fetchCart:a,removeFromCart:o,payWithStripe:s,fetchCourses:u,courses:d,realizeVoucher:i}=k.useContext(ke.EscolaLMSContext),{t:c}=ue(),{push:b,location:w}=we(),j=it(),O=ot(),[$,h]=k.useState(!1),[g,A]=k.useState({name:""}),[L,_]=k.useState(r.value.additional_discount>0?"granted":void 0),C=t.includes("_test_"),B={arrows:!1,infinite:!0,speed:500,slidesToShow:3,draggable:!1,slidesToScroll:3,responsive:[{breakpoint:768,settings:{draggable:!0,slidesToShow:2,slidesToScroll:2}},{breakpoint:576,settings:{slidesToShow:1,centerMode:!0,slidesToScroll:1}}]};k.useEffect(()=>{!e.loading&&!e.value?b(V.login):(u({per_page:6}),a())},[]);const T=k.useCallback(f=>{h(!0),s(f,"https://demo-stage.escolalms.com/#/user/my-profile").then(()=>{h(!1),b("/cart?status=success")}).catch(()=>{q.error(`${c("UnexpectedError")}`),h(!1)}).finally(()=>h(!1))},[]),M=()=>{if(!g.name){q.error(`${c("Cart.EmptyNameWarning")}`);return}if(!j||!O){q.error(`${c("UnexpectedError")}`);return}const f=O.getElement(Ae);f&&h(!0),f&&j.createPaymentMethod({type:"card",card:f,billing_details:g}).then(E=>{var N;E.error?(h(!1),q.error(E.error.message),console.log(E.error)):(T((N=E==null?void 0:E.paymentMethod)==null?void 0:N.id),setTimeout(()=>{h(!1)},3e3))}).catch(()=>{h(!1),q.error(`${c("UnexpectedError")}`)})};return w.search.includes("?status=success")?n.jsx(Et,{}):n.jsx(Pe,{metaTitle:c("Cart.Cart"),children:n.jsxs(wt,{children:[n.jsx(Te,{children:((I=r.value)==null?void 0:I.items.length)!==0?n.jsxs(R.Row,{children:[n.jsxs(R.Col,{lg:9,children:[n.jsx(Ke,{items:[n.jsx(ze,{to:V.home,children:c("Home")}),n.jsx(ae.Text,{size:"12",children:c("Cart.YourCart")})]}),n.jsxs("div",{className:"module-wrapper",children:[n.jsx(U.Title,{level:4,children:c("Cart.YourCart")}),n.jsx("div",{className:"products-container",children:(K=r.value)==null?void 0:K.items.map(f=>{var E,N,G,z,v,H,P,F;return n.jsx(De.CheckoutCard,{mobile:ce,img:{src:((E=f.product)==null?void 0:E.poster_url)||Xe,alt:((N=f.product)==null?void 0:N.name)||""},title:(G=f.product)==null?void 0:G.name,price:`${se((z=f.product)==null?void 0:z.price,(v=f.product)==null?void 0:v.tax_rate)} zł`,oldPrice:(H=f.product)!=null&&H.price_old?`${se((P=f.product)==null?void 0:P.price_old,(F=f.product)==null?void 0:F.tax_rate)} zł`:void 0,handleDelete:()=>{var D;return o(Number((D=f.product)==null?void 0:D.id))}},f.id)})})]}),n.jsxs("div",{className:"module-wrapper",children:[n.jsx(U.Title,{level:4,children:c("Cart.ChoosePaymentMethod")}),n.jsxs("div",{className:"payments-form",children:[n.jsx("div",{className:"collapse-wrapper",children:n.jsx(yt,{active:!0,title:c("Cart.CreditCard"),children:n.jsx(bt,{setBillingDetails:A,billingDetails:g})})}),C&&n.jsx("div",{className:"card-info",children:n.jsxs(ae.Text,{size:"14",children:[c("Cart.UseTestCard"),":"," ",n.jsx(qe.Link,{href:"https://docs.wellms.io/getting-started/demo.html",target:"_blank",rel:"noreferrer nofollow",children:c("Cart.LearnMore")})]})})]})]}),n.jsxs("section",{className:"slider-section",children:[n.jsx(U.Title,{level:4,children:c("Cart.Interest")}),d&&d.list&&n.jsx(xe,{courses:d.list.data,sliderSettings:B})]})]}),n.jsxs(R.Col,{lg:3,children:[n.jsx(U.Title,{style:{marginBottom:20},level:4,as:"h3",children:c("Cart.Summary")}),n.jsx("div",{className:"summary-box-wrapper",children:n.jsx(gt.CartCard,{mobile:ce,onBuyClick:()=>M(),id:1,title:`${se(Number(((X=r.value)==null?void 0:X.total_with_tax)||0))} zł`,discount:{onDiscountClick:f=>i(f).then(E=>{E.success?(_("granted"),a()):_("error")}).catch(()=>{_("error")}),onDeleteDiscountClick:()=>console.log("clicked"),status:L}})})]})]}):n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"empty-cart",children:[n.jsx(U.Title,{level:3,children:c("Cart.EmptyCartTitle")}),n.jsx(ae.Text,{children:c("Cart.EmptyCartText")}),n.jsx(ie.Button,{mode:"secondary",onClick:()=>b(V.courses),children:c("Cart.EmptyCartBtnText")})]}),n.jsxs("section",{className:"slider-section",children:[n.jsx(U.Title,{level:4,children:c("Cart.Interest")}),d&&d.list&&n.jsx(xe,{courses:d.list.data,sliderSettings:B})]})]})}),(r.loading||$)&&n.jsx(Ye,{})]})})},Mt=()=>{var u,d,i;const{config:t}=k.useContext(Ve.EscolaLMSContext),e=c=>vt(c),r=(d=(u=t==null?void 0:t.value)==null?void 0:u.escolalms_payments)==null?void 0:d.drivers,a=(i=r==null?void 0:r.stripe)==null?void 0:i.publishable_key,o=je(),s=Ee.getFontFromTheme(o);return n.jsx(Oe,{stripe:e(a),options:{fonts:[{cssSrc:s.links[0]}]},children:n.jsx(kt,{stripeKey:a})})};export{Mt as default};
