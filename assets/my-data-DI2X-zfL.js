...
`])),function(e){return e.mobile?"18px":"28px"},function(e){return e.mobile?"15px":"30px"}),G=F.default.div(E||(E=S([`
  margin: 0;
  padding: 0;
  width: 100%;
  display: flex;
