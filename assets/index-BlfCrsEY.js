import{q as x,j as t,p as y,ad as B,r as l,f as w,G as $,i as C,Y as P,aI as L,an as f,aJ as S,aK as z,T as v,h as k,aL as O,aM as W,aN as Q,w as N,x as V,aO as D,au as R,as as T,aP as q,L as M,o as I,aB as H,aQ as U,m as K,s as Y}from"./index-CDjsyf2-.js";import{u as m,C as G,a as J,b as X}from"./CourseAgenda-DYTv8QYF.js";import{R as Z}from"./index-E5hhR258.js";import{b as ee,Q as te}from"./questionnaires-OU3QWUgE.js";import{u as se}from"./useDownloadCertificate-CW6t68b2.js";import"./index-Bh5fxh3G.js";import"./ResponsiveImage-BmseR_VP.js";import"./Upload-razvd5NE.js";import"./toast-B-P2W3bd.js";const ie=x.div`
...
`,Re=x(N.Text)`
  ...
  margin: 0;
  line-height: 0;
`,qe=()=>{const{currentCourseProgram:e}=m(),{t:s}=w();return t.jsxs(Qe,{children:[t.jsxs(Ve,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(M,{to:I.myProfile,children:t.jsxs(De,{children:[!C&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=m();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(We,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ke=()=>t.jsx(X,{children:t.jsx(Ue,{})}),ot=()=>{var s;const{program:e}=l.useContext(K.EscolaLMSContext);return t.jsx(Y,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ke,{})})};export{ot as default};
