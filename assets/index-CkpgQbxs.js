...
`,We=({title:t,children:e,active:n,onClick:a})=>{const[i,s]=A.useState(n||!1);return r.jsxs(Tt,{children:[r.jsx("div",{className:"collapse-title",children:r.jsx(Ge,{name:t,label:r.jsx("strong",{children:t}),checked:n||i,onChange:()=>[s(!i),a&&a()]})}),(n||i)&&r.jsx("div",{className:"collapse-content",children:e})]})},Nt=G.div`
  .input-wrapper {
...
`,Ue=()=>{const{t}=X(),{fetchProgress:e}=A.useContext(Ze.EscolaLMSContext);return A.useEffect(()=>{e()},[]),r.jsx(Rt,{$isMobile:F,children:r.jsx(pe,{children:r.jsxs("div",{className:"cart-success-container",children:[r.jsx(Xe,{}),r.jsx(R.Title,{level:2,children:t("Cart.ThankYouTitle")}),r.jsxs("div",{children:[r.jsx($.Text,{size:"16",className:"cart-success-text",children:t("Cart.ThankYouText")}),r.jsx(ce,{to:Z.myProfile,children:r.jsx($.Text,{size:"16",children:t("Navbar.MyCourses")})})]}),r.jsxs("div",{children:[r.jsx($.Text,{size:"16",children:t("Cart.Status")})," ",r.jsx(ce,{to:Z.myOrders,children:r.jsx($.Text,{size:"16",children:t("Navbar.MyOrders")})})]})]})})})},de=G.section`
