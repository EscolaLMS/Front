import{aw as b,g as l,f as h,j as e,q as m,n,K as u,r as x,h as y,G as k,N as j}from"./index-BsLXwVX-.js";var w=b();const C=l(w),v=({onSubmit:a})=>{const{t}=h();return e.jsx(C,{placeholder:t("Filters.Search"),onSubmit:a})},S=m("div")`
  display: flex;
