import{f as p,j as e,ak as A,T as D,aE as F,r as l,A as j,L as k,l as S,s as C,q as T,w as m,ax as H,n as r,ay as u,az as q,aA as J,aB as G,ai as L,h as R,i as U,Y as w,v as h,J as $,aD as Y,N as K,C as Q,D as V,o as X,aJ as Z}from"./index-CQ96WfSz.js";import{C as b,T as O}from"./index-C9NMs52-.js";import{B as ee}from"./index-DJo8rp4U.js";import{a as te}from"./ResponsiveImage-D_FmW4Qc.js";import{P as se}from"./PricingCard-NI9GpFWz.js";import{W as ae}from"./index-LuZSr1In.js";import{P as oe}from"./index-D0cv_siB.js";import"./toast-CwM_HkAX.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&A(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(D.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(F,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(k,{to:S.home,children:a("Home")}),e.jsx(k,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
