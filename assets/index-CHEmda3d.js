import{r as a,D as L,f as k,i as _,j as s,x as Q,T as A,s as I,af as W,v,q as y,ah as G,A as K,aX as Z,Z as U,aY as X,aZ as Y,a_ as J,m as V,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-C31D5yYy.js";import{T as ae}from"./Tabs-C2gUw8d8.js";import{C as ne}from"./index-B4j2T7DF.js";import{R as ie}from"./ResponsiveImage-DJtrkYdm.js";import{C as le}from"./index-D1PeWBh-.js";import{C as de}from"./index-BwwFj4CL.js";import{R as ce}from"./index-DT6k4W9f.js";import{b as me,Q as ue}from"./questionnaires-CMLb55IW.js";import{u as pe}from"./useDownloadCertificate-bl4Q6Ptc.js";import{u as ge}from"./useRoles-BSpUFhcG.js";import{u as H}from"./useSearchParams-CrFGR5CH.js";import{P as xe}from"./index-DwIvHIuq.js";import{S as he}from"./swiper-B2QhkTAh.js";import{S as B}from"./swiper-react-BdGy-X-Q.js";import{C as D}from"./CourseCard-CUUvT-ue.js";import"./base-C7euzKDi.js";import"./a11y-CeduXb7H.js";import"./index-DTlyeBQ5.js";const fe=({courseData:e,visible:d,onClose:t})=>{const{sendProgress:c}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:i}=_(),g=a.useCallback(async()=>{await c(e.course.id,e.progress.map(({topic_id:p})=>({topic_id:p,status:0}))),i(`/course/${e.course.id}`)},[e.course.id,e.progress,c,i]);return s.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:s.jsxs(s.Fragment,{children:[s.jsx(A.Title,{level:4,children:o("ResetProgressModal.Continue")}),s.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),s.jsxs(W,{$gap:16,children:[s.jsx(v.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),s.jsx(v.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},Ce=y(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
