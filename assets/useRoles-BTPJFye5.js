import{q as R,a as S,j as t,T as g,bV as T,o as h,bW as f,aq as q,ao as A,p as C,w as E,D as N,z as j,c as y}from"./index-C8RYle4a.js";import{r as x}from"./sentry-DZqhWugq.js";import{Q as w,a as k}from"./questionnaire-CXWDgbJ4.js";const v=R.form`
  .question-box {
    &__title {
      font-size: 24px;
      text-align: center;
...
`,W={loading:!1,step:0},O=({entityModel:a,entityId:s,visible:u,questionnaire:e,onClose:n})=>{var r;const{sendQuestionnaireAnswer:_}=x.useContext(N.EscolaLMSContext),{t:m}=S(),[o,c]=x.useState(W),d=x.useCallback(async(i,p)=>{if(e.questions){c(l=>({...l,loading:!0}));try{(await _(a,s,e==null?void 0:e.id,{question_id:e.questions[o.step].id,rate:i,note:p,visible_on_front:e.questions[o.step].public_answers})).success&&j(`${m("RateCourse.AnswerSended")}`,"success")}catch(l){j("Error",l.message),console.error(l)}finally{c(l=>({...l,loading:!1,step:l.step+1,note:"",rating:null}))}}},[a,s,e,o]),b=x.useCallback((i,p)=>{d(i,p),e.questions&&o.step===e.questions.length-1&&n()},[d,e,o.step,n]);return t.jsx(Q,{onClose:n,visible:u,animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,width:468,closable:!1,children:e.questions&&t.jsx(z,{questionnaireTitle:e.title,entityModel:a,data:e.questions[o.step],handleSubmit:(i,p)=>b(i,p),withStarsRating:((r=e.questions[o.step])==null?void 0:r.type)===k.REVIEW,onClose:n})})},L=()=>{const{user:a}=x.useContext(y.EscolaLMSContext),s=x.useMemo(()=>{var e,n;return!!((n=(e=a.value)==null?void 0:e.roles)!=null&&n.includes("tutor"))},[a]),u=x.useMemo(()=>{var e,n;return!!((n=(e=a.value)==null?void 0:e.roles)!=null&&n.includes("student"))},[a]);return{isTutor:s,isStudent:u}};export{O as R,L as u};
//# sourceMappingURL=useRoles-BTPJFye5.js.map
