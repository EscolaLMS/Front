import{k as E,j as e,V as a,T as j,o as _,s as N,q as g,r as v,i as z,h as F,W as B,p as P,y as T,z as h,m as C,a1 as f,at as A,au as q,av as L,aw as D,ax as V,Q as G,v as Q,C as k,L as I,an as W,M as U}from"./index-9BhopFAA.js";import{P as J}from"./index-CZquVgkU.js";import{B as K}from"./index-BoEsTyo6.js";import{a as O}from"./index-C9z0WaVi.js";import{P as R}from"./PricingCard-DXEl8vJW.js";import{C as $}from"./index-mj4FoJdt.js";import{S as M,a as X}from"./sidebar-CLigZuXS.js";import{S as p}from"./index-RJU1vUaY.js";import"./floating-ui.react-dom-BZ7vqki9.js";import"./index-dCvOnDWi.js";const Y=i=>{const{consultation:t}=i,s=E();return e.jsxs(a.Row,{align:"center",children:[e.jsxs(a.Col,{lg:7,children:[(t==null?void 0:t.categories)&&t.categories.length>0&&e.jsx(O,{categories:t.categories,onCategoryClick:x=>{s.push(`/consultations/?categories[]=${x}`)}}),e.jsx("br",{}),e.jsx(j.Title,{mobile:_,level:1,children:t==null?void 0:t.name})]}),e.jsx(a.Col,{lg:4,children:(t==null?void 0:t.image_path)&&e.jsx("div",{className:"image-wrapper",children:e.jsx(N.ResponsiveImage,{path:t.image_path,srcSizes:[790*.5,790,2*790]})})})]})};g.div`
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  gap: 10px;
