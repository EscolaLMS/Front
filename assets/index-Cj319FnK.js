import{f as p,j as e,ak as z,T as R,az as F,r as l,D as j,L as B,l as S,s as C,q as T,w as m,as as q,n as r,at as u,au as w,av as A,aw as G,ai as L,h as D,i as U,a1 as J,v as h,O as $,ay as V,V as K,C as Q,H as X,o as Y,aE as Z}from"./index-CBf-QksF.js";import{C as b,T as O}from"./index-CYXIgfIK.js";import{B as ee}from"./index-E9QXZg2w.js";import{a as te}from"./ResponsiveImage-BnPBXGWb.js";import{P as se}from"./PricingCard-poshWCmx.js";import{W as ae}from"./index-DCr7mkOb.js";import{P as oe}from"./index-JHcu9MtM.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&z(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(R.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(F,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(B,{to:S.home,children:a("Home")}),e.jsx(B,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
