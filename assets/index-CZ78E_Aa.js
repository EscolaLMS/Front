import{r as a,D as L,f as k,i as _,j as s,x as Q,T as A,s as I,af as W,v,q as y,ah as G,A as K,aX as Z,Z as U,aY as X,aZ as Y,a_ as J,m as V,n as $,L as B,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-rgMY50iO.js";import{T as ae}from"./Tabs-BuuIL9KV.js";import{C as ne}from"./index-DEYhe5OT.js";import{R as ie}from"./ResponsiveImage-Dhino3nz.js";import{C as le}from"./index-oSidytsD.js";import{C as de}from"./index-C2hKWo6C.js";import{R as ce}from"./index-Dioo_SYN.js";import{b as me,Q as ue}from"./questionnaires-bnQhZjbO.js";import{u as pe}from"./useDownloadCertificate-DzTKNXCG.js";import{u as ge}from"./useRoles-DVMYcivV.js";import{u as H}from"./useSearchParams-CmF5uHDk.js";import{P as xe}from"./index-Bj_4LO6E.js";import{S as he}from"./swiper-CPGP--u2.js";import{S as D}from"./swiper-react-Blj9s0vN.js";import{C as F}from"./CourseCard-BNp2HqRG.js";import"./base-C7euzKDi.js";import"./index-DnBgoLUe.js";const fe=({courseData:e,visible:d,onClose:t})=>{const{sendProgress:c}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:i}=_(),p=a.useCallback(async()=>{await c(e.course.id,e.progress.map(({topic_id:g})=>({topic_id:g,status:0}))),i(`/course/${e.course.id}`)},[e.course.id,e.progress,c,i]);return s.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:s.jsxs(s.Fragment,{children:[s.jsx(A.Title,{level:4,children:o("ResetProgressModal.Continue")}),s.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),s.jsxs(W,{$gap:16,children:[s.jsx(v.Button,{mode:"primary",onClick:p,children:o("ResetProgressModal.WantContinue")}),s.jsx(v.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},Ce=y(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
