import{r as i,h as P,f as x,j as e,a0 as _,s as m,n as b,w as h,q as c,L as I,b4 as y,b5 as E,aj as A,ar as v,X as M,b6 as N,g as L,A as w,aL as T,b7 as S,b8 as U,v as R,b9 as k,G as B}from"./index-qD7U5zMV.js";import{P as F}from"./index-8al_xJPs.js";import{T as $}from"./Tabs-B25S27H0.js";import{a as G}from"./ResponsiveImage-biK-hrc-.js";import{C as O}from"./index-DDOwUuXl.js";import{D as p,a as C}from"./index-B9uGwa_9.js";import{P as W,C as q,a as K}from"./index-9YhTNc57.js";import{u as z}from"./useRoles-BjiWK9L0.js";import"./index-BRgMvLP6.js";import"./warning-CAvyeAS1.js";const H=({type:t})=>{var d;const{userConsultations:s,fetchUserConsultations:o}=i.useContext(P.EscolaLMSContext),{t:n}=x(),r=i.useMemo(()=>{var a;return((a=s.list)==null?void 0:a.data.filter(l=>t===j.STARTED||t===j.UPCOMING?l.in_coming||l.is_started:l.is_ended))||[]},[t,(d=s.list)==null?void 0:d.data]);return i.useEffect(()=>{o()},[t,o]),e.jsx(W,{children:s.loading?e.jsx(_,{}):r.length===0?e.jsx(m.Text,{style:{paddingLeft:b?20:40},children:n("MyProfilePage.OrdersEmpty")}):e.jsx(h.Row,{style:{gap:"30px 0"},children:r.map(a=>e.jsx(h.Col,{xs:12,md:6,lg:4,children:e.jsx(q,{consultation:a})},a.id))})})},g=i.memo(H),X=c.div`
  .course-section {
    margin-top: 0px;
  }
