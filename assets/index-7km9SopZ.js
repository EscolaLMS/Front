...
`])),function(n){var s=n.theme;return(0,C.getStylesBasedOnTheme)(s.mode,s.black,s.white)},function(n){var s=n.theme;return s.cardRadius},function(n){var s=n.theme;return(0,j.getFontFromTheme)(s).fontFamily},function(n){var s=n.theme;return(0,C.getStylesBasedOnTheme)(s.mode,s.white,s.gray1)},function(n){var s=n.theme;return s.buttonRadius},function(n){var s=n.theme;return s.primaryColor},function(n){var s=n.theme;return s.white},function(n){var s=n.theme;return s.buttonRadius}),v=function(n){var s=n.tabs,l=s===void 0?[]:s,h=n.defaultActiveKey,o=h===void 0?l[0].key:h,m=n.onClick,w=n.className,k=w===void 0?"":w,N=y.useState(o),I=N[0],ee=N[1],Q=l&&l.find(function(T){return T.key===I});return(0,b.jsxs)(f,r({className:"wellms-component ".concat(k)},{children:[(0,b.jsx)("div",r({className:"tabs-menu"},{children:(0,b.jsx)("div",r({className:"tabs-menu-inner"},{children:l.map(function(T){return T.hidden?null:(0,b.jsx)("button",r({type:"button",className:"tab-menu-btn ".concat(I===T.key?"active":""),id:(0,p.getUniqueId)("tab-menu-".concat(T.key)),onClick:function(){ee(T.key),m&&m(T.key)}},{children:T.label}),T.key)})}))})),(0,b.jsx)("div",r({id:"tabpanel-".concat(I),className:"tabs-panel"},{children:(0,b.jsx)(y.Fragment,{children:Q&&Q.component})}))]}))};e.Tabs=v,e.default=(0,u.withTheme)((0,u.default)(e.Tabs)(P||(P=d([""],[""]))));var g,P})(Y);const Te=M.div`
  display: flex;
  justify-content: space-between;
  width: 100%;
  height: 100%;
`,Se=({children:e})=>t.jsx(Te,{children:e}),Me=({courseData:e,visible:d,onClose:r})=>{const{sendProgress:c}=i.useContext(F.EscolaLMSContext),{t:a}=R(),{push:x}=E(),b=i.useCallback(async()=>{await c(e.course.id,e.progress.map(({topic_id:y})=>({topic_id:y,status:0}))),x(`/course/${e.course.id}`)},[e.course.id,e.progress,c,x]);return t.jsx(G.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:r,children:t.jsxs(t.Fragment,{children:[t.jsx(L.Title,{level:4,children:a("ResetProgressModal.Continue")}),t.jsxs(B.Text,{children:[" ",a("ResetProgressModal.RestartCourse")]}),t.jsxs(ne,{$gap:16,children:[t.jsx(A.Button,{mode:"primary",onClick:b,children:a("ResetProgressModal.WantContinue")}),t.jsx(A.Button,{mode:"primary",onClick:r,children:a("ResetProgressModal.Cancel")})]})]})})},ke=M(re)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
...
`,Le=M.div`
  ...
  justify-content: center;
  margin-top: 50px;
`,O=({filter:e=S.ALL})=>{var l,h;const{fetchMyAuthoredCourses:d,myAuthoredCourses:r,fetchPaginatedProgress:c,paginatedProgress:a}=i.useContext(J.EscolaLMSContext),[x,b]=i.useState([]),y=E(),{t:u}=R(),{setQueryParam:j}=X(),{search:C}=K(),p=new URLSearchParams(C),f=p.get("page"),v=p.get("status"),g=i.useMemo(()=>{var o,m;return e===S.AUTHORED?(o=r.list)==null?void 0:o.meta:(m=a.list)==null?void 0:m.meta},[e,(l=r.list)==null?void 0:l.meta,(h=a.list)==null?void 0:h.meta]),P=i.useCallback(o=>{let m="";switch(o){case 1:case 5:break;case 2:m="started";break;case 4:m="finished";break}return m},[]);i.useEffect(()=>{c({page:f?parseInt(f):1,per_page:8,status:P(Number(v))}),(e===S.ALL||e===S.AUTHORED)&&d()},[c,e,d,f,v,P]);const n=i.useMemo(()=>{var o;return(((o=a.list)==null?void 0:o.data)||[]).reduce((m,w)=>({...m,[w.course.id?w.course.id:-1]:Math.round((w.progress||[]).reduce((k,N)=>N.status===1?k+1:k,0)/w.progress.length*100)}),{})},[a]),s=i.useCallback(o=>o.map(m=>({...m.course,courseData:m,progress:n[m.course.id?m.course.id:-1]})),[n]);return i.useEffect(()=>{var o,m,w,k;e!==S.AUTHORED?b(s(((o=a.list)==null?void 0:o.data)||[])):e===S.AUTHORED?b(((m=r.list)==null?void 0:m.data)||[]):b([...s(((w=a.list)==null?void 0:w.data)||[]),...((k=r.list)==null?void 0:k.data)||[]])},[e,a,r,s]),t.jsxs(Ae,{children:[x.length===0&&!a.loading&&!r.loading&&t.jsxs(Ee,{children:[t.jsx(L.Title,{level:3,children:u("MyProfilePage.EmptyCoursesTitle")}),t.jsx(B.Text,{className:"small-text",children:u("MyProfilePage.EmptyCoursesText")}),t.jsx(me,{children:t.jsx(A.Button,{onClick:()=>y.push(fe.courses),mode:"secondary",children:u("MyProfilePage.EmptyCoursesBtnText")})})]}),U?t.jsxs(_e,{children:[a.loading&&r.loading&&Array.from({length:8}).map((o,m)=>t.jsx(H,{className:"single-slide",children:t.jsx(z,{})},`skeleton-card-${m}`)),(!a.loading||!r.loading)&&x&&x.map(o=>t.jsx(H,{className:"single-slide",children:t.jsx(W,{course:o})},o.id))]}):t.jsxs(t.Fragment,{children:[t.jsx($.Row,{children:a.loading||r.loading?Array.from({length:8}).map((o,m)=>t.jsx($.Col,{md:3,children:t.jsx(z,{})},`skeleton-card-${m}`)):x.map(o=>t.jsx($.Col,{md:3,children:t.jsx(W,{course:o})},o.id))}),t.jsx(Le,{children:t.jsx(we,{total:(g==null?void 0:g.total)||0,perPage:Number((g==null?void 0:g.per_page)||0),currentPage:Number((g==null?void 0:g.current_page)||1),onPage:o=>{j("page",`${o}`),window==null||window.scrollTo(0,0)}})})]})]})},Ie=()=>{const{user:e}=i.useContext(J.EscolaLMSContext),d=i.useMemo(()=>{var c,a;return!!((a=(c=e.value)==null?void 0:c.roles)!=null&&a.includes("tutor"))},[e]),r=i.useMemo(()=>{var c,a;return!!((a=(c=e.value)==null?void 0:c.roles)!=null&&a.includes("student"))},[e]);return{isTutor:d,isStudent:r}};var S=(e=>(e.IN_PROGRESS="inProgress",e.PLANNED="planned",e.FINISHED="finished",e.AUTHORED="authored",e.ALL="all",e))(S||{});const $e=M.section`
