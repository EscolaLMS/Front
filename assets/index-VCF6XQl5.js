import{q as k,K as P,r as d,h as $,j as a,aM as T,y as i,ak as v,z as w,k as A,m as p,Z as y,_ as N,$ as B,E as j,T as E,W as M}from"./index-zC_aFvST.js";import{P as c,a as z,f as O,r as R}from"./payment-DExWfhPv.js";import{u as D}from"./usePayment-dV0NxDGe.js";const K=k.div`
...
`,F=({subscription:e})=>{var u,m,g;const{t:s}=$(),{buySubscriptionByP24:l,user:t}=D(),o=A(),x=d.useMemo(()=>e.tags&&e.tags.includes("best-deal"),[e.tags]),S=d.useCallback(()=>{var r;(r=t.value)!=null&&r.id?l(e.id):o.push(p.login)},[e.id,(u=t.value)==null?void 0:u.id,l,o]);d.useEffect(()=>{(async function(){var n;const r=(n=t==null?void 0:t.value)==null?void 0:n.id;y.getPlatform()==="ios"?await c.configure({apiKey:N,appUserID:`${r}`}):y.getPlatform()==="android"&&await c.configure({apiKey:B,appUserID:`${r}`})})()},[(m=t==null?void 0:t.value)==null?void 0:m.id]);const _=d.useCallback(async()=>{var f,b;if(!((f=t.value)!=null&&f.id)){o.push(p.login);return}const r=z(e),n=await c.getOfferings(),I=((b=n==null?void 0:n.current)==null?void 0:b.availablePackages)||[],h=O(I,r);if(h)try{await c.purchaseStoreProduct({product:h}),o.push(p.home)}catch(C){R(C)}},[o,e,(g=t.value)==null?void 0:g.id]);return a.jsx(V,{$isMobile:j,children:a.jsxs("div",{className:"content",children:[x&&a.jsx("div",{className:"tag",children:a.jsx(i.Text,{size:"13",children:s("Subscriptions.CheapestOffer")})}),a.jsx(i.Text,{children:s("Subscriptions.AccessVia")}),a.jsxs(E.Title,{level:1,as:"h4",children:[e.subscription_duration," ",s(`Subscriptions.Periods.${e.subscription_period}`)]}),a.jsxs(i.Text,{className:"information",size:"13",children:[a.jsx(T,{})," ",e.trial_duration,"-",s(`Subscriptions.Periods.${e.trial_period}`)," ",s("Subscriptions.TrialText")]}),a.jsx("div",{className:"divider"}),a.jsx(i.Text,{size:"13",className:"description",children:e.name}),a.jsxs(i.Text,{size:"24",className:"price",bold:!0,children:[M(e.gross_price)," zł"]}),a.jsx(w.Button,{mode:"secondary",onClick:()=>{if(j){_();return}S()},children:s("Subscriptions.IPick")})]})})};export{Y as A,F as S};
