import{b as N,J as M,r as i,m as k,j as e,q as x,i as n,N as c,L as m,at as E,x as d,G as u,T as b,f as p,h as L,o as v,au as C,I as T,av as _,l as I,aw as R,ax as h,ay as z,az as B,aA as A,ak as S,ad as D,ae as G,v as W,C as q}from"./index-Cez1ZG_A.js";import{P as O}from"./index-B_QNHrIe.js";import{a as U}from"./PricingCard-lZgPuQf5.js";import{P as F}from"./index-lwdUL6PI.js";import{B as H}from"./index-sluenWnV.js";import"./index-BPVGT-bo.js";const V=N.createContext({}),J=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},K=x.div`
  width: 100%;
  left: 0;
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(O,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},we=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(W,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(J,{children:e.jsx(q,{children:e.jsx(pe,{})})})})};export{we as default};
