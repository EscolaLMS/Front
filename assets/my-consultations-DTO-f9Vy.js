import{r as o,i as H,h as I,as as Q,j as t,V as P,y as N,o as K,q as w,L as se,ay as re,X as ae,N as q,aQ as U,aR as X,aS as Y,aT as z,aU as G,ax as oe,al as ie,aV as ce,g as de,z as O,aW as le,aX as ue,T as me,F as Z,aY as ee,a0 as fe,v as pe,C as ge}from"./index-DSCUWzSv.js";import{a as he,T as xe}from"./index-CSa1k9Kx.js";import{C as te,a as Ce}from"./CourseCard-lCEjaTYC.js";import{P as je,C as ye,D as R,a as M,b as _e}from"./index-BU6BMlLh.js";import{u as B,R as Ee}from"./useRoles-BwQLMWfu.js";import{Q as F}from"./questionnaire-CXWDgbJ4.js";import{u as ve,Q as we}from"./index-DPHC5fHx.js";import"./questionnaires-De7YnJrd.js";import"./useDownloadCertificate-D6L7B392.js";import"./base-7gvCcPfx.js";import"./index-w-Z9NoFv.js";import"./swiper-DpuCcnoW.js";import"./swiper-react-ft3sPPqI.js";import"./a11y-2tju78nt.js";import"./index-C483pC0F.js";import"./floating-ui.react-dom-CTdYFKzF.js";import"./index-BE9PI57n.js";const Te=({type:e})=>{var g;const{userConsultations:r,fetchUserConsultations:a,token:n}=o.useContext(H.EscolaLMSContext),{t:d}=I(),[i,l]=o.useState([]),u=o.useMemo(()=>{var C;const c=((C=r.list)==null?void 0:C.data.filter(h=>e===k.STARTED||e===k.UPCOMING?h.in_coming||h.is_started:h.is_ended))||[];return Array.from(new Map(c.map(h=>[h.id,h])).values())},[e,(g=r.list)==null?void 0:g.data]),s=o.useCallback(async c=>{try{const C=await(await fetch(`${Q}/api/consultations/me?ids[]=${c}`,{headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`}})).json();C.success&&C.data.length>0&&l(h=>{const x=h.findIndex(m=>m.id===c);return x!==-1&&(h[x]=C.data[0]),[...h]})}catch(f){console.error(f)}},[n]),p=o.useCallback(()=>{i.forEach(c=>{!c.is_started&&!c.is_ended&&s(c.id)})},[i,s]);return o.useEffect(()=>{a()},[e,a]),o.useEffect(()=>{l([]),l(u);const c=setInterval(()=>{p()},5e3);return()=>{l([]),clearInterval(c)}},[e,u,p]),t.jsx(je,{children:t.jsx(P.Row,{style:{gap:"30px 0"},children:r.loading?Array.from({length:8}).map((c,f)=>t.jsx(P.Col,{md:3,children:t.jsx(te,{})},`skeleton-card-${f}`)):i.length===0?t.jsx(N.Text,{style:{paddingLeft:K?20:40},children:d("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:i.map(c=>t.jsx(P.Col,{xs:12,md:6,lg:3,children:t.jsx(ye,{consultation:c})},c.id))})})})},$=o.memo(Te),be=w.div`
  .course-section {
    margin-top: 0px;
  }
