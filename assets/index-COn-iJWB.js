import{q as x,j as t,p as y,ag as B,r as l,f as w,H as $,i as C,a1 as P,aM as L,ar as f,aN as S,aO as z,T as v,h as k,aP as O,aQ as W,aR as Q,x as N,y as V,aS as D,ay as R,aw as I,aT as q,L as M,o as T,aF as H,aU as U,m as K,v as Y}from"./index-CZ-rWARv.js";import{u as m,C as G,a as J,b as X}from"./CourseAgenda-DgdKuBRd.js";import{R as Z}from"./index-pCaNK4cn.js";import{b as ee,Q as te}from"./questionnaires-DwLB5fyz.js";import{u as se}from"./useDownloadCertificate-B50gcVaP.js";import"./index-DVActjap.js";import"./Upload-BwOaxFgT.js";const ie=x.div`
...
`,qe=()=>{const{currentCourseProgram:e}=m(),{t:s}=w();return t.jsxs(Qe,{children:[t.jsxs(Ve,{children:[t.jsx("span",{children:s("CoursePanel.Course",{defaultValue:"Kurs"})})," ",e==null?void 0:e.title]}),t.jsx(M,{to:T.myProfile,children:t.jsxs(De,{children:[!C&&t.jsx(Re,{children:s("CoursePanel.Leave")}),t.jsx(U,{})]})})]})},He=x.div`
  ...
  z-index: 1000;
`,Ue=()=>{const{showFinish:e,currentLesson:s}=m();return t.jsxs(He,{children:[t.jsx(qe,{}),!e&&t.jsx(Fe,{}),e&&t.jsx(We,{}),(s==null?void 0:s.id)&&t.jsx(me,{lessonID:s==null?void 0:s.id})]})},Ke=()=>t.jsx(X,{children:t.jsx(Ue,{})}),st=()=>{var s;const{program:e}=l.useContext(K.EscolaLMSContext);return t.jsx(Y,{metaTitle:((s=e.value)==null?void 0:s.title)||"Course",children:t.jsx(Ke,{})})};export{st as default};
