...
`,R=({error:t,goTo:s=y.courses,goToText:e,alternativeButton:o})=>{const{t:a}=w(),l=F(),i=e??a("CoursePage.SeeOtherCourses");return r.jsx(L,{children:r.jsxs(Ce,{children:[r.jsx(S.Text,{size:"16",children:r.jsx("strong",{children:a("CoursePage.ErrorOccurred")})}),r.jsx(S.Text,{size:"14",children:t}),r.jsx("hr",{}),r.jsxs("div",{className:"buttons-block",children:[r.jsx(_.Button,{mode:"secondary",onClick:()=>l.push(s),children:i}),o&&r.jsx(_.Button,{mode:"outline",onClick:()=>l.push(o.goTo),children:o.goToText})]})]})})},be=D.section`
