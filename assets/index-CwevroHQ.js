import{b as E,U as M,r as i,m as k,j as e,q as x,i as n,W as c,L as m,aA as N,y as d,O as u,T as b,f as p,h as L,o as v,aB as C,I as T,aC as _,l as I,aD as R,aE as h,aF as B,aG as z,aH as A,ar as S,ak as D,al as W,w as G,C as O}from"./index-7DCmJPFg.js";import{P as U}from"./index-D5PKkC6e.js";import{a as q}from"./PricingCard-DNMZxe6F.js";import{P as F}from"./index-CcB8IiQf.js";import{B as H}from"./index-D5R4M1Nt.js";const V=E.createContext({}),J=({children:t})=>{const{id:a}=M(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},K=x.div`
  width: 100%;
  left: 0;
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(U,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},fe=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(G,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(J,{children:e.jsx(O,{children:e.jsx(pe,{})})})})};export{fe as default};
