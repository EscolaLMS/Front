...
`,et=({step:n,onAnswer:t,answers:p})=>{const{settings:e}=F.useContext(be.EscolaLMSContext),{i18n:r}=ie(),s=F.useCallback(()=>n.image?e.value.onboarding[n.image]:null,[n,e.value.onboarding]),g=F.useCallback(u=>{switch(n.type){case J.radio:return C.jsx(X.Radio,{value:u.value,label:u.label[r.language],name:n.data,onChange:l=>t(l.target.value)});case J.options:return C.jsx(Je,{$isActive:p&&p[n.data]===u.value||!1,onClick:()=>t(u.value),children:u.label[r.language]});default:return C.jsx(X.Radio,{value:u.value,label:u.label[r.language],name:n.data,onChange:l=>t(l.target.value)})}},[r.language,n.type,n.data,t,p]);return C.jsxs(Ze,{children:[n.image&&s()&&C.jsx("div",{className:"step-image",children:C.jsx(xe,{path:s(),srcSizes:[500,750,1e3]})}),n.hint&&C.jsxs(Qe,{children:[C.jsx(X.Title,{level:4,children:n.hint.title[r.language]}),C.jsx(X.Text,{size:"13",children:n.hint.text[r.language]})]}),C.jsx(X.Title,{level:4,children:n.question[r.language]}),C.jsxs("div",{className:`options ${n.type===J.options?"buttons":""}`,children:[n.type===J.slide&&C.jsx(Ke,{options:n.options,onAnswer:t}),n.type!==J.slide&&n.options.map((u,l)=>C.jsx("div",{className:"option",children:g(u)},u.value+l))]})]})},tt=Y.div`
