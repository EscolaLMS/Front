import{b as J,G as K,r as o,h as L,j as e,A as m,f as h,v as A,l as v,T as p,q as E,s as x,as as S,k as C,at as b,au as Q,av as Z,aw as ee,ai as te,i as se,a2 as q,o as u,p as j,N,ax as ie,ay as ae,Y as re,al as z,ad as ne,ae as oe,ak as le,az as de,X as ce,aA as xe,aq as me,L as pe,C as ue}from"./index-DuLQ5VKT.js";import{P as he}from"./index-B17mMKeX.js";import{B as ge}from"./index-YzPqBO_p.js";import{a as Y}from"./ResponsiveImage-D9-kAHzA.js";import{P as X}from"./PricingCard-CZ6W3Msx.js";import{P as je}from"./index-Csz7Orhm.js";import{D as Ee}from"./index-BPm157He.js";import{C as _}from"./index-CY_0W4mQ.js";import{E as w}from"./index-lMPDo6hl.js";import"./index-PVNoMdOp.js";import"./index-C7thBZXl.js";import"./index-zkd_jZQt.js";const ve=J.createContext({}),Ce=({children:t})=>{const{id:s}=K(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
