import{H as M,c as y,j as e,g as n,q as p,L as m,aL as E,o as d,J as c,D as x,T as v,a as u,b as L,f as b,aM as C,W as w,ah as N,au as $,aE as I,aF as h,aG as R,aH as B,aI as _,as as z,k as D,C as A}from"./index-DG-N9xU8.js";import{r as o,R as W}from"./sentry-DZqhWugq.js";import{P as G}from"./index-BRzv9TBs.js";import{a as H}from"./PricingCard-BkzArigh.js";import{P as q}from"./index-DEhRzHsz.js";import{B as F}from"./index-w1STyiu0.js";import{C as O,T as U}from"./index-CCeFqGfb.js";import"./katex-D1m830yy.js";import"./lodash-Bu-jC-fW.js";const J=W.createContext({}),V=({children:t})=>{const{id:s}=M(),{fetchProduct:a}=o.useContext(y.EscolaLMSContext);return o.useEffect(()=>{s&&a(Number(s))},[a,s]),e.jsx(J.Provider,{value:{},children:t})},K=p.div`
  width: 100%;
  left: 0;
...
//# sourceMappingURL=index-BgPerruM.js.map
