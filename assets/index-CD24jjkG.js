import{b as S,r as i,h as w,k as P,i as k,j as e,q as v,n as d,f as u,T as $,G as _,L as C,ax as T,aK as N,aL as E,U as F,X as L,S as I,w as y,D as H,o as M,C as R}from"./index-Bo8UkscO.js";import{q as f}from"./base-C7euzKDi.js";import{C as q}from"./index-CnadCGrz.js";import{C as B}from"./index-DzuqAlYx.js";import{F as D,S as O}from"./index-mrm-aJDu.js";import{P as U}from"./index-D6txpOmq.js";import{a as X}from"./ResponsiveImage-wHQCVyd2.js";import{C as z}from"./index-PGMEsYK1.js";import{T as A}from"./index-BlWqUIM7.js";import{C as G}from"./index-rPhH6DdW.js";import"./swiper-react-dLA_7gCe.js";const h=S.createContext({}),b=(s={})=>f.stringify(s),K=({children:s})=>{const{fetchProducts:r,products:a,fetchCategories:t,fetchTags:n}=i.useContext(w.EscolaLMSContext),o=P(),{push:g}=k();i.useEffect(()=>{t(),n()},[]);const[c,x]=i.useState(),m=(l={})=>({page:1,per_page:8,type:"bundle",order_by:"created_at",order:"DESC",...l});return i.useEffect(()=>{g(`${o.pathname}?${b(c)}`)},[c,o.pathname]),i.useEffect(()=>{if(o.search&&o.search.split("?")[1]!==b(c)){const l=f.parse(o.search);x(l),r(l||{})}else r(m(c))},[o.search]),e.jsx(h.Provider,{value:{params:c,setParams:x,packages:a},children:s})},J=({children:s})=>{const r=v("div")`
