import{a as p,j as e,ab as q,T as D,aD as z,D as j,L as B,f as S,o as C,q as T,J as m,aE as G,g as r,aF as u,aG as J,aH as A,aI as U,as as K,ar as I,c as R,b as w,i as Q,p as h,W as L,aJ as V,au as X,C as Y,H as Z,k as b,aK as O}from"./index-C3T_xQie.js";import{r as n}from"./sentry-DZqhWugq.js";import{C as ee,T as te}from"./index-C5bvILM_.js";import{B as se}from"./index-E-PHOJWn.js";import{P as ae}from"./PricingCard-CTNSVXKv.js";import{W as oe}from"./index-KA-ILNb1.js";import{P as ie}from"./index-B5qUEw-E.js";import"./katex-D1m830yy.js";import"./lodash-Bu-jC-fW.js";import"./index-B4MZUx7N.js";import"./useRoles-B4brTDOW.js";import"./questionnaire-CXWDgbJ4.js";import"./index-B7vnVY_d.js";import"./index-BDUkX5Ha.js";const $=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&q(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(D.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(z,{children:t})]})}):null},ne=()=>{const{webinar:t}=n.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(se,{items:[e.jsx(B,{to:S.home,children:a("Home")}),e.jsx(B,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},le=T.div`
  .webinar-main-info {
    .image-wrapper {
...
//# sourceMappingURL=index-BZqB_xrK.js.map
