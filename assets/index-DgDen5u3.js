import{f as p,j as e,al as A,T as D,aE as F,r as l,A as j,L,l as S,s as C,q as T,w as m,ax as H,n as r,ay as u,az as q,aA as J,aB as G,aj as $,h as R,i as U,Z as w,v as h,J as k,aD as Z,N as K,C as Q,D as V,o as X,aJ as Y}from"./index-Cg8uAso-.js";import{C as b,T as O}from"./index-CVOaVgN7.js";import{B as ee}from"./index-C3TBD7zM.js";import{a as te}from"./ResponsiveImage-BIRGvmK9.js";import{P as se}from"./PricingCard-C89Ngzit.js";import{W as ae}from"./index-ubM2d0NS.js";import{P as oe}from"./index-BdvnVcn3.js";import"./toast-C85uSAFb.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&A(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(D.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(F,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(L,{to:S.home,children:a("Home")}),e.jsx(L,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
