import{r as a,D as L,f as k,i as _,j as s,x as Q,T as A,s as I,af as W,v,q as y,ah as G,A as K,aX as Z,Z as U,aY as X,aZ as Y,a_ as J,m as V,n as $,L as B,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-BwDDCa5l.js";import{T as ae}from"./Tabs-B1M6WKle.js";import{C as ne}from"./index-tZXKSMhE.js";import{R as ie}from"./ResponsiveImage-BfAhZdZG.js";import{C as le}from"./index-CA9fETjN.js";import{C as de}from"./index-CHrUvAxK.js";import{R as ce}from"./index-CdiRyItl.js";import{b as me,Q as ue}from"./questionnaires-B0SMBGXj.js";import{u as pe}from"./useDownloadCertificate-S0p9VWMq.js";import{u as ge}from"./useRoles-CZ3Pbmi4.js";import{u as H}from"./useSearchParams-CMraK1kM.js";import{P as xe}from"./index-BeRNFxkO.js";import{S as he}from"./swiper-BWFF_Qco.js";import{S as D}from"./swiper-react-CNMkIwij.js";import{C as F}from"./CourseCard-C30JGy12.js";import"./base-C7euzKDi.js";import"./index-DgkCRAhC.js";const fe=({courseData:e,visible:d,onClose:t})=>{const{sendProgress:c}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:i}=_(),p=a.useCallback(async()=>{await c(e.course.id,e.progress.map(({topic_id:g})=>({topic_id:g,status:0}))),i(`/course/${e.course.id}`)},[e.course.id,e.progress,c,i]);return s.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:s.jsxs(s.Fragment,{children:[s.jsx(A.Title,{level:4,children:o("ResetProgressModal.Continue")}),s.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),s.jsxs(W,{$gap:16,children:[s.jsx(v.Button,{mode:"primary",onClick:p,children:o("ResetProgressModal.WantContinue")}),s.jsx(v.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},Ce=y(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
