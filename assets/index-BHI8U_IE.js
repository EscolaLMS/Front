import{r as p,i as D,k as M,l as $,m as L,q as E,j as e,T as B,n as O,o as N,p as z,L as H,s as A,h as q,v as W,C as I,B as Q,M as F}from"./index-C2iROiop.js";import{C as G}from"./index-NaTBLuQa.js";import{D as y}from"./index-DQiEUBzi.js";import{S as R}from"./swiper-react-DzLCgzby.js";import{S as _}from"./swiper-DHhNMrDW.js";import{C as J}from"./CourseCard-DFrk2dvp.js";import{u as K,C as g}from"./index-BS_93E5A.js";import{C as X,a as Y}from"./index-96reVEJS.js";import"./index-BrOxqmPZ.js";import"./useFetchCourses-kC5AtHzi.js";import"./a11y-oO_e37C6.js";import"./index-BG5Lv-KK.js";import"./useRoles-bVBpPEKV.js";import"./questionnaire-CXWDgbJ4.js";import"./questionnaires-m71dmL-H.js";import"./useDownloadCertificate-DCqODaP1.js";import"./base-7gvCcPfx.js";import"./index-CXwAIU6m.js";const Z=(o=g.ALL)=>{var P,k;const{fetchMyAuthoredCourses:r,myAuthoredCourses:n,fetchPaginatedProgress:l,paginatedProgress:i}=p.useContext(D.EscolaLMSContext),[s,c]=p.useState([]),d=M(),{setQueryParam:m}=K(),{search:w}=$(),x=new URLSearchParams(w),h=x.get("page"),j=x.get("status"),f=p.useMemo(()=>{var t,a;return o===g.AUTHORED?(t=n.list)==null?void 0:t.meta:(a=i.list)==null?void 0:a.meta},[o,(P=n.list)==null?void 0:P.meta,(k=i.list)==null?void 0:k.meta]),C=p.useCallback(t=>{let a="";switch(t){case 1:case 5:break;case 2:a="started";break;case 3:a="planned";break;case 4:a="finished";break}return a},[]);p.useEffect(()=>{l({page:h?parseInt(h):1,per_page:18,status:C(Number(j))}),(o===g.ALL||o===g.AUTHORED)&&r()},[l,o,r,h,j,C]);const T=p.useMemo(()=>{var t;return(((t=i.list)==null?void 0:t.data)||[]).reduce((a,u)=>({...a,[u.course.id?u.course.id:-1]:Math.round((u.progress||[]).reduce((S,U)=>U.status===1?S+1:S,0)/u.progress.length*100)}),{})},[i]),b=p.useCallback(t=>t.map(a=>({...a.course,courseData:a,progress:T[a.course.id?a.course.id:-1]})),[T]);return p.useEffect(()=>{var t,a,u,S;o!==g.AUTHORED?c(b(((t=i.list)==null?void 0:t.data)||[])):o===g.AUTHORED?c(((a=n.list)==null?void 0:a.data)||[]):c([...b(((u=i.list)==null?void 0:u.data)||[]),...((S=n.list)==null?void 0:S.data)||[]])},[o,i,n,b]),{coursesToMap:s,paginationMeta:f,loading:i.loading||n.loading,handlePagination:t=>{m("page",`${t}`),window==null||window.scrollTo(0,0)},redirectToCourses:()=>d.push(L.courses)}},V=E.div`
  position: relative;
