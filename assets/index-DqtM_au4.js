import{f as p,j as e,ag as z,o as R,au as F,r as l,A as j,v as B,l as S,T as C,q as T,s as m,an as H,k as r,ao as u,ap as A,aq as G,ar as U,h as D,i as J,a0 as K,p as h,K as L,at as w,W as Q,C as V,G as X,L as Y,az as Z}from"./index-CJUViYQs.js";import{C as b,T as O}from"./index-DQ5zMKuv.js";import{B as ee}from"./index-CWOTO5_N.js";import{a as te}from"./ResponsiveImage-CYeKSXk0.js";import{f as $}from"./date-DocSkm8y.js";import{P as se}from"./PricingCard-BTy5Kmij.js";import{W as ae}from"./index-CJ1mQ1ho.js";import{P as oe}from"./index-CAagf-yf.js";import"./app-B2E7767C.js";import"./index-D-lsSNuI.js";import"./index-CkZQCNYJ.js";const I=({description:t,title:a})=>{const{t:o}=p();return t?e.jsx(e.Fragment,{children:t&&z(t)!==""&&e.jsxs("section",{className:"with-border",children:[e.jsx(R.Title,{level:4,children:a??o("SectionDescriptionTitle")}),e.jsx(F,{children:t})]})}):null},ie=()=>{const{webinar:t}=l.useContext(j.EscolaLMSContext),{t:a}=p();return t.value?e.jsx(ee,{items:[e.jsx(B,{to:S.home,children:a("Home")}),e.jsx(B,{to:S.webinars,children:a("Menu.Webinars")}),e.jsx(C.Text,{size:"12",children:t.value.name})]}):null},ne=T.div`
  .webinar-main-info {
    .image-wrapper {
