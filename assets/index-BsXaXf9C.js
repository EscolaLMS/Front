...
`,Re=({courseId:e})=>{const{fetchCertificates:d}=l.useContext(I.EscolaLMSContext),{downloadCertificate:r,loadingId:i}=ve(),{t:a}=R(),[x,b]=l.useState(!1),y=l.useCallback(async()=>{try{const u=await d({assignable_type:ae.CertificateAssignableTypes.Course,assignable_id:Number(e)});if(u&&u.success){const j=u.data||[];if(j.length===0){b(!0);return}j.forEach(({id:C,title:p})=>{r(C,p)})}}catch(u){oe(`${a("UnexpectedError")}`,"error"),console.log(u)}},[e,r,a,d]);return t.jsx(Z,{onClick:y,children:!x&&t.jsxs(t.Fragment,{children:[t.jsx(ie,{})," ",a("MyProfilePage.DownloadCertificate")," ",i>-1&&t.jsx(V,{width:"10px",height:"10px"})]})})},Z=k.button`
  all: unset;
...
`,Ie=()=>{const{t:e}=R(),{isTutor:d}=$e(),{query:r,setQueryParam:i}=X(),a={tabs:[{label:e("MyProfilePage.ALlCourses"),key:1,component:t.jsx(N,{filter:"all"})},{label:e("MyProfilePage.InProgress"),key:2,component:t.jsx(N,{filter:"inProgress"})},{label:e("MyProfilePage.Finished"),key:4,component:t.jsx(N,{filter:"finished"})},{label:e("MyProfilePage.Authored"),key:5,component:t.jsx(N,{filter:"authored"}),hidden:!d}],defaultActiveKey:Number(r.get("status")||1)};return t.jsx(ge,{children:t.jsx(Fe,{children:t.jsx(he,{children:t.jsx("div",{className:"courses-wrapper",children:t.jsx(Y.Tabs,{onClick:x=>{i("status",String(x)),i("page","1")},tabs:a.tabs,defaultActiveKey:a.defaultActiveKey})})})})})},Ge=Object.freeze(Object.defineProperty({__proto__:null,CourseStatus:S,default:Ie},Symbol.toStringTag,{value:"Module"}));export{S as C,Ge as i,X as u};
