import{r as o,i as H,h as I,af as Q,j as t,V as P,y as N,o as K,q as w,L as se,al as re,X as ae,N as q,aQ as U,aR as X,aS as Y,aT as z,aU as G,ak as oe,at as ie,aV as ce,g as de,z as O,aW as le,aX as ue,T as me,F as Z,aY as ee,a0 as fe,v as pe,C as ge}from"./index-C2iROiop.js";import{a as he,T as xe}from"./index-BS_93E5A.js";import{C as Ce}from"./index-96reVEJS.js";import{P as je,C as ye,D as R,a as M,b as _e}from"./index-hWQhmtvK.js";import{C as te}from"./CourseCard-DFrk2dvp.js";import{u as B,R as Ee}from"./useRoles-bVBpPEKV.js";import{Q as F}from"./questionnaire-CXWDgbJ4.js";import{u as ve,Q as we}from"./index-CZwRHw1u.js";import"./questionnaires-m71dmL-H.js";import"./useDownloadCertificate-DCqODaP1.js";import"./base-7gvCcPfx.js";import"./index-CXwAIU6m.js";import"./swiper-DHhNMrDW.js";import"./swiper-react-DzLCgzby.js";import"./a11y-oO_e37C6.js";import"./floating-ui.react-dom-BVhlJb4a.js";import"./index-BrOxqmPZ.js";import"./index-BG5Lv-KK.js";const Te=({type:e})=>{var g;const{userConsultations:r,fetchUserConsultations:a,token:n}=o.useContext(H.EscolaLMSContext),{t:d}=I(),[i,l]=o.useState([]),u=o.useMemo(()=>{var C;const c=((C=r.list)==null?void 0:C.data.filter(h=>e===k.STARTED||e===k.UPCOMING?h.in_coming||h.is_started:h.is_ended))||[];return Array.from(new Map(c.map(h=>[h.id,h])).values())},[e,(g=r.list)==null?void 0:g.data]),s=o.useCallback(async c=>{try{const C=await(await fetch(`${Q}/api/consultations/me?ids[]=${c}`,{headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`}})).json();C.success&&C.data.length>0&&l(h=>{const x=h.findIndex(m=>m.id===c);return x!==-1&&(h[x]=C.data[0]),[...h]})}catch(f){console.error(f)}},[n]),p=o.useCallback(()=>{i.forEach(c=>{!c.is_started&&!c.is_ended&&s(c.id)})},[i,s]);return o.useEffect(()=>{a()},[e,a]),o.useEffect(()=>{l([]),l(u);const c=setInterval(()=>{p()},5e3);return()=>{l([]),clearInterval(c)}},[e,u,p]),t.jsx(je,{children:t.jsx(P.Row,{style:{gap:"30px 0"},children:r.loading?Array.from({length:8}).map((c,f)=>t.jsx(P.Col,{md:3,children:t.jsx(te,{})},`skeleton-card-${f}`)):i.length===0?t.jsx(N.Text,{style:{paddingLeft:K?20:40},children:d("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:i.map(c=>t.jsx(P.Col,{xs:12,md:6,lg:3,children:t.jsx(ye,{consultation:c})},c.id))})})})},$=o.memo(Te),be=w.div`
  .course-section {
    margin-top: 0px;
  }
...
`,Ie=({product:e})=>e?t.jsx(se,{to:`/consultations/${e.id}`,children:e.poster_path?t.jsx(re,{path:e.poster_path,alt:e.name,srcSizes:[300,600,900]}):t.jsx(Ce,{})}):null,Se=w.div`
  display: flex;
  align-items: center;
  user-select: none;
...
`,Pe={reported:{type:v.WAITING,info:"ConsultationStatus.UnconfirmedInfo"},approved:{type:v.ACCEPTED,info:"ConsultationStatus.ConfirmedInfo"},reject:{type:v.ENDED,info:"ConsultationStatus.RejectedInfo"}},Ne=({consultation:e})=>{const{approveConsultationTerm:r,rejectConsultationTerm:a}=o.useContext(q.EscolaLMSContext),{t:n}=I(),d=i=>{switch(i){case"reported":return t.jsx(A,{status:v.WAITING,name:n("ConsultationStatus.Unconfirmed")});case"approved":return t.jsx(A,{status:v.ACCEPTED,name:n("ConsultationStatus.Appointment")});case"reject":return t.jsx(A,{status:v.ENDED,name:n("ConsultationStatus.Canceled")})}};return t.jsx(Ae,{children:e.users.map(i=>t.jsxs("div",{children:[t.jsxs(N.Text,{className:"text",children:[i.first_name," ",i.last_name]}),t.jsx(N.Text,{className:"text",children:i.email}),e.users.length>1&&t.jsxs(t.Fragment,{children:[Pe[i.executed_status]&&d(i.executed_status),t.jsxs(De,{children:[t.jsx(U,{icon:t.jsx(X,{}),text:n("Confirm"),onClick:()=>r(e.consultation_term_id,e.date,i.id)}),t.jsx(U,{icon:t.jsx(Y,{}),text:n("Cancel"),onClick:()=>a(e.consultation_term_id,e.date,i.id)})]})]}),t.jsx("hr",{})]},i.id))})},Re=w.div`
  display: flex;
  flex-direction: row;
...
`,$e=({time:e})=>t.jsxs(ke,{children:[t.jsx("div",{className:"icon-container",children:t.jsx(ie,{color:"#ffffff",width:"22px",height:"22px"})}),t.jsx(N.Text,{className:"time",children:e})]}),Le=w.div`
  ...
  width: 100%;
  gap: 12px;
`,Ue=({consultation:e})=>t.jsxs(Le,{children:[t.jsx(Ne,{consultation:e}),t.jsx($e,{time:e.duration}),t.jsx(Me,{consultation:e})]});var Oe=ce();const Fe=de(Oe),Qe=({consultation:e})=>{const{approveConsultationTerm:r,rejectConsultationTerm:a}=o.useContext(q.EscolaLMSContext),{t:n}=I(),{consultation_term_id:d}=e,i=o.useMemo(()=>[{id:1,content:t.jsx(U,{icon:t.jsx(X,{}),text:n("Confirm"),onClick:()=>r(d,e.date)})},{id:2,content:t.jsx(U,{icon:t.jsx(Y,{}),text:n("Cancel"),onClick:()=>a(d,e.date)})}],[r,d,a,n,e.date]);return t.jsx(Fe,{menuItems:i,child:t.jsx(O.Button,{mode:"icon",children:t.jsx(le,{})})})},qe=w.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  justify-content: space-between;
...
`,ut=({message:e,closeToast:r,userConsentedRef:a})=>{const{t:n}=I();return t.jsxs(dt,{className:"jitsy-message",children:[t.jsx(me.Title,{className:"jitsy-message__title",children:n("ConsultationPage.EmotionConsent")}),t.jsx(N.Text,{size:"16",children:e}),t.jsxs(lt,{children:[t.jsx(O.Button,{onClick:()=>[a.current=!0,r()],children:n("ConsultationPage.Yes")}),t.jsx(O.Button,{mode:"secondary",onClick:()=>[a.current=!1,r()],children:n("ConsultationPage.No")})]})]})},mt=w(Z.Modal)`
  .rc-dialog-content {
    border-radius: 15px;
  }
  .rc-dialog-body {
