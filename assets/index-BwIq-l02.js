import{r as a,A as L,f as k,i as _,j as e,x as Q,T as v,s as I,ag as W,v as A,q as w,ai as G,aZ as K,a_ as Z,a0 as U,a$ as J,b0 as V,b1 as X,m as Y,n as $,L as F,h as ee,k as se,l as te,w as N,o as oe,C as re}from"./index-Y7MkVNL0.js";import{T as ae}from"./Tabs-ZA9XUxZK.js";import{C as ie}from"./index-YNenLWAz.js";import{R as ne}from"./ResponsiveImage-Bg5JmU8F.js";import{C as le}from"./index-B4Ft1qWl.js";import{C as ce}from"./index-Czav_-gG.js";import{R as de}from"./index-Bm7tgtz_.js";import{b as ue,Q as me}from"./questionnaires-S75rh2Il.js";import{u as pe}from"./useDownloadCertificate-BgD15HEJ.js";import{t as ge}from"./toast-Do-tUl85.js";import{u as xe}from"./useRoles-CT5000e9.js";import{u as H}from"./useSearchParams-CyoehSAU.js";import{P as he}from"./index-B9bQ0Vbc.js";import{S as fe}from"./swiper-rkUk1TG9.js";import{S as O}from"./swiper-react-CfbYqTKx.js";import{C as B}from"./CourseCard-Bn_O0xpL.js";import"./base-C7euzKDi.js";import"./a11y-G6tS88fM.js";import"./index-cmPkMwOZ.js";const Ce=({courseData:s,visible:d,onClose:t})=>{const{sendProgress:u}=a.useContext(L.EscolaLMSContext),{t:o}=k(),{push:l}=_(),g=a.useCallback(async()=>{await u(s.course.id,s.progress.map(({topic_id:f})=>({topic_id:f,status:0}))),l(`/course/${s.course.id}`)},[s.course.id,s.progress,u,l]);return e.jsx(Q.Modal,{animation:"zoom",maskAnimation:"fade",destroyOnClose:!0,visible:d,onClose:t,children:e.jsxs(e.Fragment,{children:[e.jsx(v.Title,{level:4,children:o("ResetProgressModal.Continue")}),e.jsxs(I.Text,{children:[" ",o("ResetProgressModal.RestartCourse")]}),e.jsxs(W,{$gap:16,children:[e.jsx(A.Button,{mode:"primary",onClick:g,children:o("ResetProgressModal.WantContinue")}),e.jsx(A.Button,{mode:"primary",onClick:t,children:o("ResetProgressModal.Cancel")})]})]})})},je=w(G)`
  gap: 6px;
  margin: 0;
  width: 100%;
  p {
