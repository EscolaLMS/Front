import{b as K,H as Q,r as o,h as L,j as e,D as m,f as h,L as A,l as v,s as p,q as E,w as x,as as S,n as C,at as b,au as Y,av as Z,aw as ee,ai as te,i as se,a1 as q,T as u,v as j,O as N,ax as ie,ay as ae,V as re,al as z,ad as ne,ae as oe,ak as le,az as de,X as ce,aA as xe,aq as me,o as pe,C as ue}from"./index-CBf-QksF.js";import{P as he}from"./index-xwqFlg5Y.js";import{B as ge}from"./index-E9QXZg2w.js";import{a as J}from"./ResponsiveImage-BnPBXGWb.js";import{P as X}from"./PricingCard-poshWCmx.js";import{P as je}from"./index-JHcu9MtM.js";import{D as Ee}from"./index-BdXw4yLt.js";import{C as _}from"./index-X1BgvaTF.js";import{E as w}from"./index-CBDwrCSh.js";import"./index-DSumW0cD.js";import"./index-BRT4m0w7.js";import"./index-DVEYPayL.js";const ve=K.createContext({}),Ce=({children:t})=>{const{id:s}=Q(),{fetchStationaryEvent:i}=o.useContext(L.EscolaLMSContext);return o.useEffect(()=>{s&&i(Number(s))},[i,s]),e.jsx(ve.Provider,{value:{},children:t})},fe=()=>{const{stationaryEvent:t}=o.useContext(m.EscolaLMSContext),{t:s}=h();return t.value?e.jsx(ge,{items:[e.jsx(A,{to:v.home,children:s("Home")}),e.jsx(A,{to:v.events,children:s("Menu.Events")}),e.jsx(p.Text,{size:"12",children:t.value.name})]}):null},be=E.div`
  .event-main-info {
    .image-wrapper {
