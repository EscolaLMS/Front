import{c as ne,a as k,a9 as V,j as t,J as U,o as T,g as ae,q as E,L as Ce,as as je,X as we,D as H,aK as J,aL as oe,aM as ie,aN as Z,aO as ee,ar as ye,ah as be,aP as ve,p as W,aQ as Ee,aR as _e,T as Ie,w as ce,aS as de,U as Te,k as ke,C as Se}from"./index-BVKw6C67.js";import{r as a}from"./sentry-DZqhWugq.js";import{a as Ae,T as De}from"./index-CE0GdeGI.js";import{C as le,b as Ne}from"./CourseCard-ChDb8em-.js";import{P as Pe,C as Re,D as O,a as $,b as Me}from"./index-DIjUyznm.js";import{g as Le}from"./katex-D1m830yy.js";import{u as K,R as Ue}from"./useRoles-Bc6d1cya.js";import{S as P}from"./index-B7vnVY_d.js";import{Q as z}from"./questionnaire-CXWDgbJ4.js";import{u as Oe,Q as $e}from"./index-Dz5GNhBo.js";import"./lodash-Bu-jC-fW.js";import"./questionnaires-BF59slla.js";import"./useDownloadCertificate-BAilYigp.js";import"./base-Bd27snqx.js";import"./index-fNrV6ZDE.js";import"./swiper-B7A2CjwQ.js";import"./swiper-CphuuvCl.js";import"./index-85pqyAwa.js";const We=({type:e})=>{var h;const{userConsultations:r,fetchUserConsultations:i,token:n}=a.useContext(ne.EscolaLMSContext),{t:l}=k(),[c,u]=a.useState([]),m=a.useMemo(()=>{var C;const s=((C=r.list)==null?void 0:C.data.filter(g=>e===B.STARTED||e===B.UPCOMING?g.in_coming||g.is_started:g.is_ended))||[];return Array.from(new Map(s.map(g=>[g.id,g])).values())},[e,(h=r.list)==null?void 0:h.data]),o=a.useCallback(async(s,f)=>{try{const g=await(await fetch(`${V}/api/consultations/me?ids[]=${s}`,{headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`}})).json();if(g.success&&g.data.length>0){const p=g.data.findIndex(d=>(d==null?void 0:d.consultation_term_id)===f);u(d=>{const y=d.findIndex(j=>(j==null?void 0:j.consultation_term_id)===f);return y!==-1&&p!==-1&&(d[y]=g.data[p]),[...d]})}}catch(C){console.error(C)}},[n]),x=a.useCallback(()=>{c.forEach(s=>{!s.is_started&&!s.is_ended&&(s==null?void 0:s.consultation_term_id)!==void 0&&o(s==null?void 0:s.id,s==null?void 0:s.consultation_term_id)})},[c,o]);return a.useEffect(()=>{i()},[e,i]),a.useEffect(()=>{u([]),u(m);const s=setInterval(()=>{x()},3e4);return()=>{u([]),clearInterval(s)}},[e,m,x]),t.jsx(Pe,{children:t.jsx(U.Row,{style:{gap:"30px 0"},children:r.loading?Array.from({length:8}).map((s,f)=>t.jsx(U.Col,{md:3,children:t.jsx(le,{})},`skeleton-card-${f}`)):c.length===0?t.jsx(T.Text,{style:{paddingLeft:ae?20:40},children:l("MyProfilePage.OrdersEmpty")}):t.jsx(t.Fragment,{children:c.map(s=>t.jsx(U.Col,{xs:12,md:6,lg:3,children:t.jsx(Re,{consultation:s})},s.id))})})})},q=a.memo(We),Be=E.div`
  .course-section {
    margin-top: 0px;
  }
...
//# sourceMappingURL=my-consultations-CHYsGdJW.js.map
