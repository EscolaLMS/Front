import{b as M,K as N,r as i,m as k,j as e,q as x,i as n,z as c,L as m,at as E,x as d,H as u,T as b,f as p,h as L,o as v,au as C,I as T,av as _,l as I,aw as R,ax as h,ay as z,az as B,aA as A,ak as S,ad as D,ae as W,v as q,C as G}from"./index-mArHxJMN.js";import{P as H}from"./index-BDBGXbep.js";import{a as O}from"./PricingCard-D5KoYlJW.js";import{P as U}from"./index-BzUxKdvM.js";import{B as F}from"./index-DXdjY6lF.js";import"./index-CKMSAvs9.js";const V=M.createContext({}),K=({children:t})=>{const{id:a}=N(),{fetchProduct:s}=i.useContext(k.EscolaLMSContext);return i.useEffect(()=>{a&&s(Number(a))},[s,a]),e.jsx(V.Provider,{value:{},children:t})},J=x.div`
  width: 100%;
  left: 0;
...
`,Q=({children:t})=>e.jsx(J,{children:t});var l=(t=>(t.Consultation="App\\Models\\Consultation",t.StationaryEvent="App\\Models\\StationaryEvent",t.Course="App\\Models\\Course",t.Webinar="App\\Models\\Webinar",t))(l||{});const X=t=>t.reduce((a,s)=>{const o=s.productable_type,r=a[o]??[];return{...a,[o]:[...r,s]}},{}),Y=x(c.Col)`
...
`,pe=()=>{const{product:t}=i.useContext(u.EscolaLMSContext),{t:a}=p();return t.loading||!t.value?e.jsx(H,{}):e.jsx(me,{children:e.jsxs(c.Row,{children:[e.jsxs(c.Col,{md:12,lg:9,children:[e.jsx(ne,{}),e.jsx(oe,{}),e.jsx(le,{title:a("PackagePage.CompaniesSectionTitle")}),e.jsx(ue,{}),e.jsx(xe,{title:a("PackagePage.TutorsSectionTitle"),users:t.value.authors})]}),e.jsx(c.Col,{md:12,lg:3,children:e.jsx(se,{})})]})})},we=()=>{var a;const{product:t}=i.useContext(u.EscolaLMSContext);return e.jsx(q,{metaTitle:(a=t.value)==null?void 0:a.name,children:e.jsx(K,{children:e.jsx(G,{children:e.jsx(pe,{})})})})};export{we as default};
