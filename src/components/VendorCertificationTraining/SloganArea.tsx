  ...
  return (
    <div className="slogan-area mtb-100 bg-fffaf3 ptb-100">
        ...
        <div className="row align-items-center">
          <div className="col-lg-5 col-md-12">
            <div className="slogan-image">
              <img
                src={`${process.env.PUBLIC_URL}/images/man3.jpeg`}
                alt="image"
              />
            </div>
          </div>
      ...
      <div className="shape2">
        <img src={`${process.env.PUBLIC_URL}/images/shape2.png`} alt="image" />
      </div>
      <div className="shape3">
        <img src={`${process.env.PUBLIC_URL}/images/shape3.png`} alt="image" />
      </div>
      <div className="shape4">
        <img src={`${process.env.PUBLIC_URL}/images/shape4.png`} alt="image" />
      </div>
