  ...
  return (
    <div className="view-all-courses-area-two ptb-70 bg-fef8ef">
        ...
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-12">
            <div className="view-all-courses-content">
              ...
              <p>
                With The Open University you can study whenever and wherever you choose. We have
                students in over 128 countries, and a global reputation as a pioneer in the field of
                flexible learning. Our flexible teaching also means, if you travel often or need to
          ...
          <div className="col-lg-6 col-md-12">
            <div className="view-all-courses-image">
              ...
              <div className="shape11" data-speed="0.06" data-revert="true">
                <img src={`${process.env.PUBLIC_URL}/images/shape10.png`} alt="Course Shape" />
              </div>
              <div className="shape12" data-speed="0.06" data-revert="true">
                <img src={`${process.env.PUBLIC_URL}/images/shape11.png`} alt="Course Shape" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="shape1" data-speed="0.06" data-revert="true">
        <img src={`${process.env.PUBLIC_URL}/images/shape1.png`} alt="Course Shape" />
      </div>
      <div className="shape9" data-speed="0.06" data-revert="true">
        <img src={`${process.env.PUBLIC_URL}/images/shape8.svg`} alt="Course Shape" />
      </div>
    </div>
  );
};
