...
const mockResponseFetchSuccess = {
  ...
  data: {
    ...
    title: "Enim voluptatem est doloremque facilis ipsa et soluta suscipit.",
    summary:
    ...
    lessons: [
      {
        ...
        topics: [
          ...
          },
          {
            ...
            lesson_id: 49,
            topicable_id: 70,
            topicable_type: "EscolaLms\\Courses\\Models\\TopicContent\\H5P",
            order: 0,
            active: true,
            preview: false,
            topicable: {
        ...
        topics: [
          {
            ...
            lesson_id: 45,
            topicable_id: 5,
            topicable_type: "EscolaLms\\Courses\\Models\\TopicContent\\OEmbed",
            order: 7,
            active: true,
            preview: false,
            topicable: {
