      ...
      lectures: [
        {
          ...
          resources: [
            ...
            },
            {
              ...
              file_size: "4113874",
              duration: null,
              file_tag: "program_resource_link",
              uploader_id: 2,
              course_id: 1,
              processed: 1,
              created_at: null,
        ...
        },
        {
          lecture_quiz_id: 2,
          type: null,
          title: "Asperiores officiis inventore repudiandae minus deleniti.",
          description:
...
describe("redux saga data", () => {
  ...
  it("handles fetch success", () => {
    const goodResponse = {
      loading: false,
      error: false,
      list: mockResponseFetchSuccess.sections,
    };
